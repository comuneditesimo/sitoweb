...
public partial class FORM_Definition_Event
{
    ...
    [InverseProperty("FORM_Definition_Event")]
    public virtual FORM_Definition FORM_Definition { get; set; }

    [InverseProperty("FORM_Definition_Event")]
    public virtual ICollection<FORM_Definition_Event_Extended> FORM_Definition_Event_Extended { get; set; } = new List<FORM_Definition_Event_Extended>();
}