...
[Keyless]
public partial class V_CANTEEN_RequestRefundBalances_Report
{
    ...
    public string AuthorityMail { get; set; }

    public string AuthorityMailIT { get; set; }
    ...
    public string Privacy_DE { get; set; }
