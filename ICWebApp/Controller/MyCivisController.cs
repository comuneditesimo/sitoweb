...
namespace ICWebApp.Controller
{
    ...
    public class MyCivisController : ControllerBase
    {
        ...
        public async Task<IActionResult> Services()
        {
            ...
            {
                var services = await _ConfProvider.GetMyCivisConfiguration(municipality.AUTH_Municipality_ID);
        ...
        public async Task<IActionResult> ServicesPositions(string lang, string? fiscalNumber = null, string? vatCode = null, string? iamPersonId = null, string? serviceUids = null)
        {
            ...
            if (municipality != null && lang != null)
            {
                var services = await _ConfProvider.GetMyCivisConfiguration(municipality.AUTH_Municipality_ID);
                    ...
                    if (!Request.Host.Value.Contains("localhost"))
                    {
                        ...
                        if (Commitresponse.StatusCode == System.Net.HttpStatusCode.OK)
                        {
                            ...
                            if (data != null && data.owner != null)
                            {
                                ...
                                externalVerif.PlaceOfBirth = data.owner.birthPlace.italianMunicipality.Name;
                                ...
                                var currentLang = await _UnitOfWork.Repository<LANG_Languages>().FirstOrDefaultAsync(p => p.ID == municipality.DefaultLanguage);
        ...
        private async Task<AUTH_Comunix_Urls?> GetMunicipality()
        {
            //URLUPDATE --TOTEST does this even still work? Can't make any requests to localhost/mycivis/services...
            ...
            */
            ...
            var cmxUrls = await _UnitOfWork.Repository<AUTH_Comunix_Urls>().ToListAsync();
            var url = cmxUrls.FirstOrDefault(e => Request.Host.Value.ToLower().Contains(e.Url.ToLower()));
