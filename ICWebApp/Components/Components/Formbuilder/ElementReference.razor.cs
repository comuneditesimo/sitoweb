...
namespace ICWebApp.Components.Components.Formbuilder
{
    public partial class ElementReference
    {
                ...
                if (formFields != null)
                {
                    ...
                    foreach(var f in formFields)
                    {
                        if (f.FORM_Definition_Fields_Type_ID != null)
                        {
                            ...
                            else if (type != null && type.CanBeReferenced == true && Model.FORM_Definition_Fields_Type_ID == FORMElements.ColumnContainer && type.ID == FORMElements.Number)        //Number
                            {
                                PossibleReferenceList.Add(f);
                            }
                            else if (type != null && type.CanBeReferenced == true && Model.FORM_Definition_Fields_Type_ID == FORMElements.ColumnContainer && type.ID == FORMElements.CalculatingFields)        //DROPDOWN
                            {
                                PossibleReferenceList.Add(f);
                            }
                            ...
                            else if (type != null && Model.FORM_Definition_Fields_Type_ID == FORMElements.CalculatingFields && type.ID == FORMElements.Number)
                            {
                                PossibleReferenceList.Add(f);
                            }
                            else if (type != null && Model.FORM_Definition_Fields_Type_ID == FORMElements.CalculatingFields && type.ID == FORMElements.Money)
                            {
                                PossibleReferenceList.Add(f);
                            }
                            else if (type != null && Model.FORM_Definition_Fields_Type_ID == FORMElements.CalculatingFields && type.ID == FORMElements.CalculatingFields && Model.ID != f.ID)
                            {
                                PossibleReferenceList.Add(f);
                            }
                        }
        ...
        private async Task<bool> AddReference()
        {
            ...
            fref.FORM_Definition_Field_Source_ID = null;
            fref.TriggerValue = null;
            fref.IsCalculatingFieldReference = false;

            long NextNumber = 0;

            if(Model.FORM_Definition_Field_ReferenceFORM_Definition_Field != null &&
               Model.FORM_Definition_Field_ReferenceFORM_Definition_Field.Where(p => p.ToRemove == false && p.IsCalculatingFieldReference != true).Count() > 0 &&
               Model.FORM_Definition_Field_ReferenceFORM_Definition_Field.Where(p => p.ToRemove == false && p.IsCalculatingFieldReference != true).Max(p => p.SortOrder) != null)
            {
                NextNumber = Model.FORM_Definition_Field_ReferenceFORM_Definition_Field.Where(p => p.ToRemove == false && p.IsCalculatingFieldReference != true).Max(p => p.SortOrder)!.Value + 1;
            }
        ...
        private async Task<bool> AddCalculatingFieldReference()
        {
            FORM_Definition_Field_Reference fref = new FORM_Definition_Field_Reference();
            ...
            fref.FORM_Definition_Field_Source_ID = null;
            fref.TriggerValue = null;
            fref.IsCalculatingFieldReference = true;
        ...
        {
            if (fref.IsCalculatingFieldReference == true)
            {
                var previousItem = Model.FORM_Definition_Field_ReferenceFORM_Definition_Field.Where(p => p.ToRemove == false && p.IsCalculatingFieldReference == true).FirstOrDefault(p => p.SortOrder == fref.SortOrder - 1);
