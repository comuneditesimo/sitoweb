...
namespace ICWebApp.Components.Components.Formbuilder
{
    public partial class ElementContainer
    {
        ...
        [Parameter] public EventCallback<FORM_Definition_Field> OnCopyClicked { get; set; }
        ...
        private void OnCopy(FORM_Definition_Field Model)
        {
            OnCopyClicked.InvokeAsync(Model);
            StateHasChanged();
        }
