...
namespace ICWebApp.Components.Components.MainMenu.Frontend
{
    public partial class NavMenu
    {
        ...
        private async Task<bool> LoadMenu()
        {
            try
            {
                ...
                if (SessionWrapper.CurrentMunicipalUser != null && AUTHProvider.HasMunicipalUserRole(AuthRoles.Citizen)) //CITIZEN
                {
