...
namespace ICWebApp.Components.Components.Canteen
{
    public partial class SubscriptionElementComponent
    {
        ...
        private CANTEEN_Configuration? Config;
        ...
        protected override async void OnInitialized()
        {
            ...
            {
                Config = await CanteenProvider.GetConfiguration(SessionWrapper.AUTH_Municipality_ID.Value);
            }
        ...
        protected override async Task OnParametersSetAsync()
        {
            ...
            var CanteenData = await CanteenProvider.GetCanteens(SessionWrapper.AUTH_Municipality_ID.Value);
