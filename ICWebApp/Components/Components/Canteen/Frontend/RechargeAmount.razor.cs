    ...
    public partial class RechargeAmount
    {
        ...
        private async void SaveForm()
        {
            ...
            if (NewBalance > 0 && (PAY_Transaction_IDs == null || PAY_Transaction_IDs.Count() == 0))
            {
                ...
                newPayment.Description = TextProvider.Get("CANTEEN_DASHBOARD_RECARGEBALANCE");
                ...
                trans.Description = TextProvider.Get("CANTEEN_CANTEEN") + " " + TextProvider.Get("CANTEEN_DASHBOARD_RECARGEBALANCE");
                ...
                transPos.Description = TextProvider.Get("CANTEEN_DASHBOARD_RECARGEBALANCE") + " - " + (userAnagrafic?.FiscalNumber ?? (SessionWrapper.CurrentUser.Firstname + " " + SessionWrapper.CurrentUser.Lastname));
