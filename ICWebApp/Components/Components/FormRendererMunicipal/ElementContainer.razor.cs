...
namespace ICWebApp.Components.Components.FormRendererMunicipal
{
    public partial class ElementContainer
    {
        ...
        private void CheckReference()
        {
            ...
            {
                foreach(var f in ReferenceList.Where(p => p.FORM_Definition_Field_ID == DefinitionField.ID && p.IsCalculatingFieldReference != true))
                {
