...
namespace ICWebApp.Components.Components.Tasks.Priority
{
    public partial class Edit
    {
        ...
        [Parameter] public TASK_Priority Priority { get; set; }
        [Parameter] public List<TASK_Priority_Extended> PriorityExtended { get; set; }
        [Parameter] public EventCallback<(TASK_Priority, List<TASK_Priority_Extended>, List<V_TASK_Context>)> Saved { get; set; }
        ...
        private async void SaveForm()
        {
            ...
            await Saved.InvokeAsync((Priority, PriorityExtended, _additionalContexts));
            StateHasChanged();
        }
