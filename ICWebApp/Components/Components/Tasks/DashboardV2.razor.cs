    ...
    public partial class DashboardV2
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            if (SessionWrapper.AUTH_Municipality_ID != null && SessionWrapper.CurrentMunicipalUser != null)
            {
                ...
                AuthorityList = await AuthProvider.GetAlllowedAuthoritiesByMunicipalUser(SessionWrapper.CurrentMunicipalUser.ID);
        ...
        private string GetContextElementColumnTitle()
        {
            if (CurrentContext != null)
            {
                switch (CurrentContext.ID)
                {
                    ...
                    case 2:
                        return TextProvider.Get("GRID_COLUMN_MAINTENANCE");
                }
            }
            return TextProvider.Get("GRID_COLUMN_FORM");
        }
