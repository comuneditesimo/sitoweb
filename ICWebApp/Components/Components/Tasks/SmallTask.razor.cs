...
namespace ICWebApp.Components.Components.Tasks
{
    public partial class SmallTask
    {
        ...
        {
            //Update Change Cache for this task
            TaskService.ChangesCache.AddChange(Task.ID, new TaskChangedValue(ChangeType.ResponsibleAdded, new List<string>(){Responsible.AUTH_Municipal_Users_ID.ToString()}));
        ...
        {
            //Update Change Cache for this task
            TaskService.ChangesCache.AddChange(Task.ID, new TaskChangedValue(ChangeType.ResponsibleRemoved, new List<string>(){Responsible.AUTH_Municipal_Users_ID.ToString()}));
