...
namespace ICWebApp.Components.Components.Tasks
{
    public partial class Edit
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            if (string.IsNullOrEmpty(ID))
            {
                ...
                {
                    Task.CreatedByAUTH_Municipal_User_ID = SessionWrapper.CurrentMunicipalUser.ID;
                }
        ...
        private async Task<bool> ResponsibleRemovedEvent(TASK_Task_Responsible Item)
        {
            ...
            if (addedResponsibles.All(e => e != Item.AUTH_Municipal_Users_ID.Value))
            {
                TaskService.ChangesCache.AddChange(Task, 
                    new TaskChangedValue(ChangeType.ResponsibleRemoved, new List<string>(){Item.AUTH_Municipal_Users_ID.Value.ToString()}), true);
            }
            else
            {
        ...
        {
            addedResponsibles.Add(Item.AUTH_Municipal_Users_ID.Value);
            return true;
        }
