...
using ICWebApp.Components.Components.Global;
...
namespace ICWebApp.Components.Components.User.Backend
{
    public partial class UserSupportComponent
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            {
                UserSettings = await AuthSettingsProvider.GetSettings(SessionWrapper.CurrentMunicipalUser.ID);
            ...
            if (SessionWrapper != null && SessionWrapper.CurrentMunicipalUser != null)
            {
                Ticket.Email = SessionWrapper.CurrentMunicipalUser.Email;
            }
