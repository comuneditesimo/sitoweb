...
namespace ICWebApp.Components.Pages.Canteen.Admin
{
    public partial class CanteenDetailPage
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            {
                Properties = await CanteenProvider.GetPropertyList(SessionWrapper.AUTH_Municipality_ID.Value, LangProvider.GetCurrentLanguageID());
                Ressources = await CanteenProvider.GetRessourceList(SessionWrapper.AUTH_Municipality_ID.Value, LangProvider.GetCurrentLanguageID());
            }
