...
using ICWebApp.Components.Pages.Canteen.Backend;
...
namespace ICWebApp.Components.Pages.Canteen.Admin.SubPages
{
    public partial class CanteenPeriod
    {
        ...
        private async void  SingleSelectionChangeHandler(DateTime newValue)
        {
            ...
            if (day == null)
            {
                var schoolyearList = await CanteenProvider.GetSchoolsyearsCurrent(SessionWrapper.AUTH_Municipality_ID.Value);
