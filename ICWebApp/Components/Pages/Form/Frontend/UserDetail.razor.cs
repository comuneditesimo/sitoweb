...
namespace ICWebApp.Components.Pages.Form.Frontend
{
    public partial class UserDetail
    {
        ...
        private bool _applicationHasMessages = false;
        ...
        protected override async Task OnParametersSetAsync()
        {
            ...
            {
                if((SessionWrapper.CurrentUser == null || CurrentApplication.AUTH_Users_ID != SessionWrapper.CurrentUser.ID) && (SessionWrapper.CurrentSubstituteUser == null || CurrentApplication.AUTH_Users_ID != SessionWrapper.CurrentSubstituteUser.ID))
                {
                    BusyIndicatorService.IsBusy = true;
                    NavManager.NavigateTo("/");
                    StateHasChanged();
                ...
                _applicationHasMessages = await ChatProvider.HasContextMessages(CurrentApplication.ID.ToString());
            }
