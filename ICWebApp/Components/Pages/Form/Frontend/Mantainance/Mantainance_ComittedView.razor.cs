...
{
    public partial class Mantainance_ComittedView
    {
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            if (firstRender)
            {
                ...
                CrumbService.AddBreadCrumb(NavManager.ToBaseRelativePath(NavManager.Uri), "FRONTEND_MANTAINANCES_COMITTED_VIEW", null);
