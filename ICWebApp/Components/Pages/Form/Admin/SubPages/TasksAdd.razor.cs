...
namespace ICWebApp.Components.Pages.Form.Admin.SubPages
{
    public partial class TasksAdd
    {
        ...
        private List<AUTH_Municipal_Users> UserList = new List<AUTH_Municipal_Users>();
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            else
            {
                ...
                if (Data != null && Languages != null && Data.FORM_Definition_Tasks_Extended != null &&
                    Data.FORM_Definition_Tasks_Extended.Count < Languages.Count)
                {
                    foreach (var l in Languages)
                    {
                        if (Data.FORM_Definition_Tasks_Extended.FirstOrDefault(p => p.LANG_Languages_ID == l.ID) == null)
        ...
        private async void AddTarget()
        {
            ...
            {
                UserList = await AuthProvider.GetMunicipalUserList(SessionWrapper.AUTH_Municipality_ID.Value, AuthRoles.Employee);    //EMPLOYEE
            }
        ...
        private async void SaveTarget()
        {
            ...
            {
                CurrentTarget.AUTH_Municipal_Users = null;
