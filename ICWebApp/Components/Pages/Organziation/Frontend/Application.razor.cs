...
namespace ICWebApp.Components.Pages.Organziation.Frontend
{
    public partial class Application
    {
        ...
        {
            NewOrgRequest.PrivacyConfirmed = !NewOrgRequest.PrivacyConfirmed;
        ...
        private async void UpdateAddressData(Guid Municipality_ID)
        {
            ...
            if (data != null)
            {
                ...
                NewOrgRequest.DomicileMunicipality = data.Name;
        ...
        private async void GV_UpdateAddressData(Guid Municipality_ID)
        {
            ...
            if (data != null)
            {
                ...
                NewOrgRequest.GV_DomicileMunicipality = data.Name;
        ...
        private void BolloFreeChangedHandler(bool value)
        {
            bool val = value;
            if (!val)
            {
