...
namespace ICWebApp.Components.Pages.Homepage.Frontend.Request
{
    public partial class Success
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            Data = await HomeProvider.GetRequest(Guid.Parse(ID));
            ...
            SessionWrapper.PageTitle = TextProvider.Get("HOME_REQUEST_SUCCESS_PAGE_TITLE");
            SessionWrapper.PageSubTitle = null;
            SessionWrapper.PageDescription = TextProvider.Get("HOME_REQUEST_SUCCESS_PAGE_DESCRIPTION");
