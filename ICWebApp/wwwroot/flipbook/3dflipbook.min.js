...
!function (modules) {
    ...
    Utils.MOBILE_DIAG = 11, Utils._escapeHTMLchars = {
        "&": "&amp;",
        "<": "&lt;",
        ">": "&gt;"
    ...
    var GraphUtils = function () {
        ...
        return GraphUtils.createCanvas = function (width, height) {
    ...
    var _GraphUtils = __webpack_require__(4),
        ...
        ImageBase = function () {
            ...
            return ImageBase.prototype.setRenderCanvas = function (c, ctx) {
                ...
                return Math.abs(this.resW - this.c.width) >= 1 && (this.c.width = Math.ceil(this.resW)), Math.abs(this.resH - this.c.height) >= 1 && (this.c.height = Math.ceil(this.resH)), this.ctx.save(), this.ctx.scale(this.c.width / this.width, this.c.height / this.height), this.ctx
        ...
        SheetBlock = function () {
            function SheetBlock(visual, p, first, last) {
                ...
                if (this.aSplines = [], this.geometry = _sheetBlock2.default.geometry.clone(), this.p.sideFaces = [{
                    ...
                    map: this.sideTexture
                }), new _libs.THREE.MeshPhongMaterial, new _libs.THREE.MeshPhongMaterial({
                    map: this.sideTexture
                })], this.p.setTexture(this.materials[0], 2 * first), this.p.setTexture(this.materials[1], 2 * last - 1), this.mesh = new _libs.THREE.Mesh(this.geometry, this.materials), this.mesh.castShadow = !0, this.mesh.receiveShadow = !0, this.three = this.mesh, this.three.userData.self = this, this.markers = [], this.p.marker.use) {
            ...
            return SheetBlock.prototype.dispose = function () {
                ...
                return _extends({}, this.p.page, {
                    width: this.p.page.width - (this.reducedWidth ? .001 * this.p.page.width : 0),
                ...
                var off = this.angle > Math.PI / 2 ? 0 : this.geometry.vertices.length / 2;
                ...
                return w0.copy(vs[0]), this.three.localToWorld(w0), w1.copy(vs[1]), this.three.localToWorld(w1), {
                ...
                var vs = this.getTopCerners();
                v.set(0, -100, 0);
                for (var w = new _libs.THREE.Vector3, _iterator3 = vs, _isArray3 = Array.isArray(_iterator3), _i5 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator](); ;) {
                    var _ref3;
                    if (_isArray3) {
                    ...
                    var vi = _ref3;
                    w.copy(vi), this.three.localToWorld(w), v.x += .25 * w.x, v.y = Math.max(w.y, w.y), v.z += .25 * w.z
                }
                return v
                ...
                var state = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.state,
                    ...
                    flipDirection = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : "right",
                    PI = Math.PI;
                this.state = state;
                ...
                if ("closed" === this.state) points = this.getInterpolationPoints(this.closedInterpolationIndeces, this.closedInterpolationIndeces);
                    ...
                    } else points = this.getInterpolationPoints(this.openedInterpolationIndeces["right" === flipDirection ? this.angle > PI / 2 ? "left" : "right" : this.angle < PI / 2 ? "left" : "right"], this.closedInterpolationIndeces);
                var hl = void 0,
                    hr = void 0,
                ...
                var dDepth = .1 * props.depth;
                hl > hr ? (hr -= dDepth, hl += dDepth) : (hr += dDepth, hl -= dDepth);
                ...
                sp.set(sp.x + .2 * dp.x / ln, sp.y + .2 * dp.y / ln, 0), bl = _MathUtils2.default.splitSpline(this.pSpline, N), bl.ls.push(1e7), _MathUtils2.default.mapl2L(bl.ls, bl.len, _sheetBlock2.default.resX, function (i) {
                ...
                return {
                    interpolationPoints: [{
                        ...
                        x: [
                            ...
                            [0, .2482, .4997, .75, 1],
                            [0, .2428, .4989, .75, 1],
                            [0, .125, .3214, .5574, .8192],
                            [0, -.0434, 0, .1302, .342],
                            [0, .0434, -0, -.1302, -.342],
                            [0, .1705, .341, .4821, .5736],
                            [0, 0, 0, 0, 0], x
                        ],
                        y: [
                            [0, 0, 0, 0, 0],
                            [0, .03, .0166, .0033, 1e-4],
                            [0, .0596, .0331, .0065, 2e-4],
                            [0, .2165, .383, .5018, .5736],
                            [0, .2462, .5, .7386, .9397],
                            [0, .2462, .5, .7386, .9397],
                            [0, .1828, .3657, .5745, .8192],
                            [0, .25, .5, .75, 1], y
                        ]
                    }, {
                        x: [
    ...
    function props() {
        ...
        return styles["volume-unrolling"] = _extends({}, styles.volume, {
    ...
    _libs.THREE.CSS3DObject = function (_THREE$Object3D) {
        ...
        function getObjectCSSMatrix(matrix, cameraCSSMatrix) {
            var elements = matrix.elements,
                matrix3d = "matrix3d(" + [epsilon(elements[0]), epsilon(elements[1]), epsilon(elements[2]), epsilon(elements[3]), epsilon(-elements[4]), epsilon(-elements[5]), epsilon(-elements[6]), epsilon(-elements[7]), epsilon(elements[8]), epsilon(elements[9]), epsilon(elements[10]), epsilon(elements[11]), epsilon(elements[12]), epsilon(elements[13]), epsilon(elements[14]), epsilon(elements[15])].join(",") + ")";
    ...
    var _libs = __webpack_require__(0),
        ...
        CSSLayer = function (_CSS3DObject) {
            function CSSLayer(width, height, props) {
                ...
                return _this.props = props, _this.jContainer = (0, _libs.$)('<div class="hidden css-layer"></div>'), _this.setSize(width, height), _this.setData(), _this.set(_this.jContainer[0]), _this
            }
            return _inherits(CSSLayer, _CSS3DObject), CSSLayer.init = function (doc) {
                ...
                this.jContainer.width(widthPxs).height(heightPxs), this.scale.x = 1 / (widthPxs / width), this.scale.y = 1 / (widthPxs / width)
    ...
    _libs.PDFJS.GlobalWorkerOptions.workerSrc = (window.PDFJS_LOCALE ? PDFJS_LOCALE : __webpack_require__.i({
        pdfJsWorker: basePath + "js/pdf.worker.js",
        pdfJsCMapUrl: "cmaps/"
    })).pdfJsWorker, _libs.PDFJS.cMapUrl = (window.PDFJS_LOCALE ? PDFJS_LOCALE : __webpack_require__.i({
        pdfJsWorker: basePath + "js/pdf.worker.js",
        pdfJsCMapUrl: "cmaps/"
    })).pdfJsCMapUrl, _libs.PDFJS.cMapPacked = !0, _libs.PDFJS.disableAutoFetch = !0, _libs.PDFJS.disableStream = !0, _libs.PDFJS.disableRange = !1, _libs.PDFJS.imageResourcesPath = "images/pdfjs/", _libs.PDFJS.externalLinkTarget = _libs.PDFJS.LinkTarget.BLANK, _libs.PDFJS.disableFontFace = void 0;
    var Pdf = function () {
        function Pdf(src, loadingProgress, openOptions) {
            ...
            _classCallCheck(this, Pdf), this.src = _Utils2.default.normalizeUrl(src), this.handlerQueue = [], this.progresData = {
                loaded: -1,
                total: 1
            }, this.loadingProgress = loadingProgress, this.task = _libs.PDFJS.getDocument(_extends({
                url: this.src,
            ...
            }, openOptions)), this.task.onProgress = function (data) {
        ...
        return Pdf.prototype.init = function (handler, pages) {
            if (this.handler = handler, pages) {
                ...
                this.doubledPages = p0s.width / p0s.height / (p1s.width / p1s.height) < .75
    ...
    var _Controller2 = __webpack_require__(15),
        ...
        WidgetController = function (_Controller) {
            function WidgetController(view, name) {
                ...
                return _this.name = name, _this.view = view, _this.visible = !1, _this
            }
            return _inherits(WidgetController, _Controller), WidgetController.prototype.togle = function () {
                ...
                this.view && this.view.setState(this.name, {
                    enable: !0,
    ...
    _libs.$.fn.FlipBook = function (options) {
        ...
        return options.activateFullScreen && _FullScreenX2.default.request(parentContainer), scene.view = new _BookView2.default(parentContainer, function () {
            if (_Detector2.default.webgl) {
                scene.loadingCtrl = new _LoadingController2.default(scene.view, !0, function (progress) {
                ...
                }), scene.userMessageCtrl = new _UserMessageController2.default(scene.view), scene.visual = new _VisualWorld2.default(scene.view.getContainer().ownerDocument.defaultView, scene.view.getContainer().ownerDocument, scene.view.getView()), options.propertiesCallback && new _ClbBookPropsBuilder2.default(scene.visual, function () {
                    return {
                        type: "blank"
                    }
                }, 1, function (props) {
                    ...
                    var style = [];
                    "" !== props.backgroundColor && style.push("background-color:#" + new THREE.Color(props.backgroundColor).getHexString()), "" !== props.backgroundImage && style.push("background-image:url('" + props.backgroundImage + "')"), "" !== props.backgroundStyle && style.push(props.backgroundStyle), style.length && scene.view.getView().attr("style", style.join(";"))
                    ...
                    }), scene.tocCtrl = new _TocController2.default(scene.view, scene.ctrl), scene.tocCtrl.setThumbnails(scene.thumbnails), options.outline && (scene.bookmarks = new _Bookmarks2.default(scene.view.getBookmarksView(), options.outline), scene.tocCtrl.setBookmarks(scene.bookmarks)), scene.ctrl.setTocCtrl(scene.tocCtrl), scene.view.addHandler(scene.tocCtrl), "pdf" === test.type && (scene.search = new _Search2.default(scene.view.getSearchView(), scene.book.getPages()), scene.search.onQuery = scene.book.setQuery.bind(scene.book), scene.book.addEventListener("searchResults", function (e) {
                        scene.search.setResults(e.results, e.lastPage)
                    }), scene.tocCtrl.setSearch(scene.search), scene.ctrl.setTocCtrl(scene.tocCtrl), scene.pdfLinksHandler = new _PdfLinksHandler2.default(test.src, scene.ctrl, scene.visual.element), scene.book.addEventListener("pdfAnnotation", scene.pdfLinksHandler.handleEvent.bind(scene.pdfLinksHandler)), scene.bookmarks || test.src.getHandler(function (handler) {
                        handler.getOutline().then(function (outline) {
                            outline && outline.length && (scene.bookmarks = new _Bookmarks2.default(scene.view.getBookmarksView(), outline), scene.tocCtrl.setBookmarks(scene.bookmarks, test.src), scene.ctrl.setTocCtrl(scene.tocCtrl))
                        })
                    }), options.pdfLinks && options.pdfLinks.handler && scene.pdfLinksHandler.setHandler(options.pdfLinks.handler)), scene.sounds = new _SoundsEnviroment2.default(options.template), scene.ctrl.setSounds(scene.sounds), scene.sounds.subscribeFlips(scene.ctrl), scene.ready = !0;
                    ...
                    scene.shareCtrl = new _ShareController2.default(scene.view, scene.ctrl, options.shareLinkBuilder ? options.shareLinkBuilder : function (page) {
                        return new RegExp("([?&])" + autoNavigator.urlParam + "=[0-9]+").test(location.href) ? location.href.replace(new RegExp("([?&])" + autoNavigator.urlParam + "=[0-9]+"), "$1" + autoNavigator.urlParam + "=" + page) : location.href.split("#")[0] + (~location.href.indexOf("?") ? "&" : "?") + autoNavigator.urlParam + "=" + page + location.hash
                    }), scene.ctrl.setShareCtrl(scene.shareCtrl), scene.view.addHandler(scene.shareCtrl), autoNavigator.dispose(), options.ready && options.ready(scene), scene.ctrl.ready(scene), scene.pendingDispose && scene.dispose()
                };
    ...
    var _extends = Object.assign || function (target) {
        ...
        Binder = function () {
            function Binder(visual, p) {
                ...
                }), this.OZ = new _libs.THREE.Vector3(0, 0, 1), this.backG = new _libs.THREE.BoxGeometry(.001, this.p.backSize, p.cover.height);
                var color = {
                    color: p.cover.color
                },
                    transparent = {
                ...
                this.materials = [new _libs.THREE.MeshPhongMaterial(color), new _libs.THREE.MeshPhongMaterial(color), new _libs.THREE.MeshPhongMaterial(transparent), new _libs.THREE.MeshPhongMaterial(transparent), new _libs.THREE.MeshPhongMaterial(transparent), new _libs.THREE.MeshPhongMaterial(transparent)];
                ...
                }), this.three = new _libs.THREE.Object3D, this.back = new _libs.THREE.Object3D, this.backRT = new _libs.THREE.Object3D, this.backRR = new _libs.THREE.Object3D, this.backLT = new _libs.THREE.Object3D, this.backLR = new _libs.THREE.Object3D, this.leftPivot = new _libs.THREE.Object3D, this.rightPivot = new _libs.THREE.Object3D, hidden || (backM.position.set(.5 * (p.cover.depth - .001), 0, 0), this.back.add(backM)), this.back.add(this.leftPivot), this.back.add(this.rightPivot), this.backRT.add(this.back), this.backRR.add(this.backRT), this.backLT.add(this.backRR), this.backLR.add(this.backLT), this.three.add(this.backLR)
            }
    ...
    var _extends = Object.assign || function (target) {
        ...
        Book = function (_THREE$EventDispatche) {
            function Book(visual, sheets, pageCallback, props) {
                ...
                }, _this.visual = visual, _this.mouseController = !0, _this.p = _extends({}, _this.prepareProps(_extends({}, props, {
                    sheets: sheets
                })), {
                ...
                return _this.enableMouse(_this.p.interactiveCorners), 2 === _this.getPages() && (_this.enableMouse(!1), coverP[_this.p.rtl ? "left" : "right"] = _extends({}, _this.p.cover, {
                    width: 1e-6,
                    height: 1e-6
                ...
                }), 0, sheets, 0, "closed")), _this.reducePagesWidth(!0), _this.set(Math.PI / 2), _this.openedBox = (new _libs.THREE.Box3).setFromObject(_this.leftCover.three), _this.openedBox.union((new _libs.THREE.Box3).setFromObject(_this.rightCover.three)), _this.angle = _this.p.rtl ? Math.PI : 0, _this.closedAngle = 0, _this.set(_this.angle, 0), _this.lastMousePos = {
                    t: 0
                ...
                }, _this.visual.addObject(_this.three), _this.tmpBox = new _libs.THREE.Box3, _this.bookShadowMaterial = new _libs.THREE.MeshPhongMaterial({
                    color: 0,
                    side: _libs.THREE.DoubleSide,
                    transparent: !0
                }), _this.bookShadow = new _libs.THREE.Mesh(new _libs.THREE.PlaneGeometry(1, 1).rotateX(-Math.PI / 2), _this.bookShadowMaterial), _this.visual.addObject(_this.bookShadow), _this.calculateShadow(), _this.visual.addEventListener("resize", _this.pageManager.refreshZoom.bind(_this.pageManager)), setTimeout(function () {
                    _this.isProcessing() || (_this.notifyBeforeAnimation(), _this.notifyAfterAnimation())
                }, 100), _this.updateThree(), _this
            }
            return _inherits(Book, _THREE$EventDispatche), Book.prototype.calculateShadow = function () {
                var box = this.tmpBox;
                box.setFromObject(this.three), this.bookShadow.scale.set(box.max.x - box.min.x, 1, box.max.z - box.min.z);
                this.bookShadow.position.set(.5 * (box.max.x + box.min.x) - .015, box.min.y - .0015, .5 * (box.max.z + box.min.z) - .015), this.bookShadowMaterial.opacity = .03, this.visual.shadowPlace.position.set(0, box.min.y - .015, 0)
                ...
                for (var l = Book.lightModes[this.p.lighting][mode], bs = [this.leftCover].concat(this.sheetBlocks, [this.rightCover]), _iterator6 = bs, _isArray6 = Array.isArray(_iterator6), _i6 = 0, _iterator6 = _isArray6 ? _iterator6 : _iterator6[Symbol.iterator](); ;) {
                    var _ref6;
                    if (_isArray6) {
                ...
                }), this.setVisualMode("live"), this.flipDisabled = !0, res = this.layerManager.hide().then(function () {
                    return delete _this6.flipDisabled
                })), res
            }, Book.prototype.notifyAfterAnimation = function () {
                if (this.animationNotification) {
                    var p = this.getPage();
                    this.userDirection.lastTopPage !== p && (this.userDirection.direction = Math.sign(p - this.userDirection.lastTopPage), this.userDirection.lastTopPage = p), delete this.animationNotification, this.setVisualMode("static"), this.layerManager.show(), this.dispatchEvent({
                        type: "afterAnimation"
                    })
                }
                ...
                return block !== this.leftCover && block !== this.rightCover || (this.bookShadowMaterial.opacity = 0), res.then(function () {
                    return block.physicId = _this7.sheetPhysics.addObject(mass, angle, velocity, flexibility, coverHeight, function (angl, ch) {
                        simulateClb(angl, ch), progressClb(block, Math.abs(angle - angl) / Math.PI, "process", type()), _this7.calculateShadow(), _this7.updateThree()
                    }, function (angl, ch) {
                        if (removeClb(angl, ch), delete block.physicId, progressClb(block, Math.abs(angle - angl) / Math.PI, "finish", type()), !_this7.sheetPhysics.getSize()) {
                            var p = _this7.getPage();
                            0 !== p && p !== _this7.getPages() - 1 || _this7.reducePagesWidth(!0)
                        }
                        Promise.resolve().then(function () {
                            _this7.sheetPhysics.getSize() || (_this7.notifyAfterAnimation(), _this7.calculateShadow())
                        }), _this7.updateThree()
                    ...
                    }), progressClb(block, 0, "init", type()), 1 === _this7.sheetPhysics.getSize() && _this7.reducePagesWidth(!1), block
                }).catch(function () { })
                ...
                p.cover.depth = Math.min(p.cover.depth, 3 * depth), p.page.depth = Math.min(p.page.depth, depth);
                ...
                return function (n, clb) {
                    return loader(n, function (ls) {
                        for (var nls = [], _iterator9 = ls, _isArray9 = Array.isArray(_iterator9), _i9 = 0, _iterator9 = _isArray9 ? _iterator9 : _iterator9[Symbol.iterator](); ;) {
                            var _ref9;
                            if (_isArray9) {
                ...
                return function (c, p) {
                    ...
                    for (var no = _this10.cssLayerJsObjectInit(c, p), ro = {}, _arr = ["hide", "hidden", "show", "shown", "dispose"], _loop = function () {
                        var n = _arr[_i10];
                        ro[n] = function () {
                            clIfEx(no[n]), clIfEx(o[n])
                        }
                    }, _i10 = 0; _i10 < _arr.length; _i10++) _loop();
                    return ro
                }
                ...
                if (ys.length) {
                    ...
                    var p01 = function (n, nm, d) {
                        return void 0 === n.attr(nm) ? d : "true" === n.attr(nm) ? 1 : 0
                    };
                ...
                if (ads.length && !this.visual.wnd.adsbygoogle) {
                    ...
                    script.async = !0, script.src = "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=" + ads.attr("data-ad-client"), this.visual.doc.body.appendChild(script)
                }
                return {
                    hide: function () {
                        _this11.pendingPlayers.length && (_this11.pendingPlayers = [], _this11.dispatchEvent({
                            type: "pendingPlayers"
                    ...
                    shown: function () {
                        c.find(".play-on-shown").each(function (_, p) {
                            ...
                            var update = !1;
                            if (c.find(".adsbygoogle").each(function (_, ad) {
    ...
    var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) {
        ...
        BookController = function (_Controller) {
            function BookController(book, view, props) {
                ...
                var _this = _possibleConstructorReturn(this, _Controller.call(this));
                _this.navigationControls = !0, _this.book = book, _this.visual = book.visual, _this.p = BookController.prepareProps(props), _this.p.rtl = book.p.rtl, _this.orbit = book.visual.getOrbit(), book.setFlipProgressClb(_this.updateViewIfState.bind(_this)), _this.view = view, _this.bindActions(), _this.state = {
                ...
                return _this.bookWatcher = new _Object3DWatcher2.default(_this.visual, function () {
                    if (_this.state.singlePage) _this.state.activeSide ? box0.setFromObject(book.rightCover.three) : box0.setFromObject(book.leftCover.three);
                    else {
                        box0.setFromObject(book.leftCover.three), box1.setFromObject(book.rightCover.three), box0.union(box1);
                        var width = Math.max(box0.min.x - box0.min.x, bookWidth),
                            x0 = (box0.min.x + box0.max.x) / 2;
                        box0.min.x = x0 - .5 * width, box0.max.x = x0 + .5 * width
                    }
                    return box0
                }), _this.bookWatcher.scale = _this.p.scale.default, _this.book.setZoom(_this.bookWatcher.scale, _this.state.singlePage), _this.Stats = new _stats2.default, _this.Stats.domElement.style.position = "absolute", _this.Stats.domElement.style.top = "0px", _this.binds = {
            ...
            return _inherits(BookController, _Controller), BookController.prototype.dispose = function () {
                ...
                var _this2 = this;
                this.view.templateObject.appLoaded && Promise.resolve().then(function () {
                    return _this2.view.templateObject.appLoaded(scene)
                })
            }, BookController.prototype.loadingAnimationHandler = function () {
                for (var _this3 = this, pages = this.book.getTopPages(), visible = !1, _iterator = pages, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator](); ;) {
                    var _ref;
                    if (_isArray) {
                        if (_i >= _iterator.length) break;
                        _ref = _iterator[_i++]
                ...
                visible = visible || this.printer && this.printer.loading, visible ? this.pendingLoadingAnimation || (this.pendingLoadingAnimation = !0, setTimeout(function () {
                    _this3.pendingLoadingAnimation && _this3.view && _this3.view.setState("widLoading", {
                        visible: visible
                    })
                }, 2e3)) : (delete this.pendingLoadingAnimation, this.view.setState("widLoading", {
                    visible: visible
                }))
            }, BookController.prototype.initLoadingAnimation = function () {
                var handler = this.loadingAnimationHandler.bind(this);
                this.book.addEventListener("beforeAnimation", handler), this.book.addEventListener("afterAnimation", handler), this.book.addEventListener("startRendering", handler), this.book.addEventListener("endRendering", handler)
                ...
                this.tocCtrl = tocCtrl, this.tocCtrl.onChange = this.updateView.bind(this), this.tocCtrl.setActiveTab(this.actions.cmdToc.defaultTab), this.actions.cmdToc.active && !tocCtrl.visible && tocCtrl.togle()
            }, BookController.prototype.setShareCtrl = function (shareCtrl) {
                this.shareCtrl = shareCtrl, this.shareCtrl.onChange = this.updateView.bind(this), this.updateView()
            }, BookController.prototype.setPrinter = function (printer) {
                this.printer = printer;
                var handler = this.loadingAnimationHandler.bind(this);
                this.printer.addEventListener("loading", handler), this.printer.addEventListener("loaded", handler), this.updateView()
                ...
                this.state.autoPlay = !this.state.autoPlay, this.state.autoPlay && this.autoPlay(), this.updateView()
            }, BookController.prototype.autoPlay = function () {
                var _this4 = this,
                    pendingAutoPlay = Date.now();
                this.pendingAutoPlay = pendingAutoPlay, setTimeout(function () {
                    if (_this4.pendingAutoPlay === pendingAutoPlay && _this4.state.autoPlay) {
                        if (!_this4.book.isProcessing()) {
                            var flipped = void 0;
                            _this4.p.rtl ? (flipped = _this4.canFlipLeft()) && _this4.cmdBackward() : (flipped = _this4.canFlipRight()) && _this4.cmdForward(), flipped || _this4.goToPage(0)
                        }
                        _this4.autoPlay()
                    }
                ...
                this.isSinglePageAvailable() && (this.state.singlePage = !this.state.singlePage, this.setBookZoom(this.bookWatcher.scale), this.updateView(), this.dispatchAsync({
                    type: "pageMode",
                ...
                var setClb = function (fl, time, clb) {
                    return new Promise(function (resolve) {
                        setTimeout(function () {
                            fl < 0 ? _this7.startFlip(_this7.book.flipLeft(-fl, clb)) : _this7.startFlip(_this7.book.flipRight(fl, clb)), resolve()
                        }, time)
                    })
                };
                ...
                return flipRes ? flipRes.then(function (block) {
                    return block && _this8.dispatchAsync({
                        type: "startFlip"
                    }), block
                ...
                for (var name in this) ! function (name) {
                    0 === name.indexOf("cmd") && (cmds[name] = {
                        activate: function () {
                            _this9.viewState && _this9.viewState[name].enable && _this9[name].apply(_this9, arguments)
                        }
                    })
                }(name);
                return _extends({}, cmds, {
                    ...
                    mouseCmdDragZoom: {
                        activate: function (e, data) {
                            data.dy > 0 ? _this9.cmdZoomOut() : data.dy < 0 && _this9.cmdZoomIn()
                        }
                    },
                    mouseCmdPan: {
                    ...
                    mouseCmdWheelZoom: {
                        activate: function (e) {
                            ...
                            e.deltaY < 0 ? _this9.cmdZoomOut() : e.deltaY > 0 && _this9.cmdZoomIn(), (!_this9.state.smartPan || Math.abs(_this9.bookWatcher.scale - scale) > 1e-4) && e.preventDefault()
                        }
                    },
                    touchCmdRotate: {
                        activate: function (e, data) {
                            isSwipping("touchCmdRotate") || ("move" === data.state && e.preventDefault(), _this9.orbit.actions.rotate(e, data))
                        }
                    },
                    touchCmdZoom: {
                        activate: function (e, data) {
                            if (!isSwipping("touchCmdZoom")) {
                                ...
                                "start" === data.state ? _this9.touchZoomData = {
                                    l: l(data),
                                    scale: _this9.bookWatcher.scale
                                } : "move" === data.state && (e.preventDefault(), _this9.setScale(l(data) / _this9.touchZoomData.l * _this9.touchZoomData.scale))
                            }
                        }
                    },
                    touchCmdPan: {
                        activate: function (e, data) {
                            isSwipping("touchCmdPan") || "move" === data.state && (!_this9.state.smartPan || _this9.bookWatcher.scale > 1) && (e.preventDefault(), _this9.orbit.actions.pan(e, data))
                        }
                    },
                    touchCmdSwipe: {
                        activate: function (e, data) {
                            if (isSwipping("touchCmdSwipe"))
                                ...
                                } else "move" === data.state ? _this9.swipeData.handled || (_this9.swipeData = _extends({}, _this9.swipeData, {
                                    x: _this9.swipeData.x + data.dx,
                                    y: _this9.swipeData.y + data.dy
                                }), Math.abs(_this9.swipeData.x0 - _this9.swipeData.x) > 100 && (_this9.swipeData.x0 > _this9.swipeData.x ? _this9.cmdForward() : _this9.cmdBackward(), _this9.swipeData.handled = !0)) : delete _this9.swipeData
                        }
                    },
                    widSettings: {
                        activate: function () { }
                ...
                }, "contextmenu", _EventsToActions2.default.mouseButtons.Right, 0), this.eToA.addAction(function (e) {
                    return (0, _libs.$)(_this10.view.getParentContainer()).trigger(e)
                }, "keydown", 27, 0), this.actions = this.getActions();
                for (var _iterator5 = Object.keys(this.actions), _isArray5 = Array.isArray(_iterator5), _i5 = 0, _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator](); ;) {
                    ...
                    if (this.actions[name] = action, 0 !== name.indexOf("mouseCmd") && 0 !== name.indexOf("touchCmd") || action.enabled) {
                ...
                return props.scale.delta = (props.scale.max - props.scale.min) / props.scale.levels, props
            }, BookController
        }(_Controller3.default);
    ...
    var _libs = __webpack_require__(1),
        BookPrinter = function (_THREE$EventDispatche) {
            function BookPrinter(context, book, styleSheet) {
                ...
                var _this = _possibleConstructorReturn(this, _THREE$EventDispatche.call(this));
                _this.book = book, _this.styleSheet = styleSheet, _this.wnd = context.wnd, _this.doc = context.doc, _this.pageCallback = book.getPageCallback();
                var test = _this.pageCallback(0);
                return _this.type = test.type, "pdf" === _this.type && (_this.pdfSrc = test.src.src), _this
            }
            return _inherits(BookPrinter, _THREE$EventDispatche), BookPrinter.prototype.cancel = function () {
                this.canceled = !0
                ...
                if (!this.loading)
                    if (delete this.canceled, "pdf" === this.type) {
                        var printWnd = void 0,
                            callManually = !1;
                        this.useIFrame() ? (callManually = !!this.frame, this.frame || (this.frame = (0, _libs.$)('<iframe src="' + this.pdfSrc + '" style="display: none;"></iframe>').appendTo(document.body)), printWnd = this.frame[0].contentWindow) : printWnd = this.wnd.open(this.pdfSrc), callManually ? printWnd.print() : (this.loading = !0, this.dispatchEvent({
                            type: "loading"
                        }), (0, _libs.$)(this.frame).on("load", function () {
                            setTimeout(function () {
                                delete _this2.loading, _this2.dispatchEvent({
                                    type: "loaded"
                                });
                                try {
                                    printWnd.print()
                ...
                for (var _this3 = this, pages = this.book.getPages(), head = new Set, body = [], done = Promise.resolve(), page = 0; page < pages; ++page) ! function (page) {
                    var info = _this3.pageCallback(page);
                    "image" === info.type ? done = done.then(function () {
                        return _this3.progress(page / pages), _this3.renderImage(head, body, info.src)
                    }) : "html" === info.type && (done = done.then(function () {
                        return _this3.progress(page / pages), _this3.renderHtml(head, body, info.src)
                    }))
                }(page);
                return done.then(function () {
                    return _this3.progress(1), {
                        head: _this3.renderHead(head),
                        body: body.join("\n")
                    }
                })
                ...
                return !!isIOSChrome || !(!isChromium || "Google Inc." !== vendorName || isIEedge), !0
    ...
    var _View2 = (__webpack_require__(1), __webpack_require__(69)),
        ...
        BookView = function (_View) {
            ...
            return _inherits(BookView, _View), BookView.prototype.initView = function () {
                ...
                return {
                    html: basePath + "templates/default-book-view.html",
                    //styles: [basePath + "css/black-book-view.css"],
                    styles: [basePath + "css/short-white-book-view.css"],
                    links: [{
                        rel: "stylesheet",
                        href: basePath + "css/font-awesome.min.css"
                    }],
                    script: basePath + "js/default-book-view.js"
                }
            }, BookView
        }(_View3.default);
        ...
        PageManager = function () {
            ...
            return PageManager.prototype.createLoadingTexture = function (p) {
                ...
                if (this.p.autoResolution.enabled) {
                    this.rendering && this.rendering.wrapper && this.rendering.wrapper.cancelRender();
                    var es = [];
                ...
                var _this2 = this;
                (this.p.cssLayersLoader ? this.p.cssLayersLoader : function (n, f) {
                    return f([])
                })(n, function (layers) {
                    var object = _this2.pageCache.get(n);
                    object && (object.wrapper.getCSSLayer && _this2.p.highlightLinks ? object.wrapper.getCSSLayer() : Promise.resolve()).then(function (l) {
                        (l || layers[0]) && (l = l || {}, layers[0] = layers[0] || {}, layers[0] = {
                            html: (l.html || "") + (layers[0].html || ""),
                            css: (l.css || "") + (layers[0].css || ""),
                            js: layers[0].js
                        }), "active" !== object.state ? object.pendings.push({
                            clb: clb,
                            args: [layers]
                        }) : clb(layers)
                    })
                ...
                return o.texture.minFilter = _libs.THREE.LinearFilter, this.loadings.push(o), this.setMaterial(o, material), Promise.resolve().then(function () {
                    if (o.texture) {
                        ...
                        o.wrapper = _this3.imageFactory.build(pi, void 0 === pi.number ? _this3.rtlPageN(n) : pi.number, res.width, res.height, p.color, _this3.p.injector), o.wrapper.setQuery && o.wrapper.setQuery(_this3.pageQuery), o.simulate = pi.interactive ? (o.wrapper.simulate || function () { }).bind(o.wrapper) : void 0, o.wrapper.onLoad = function () {
                            ...
                            canceled ? ("queuedForRender" !== o.state && (o.state = "loaded", o.wrapper && _this3.pushInRenderQueue(_this3.rendering)), delete _this3.rendering) : o.texture && (_this3.removeFromLoadings(o), o.material && (o.material.map = o.texture, o.material.color = new _libs.THREE.Color(16777215), o.material.needsUpdate = !0), o.texture.image = image, o.texture.needsUpdate = !0, o.texture.onUpdate = function () {
                                o.texture && (o.texture.onUpdate = null), _this3.tmpMaterial.map = null, _this3.tmpMaterial.needsUpdate = !0, "queuedForRender" !== o.state && (o.state = "active", _this3.resolvePendings(o.pendings)), delete _this3.rendering, _this3.book.dispatchEvent({
                                    type: "endRendering",
                                    page: o.n
                                })
                ...
                var res = void 0;
                if (this.p.autoResolution.enabled) {
                    var k = this.p.autoResolution.coefficient * this.p.zoom * Math.sqrt(this.visual.wnd.devicePixelRatio || 1) * Math.min((this.isSinglePage(o) ? 1 : .5) * this.visual.width() / o.widthTexels, this.visual.height() / o.heightTexels);
                    res = {
                ...
                if (this.canvases) {
                    var p = this.p;
                    if (this.rendering) this.rendering.wrapper && this.rendering.wrapper.setRenderPause(!p.renderWhileFlipping && (this.book.isProcessing() || this.visual.getOrbit().isMoving())), this.book.updateThree();
                    else if (p.renderWhileFlipping || !this.book.isProcessing() && !this.visual.getOrbit().isMoving()) {
                        ...
                        if (this.rendering)
                            if (this.rendering.wrapper && this.rendering.wrapper.startRender) {
                                ...
                                this.nextCanvas = (this.nextCanvas + 1) % this.canvases.length, this.rendering.wrapper.setRenderCanvas(_o.c, _o.ctx), this.rendering.wrapper.setResolution(this.calcResolution(this.rendering)), this.rendering.wrapper.startRender(), this.book.dispatchEvent({
                                    type: "startRendering",
                                    page: _o.n
                                })
    ...
    var _BookPropsBuilder2 = __webpack_require__(9),
        ...
        PdfBookPropsBuilder = function (_BookPropsBuilder) {
            function PdfBookPropsBuilder(src, onReady, style, pdfOpenOptions) {
                ...
                var _this = _possibleConstructorReturn(this, _BookPropsBuilder.call(this, onReady, style));
                return _this.pdf = new _Pdf2.default(src, void 0, pdfOpenOptions), _this.pageDescription = {
                    type: "pdf",
                    src: _this.pdf,
                    interactive: !0
                }, _this.binds = {
    ...
    var _libs = __webpack_require__(1),
        ...
        ShareController = function (_WidgetController) {
            function ShareController(view, bookCtrl) {
                var linkBuilder = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : function (page) {
                    return page
                };
                _classCallCheck(this, ShareController);
                var _this = _possibleConstructorReturn(this, _WidgetController.call(this, view, "widShare"));
                return _this.bookCtrl = bookCtrl, _this.linkBuilder = linkBuilder, bookCtrl.addEventListener("endFlip", _this.updateView.bind(_this)), _this
            }
            return _inherits(ShareController, _WidgetController), ShareController.prototype.cmdCloseShare = function () {
                this.hide()
            }, ShareController.prototype.clickLink = function (u) {
                var blank = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
                    a = (0, _libs.$)('<a href="' + u + '"' + (blank ? ' target="_blank"' : "") + "></a>").appendTo(this.view.getContainer());
                a[0].click(), a.remove()
                ...
                this.clickLink("mailto:?subject=" + (0, _libs.tr)("We wanted you to see this book") + "&body=" + (0, _libs.tr)("Check out this site") + " " + encodeURIComponent(this.getLink()), !1)
                ...
                if (this.view) {
                    for (var _arr = ["cmdCloseShare", "cmdFacebook", "cmdTwitter", "cmdEmail"], _i = 0; _i < _arr.length; _i++) {
                        var cmd = _arr[_i];
    ...
    var _CSSLayer = __webpack_require__(13),
        ...
        SheetCssLayer = function () {
            ...
            return SheetCssLayer.prototype.dispose = function () {
                ...
                this.block = block;
                var size = block.getTopSize();
                this.layer.setSize(size.width, size.height), this.block.getTopWorldRotation(this.layer.rotation), this.block.getTopWorldPosition(this.layer.position)
            }, SheetCssLayer
        }();
    ...
    var _extends = Object.assign || function (target) {
        ...
        SheetPhysics = function () {
            ...
            return SheetPhysics.targetForceClb = function (o, a, v, ch) {
                ...
                return [-this.g * cosAlf + brf + f / this.m, v + .01 * (Math.random() - .5), this.flbt * ((2 / (1 + Math.exp(-.2 * cf)) - 1) * (1 - 2 / (1 + Math.exp(-5 * (Math.abs(ch) - 2)))) - ch)]
            }, SheetPhysics
        }();
    ...
    var SoundsEnviroment = function () {
        ...
        return SoundsEnviroment.prototype.setEnabled = function (enabled) {
            ...
            this.enabled && this.audio.startFlip && this.play(this.audio.startFlip)
        }, SoundsEnviroment.prototype.endFlip = function () {
            this.enabled && this.audio.startFlip && (this.audio.startFlip.pause(), this.audio.startFlip.currentTime = 0), this.enabled && this.audio.endFlip && this.play(this.audio.endFlip)
    ...
    var _WidgetController2 = __webpack_require__(22),
        ...
        TocController = function (_WidgetController) {
            ...
            return _inherits(TocController, _WidgetController), TocController.prototype.setThumbnails = function (thumbnails) {
                ...
                bookmarks.getSize() && (this.bookmarks = bookmarks, this.pdf = pdf, bookmarks.onNavigate = this.navigateBookmarks.bind(this), this.isBookmarks = !0, this.fireChange())
                ...
                data = (data + "").trim();
                var number = void 0;
                (number = parseInt(data)) == data ? this.goToPage(number) : this.openUrl(data)
            }, TocController.prototype.navigateBookmarks = function (item) {
                var _this2 = this;
                item.url ? this.openUrl(item.url) : item.dest ? this.pdf.getDestination(item.dest).then(function (number) {
    ...
    var _libs = __webpack_require__(0),
        ...
        LoadingAnimation = function () {
            function LoadingAnimation(width, height, color) {
                _classCallCheck(this, LoadingAnimation), this.c = _GraphUtils2.default.createCanvas(width, height), this.p = {
                    g: 9.8,
                    dt: 1 / 60,
                    color: color,
                    updateInterval: .25
        ...
        Object3DWatcher = function () {
            function Object3DWatcher(visual, boundBoxClb) {
                ...
                _classCallCheck(this, Object3DWatcher), this.visual = visual, this.boundBoxClb = boundBoxClb, this.testScale = testScale, this.camera = visual.camera, this.element = this.visual.element, this.elementSize = {
                    w: 1,
                    h: 1
                }, this.orbit = visual.getOrbit(), this.scale = 1, this.padding = 0, this.eps = 1e-4, this.v = new _libs.THREE.Vector3, this.dv = new _libs.THREE.Vector2, this.enabled = !1, visual.addRenderCallback(this.update.bind(this)), this.os = {
                    vx: 0,
                    vy: 0,
                    x: 0,
                    y: 0
            ...
            return Object3DWatcher.prototype.setPadding = function (padding) {
                ...
                if (this.testScale() && Math.abs(1 / K - this.scale) > this.eps) {
                    ...
                    this.orbit.setScale(this.orbit.getScale() / (K * scale)), this.orbit.update(), this.camera.updateMatrixWorld(), box = this.computeClientBoundBox(), Kx = this.elementSize.w / box.width, Ky = this.elementSize.h / box.height, K = Math.min(Kx, Ky), moving = !0
                }
                var dv = this.dv;
                if (K > 1 - this.eps)
                    if (this.padding) {
                ...
                if (Math.sqrt(this.os.vx * this.os.vx + this.os.vy * this.os.vy) > .003 || dv.length() > .003) {
                    var dt = 1 / 60,
                        t = 0,
                        os = _extends({}, this.os, {
                            x: 0,
    ...
    var _libs = __webpack_require__(0),
        Orbit = function (_THREE$EventDispatche) {
            function Orbit(object, world) {
                ...
                function rotate(event, data) {
                    if (scope.enabled && scope.enableRotate && "move" === data.state) {
                        ...
                        rotateLeft(2 * Math.PI * data.dx / clientWidth * scope.rotateSpeed), rotateUp(2 * Math.PI * data.dy / clientHeight * scope.rotateSpeed), scope.update()
                    }
                }
                ...
                return scope.pan = function () {
                    ...
                    return function (deltaX, deltaY) {
                        ...
                        if (scope.object instanceof _libs.THREE.PerspectiveCamera) {
                            ...
                            targetDistance *= Math.tan(scope.object.fov / 2 * Math.PI / 180), panLeft(2 * deltaX * targetDistance / clientHeight, scope.object.matrix), panUp(2 * deltaY * targetDistance / clientHeight, scope.object.matrix)
                        } else scope.object instanceof _libs.THREE.OrthographicCamera ? (panLeft(deltaX * (scope.object.right - scope.object.left) / scope.object.zoom / clientWidth, scope.object.matrix), panUp(deltaY * (scope.object.top - scope.object.bottom) / scope.object.zoom / clientHeight, scope.object.matrix)) : (console.warn("WARNING: OrbitControls.js encountered an unknown camera type-pan disabled."), scope.enablePan = !1)
                    }
                }(), _this.actions = {
                    rotate: rotate,
                    pan: pan,
            ...
            return _inherits(Orbit, _THREE$EventDispatche), Orbit.prototype.setMoving = function (moving) {
                this.moving = moving
    ...
    var _libs = __webpack_require__(0),
        ...
        PdfImage = function (_ImageBase) {
            ...
            return _inherits(PdfImage, _ImageBase), PdfImage.prototype.setQuery = function (query) {
                ...
                this.cssLayer = {
                    html: htmls.length ? "<pdf-layer>" + htmls.join("") + "</pdf-layer>" : void 0
                ...
                var _this4 = this;
                if (this.finder) {
                    for (var testSz = (this.page.view, (0, _libs.$)('<div style="position: absolute; visibility: hidden;"></div>').appendTo("body")), textDiv = testSz[0], baseOffset = testSz.offset().left, _iterator4 = this.finder.getHits(), _isArray4 = Array.isArray(_iterator4), _i4 = 0, _iterator4 = _isArray4 ? _iterator4 : _iterator4[Symbol.iterator](); ;) {
                        var _ref4;
                        if (_isArray4) {
                            if (_i4 >= _iterator4.length) break;
                            _ref4 = _iterator4[_i4++]
                ...
                (!this.viewport || Math.abs(this.viewport.scale - scale) > 1e-4) && (this.viewport = this.page.getViewport({
                    scale: scale
                }), "full" !== this.type && ("right" === this.type ? (this.viewport.offsetX += .5 * this.viewport.width * 1.0005, this.viewport.transform[4] -= .5 * this.viewport.width * 1.0005, this.viewport.width *= .5 / 1.0005) : this.viewport.width /= 2), this.resW = this.width = this.viewport.width, this.resH = this.height = this.viewport.height)
            }, PdfImage.prototype.init = function () {
                var _this5 = this;
                this.type = this.pdf.getPageType(this.n), this.pdf.getPage(this.n).then(function (page) {
                    _this5.page = page, _this5.size = _Pdf2.default.getPageSize(page), "full" !== _this5.type && (_this5.size.width /= 2), page.getAnnotations().then(_this5.setAnnotations.bind(_this5)), page.getTextContent().then(_this5.setHits.bind(_this5)), _this5.calcViewport(), _this5.finishLoad()
                }).catch(function (e) {
                ...
                if (this.page) {
                    this.pushCtx();
                    this.ctx.clearRect(0, 0, this.c.width, this.c.height), this.renderTask = this.page.render({
        ...
        Search = function () {
            ...
            return Search.prototype.dispose = function () {
                ...
                for (var htmls = [], i = this.prevResults.length; i < results.length; ++i) {
                    ...
                    htmls.push('<div class="result" data="' + result.page + '">'), htmls.push("<a>"), htmls.push("<div>" + result.contexts.join("</div><div>") + "</div>"), htmls.push("</a>"), htmls.push("</div>")
                } (0, _libs.$)(htmls.join("")).appendTo(this.results), this.prevResults = [].concat(results), void 0 === lastPage ? this.status.html("") : this.status.html(lastPage + 1 + " of " + this.pages)
            }, Search
        }();
    ...
    var _extends = Object.assign || function (target) {
        ...
        Thumbnails = function () {
            function Thumbnails(context, container, thumbnailsClb, size) {
                ...
                _classCallCheck(this, Thumbnails), this.container = container, this.p = props, this.thumbnailsClb = thumbnailsClb, this.size = size, this.queue = {
                    first: 0,
                    len: 0
                }, this.canvas = _GraphUtils2.default.createCanvas(), this.imageFactory = new _ImageFactory2.default(_extends({}, context, {
            ...
            return Thumbnails.prototype.getSize = function () {
                ...
                var _this2 = this;
                first = Math.min(first, this.size - 1), len = Math.min(len, this.size - first), this.queue = {
                    first: first,
                    len: len
                }, Promise.resolve().then(function () {
                ...
                wrapper.onChange = function (canvas) {
                    _this3.setImage(thumbnail, canvas.toDataURL("image/png")), thumbnail.loaded = !0, wrapper.dispose(), _this3.loading = !1, Promise.resolve().then(function () {
                ...
                thumbnail.img = img, thumbnail.thumbnail && (thumbnail.thumbnail.css("background-image", ["url('", img, "')"].join("")), thumbnail.thumbnail.removeClass("loading")), trigger && this.container.trigger("fb3d.thumbnails.thumbnailLoaded", [thumbnail])
            }, Thumbnails.prototype.render = function () {
                for (var elements = ['<div class="thumbnails">'], i = 0; i < this.size; ++i) elements.push(['<div class="item"><a><div class="thumbnail loading" style="padding-top:' + Math.round(100 / this.p.kWtoH) + '%;"></div></a><div class="heading"><a title="', i + 1, '">', i + 1, "</a></div></div>"].join(""));
    ...
    var _extends = Object.assign || function (target) {
        ...
        View = function () {
            function View(parentContainer, onLoad) {
                ...
                }, this.parentContainer = (0, _libs.$)(parentContainer), this.isIOS = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream, this.isSafari = /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
                var initUrl = this.isSafari ? View.initUrl : void 0;
                this.parentContainer.html('<iframe title="View" style="border: 0;' + (this.isIOS ? "" : " width: 100%; height: 100%") + '" ' + (initUrl ? ' src="' + initUrl + '"' : "") + ' scrolling="no"></iframe>'), this.frame = this.parentContainer.find("iframe")[0];
                var build = function build() {
                    _this3.isIOS && ((0, _libs.$)(_this3.parentContainer[0].ownerDocument.defaultView).on("resize", _this3.binds.onResize), _this3.onResize(), setTimeout(_this3.checkIframeSize.bind(_this3), 250)), _this3.container = (0, _libs.$)(_this3.frame.contentDocument.body), _this3.container.css("margin", "0"), _this3.head = (0, _libs.$)(_this3.frame.contentDocument.head), _this3.onLoad = onLoad, _this3.handlers = [], _this3.styleData = {};
                    var script = template.html ? template.script : _this3.getTemplate().script,
                        urls = void 0,
                        files = void 0,
                        links = void 0,
                        templateName = void 0;
                    "function" == typeof template ? (urls = {}, files = template(), links = [], templateName = files.name) : (links = template.links || _this3.getTemplate().links, urls = {
                        styles: template.styles || _this3.getTemplate().styles,
                        html: [template.html || _this3.getTemplate().html],
                        script: script ? [script] : []
                    }, templateName = template.name, files = {}), templateName && _this3.container.addClass(templateName), _this3.loadFiles(urls, files).then(function () {
                        ...
                        for (var _iterator8 = links, _isArray8 = Array.isArray(_iterator8), _i8 = 0, _iterator8 = _isArray8 ? _iterator8 : _iterator8[Symbol.iterator](); ;) {
                            ...
                            var _link = _ref8;
                            _this3.jLinks.push((0, _libs.$)(["<link ", _this3.objToAttrsStr(_extends({}, _link, {
                                href: _this3.urlResolver(_this3.getCurrentUrl(), _link.href)
                            })), ">"].join("")).appendTo(_this3.head))
                        }
                        if (files.script[0]) {
                ...
                initUrl ? (0, _libs.$)(this.frame.contentWindow).on("load", build) : (this.frame.contentWindow.stop && this.frame.contentWindow.stop(), build())
            }
            return View.classProperty = function (ctrl, className, value) {
                ...
                if (url = url.replace(/\\/g, "/"), "/" === url.charAt(0) && (baseUrl = this.getRootUrl(), url = url.substr(1)), baseUrl.match(/^https{0,1}:/i) || (baseUrl = this.urlResolver(this.getCurrentUrl(), baseUrl)), !url.match(/^(data|blob|http|https):/i)) {
                    ...
                    for (var _iterator4 = parts, _isArray4 = Array.isArray(_iterator4), _i4 = 0, _iterator4 = _isArray4 ? _iterator4 : _iterator4[Symbol.iterator](); ;) {
                        ...
                        var part = _ref4;
                        "." === part || (".." === part ? url.length > 3 && url.pop() : url.push(part))
                    }
                    url = url.join("/")
                }
                return url
        ...
        VisualWorld = function (_THREE$EventDispatche) {
            function VisualWorld(wnd, doc, container) {
                ...
                _this.camera.position.x = 0, _this.camera.position.y = 5.5, _this.camera.position.z = 0, _this.renderer = new _libs.THREE.WebGLRenderer({
                    ...
                    antialias: !0
                }), _this.renderer.shadowMap.enabled = !0, _this.renderer.shadowMap.type = _libs.THREE.PCFSoftShadowMap, _this.renderer.setClearColor(0, 0), _this.renderer.setPixelRatio(Math.sqrt(_this.wnd.devicePixelRatio || 1)), _this.renderer.setSize(_this.width(), _this.height()), _this.jContainer.append(_this.renderer.domElement), _this.cssRenderer = new _CSS3DRenderer2.default, _this.cssRenderer.setSize(_this.width(), _this.height()), (0, _libs.$)(_this.cssRenderer.domElement).css({
                    position: "absolute",
                    top: 0,
                    margin: 0,
                    padding: 0
                }), _this.jContainer.append(_this.cssRenderer.domElement), _this.element = _this.cssRenderer.domElement, _this.textureLoader = new _libs.THREE.TextureLoader, _this.ambientLight = new _libs.THREE.AmbientLight(16777215), _this.scene.add(_this.ambientLight), _this.light = new _libs.THREE.DirectionalLight(0, 1), _this.light.position.set(-6, 6, -3);
                _this.light.castShadow = !0, _this.light.shadow.camera.left = -3, _this.light.shadow.camera.right = 3, _this.light.shadow.camera.top = 3, _this.light.shadow.camera.bottom = -3, _this.light.shadow.camera.near = .5, _this.light.shadow.camera.far = 20, _this.light.shadow.mapSize.x = 512, _this.light.shadow.mapSize.y = 512, _this.scene.add(_this.light), _this.shadowPlace = new _libs.THREE.Mesh(new _libs.THREE.PlaneGeometry(10, 10).rotateX(-Math.PI / 2), new _libs.THREE.ShadowMaterial({
                    color: 0,
                    transparent: !0,
                    opacity: .2
                })), _this.shadowPlace.position.set(0, 0, 0), _this.shadowPlace.receiveShadow = !0, _this.shadowPlace.castShadow = !1, _this.scene.add(_this.shadowPlace), _this.controls = new _Orbit2.default(_this.camera, _this), _this.controls.target.y = .5;
            ...
            return _inherits(VisualWorld, _THREE$EventDispatche), VisualWorld.prototype.getDiag = function () {
                ...
                this.ambientLight.color.set(ambient), this.light.color.set(directional), this.updateThree()
                ...
                if (width > 1 && height > 1) {
                    ...
                    if (!this.lastResize || Math.abs(this.lastResize.width - width) + Math.abs(this.lastResize.height - height) > 1) {
                        ...
                        setTimeout(function () {
                            resizeStamp === _this2.resizeStamp && (updateCamera(_this2.camera), updateRenderer(_this2.renderer), updateRenderer(_this2.cssRenderer), _this2.updateThree(), _this2.dispatchEvent({
                                type: "resize"
                            }))
                        }, 10)
                    }
                ...
                var deltaTime = Math.min(this.clock.getDelta(), .034);
