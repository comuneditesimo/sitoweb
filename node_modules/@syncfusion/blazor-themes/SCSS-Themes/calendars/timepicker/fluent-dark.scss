...
$timepicker-list-bigger-font-size: $text-lg !default;
...
// mouse small
$timepicker-list-small-font-size: $text-xs !default;
...
$timepicker-list-bigger-small-line-height: 38px !default;
...
$timepicker-list-default-font-color: $flyout-text-color !default;
$timepicker-list-border-color: 0 solid $border-light !default;
...
$timepicker-icon-active-bg-color: $flyout-text-color-selected;
$timepicker-active-border-color: darken($primary, 10%) !default;
$timepicker-list-active-font-color: $flyout-text-color-pressed !default;
$timepicker-list-active-icon-color: $flyout-text-color-selected !default;
...
$timepicker-list-popup-icon-active-color: $flyout-text-color-selected !default;
...
$timepicker-disable-text: $flyout-text-color-disabled !default;
$timepicker-default-overlay: $overlay-bg-color !default;
$timepicker-list-small-font-color: $flyout-text-color !default;

// modal dialog colors
$modal-header-bg-color: $secondary-border-color !default;
$modal-header-text-color: $content-bg-color !default;
