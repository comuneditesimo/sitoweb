...
$timepicker-list-default-font-color: rgba($flyout-text-color) !default;
...
$timepicker-list-active-bg-color: rgba($primary) !default;
$timepicker-list-active-font-color: rgba($primary-text-color) !default;
$timepicker-list-active-icon-color: rgba($icon-color) !default;
$timepicker-list-hover-bg-color: $flyout-bg-color-hover !default;
$timepicker-list-hover-font-color: rgba($flyout-text-color-hover) !default;
$timepicker-list-popup-icon-active-color: rgba($icon-color) !default;
$timepicker-list-active-hover-bg-color: rgba($primary) !default;
$timepicker-list-active-hover-font-color: rgba($primary-text-color) !default;
$timepicker-list-normal-padding: 0 !default;
$timepicker-list-bigger-padding: 0 !default;
$timepicker-font-icon: '\e20c' !default;
$timepicker-icon-normal-font-size: $font-icon-16 !default;
$timepicker-icon-bigger-font-size: $font-icon-20 !default;
...
$timepicker-disable-text: $primary-text-disabled !default;
$timepicker-disable-opacity: 1 !default;
$timepicker-default-overlay: $content-bg-color-alt1 !default;
$timepicker-icon-padding: 4px !default;
$timepicker-normal-icon-border-radius: 16px !default;
$timepicker-bigger-icon-border-radius: 20px !default;

// icon active
$timepicker-icon-active-border: 1px !default;
$timepicker-icon-active-border-radius: 20px;
$timepicker-icon-active-bg-color: rgba($content-text-color, .12) !default;
$timepicker-bigger-icon-margin: 0 !default;
$timepicker-icon-margin: 0 !default;
$timepicker-time-small-icon-margin: 0 !default;
$timepicker-bigger-small-icon-margin: 0 !default;
...
$timepicker-list-small-font-color: rgba($content-text-color) !default;

// mouse small icon
$timepicker-icon-small-font-size: $font-icon-16 !default;
$timepicker-small-input-min-height: 22px !default;
$timepicker-small-input-min-width: 22px !default;
$timepicker-small-icon-border-radius: 14px !default;

// Touch small
$timepicker-list-bigger-small-font-size: 13px !default;
$timepicker-list-bigger-small-line-height: 36px !default;
$timepicker-list-bigger-small-text-indent: 16px !default;

// Touch small icon
$timepicker-icon-bigger-small-font-size: $font-icon-20 !default;
$timepicker-bigger-small-input-min-height: 34px !default;
$timepicker-bigger-small-input-min-width: 34px !default;
$timepicker-bigger-small-icon-border-radius: 20px !default;

// modal dialog colors
$modal-header-bg-color: rgba($primary) !default;
$modal-header-text-color: rgba($primary-text-color) !default;
