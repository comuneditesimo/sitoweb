...
// size variables
$timepicker-skin-name: $skin-name !default;
...
$timepicker-popup-border-radius: 8px !default;
...
// modal dialog colors
$modal-header-bg-color: $content-bg-color-alt1 !default;
...
@include export-module('timepicker-bds-icons') {
