...
$modal-year-line-height: 22px !default;
$modal-month-font-size: $text-lg !default;
$modal-month-font-weight: $font-weight-medium !default;
$modal-month-line-height: 28px !default;
...
$modal-portrait-prev-icon-margin: 16px !default;
...
$modal-today-text-color: $primary-text-color !default;
