...
$datepicker-modal-header-bg: $datepicker-popup-bg-color !default;
$datepicker-modal-header-color: $grey-dark-font !default;
...
$modal-header-border-color: rgba($grey-44, 100%) !default;
...
$modal-portrait-calendar-padding: 0 !default;
