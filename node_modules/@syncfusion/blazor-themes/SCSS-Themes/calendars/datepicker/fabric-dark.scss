...
$datepicker-modal-header-bg: $neutral-lighter-alt !default;
$datepicker-modal-header-color: $neutral-primary !default;
...
$modal-header-border-color: $neutral-light !default;
