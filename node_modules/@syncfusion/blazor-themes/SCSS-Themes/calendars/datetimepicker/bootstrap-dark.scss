...
$datetime-list-active-icon-color: $grey-dark-font !default;
$datetime-list-font-weight: regular !default;
$datetime-popup-shadow:  0 6px 12px rgba($base-font, .5) !default;
...
$datetime-list-active-hover-bg-color: $brand-primary !default;
$datetime-list-active-hover-font-color: $brand-primary-font !default;
...
@include export-module('datetimepicker-bootstrap-icons') {
