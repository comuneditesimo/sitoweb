...
$calendar-light-font: $header-font !default;
$calendar-bg-color: $bg-base-0 !default;
$calendar-active-font-color: $selection-font !default;
$calendar-active-hover-font-color: $selection-font !default;
$calendar-active-today-font-color: $selection-font !default;
$calendar-active-today-hover-font-color: $selection-font !default;
$calendar-active-bg-color: $selection-bg !default;
$calendar-active-bg-border-color: 1px solid $selection-bg !default;
$calendar-active-bg-box-shadow: none !default;
$calendar-hover-color: $hover-bg !default;
$calendar-header-font-color: $header-font !default;
$calendar-header-icon-color: $content-font !default;
$calendar-active-icon-color: $selection-font !default;
$calendar-week-header-font-color: $content-font !default;
$calendar-title-font-color: $selection-bg !default;
$calendar-title-decoration-style: underline !default;
$calendar-icon-font-color: $content-font !default;
$calendar-active-state-icon-bg-color: $selection-bg !default;
$calendar-icon-hover-bg-color: $hover-bg !default;
$calendar-device-icon-hover-bg-color: none !default;
$calendar-focus-date-color: $content-font !default;
$calendar-other-month-date: $content-font-alt !default;
$calendar-text-color: $content-font !default;
$calendar-hover-text: $hover-font !default;
$calendar-today-bg-style: $bg-base-0 !default;
$calendar-focus-bg-color: $bg-base-20 !default;
$calendar-focused-today-bg-style: $bg-base-0 !default;
$calendar-focused-today-box-shadow: none !default;
$calendar-focused-today-border-style: 1px dashed $hover-border !default;
$calendar-border-style: 1px solid $border-default !default;
...
$calendar-title-font-size: 17px !default;
$calendar-focused-state-color: $content-font !default;
$calendar-bigger-header-padding: 12px 12px 0 12px !default;
$calendar-bigger-icon-size: 46px !default;
$calendar-icon-line-height: 16px !default;
$calendar-bigger-max-width: 288px !default;
$calendar-bigger-min-width: 288px !default;
$calendar-bigger-month-view-height: 37px !default;
$calendar-bigger-day-header-height: $calendar-bigger-month-view-height !default;
$calendar-bigger-year-decade-height: 54px !default;
...
$calendar-normal-max-width: 232px !default;
...
$calendar-table-padding: 0 10px 10px 10px !default;
$calendar-zero-value: 0 !default;
$calendar-next-prev-icon-size: 16px !default;
$calendar-prev-icon: '\e85e' !default;
$calendar-next-icon: '\e84f' !default;
$calendar-date-font-size: 12px !default;
$calendar-title-font-weight-style: 300 !default;
$calendar-yeardecade-bg-color: $bg-base-0 !default;
...
$calendar-yeardecade-padding: 0 6px 0 !default;
$calendar-yeardecade-header-padding: 10px !default;
$calendar-week-header-bg-style: none !default;
$calendar-none-style: none !default;
$calendar-disable-font-weight-style: 500 !default;
...
$calendar-week-number-color-style: $content-font !default;
...
$calendar-bigger-table-yeardecade-padding: 0 8.5px 3.5px 8.5px !default;
$calendar-bigger-header-font-size: 19px !default;
$calendar-bigger-month-font-size: 14px !default;
$calendar-bigger-yeardecade-header-padding: 12px 12px 10px 12px !default;
$calendar-bigger-year-decade-padding: 0 0 13px 0 !default;
$calendar-yeardecade-hover-bg: $hover-bg !default;
$calendar-bigger-yeardecade-font-size: 14px !default;
$calendar-bigger-yeardecade-font-weight: normal !default;
$calendar-normal-day-header-font-weight: 500 !default;
$calendar-other-month-date-hover-bg: $hover-font !default;
$calendar-yeardecade-selected-hover-bg:  $selection-bg !default;
$calendar-bigger-day-font-size: 14px !default;
$calendar-yeardecade-font-weight: normal !default;
$calendar-today-focus-color: $content-font !default;
$calendar-today-color: $selection-bg !default;
...
$calendar-disabled-today-box-shadow: inset 1px 0 $border-fg-alt, inset 0 1px $border-fg-alt, inset -1px 0 $border-fg-alt, inset 0 -1px $border-fg-alt !default;
$calendar-disabled-today-font-color: none !default;
$calendar-today-border-color: 1px solid $border-fg-alt !default;
$calendar-focus-border-color: 1px dashed $border-fg !default;
$calendar-focus-box-shadow: none !default;
$calendar-hover-border-color: 1px solid $hover-border !default;
$calendar-default-border-color: 1px solid transparent !default;
...
$calendar-today-bg-hover-color: $bg-base-20 !default;
$calendar-disable-font-color: $disable !default;
$calendar-disable-opacity: 1 !default;
$calendar-active-hover-bg-color: lighten($selection-bg, 15%) !default;
$calendar-other-decade-cell-color: $calendar-other-month-date !default;
$calendar-decade-title-left-margin-style: $calendar-title-margin-left-style !default;
$calendar-icon-padding: 6px 7px !default;
$calendar-icon-button-margin: 0 !default;
$calendar-bigger-icon-padding: 13px !default;
...
$calendar-today-disabled-background-style: $bg-base-0 !default;
$calendar-today-disabled-border-style: $bg-base-0 !default;
$calendar-today-disabled-box-shadow: none !default;
$calendar-today-disabled-color: $disable !default;
...
$calendar-small-title-font-size: 14px !default;
...
$calendar-small-title-font-color: $selection-bg !default;
