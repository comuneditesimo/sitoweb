...
$calendar-normal-header-padding: 8px 12px 6px 16px !default;
$calendar-bigger-header-padding: 16px 16px 8px 24px !default;
...
$calendar-wrapper-border-radius: 8px !default;
...
$calendar-normal-max-width: 230px !default;
$calendar-normal-min-width: 230px !default;
$calendar-bigger-max-width: 312px !default;
$calendar-bigger-min-width: 312px !default;
...
$calendar-weeknumber-bigger-width: 328px !default;
...
$calendar-normal-year-decade-width: 50px !default;
...
$calendar-bigger-year-decade-width: 60px !default;
...
$calendar-bigger-icon-size: 28px !default;
...
//pending
$calendar-icon-font-size-style: $font-icon-20 !default;
$calendar-bigger-icon-font-size: $font-icon-24 !default;
...
$calendar-small-icon-font-size-style: $font-icon-18 !default;
...
$calendar-week-bigger-min-width: 312px !default;
...
$calendar-border-radius: 30px !default;
...
$calendar-active-icon-color: $icon-color-pressed !default;
$calendar-title-hover-color: $content-text-color !default;
$calendar-icon-hover-color: $content-text-color-alt1 !default;
$calendar-icon-hover-bg-color: transparent !default;
...
$calendar-yeardecade-selected-hover-bg: $content-bg-color-hover !default;
...
$calendar-active-font-color: $primary-text-color !default;
$calendar-active-hover-font-color: $primary !default;
$calendar-active-today-font-color: $primary !default;
$calendar-active-today-hover-font-color: $primary !default;
...
$calendar-active-hover-bg-color: $content-bg-color-selected !default;
...
@include export-module('calendar-bds-icons') {
