...
$range-presets-bg: $grey-dark !default;
$range-preset-normal-font-color: $grey-dark-font !default;
$range-font-color: none !default;
$range-active-icon-color: $grey-dark-font !default;
$range-active-state-icon-color: $grey-dark-font !default;
$range-hover-color: $grey-99 !default;
$range-hover-content-color: darken($range-hover-color, 15%) !default;
$range-today-color: $grey-light !default;
$range-calendar-today-color: $grey-dark-font !default;
$range-selection-bg: darken($brand-primary, 10%) !default;
$range-other-hover-color: $grey-99 !default;
...
$range-calendar-dark-color: $grey-dark-font !default;
$range-calendar-header-text-color: $grey-dark-font !default;
$range-calendar-header-dark-color: $grey-dark-font !default;
$range-calendar-medium-color: $grey-dark-font !default;
$range-calendar-light-color: $grey-dark-font !default;
...
$range-device-control-header-padding: 20px 10px 1px 10px !default;
...
$range-change-icon-color: $grey-dark-font !default;
...
$modal-range-header-border-bottom: 1px solid $grey-44 !default;
...
// modal dialog colors
$modal-range-header-bg-color: $grey-dark !default;
$modal-range-header-text-color: $grey-dark-font !default;
