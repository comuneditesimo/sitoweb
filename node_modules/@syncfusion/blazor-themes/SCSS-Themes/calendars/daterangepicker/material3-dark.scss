...
//default
$range-bg-color: $content-bg-color-alt3 !default;
$range-primary-color: rgba($primary) !default;
$range-primary-font-color: rgba($primary-text-color) !default;
$range-presets-bg: $transparent !default;
$range-preset-normal-font-color: rgba($content-text-color) !default;
$range-font-color: rgba($content-text-color) !default;
...
$range-active-icon-color: rgba($icon-color) !default;
$range-active-state-icon-color: rgba($icon-color) !default;
$range-hover-color: $content-bg-color-alt2 !default;
$range-hover-content-color: $flyout-bg-color-hover !default;
$range-today-color: $transparent !default;
$range-selection-bg: rgba($primary) !default;
$range-other-hover-color: $transparent !default;
$range-other-month-date: rgba($content-text-color-alt1) !default;
...
$range-calendar-dark-color: rgba($content-text-color) !default;
$range-calendar-header-text-color: rgba($content-text-color) !default;
$range-calendar-header-dark-color: rgba($content-text-color) !default;
$range-calendar-medium-color: rgba($content-text-color-alt1) !default;
$range-calendar-light-color: rgba($content-text-color-alt1) !default;
...
$range-font-weight-normal: $font-weight-medium !default;
...
$range-change-icon-color: rgba($icon-color) !default;
$range-indicator-label-width: 100% !default;
$range-device-indicator-margin: 10px 0 !default;
$range-separator-height: 1px !default;
$range-border-value: .75px solid rgba($border-light) !default;
$range-separator-color: $flyout-bg-color !default;
...
$range-btn-border-value: 1px solid rgba($primary) !default;
$range-btn-left-radius: 16px 0 0 16px !default;
$range-btn-right-radius: 0 16px 16px 0 !default;
...
$range-icon-hover-color: rgba($content-text-color-alt1) !default;
$range-icon-border-radius: 50% !default;
$range-icon-container-min-height: 30px !default;
...
$range-hover-bg-color: $transparent !default;
$range-icon-bigger-container-min-height: 38px !default;
$range-icon-bigger-container-min-width: 38px !default;
$range-icon-bigger-border-radius: 20px !default;

// new variable
$range-icon: '\e245' !default;
$range-icon-font-size: $font-icon-16 !default;
$range-bigger-icon-font-size: $font-icon-20 !default;
...
$range-overlay: $content-bg-color-alt1 !default;
$range-popup-padding: 0 !default;
$range-presets-bg-color: $transparent !default;
$range-presets-bg-active-color: rgba($content-bg-color-selected) !default;
$range-presets-font-color: rgba($content-text-color) !default;
$range-calendar-normal-table-padding: 0 10px 10px !default;
$range-calendar-bigger-table-padding: 0 12px 12px !default;
$range-popup-border-radius: 8px !default;
$range-list-border-radius: 0 !default;
$range-presets-hover-bg: $flyout-bg-color-pressed !default;
...
$range-calendar-active-border: 1px solid rgba($primary) !default;
$range-today-border-color: $range-calendar-active-border !default;
$range-calendar-today-color: rgba($primary) !default;
...
$range-active-font-color: rgba($primary-text-color) !default;
...
$range-small-icon-container-min-width: 22px !default;
$range-small-icon-container-min-height: 22px !default;
$range-small-icon-border-radius: 14px !default;
$range-bigger-small-icon-container-min-width: 34px !default;
$range-bigger-small-icon-container-min-height: 34px !default;
$range-bigger-small-icon-border-radius: 20px !default;

// mouse small icon
$range-small-icon-font-size: $font-icon-16 !default;

// touch small icon
$range-bigger-small-icon-font-size: $font-icon-20 !default;
...
// modal dialog colors
$modal-range-header-bg-color: rgba($primary) !default;
