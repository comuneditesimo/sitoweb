...
$range-font-color: $selection-font !default;
$range-active-icon-color: $content-font !default;
$range-active-state-icon-color: $selection-font !default;
$range-hover-color: $selection-bg !default;
...
$range-calendar-dark-color: $selection-font !default;
$range-calendar-header-text-color: $selection-bg !default;
...
$range-calendar-header-padding: 10px 12px 0 12px !default;
$range-e-bigger-header-padding: 10px 16px 0 16px !default;
...
$range-presets-bg: $bg-base-0 !default;
$range-preset-normal-font-color: $content-font-color !default;
...
$range-calendar-selection-border: 1px solid $selection-bg !default;
$range-calendar-hover-border: 1px solid darken($range-hover-color, 15%) !default;
$range-calendar-hover-border-color: 1px solid darken($range-hover-color, 15%) !default;
$range-calendar-other-month-border: 1px solid $bg-base-0 !default;
...
$range-change-icon-color: $content-font !default;
...
$range-btn-border-value: 1px solid $content-font !default;
...
$range-background: $bg-base-0 !default;
...
$range-today-border-color: 1px solid $hover-bg !default;
...
$range-popup-border: 1px solid $content-font !default;
$range-overlay: rgba($bg-base-0, .6) !default;
$range-popup-padding: 0 !default;
$range-presets-bg-color: $selection-bg !default;
$range-presets-font-color: $selection-font !default;
$range-calendar-normal-table-padding: 0 11.5px 10px !default;
$range-calendar-bigger-table-padding: 0 16px 15px !default;
$range-popup-border-radius: 0 !default;
$range-list-border-radius: 0 !default;
$range-presets-hover-bg: $hover-bg !default;
...
$range-calendar-today-start-color: 1px solid $hover-bg !default;
...
$modal-range-header-border-bottom: 1px solid $border-default !default;
...
// modal dialog colors
$modal-range-header-bg-color: $bg-base-0 !default;
$modal-range-header-text-color: $content-font !default;
