...
$range-device-max-width: 300px !default;
...
$range-device-control-header-padding: 12px 37px !default;
$range-control-header-margin: 8px 0 !default;
$range-indicator-margin: 0 !default;
$range-lg-day-header-format-width: 100% !default;
$range-start-end-container-height: 34px !default;
...
$range-bigger-footer-height: 63px !default;
$range-btn-height: 38px !default;
...
$range-hover-start-radius: 30px 0 0 30px !default;
$range-hover-end-radius: 0 30px 30px 0 !default;
$range-btn-height: 38px !default;
$range-device-btn-line-height: 36px !default;
...
$range-icon-container-min-width: 20px !default;
...
$range-bigger-icon-container-min-width: 20px !default;
...
$range-popup-header-border-radius: 12px 12px 0 0 !default;
$range-popup-footer-border-radius: 0 0 12px 12px !default;
$range-list-border-radius: 0 !default;
$range-bigger-nav-icon-width: 28px !default;
$range-bigger-nav-icon-height: 28px !default;
$range-calendar-popup-padding: 0 8px 8px !default;
$range-bigger-calendar-popup-padding: 0 16px 12px !default;
...
$range-header-label-size: $text-base !default;
$range-bigger-header-label-size: $text-lg !default;
$range-small-header-label-size: $text-base !default;
...
$range-footer-background: $content-bg-color-alt1 !default;
$range-header-bg-color: $content-bg-color-alt1 !default;
...
$range-presets-font-color: $content-text-color !default;
$range-presets-hover-bg: $content-bg-color-hover !default;
$range-list-hover-color: $content-text-color-hover !default;
$range-calendar-active-border: 1px solid $content-text-color !default;
...
// modal dialog colors
$modal-range-header-bg-color: $content-bg-color-alt1 !default;
...
@include export-module('daterangepicker-bds-icons') {
