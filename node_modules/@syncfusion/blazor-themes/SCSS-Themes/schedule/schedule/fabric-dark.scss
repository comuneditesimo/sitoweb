...
@import '../../schedule/recurrence-editor/fabric-dark.scss';
...
$schedule-header-border-color: $neutral-light !default;
$schedule-header-font-color: $neutral-secondary-alt !default;
$schedule-header-hover-color: $neutral-light !default;
$schedule-content-bg-color: $neutral-white !default;
$schedule-content-border-color: $neutral-light !default;
$schedule-primary-content-font-color: $neutral-light-font !default;
$schedule-secondary-content-font-color: $neutral-light-font !default;
$schedule-select-font-color: $schedule-primary-content-font-color !default;
$schedule-select-bg-color: $neutral-quintenary !default;
$schedule-work-cells-bg-color: $neutral-lighter-alt !default;
$schedule-current-date-bg-color: $theme-primary !default;
$schedule-disable-dates-color: rgba($grey-dark-font, .08) !default;
$schedule-disable-font-color: $neutral-tertiary-alt !default;
$schedule-workhour-bg-color: $neutral-white !default;
$schedule-hover-bg-color: $neutral-light !default;
$schedule-resource-focus-bg-color: $schedule-hover-bg-color !default;
$schedule-hover-font-color: $neutral-light-font !default;
$schedule-active-border-color: $theme-primary !default;
$schedule-active-font-color: $theme-tertiary !default;
$schedule-active-color: $theme-primary-font !default;
...
$schedule-appointment-border-color: $theme-darker !default;
$schedule-appointment-border-radius: 2px !default;
$schedule-appointment-selected-border: 1px solid $neutral-primary !default;
$schedule-appointment-active-border-color: $neutral-primary !default;
...
$schedule-agenda-color: $neutral-white !default;
...
$schedule-tbar-default-icon-color: $default-icon-color !default;
$schedule-tbar-separator-size: $border-size !default;
$schedule-tbar-default-bg: $neutral-white !default;
$schedule-tbar-separator-border: $neutral-light !default;
$schedule-tbar-border-nav: $neutral-white !default;
$schedule-tbar-border-nav-type: solid !default;
$schedule-tbar-hover-bg: $neutral-light !default;
$schedule-tbar-hover-font: $neutral-light-font !default;
...
$schedule-tbar-btn-bgr-minheight: 50px !default;
...
$schedule-box-shadow: 0 1px 1px rgba($shadow, .15) !default;
...
$schedule-popup-border-color: $neutral-light !default;
$schedule-popup-bg-color: $neutral-white !default;
$schedule-popup-header-icon-color: $neutral-light-font !default;
$schedule-popup-header-icon-hover-color: $neutral-light-fontalt !default;
$schedule-popup-header-icon-hover-bg-color: $neutral-light !default;
$schedule-popup-icon-color: $neutral-light-font !default;
$schedule-popup-icon-hover-color: $neutral-light-fontalt !default;
$schedule-popup-icon-hover-bg-color: $neutral-light !default;
$schedule-popup-content-icon-color: $neutral-light-font !default;
$schedule-event-popup-content-padding: 0 18px 16px 26px !default;
$schedule-event-popup-fields-padding: 12px !default;
$schedule-popup-title-color: $neutral-lighter !default;
...
$schedule-icon-color: $neutral-light-font !default;
