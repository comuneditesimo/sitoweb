...
@import '../../calendars/daterangepicker/highcontrast.scss';
...
@import '../../calendars/timepicker/highcontrast.scss';
@import '../../schedule/recurrence-editor/highcontrast.scss';
...
$schedule-header-font-color: $content-font !default;
$schedule-header-hover-color: $hover-bg !default;
$schedule-content-bg-color: $bg-base-10 !default;
$schedule-content-border-color: $border-default !default;
$schedule-primary-content-font-color: $content-font !default;
$schedule-secondary-content-font-color: $content-font-alt !default;
$schedule-select-bg-color: $selection-bg !default;
$schedule-select-font-color: $selection-font !default;
$schedule-work-cells-bg-color: $bg-base-10 !default;
$schedule-current-date-bg-color: transparent !default;
$schedule-disable-dates-color: rgba($shadow, .08) !default;
$schedule-disable-font-color: rgba($default-font-color, .26) !default;
$schedule-workhour-bg-color: $bg-base-0 !default;
$schedule-hover-bg-color: $hover-bg !default;
$schedule-resource-focus-bg-color: $schedule-hover-bg-color !default;
$schedule-hover-font-color: $hover-font !default;
$schedule-active-color: $selection-font !default;
$schedule-active-border-color: $selection-border !default;
$schedule-active-font-color: $selection-bg !default;
$schedule-current-day-active-color: $schedule-active-font-color !default;
...
$schedule-header-cells-padding: 5px !default;
...
$schedule-date-navigation-font-size: 14px !default;
$schedule-header-nrml-font-size: 16px !default;
$schedule-header-bgr-font-size: 18px !default;
$schedule-header-device-font-size: 20px !default;
$schedule-content-nrml-font-size: 14px !default;
$schedule-content-bgr-font-size: 15px !default;
$schedule-content-device-font-size: 14px !default;
$schedule-date-month-header-wrap-bgr-font-size: 14px !default;
$schedule-date-header-wrap-nrml-font-size: 13px !default;
$schedule-date-header-wrap-bgr-font-size: 18px !default;
$schedule-date-header-wrap-device-font-size: 13px !default;
...
$schedule-appointment-bg-color: lighten($success-bg, 5%) !default;
...
$schedule-appointment-border-color: $bg-base-10 !default;
$schedule-appointment-border-radius: 2px !default;
$schedule-appointment-selected-border: 1px solid $border-fg !default;
...
$schedule-time-scale-nrml-font-size: 13px !default;
$schedule-time-scale-bgr-font-size: 14px !default;
...
$schedule-month-work-cells-border: 0 0 1px !default;
$schedule-month-work-cells-height: 70px !default;
$schedule-rtl-month-work-cells-border: 0 0 1px !default;
...
$schedule-agenda-color: $bg-base-10 !default;
$schedule-agenda-date-header-padding: 10px 32px 0 16px !default;
$schedule-recurrence-font-size: 9px !default;
...
$schedule-tbar-border-bottom-size: 1px solid $schedule-header-border-color !default;
...
$schedule-tbar-down-arrow-margin-top: 3px !default;
$schedule-tbar-default-icon-color: $content-font !default;
$schedule-tbar-separator-size: $border-size !default;
$schedule-tbar-default-bg: $bg-base-0 !default;
$schedule-tbar-separator-border: $border-fg !default;
$schedule-tbar-border-nav: $border-default !default;
$schedule-tbar-border-nav-type: solid !default;
$schedule-tbar-hover-bg: $hover-bg !default;
$schedule-tbar-hover-font: $hover-font !default;
...
$schedule-tbar-separator-bgr-minheight: 27px !default;
...
$schedule-tbar-btn-bgr-minheight: 49px !default;
...
$schedule-tbar-btn-icn-right-bgr-padding: 0 12px 0 0 !default;
...
$schedule-box-shadow: 0 1px 0 rgba($shadow, .15) !default;
$schedule-popup-box-shadow-1: 0 24px 38px 3px rgba($shadow, .14) !default;
$schedule-popup-box-shadow-2: 0 9px 46px 8px rgba($shadow, .12) !default;
$schedule-popup-box-shadow-3: 0 11px 15px -7px rgba($shadow, .2) !default;
$schedule-popup-border-color: #e0e0e0 !default;
$schedule-popup-bg-color: $bg-base-0 !default;
$schedule-popup-header-icon-color: $schedule-primary-content-font-color !default;
$schedule-popup-header-icon-hover-color: $content-font !default;
$schedule-popup-header-icon-hover-bg-color: $hover-bg !default;
$schedule-popup-icon-color: $schedule-primary-content-font-color !default;
$schedule-popup-icon-hover-color: $content-font !default;
$schedule-popup-icon-hover-bg-color: $hover-bg !default;
...
$schedule-popup-title-color: rgba($color: lighten($success-bg, 5%), $alpha: .3) !default;
...
$schedule-icon-color: $content-font !default;
...
$schedule-popup-icon-font-size: 18px !default;
$schedule-popup-icon-padding: 4px 13px 0 0 !default;
$schedule-popup-footer-text-transform: capitalize !default;
$schedule-cell-popup-header-icon-padding: 0 !default;
$schedule-cell-popup-span-margin: 0 0 4px !default;
$schedule-cell-popup-subject-height: 40px !default;
$schedule-bgr-cell-popup-content-padding: $schedule-popup-content-padding !default;
$schedule-bgr-cell-popup-footer-padding: $schedule-popup-footer-padding !default;
$schedule-event-popup-subject-color: $schedule-appointment-font-color !default;
...
$schedule-event-popup-subject-padding: 8px 0 8px 10px !default;
...
$schedule-val-error-color: $error-alt !default;
$schedule-val-error-bg-color: $error-bg !default;

$schedule-block-appointment-bg-color: rgba(255, 255, 255, .2) !default;
$schedule-block-appointment-font-color: $bg-base-75 !default;

$schedule-resource-color-margin-top: 12px !default;
...
$schedule-current-date-header-font-color: $schedule-active-font-color !default;
$schedule-selected-date-header-cell-font-color: $schedule-select-font-color !default;
$schedule-appointment-detail-line-height: unset !default;
...
$schedule-more-event-close-icon-font-size: 9px !default;
$schedule-tbar-btn-icn-right-bgr-padding-top: 0 !default;
$schedule-following-events-dlg-padding: 2% !default;
...
$schedule-tbar-border-hover-color: $hover-border !default;
$schedule-tree-content-color: #fff !default;
...
@include export-module('schedule-highcontrast-icons') {
  .e-schedule {
    .e-schedule-toolbar {
      & .e-icon-prev::before {
        content: '\e98f';
