...
@import '../../schedule/recurrence-editor/bootstrap-dark.scss';
...
$schedule-header-hover-color: $grey-light !default;
$schedule-content-bg-color: $grey-f8 !default;
$schedule-content-border-color: $grey-99 !default;
$schedule-primary-content-font-color: $grey-dark-font !default;
$schedule-secondary-content-font-color: $grey-f5 !default;
$schedule-select-font-color: $grey-dark-font !default;
$schedule-select-bg-color: $grey-88 !default;
$schedule-work-cells-bg-color: $grey-dark !default;
$schedule-current-date-bg-color: $brand-primary !default;
$schedule-disable-dates-color: rgba($shadow, .08) !default;
$schedule-disable-font-color: rgba($default-font-color, .26) !default;
$schedule-workhour-bg-color: $grey-base !default;
$schedule-hover-bg-color: $grey-light !default;
...
$schedule-active-font-color: lighten($brand-primary, 15%) !default;
...
$schedule-date-header-wrap-bgr-font-size: 14px !default;
...
$schedule-agenda-color: $grey-base !default;
...
$schedule-tbar-default-bg: $grey-darker !default;
$schedule-tbar-separator-border: $grey-99 !default;
$schedule-tbar-border-nav: $grey-f8 !default;
$schedule-tbar-border-nav-type: solid !default;
$schedule-tbar-hover-bg: $grey-light !default;
$schedule-tbar-hover-font: $brand-primary !default;
...
$schedule-tbar-btn-bgr-minheight: 34px !default;
$schedule-tbar-btn-bgr-minwidth: 34px !default;
$schedule-tbar-btn-bgr-padding: 0 !default;
...
$schedule-popup-border-color: $grey-99 !default;
$schedule-popup-bg-color: $grey-base !default;
$schedule-popup-header-icon-color: $grey-dark-font !default;
$schedule-popup-header-icon-hover-color: $grey-dark-font !default;
$schedule-popup-header-icon-hover-bg-color: $schedule-select-bg-color !default;
$schedule-popup-icon-color: $grey-dark-font !default;
$schedule-popup-icon-hover-color: $grey-light-font !default;
...
$schedule-following-events-dlg-padding: 15px !default;
