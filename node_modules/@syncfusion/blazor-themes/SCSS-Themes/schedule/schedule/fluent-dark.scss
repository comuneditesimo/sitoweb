...
@import '../../schedule/recurrence-editor/fluent-dark.scss';
...
$schedule-secondary-content-font-color: $content-text-color-alt3 !default;
...
$schedule-timezone-enable-nrml-height: 56px !default;
...
$schedule-tbar-default-bg: $content-bg-color !default;
...
$schedule-popup-box-shadow-1: $shadow-xl !default;
...
$schedule-event-popup-content-padding: 0 24px 12px !default;
...
$schedule-popup-icon-padding: 0 12px 0 0 !default;
...
$schedule-popup-header-icon-font-size: $text-xs !default;
...
$schedule-event-popup-subject-wrap-padding: 14px 24px !default;
...
$schedule-resource-tree-text-content-padding: 0 12px 0 20px !default;
...
$schedule-following-events-dlg-padding: 0 24px 24px !default;
...
@include export-module('schedule-fluent-icons') {
  .e-schedule {
    .e-schedule-toolbar {
      & .e-icon-prev::before {
        content: '\e765';
