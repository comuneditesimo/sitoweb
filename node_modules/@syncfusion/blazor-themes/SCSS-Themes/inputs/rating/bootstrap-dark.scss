...
$rating-selected-bg-color: $grey-cc !default;
$rating-unrated-bg-color: $grey-ad !default;
$rating-hover-bg-color: $brand-primary-lighten-20 !default;
$rating-pressed-bg-color: $brand-primary-lighten-20 !default;
...
$rating-reset-icon-color: $grey-cc !default;
$rating-reset-hover-icon-color: $grey-ad !default;
