...
$rating-selected-bg-color: rgba($rating-selected-color) !default;
...
$rating-li-focus: rgba($rating-selected-color) !default;
$rating-reset-icon-color: rgba($icon-color) !default;
$rating-reset-hover-icon-color: rgba($icon-color-hover) !default;
