...
$textarea-padding: 6px 8px 6px 8px !default;
$textarea-bigger-padding: 8px 12px 8px 12px !default;
...
$input-box-border-radius: 2px !default;
$input-small-border-radius: 2px !default;
$input-bigger-border-radius: 2px !default;
$input-bigger-small-border-radius: 2px !default;
$input-groupo-focus-border-radius: 2px !default;
...
$input-bigger-clear-icon: 14px !default;
...
$float-label-bigger-font-size: $text-base !default;
...
$input-error-border-shadow:  0 0 0 1px  $border-error !default;
$input-success-border-shadow: 0 0 0 1px $border-success !default;
$input-warning-border-shadow:  0 0 0 1px $border-warning !default;
$input-group-border-shadow: $shadow-sm !default;
$input-group-icon-border-color: $border-dark;

// color

$hover-border-color: $border-alt !default;
$pressed-border-color: $primary !default;
...
$input-clear-icon-hover-bg-color: $content-bg-color-hover !default;
...
$input-disable-border-color: $content-bg-color-alt2 !default;
...
$input-group-pressed-bg: $content-bg-color-alt4 !default;
...
$input-group-border-color-hover: $border-alt !default;
...
$float-label-font-color: $content-text-color-alt2 !default;
$float-label-disbale-font-color: $content-text-color-disabled !default;
...
$border-type: solid !default;
$float-label-rtl-value: -10px !default;
