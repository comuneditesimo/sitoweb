...
$input-bigger-border-radius: 6px !default;
...
$input-disable-bg-color: $content-bg-color-alt1 !default;
...
$input-disable-border-color: $cool-gray-400 !default;
...
$input-header-font-color: $cool-gray-600 !default;
