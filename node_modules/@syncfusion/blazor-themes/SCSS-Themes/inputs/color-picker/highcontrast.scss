...
$cpicker-palette-value-padding: 0 12px 12px !default;
...
$cpicker-blazor-bigger-input-margin: calc(1.67% - 2.7px) !default;
...
@include export-module('color-picker-highcontrast-icons') {
  .e-container {
    & .e-value-switch-btn {
      &::before {
        content: '\e429';
