...
$slider-bg-color: $default-bg-color !default;
$slider-disabled-bg-color:  $disable !default;
$slider-disabled-opacity: 1 !default;
$slider-tick-font-color: $message-font !default;
$slider-active-bg-color: $active-bg-color !default;
...
$slider-handle-mobile-height: 18px !default;
$slider-handle-mobile-width: 18px !default;
$slider-handle-border-radius: 50% !default;
$slider-button-icon-color: $bg-base-75 !default;
...
$slider-range-bar-color: $selection-bg !default;
$slider-range-bar-hover-color: $selection-bg !default;
$slider-color: $bg-base-5 !default;
$slider-handle-start-border-color: $border-alt !default;
$slider-track-color: $bg-base-75 !default;
$slider-handle-focus-bg-color: rgba($border-alt, .24) !default;
$slider-button-border-color: $bg-base-100 !default;
$slider-button-bg-color: $bg-base-0 !default;
$slider-container-height: 8px !default;
$slider-normal-handle-border-size: 2px solid !default;
$slider-normal-handle-border-color: $bg-base-100 !default;
$slider-handle-bg-color: $invert-font !default;
$slider-hover-handle-color: $bg-base-100 !default;
$slider-button-icon-color: $bg-base-100 !default;
$slider-active-handle-bg-color: $bg-base-0 !default;
$slider-tack-ticks-border-color: $bg-base-0 !default;
$slider-button-icon-font-color: $bg-base-0 !default;
$slider-hover-color: $bg-base-0 !default;
...
$slider-handle-hover-border-color: $border-alt !default;
$tick-after-height: 4px !default;
$tick-after-top: -11px !default;
$largetick-before-top: -11px !default;
$largetick-before-height: 7px !default;
$largetick-after-height: 7px !default;
$largetick-after-top: 18px !default;
$tick-before-height: 4px !default;
$tick-before-top: 15px !default;
$slider-btn-container-height: 4px !default;
$slider-horizontal-btn-icon-prev: '\e937' !default;
$slider-vertical-btn-icon-prev: '\e94d' !default;
$slider-horizontal-btn-icon-next: '\e956' !default;
$slider-vertical-btn-icon-next: '\e20e' !default;
...
$slider-vertical-left: -6px !default;
$slider-vertical-left-with-btn: -7px !default;
$slider-button-font-size: 9px !default;
$slider-scale-font-family: $font-family !default;
$slider-scale-font-size: 9px !default;
$slider-mobile-scale-font-size: 9px !default;
$slider-scale-tick-image: url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsIAAA7CARUoSoAAAAAadEVYdFNvZnR3YXJlAFBhaW50Lk5FVCB2My41LjEwMPRyoQAAAA1JREFUGFdjWLZs2X8ABtoC8jsAVaIAAAAASUVORK5CYII=');
$slider-disabled-handle-show: none !default;
$slider-first-btn-margin: -4px !default;
$slider-second-btn-margin: -5px !default;
$slider-button-size: 18px !default;
$slider-button-horizon-padding: 0 35px !default;
$slider-button-vertical-padding: 35px 0 !default;
$slider-scale-value-position-top: -17px !default;
$slider-scale-value-position-bottom: -17px !default;
$tick-after-left: 2px !default;
$largetick-before-left: -1px !default;
$tick-before-left: 22px !default;
$largetick-after-left: 22px !default;
...
$slider-handle-start-top: calc(50% - 8px) !default;
$slider-handle-start-left: calc(50% - 8px) !default;
$slider-wrap-height: 28px !default;
$slider-wrap-width: 48px !default;
$slider-center-align: -2px !default;
$tick-before-mobile-top: 0 !default;
$tick-after-mobile-top: 18px !default;
$largetick-before-mobile-top: 0 !default;
$largetick-after-mobile-top: 21px !default;
$slider-btn-center-align: -9px !default;
$tick-both-top: -6px !default;
$tick-both-left: 3px !default;
$largetick-both-top: -2px !default;
$largetick-both-left: -2px !default;
$slider-range-height: 6px !default;
$slider-range-width: $slider-vertical-width !default;
$slider-range-border-radius: 0 !default;
...
$slider-scale-top: 9px !default;
$slider-scale-right: -11px !default;
$slider-track-border-color: $content-font-alt !default;
$slider-tab-border-color: $bg-base-75 !default;
$slider-tab-range-color: $slider-range-bar-color !default;
$slider-tab-track-color: $default-bg-color !default;
$slider-handle-active-color: $success-alt !default;
$slider-button-hleft-bg-image: url('data:image/png;base64,');
$slider-button-hright-bg-image: url('data:image/png;base64,');
$slider-button-vdown-bg-image: url('data:image/png;base64,');
$slider-button-vup-bg-image: url('data:image/png;base64,');
...
$slider-limit-bar-color: rgba($bg-base-0, .25) !default;
