...
$list-item-name-width: 85% !default;
...
$remove-bigger-icon-height: 40px !default;
$remove-bigger-icon-width: 40px !default;
...
$clear-icon-focus-color: $content-bg-color-hover !default;
