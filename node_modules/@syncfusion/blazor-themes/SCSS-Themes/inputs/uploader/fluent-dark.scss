...
$header-padding: 16px 0 16px 16px !default;
$drop-area-padding-left: 20px !default;
$drop-area-padding-left-smaller: 16px !default;
...
$list-item-status-font-size: $text-sm !default;
$list-item-status-bigger-font-size: $text-sm !default;
$list-item-margin-left-smaller: 16px !default;
$list-item-margin-left: 20px !default;
$list-line-height: 22px !default;
$remove-icon-margin: 24px 24px 24px 16px !default;
$remove-icon-margin-smaller: 20px 20px 20px 12px !default;
$action-buttons-margin-smaller: 8px !default;
$footer-buttons-margin: 15px !default;
$action-upload-buttons-margin-smaller: 24px 20px 24px 0 !default;
$action-clear-buttons-margin-smaller: 24px 8px 24px 20px !default;
$action-upload-buttons-margin-smaller-rtl: 24px 0 24px 20px !default;
$action-clear-buttons-margin-smaller-rtl: 24px 20px 24px 8px !default;
$footer-upload-buttons-margin: 28px 24px 28px 0 !default;
$footer-clear-buttons-margin: 28px 12px 28px 12px !default;
$footer-upload-buttons-margin-rtl: 28px 0 28px 24px !default;
$footer-clear-buttons-margin-rtl: 28px 12px 28px 12px !default;
$delete-icon-padding-smaller: 15px !default;
$delete-icon-padding: 5px !default;
...
$file-name-padding-top-smaller: 16px !default;
$file-name-padding-top: 16px !default;
$file-size-padding: $zero-value !default;
$file-size-padding-smaller: $zero-value !default;
$progress-bar-wrapper-width: 95% !default;
$progress-bar-top-paddding: 12px !default;
...
$header-padding-rtl-bigger: 20px 20px 20px $zero-value !default;
$header-padding-bigger: 20px $zero-value 20px 20px !default;
$margin-rtl-header: $zero-value !default;
$margin-rtl: 20px !default;
$margin-icon-rtl: 24px !default;
$remove-icon-rtl-bigger: $zero-value !default;
$progress-bar-width-rtl: 86% !default;
$header-padding-rtl-smaller: 16px 16px 16px $zero-value !default;
$margin-rtl-header-smaller: $zero-value !default;
$margin-rtl-smaller: 16px !default;
$margin-icon-rtl-smaller: 20px !default;
...
$remove-icon-font-size-smaller: $font-icon-14 !default;
$remove-icon-font-size: $font-icon-16 !default;
$delete-icon-font-size: $font-icon-16 !default;
$abort-icon-font-size: $font-icon-16 !default;
$delete-icon-font-size-smaller: $font-icon-14 !default;
$abort-icon-font-size-smaller: $font-icon-14 !default;
$upload-border-radius: 4px !default;
$upload-border-radius-bigger: 6px;
$remove-icon-padding-smaller: 5px !default;
...
$file-small-size-padding: 0 !default;
...
$progress-bar-bottom-paddding-small: 12px !default;
...
$list-item-margin-left-small: 12px !default;
$remove-icon-margin-small: 0 13px 0 13px !default;
$footer-upload-buttons-margin-small: 16px 16px 16px 0 !default;
$footer-clear-buttons-margin-samll: 16px 8px 16px 16px !default;
$footer-upload-buttons-margin-rtl-small: 16px 8px 16px 16px !default;
$footer-clear-buttons-margin-rtl-small: 16px 20px 16px 0 !default;
$margin-icon-rtl-small: 12px !default;
...
$upload-success-color: $border-success !default;
$upload-failure-color: $border-error !default;
...
$list-bottom-border: 0 solid $border-light !default;
$upload-border: 1px dashed $border-dark !default;
$drag-hover-border: 2px dashed $primary-outline !default;
...
@include export-module('uploader-theme') {
  ...
  .e-upload {
    ...
    @if $skin-name == 'tailwind' or $skin-name == 'FluentUI' or $skin-name == 'Material3' {
