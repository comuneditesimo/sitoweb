...
$drop-text-color: $content-font !default;
$file-drop-text-color: $drop-text-color !default;
$drag-hover-border: 2px dashed $selection-bg !default;
...
$file-size-color: $content-font-alt !default;
...
$list-bottom-border: 1px solid $border-default !default;
...
$remove-icon-before-left: 8px !default;
...
$progress-bar-wrapper-width: 94% !default;
...
$clear-icon-focus-color: $hover-bg !default;
...
$upload-in-progress-color: $selection-bg !default;
$upload-success-color: $success-alt !default;
$upload-failure-color: $error-alt !default;
$progress-background-color: $bg-base-20 !default;
$upload-border: 1px solid $border-default !default;
$remove-icon-color: $content-font !default;
$upload-hover-icon-color: $hover-font !default;
$progress-text-color: $content-font !default;

$disabled-state: rgba($content-font, .38) !default;
