...
$drop-text-color: rgba($content-text-color) !default;
$file-drop-text-color: $drop-text-color !default;
$drag-hover-border: 2px dashed $grey-500 !default;
$file-size-color: rgba($content-text-color-alt1) !default;
...
$upload-success-color: rgba($success-font-color) !default;
$upload-failure-color: rgba($error-font-color) !default;
$upload-in-progress-color: rgba($primary) !default;
$file-status-top-bigger: 54px !default;
$disabled-state: rgba($outline) !default;
...
$clear-icon-focus-color: rgba($content-text-color, .08) !default;
...
$delete-icon-font-size-smaller: 12px !default;
...
$upload-border: 1px dashed rgba($border-light) !default;
$list-bottom-border: 1px solid rgba($border-light) !default;

$remove-icon-color: rgba($icon-color) !default;
$upload-hover-icon-color: rgba($icon-color-hover) !default;
