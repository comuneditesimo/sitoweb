...
$step-optional-color: $neutral-secondary !default;
...
$step-progress-bg-color: $neutral-tertiary !default;
...
$step-valid-icon-only-color:$success-font !default;
...
$step-error-icon-color: $error-font !default;
...
$step-hover-color: $neutral-light !default;
$step-active-color: $neutral-quintenary !default;
