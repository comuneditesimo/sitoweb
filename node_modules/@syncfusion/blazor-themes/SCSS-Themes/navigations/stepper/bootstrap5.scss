...
$step-border-color: $border-light !default;
$step-hover-text-color: $primary-text-color !default;
$step-hover-not-text-color: $content-text-color !default;
$step-hover-border-color: $border-light !default;
$step-active-border-color: $border-light !default;
...
$step-hover-color: $content-bg-color-alt3 !default;
$step-active-color: $content-bg-color-alt4 !default;
