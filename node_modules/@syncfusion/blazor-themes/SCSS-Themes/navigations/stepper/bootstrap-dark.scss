...
$step-border-color: $grey-8c !default;
$step-hover-text-color: $brand-primary-font !default;
$step-hover-not-text-color: $grey-dark-font !default;
$step-hover-border-color: $grey-f9 !default;
$step-active-border-color: $grey-f9 !default;
$stepper-outline-color: $gray-base !default;
$step-color: $grey-dark-font !default;
$step-optional-color: $grey-cc !default;
$step-bg-color: $gray-light !default;
$step-completed-color: $brand-primary-font !default;
$step-completed-bg-color: $brand-primary !default;
$step-progress-bg-color: $grey-8c !default;
$step-progress-value-bg-color: $brand-primary !default;
$step-disabled-bg-color: $grey-88 !default;
$step-disabled-font-color: $grey-lighter !default;
$step-disabled-color: $grey-88 !default;
$stepper-text-color: $grey-light-font !default;
$step-valid-icon-only-color:$brand-success !default;
$step-error-icon-only-color: $brand-danger !default;
$step-valid-completed-color: $grey-light-font !default;
$step-valid-completed-bg-color: $brand-success !default;
$step-error-icon-color: $grey-light-font !default;
$step-error-completed-color: $brand-danger !default;
$step-error-completed-bg-color: $brand-danger !default;
$step-indicator-color: $grey-ad !default;
$step-hover-color: $grey-88 !default;
$step-active-color: $grey-8c !default;
$step-selected-hover-color: $brand-primary-lighten-10 !default;
$step-selected-active-color: $brand-primary-lighten-15 !default;
