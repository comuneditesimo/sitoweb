...
$menu-bigger-caret-li-padding: 30px !default;
$menu-bigger-caret-right: 10px !default;
...
$menu-bigger-li-right-padding: 10px !default;
...
$menu-li-border-color:  $border-fg !default;
...
$menu-li-selection-bgcolor:  $selection-bg !default;
...
$menu-sub-ul-bgcolor: $bg-base-0 !default;
$menu-sub-li-border-color: $border-fg !default;
$menu-ul-bgcolor: $bg-base-0 !default;
$menu-ul-border: $menu-li-border-width $menu-li-border-style $border-fg !default;
...
@include export-module('menu-highcontrast-icons') {
