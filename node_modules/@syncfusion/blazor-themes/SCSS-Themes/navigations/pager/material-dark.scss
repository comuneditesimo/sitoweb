...
//default
$pager-bg-color: $grey-dark !default;
$pager-active-bg-color: $accent !default;
$pager-hover-bg-color: rgba($grey-white, .1) !default;
$pager-number-hover-bg-color: rgba($grey-white, .1) !default;
...
$pager-color: rgba($grey-dark-font, .7) !default;
...
$pager-focus-shadow: 0 0 0 1px rgba($grey-white, .5) inset !default;
...
@include export-module('pager-material-dark-icons') {
