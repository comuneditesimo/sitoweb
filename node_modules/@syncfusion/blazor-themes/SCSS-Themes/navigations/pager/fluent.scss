...
$pager-bigger-messagebar-padding-bottom: 11px !default;
$pager-content-opacity: 1 !default;
$pager-bigger-new-container-rtl-margin: 0 !default;
$pager-next-icon-margin-left: 0 !default;
$pager-container-rtl-margin: 0 5.5px -4px 0 !default;
$pager-rtl-navigation-icon-padding: 11px 10px 10px 11px !default;
...
$pager-bigger-rtl-activeitem-padding: 13px 13px 11px 13px !default;
...
$pager-padding: 8px 12.5px 8px 11.5px !default;
$pager-numeric-font-weight: 400 !default;
...
$pager-tripledot-padding: 8px 12px 10px 11px !default;
$pager-numeric-icon-padding: 8px 13px 10px 12px !default;
$pager-pagecontainer-icon-padding: 11px 10px 10px 11px !default;
$pager-bigger-pagecontainer-icon-padding: 14px 10px 13px 11px !default;
$pager-hover-color: $content-text-color-alt3 !default;
$pager-mhover-color: $primary !default;
$pager-pagermessage-weight: 600 !default;
$pager-active-color: $secondary-text-color !default;
$pager-active-bg-color: $secondary-bg-color !default;
$pager-last-border-size: 1px !default;
$page-content-color: $content-text-color-alt3 !default;
$pager-container-margin: 3px 0 -4px .3px !default;
...
$pager-bigger-pagercontainer-icons-padding: 12.5px 12px 12px 11px !default;
$pager-bigger-pagercontainer-icons-marign-right: 0 !default;
$pager-bigger-current-item-padding: 13px 13px 11px 13px !default;
...
$pager-dropdown-margin-top: -30px !default;
$pager-dropdown-margin-left: 10px !default;
$pager-dropdown-margin-right: 8px !default;
$pager-dropdown-overflow: unset !default;
$pager-bigger-dropdown-constant-margin: 5px !default;
$pager-bigger-dropdown-margin: -35px  10px 0 18px !default;
$pager-dropdown-height: 26px !default;
$pager-dropdown-width: 64px !default;
$pager-bigger-dropdown-width: 82px !default;
$pager-constant-margin: 0 0 5px 8px !default;
$pager-bigger-letter-spacing: 14.5px 13px 10px 13px !default;
$pager-tripledot-rtl-margin-top: 0 !default;
$pager-tripledot-rtl-padding: 8px 12px 10px 11px !default;
$pager-rtl-pagerconstant-margin-top: 8px 8px 6px 8px !default;
$pager-rtl-pagerdropdown-margin: -26px 16px 0 0 !default;
...
$pager-activeitem-padding: 7px 13px 9px 12px !default;
$pager-bigger-activeitem-padding: $pager-activeitem-padding !default;
$pager-rtl-pagerdropdown-bigger-margin: -40px 16px 0 0 !default;
$pager-rtl-pagerconstant-bigger-margin-top: 14px 16px 9px 0 !default;
...
$pager-bigger-dropdown-margin-top: -31px !default;
$pager-rtl-nxtpage-margin: 0 !default;
$pager-disabled-icons-opacity: .8 !default;
$pager-current-item-font-weight: $font-weight-medium !default;
$pager-bigger-dropdown-heigh: 29px !default;
$pager-external-msg-padding: 6px 6px 0 6px !default;
$pager-rtl-bigger-tripledot-font-size: 14px !default;
$pager-current-item-font-weight: 600 !default;
$pager-skin: 'fluent' !default;
$pager-active-item-border-bottom: 2px solid $primary !default;
$pager-container-border-radius: 0 !default;
$pager-bigger-tripledot-font-size: 16px !default;
...
$pager-bigger-adaptive-dropdown-margin: -4px 2px 0 4px !default;
...
$pager-bigger-adaptive-pager-padding: 9px !default;
$pager-adaptive-pagermsgbar-margin-top: -5px !default;
$pager-adaptive-dropdown-margin: 2px 2px 0 4px !default;
$pager-rtl-adaptive-pagermsgbar-margin-top: -4px !default;
$pager-rtl-adaptive-dropdown-margin: 1px 4px 0 2px !default;
$pager-adaptive-constant-pagesizeall-top: 11px !default;
$pager-bigger-adaptive-constant-pagesizeall-top: 9px !default;
$pager-rtl-adaptive-constant-pagesizeall-top: 6px !default;
...
@include export-module('pager-fluent-icons') {
