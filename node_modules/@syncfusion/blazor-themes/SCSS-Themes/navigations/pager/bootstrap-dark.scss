...
$pager-bg-color: $grey-base !default;
$pager-border-color: $grey-99 !default;
$pager-color: $grey-dd !default;
...
$pager-number-hover-bg-color: $grey-99 !default;
$pager-font-family: Helvertica !default;
$pager-font-weight: bold !default;
$pager-messagebar-padding-right: 8px !default;
$pager-tripledot-padding: 8px 11px 9px !default;
$pager-numeric-icon-padding: 11px 12px 10px 11px !default;
$pager-pagecontainer-icon-padding: 11px 10px 12px 8px !default;
$pager-bigger-pagecontainer-icon-padding: 11px 10px 12px 8px !default;
$pager-hover-color: $grey-dark-font !default;
$pager-mhover-color: $grey-dark-font !default;
...
$pager-hover-bg-color: $grey-99 !default;
...
$pager-skin: 'bootstrap-dark' !default;
$pager-container-border-radius: 4px !default;
$pager-bigger-tripledot-font-size: $pager-tripledot-font-size !default;
$pager-focus-bg-color: $grey-light !default;
$pager-focus-tripledot-padding: $pager-tripledot-padding !default;
$pager-focus-tripledot-line-height: 1 !default;
$pager-focus-active-box-shadow: 0 0 0 1px lighten($brand-primary, 10%) inset !default;
$pager-focus-shadow: 0 0 0 1px lighten($brand-primary, 10%) inset !default;
...
@include export-module('pager-bootstrap-dark-icons') {
