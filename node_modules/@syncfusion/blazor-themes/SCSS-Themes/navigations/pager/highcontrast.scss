...
$pager-color: $default-font-color !default;
...
$pager-container-margin: 0 6px -3px !default;
...
$pager-rtl-navigation-icon-padding: 11px 9px 8px 2px !default;
...
$pager-border-color: $border-default !default;
$pager-icon-color: $content-font !default;
$pager-border-size: 0 !default;
$pager-padding: 13px 0 12px !default;
$pager-active-bg-color: $selection-bg !default;
$pager-active-color: $selection-font !default;
...
$pager-first-content-icon: 'e999' !default;
$pager-prev-content-icon: 'e829' !default;
$pager-next-content-icon: 'e830' !default;
$pager-last-content-icon: 'e938' !default;
$pager-icon-size: 12px !default;
$pager-hover-color: $hover-font !default;
$pager-number-hover-bg-color: $hover-bg !default;
$pager-pagecontainer-icon-padding: 9px 10px !default;
$pager-bigger-pagecontainer-icon-padding: 12px 10px 8px !default;
$pager-messagebar-padding-top: 12px !default;
$pager-messagebar-padding-right: 10px !default;
$pager-last-page-hover-border-radius: 0 !default;
$pager-first-page-hover-border-radius: 0 !default;
$pager-rtl-parentmsgbar-margin-left: 8px !default;
$pager-rtl-parentmsgbar-padding-top: 8px !default;
$pager-numericitem-margin-right: 0 !default;
$pager-tripledot-font-size: 20px !default;
$pager-tripledot-padding: 3px 6px 7px !default;
$pager-numeric-icon-padding: 9px 3px 8px 2px !default;
$pager-bigger-padding: 14px 0 10px !default;
$pager-bigger-messagebar-padding-right: 13px !default;
$pager-bigger-messagebar-padding-top: 11px !default;
$pager-bigger-nexticon-marign-left: $pager-next-icon-margin-left * 1.25 !default;
$pager-bigger-rtl-nexticon-marign-right: $pager-next-icon-margin-left * 1.25 !default;
$pager-bigger-current-item-border-radius: 0 !default;
$pager-bigger-pagercontainer-margin: 5px 8px 5px 13px !default;
$pager-bigger-font-size: 14px !default;
$pager-letter-spacing: 0 !default;
$bigger-icon-font-size: 17px !default;
$pager-bigger-current-item-padding: 8px 11px !default;
$pager-bigger-pagercontainer-icons-marign-right: 0 !default;
$pager-bigger-pagercontainer-icons-padding: 10px !default;
$pager-bigger-rtl-parentmsgbar-margin-left: 10px !default;
$pager-bigger-rtl-activeitem-padding: 10px 14px !default;
$pager-bigger-numeric-item-margin: 0 !default;
$pager-dropdown-margin-top: -20px !default;
$pager-dropdown-margin-left: 19px !default;
$pager-dropdown-margin-right: 0 !default;
$pager-dropdown-overflow: hidden !default;
$pager-bigger-dropdown-constant-margin: 17px !default;
$pager-bigger-dropdown-margin: -44px  0 0 15px !default;
$pager-dropdown-height: 32px !default;
$pager-dropdown-width: 90px !default;
$pager-bigger-dropdown-width: 90px !default;
$pager-constant-margin: 11px 0 4px 8px !default;
$pager-bigger-letter-spacing: 2px 10px 11px !default;
$pager-hover-bg-color: $hover-bg !default;
$pager-activeitem-padding: 9px 3px 8px 2px !default;
$pager-bigger-activeitem-padding: $pager-activeitem-padding !default;
$pager-numericitem-min-width: 30px !default;
$pager-tripledot-rtl-margin-top: 2px !default;
$pager-tripledot-rtl-padding: 0 11px 9px !default;
$pager-rtl-pagerconstant-margin-top: 8px !default;
$pager-rtl-pagerdropdown-margin: -20px 25px 0 0 !default;
...
$pager-rtl-pagerdropdown-bigger-margin: -22px 25px 0 0 !default;
$pager-rtl-pagerconstant-bigger-margin-top: 5px 10px 5px 0 !default;
...
$pager-rtl-pagermsgbar-device-margin-top: 6px !default;
$pager-bigger-constant-margin-left: 10px !default;
$pager-rtl-last-content-icon: 'e999' !default;
$pager-rtl-first-content-icon: 'e938' !default;
$pager-rtl-prev-content-icon: 'e830' !default;
$pager-rtl-next-content-icon: 'e829' !default;
$pager-rtl-first-last-icon-hover-border-radius: 0 4px 4px 0 !default;
$pager-bg-color: $bg-base-0 !default;
$pager-item-hover-border-width: 2px !default;
$pager-item-hover-border-color: $hover-border !default;
$pager-bigger-current-item-hover-padding: 6px 9px !default;
$pager-numeric-icon-hover-padding: 7px 1px 6px 0 !default;
$pager-bigger-rtl-activeitem-hover-padding: 8px 12px !default;
$pager-activeitem-hover-padding: 7px 1px 6px 0 !default;
$pager-bigger-dropdown-margin-top: -40px !default;
...
$pager-skin: 'highcontrast' !default;
$pager-container-border-radius: 4px !default;
$pager-bigger-tripledot-font-size: $pager-tripledot-font-size !default;
$pager-focus-bg-color: $hover-bg !default;
$pager-focus-tripledot-padding: $pager-tripledot-padding !default;
$pager-focus-tripledot-line-height: 1 !default;
$pager-focus-active-box-shadow: 0 0 0 1px $border-default inset !default;
$pager-focus-shadow: 0 0 0 1px $border-default inset !default;
$pager-bigger-adaptive-pagermsgbar-margin-top: -2px !default;
$pager-bigger-adaptive-dropdown-margin: -2px 2px 0 4px !default;
$pager-bigger-adaptive-dropdown-min-width: 77px !default;
$pager-bigger-adaptive-constant-top: 4px !default;
$pager-rtl-adaptive-constant-top: 4px 10px 0 8px !default;
$pager-rtl-e-bigger-adaptive-dropdown-margin: 0 4px 0 2px !default;
$pager-rtl-e-bigger-adaptive-pagermsgbar-margin-top: -2px !default;
$pager-bigger-adaptive-pager-padding: 8px !default;
$pager-adaptive-pagermsgbar-margin-top: -2px !default;
$pager-adaptive-dropdown-margin: 0 2px 0 4px !default;
$pager-rtl-adaptive-pagermsgbar-margin-top: -2px !default;
$pager-rtl-adaptive-dropdown-margin: 2px 4px 0 2px !default;
$pager-adaptive-constant-pagesizeall-top: 10px !default;
$pager-bigger-adaptive-constant-pagesizeall-top: 10px !default;
$pager-rtl-adaptive-constant-pagesizeall-top: 10px !default;
$pager-rtl-e-bigger-adaptive-constant-pagesizeall-top: 10px !default;
...
@include export-module('pager-highcontrast-icons') {
