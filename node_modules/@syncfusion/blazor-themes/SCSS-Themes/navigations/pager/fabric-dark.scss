...
//default
$pager-border-color: $neutral-light !default;
$pager-border-size: 0 !default;
$pager-padding: 13px 0 12px !default;
$pager-active-bg-color: $theme-primary !default;
$pager-active-color: $theme-primary-font !default;
...
$pager-hover-color: $neutral-light-fontalt !default;
$pager-number-hover-bg-color: $neutral-light !default;
...
$pager-dropdown-margin-top: -15px !default;
...
$pager-hover-bg-color: $neutral-light !default;
...
$pager-rtl-pagerdropdown-margin: -22px 25px 0 0 !default;
...
$page-content-color: $neutral-light-font !default;
$pager-icon-color: $neutral-light-font !default;
$pager-color: $neutral-light-font !default;
$pager-bigger-dropdown-margin-top: $pager-dropdown-margin-top !default;
...
$pager-skin: 'fabric-dark' !default;
$pager-container-border-radius: 4px !default;
$pager-bigger-tripledot-font-size: $pager-tripledot-font-size !default;
$pager-focus-bg-color: $neutral-light !default;
$pager-focus-tripledot-padding: $pager-tripledot-padding !default;
$pager-focus-tripledot-line-height: 1 !default;
$pager-focus-active-box-shadow: 0 0 0 1px $neutral-secondary inset !default;
$pager-focus-shadow: 0 0 0 1px $neutral-secondary inset !default;
$pager-bigger-adaptive-pagermsgbar-margin-top: 2px !default;
$pager-bigger-adaptive-dropdown-margin: 1px 2px 0 4px !default;
$pager-bigger-adaptive-dropdown-min-width: 77px !default;
$pager-bigger-adaptive-constant-top: 8px !default;
$pager-rtl-adaptive-constant-top: 2px 10px 0 8px !default;
$pager-rtl-e-bigger-adaptive-dropdown-margin: 3px 4px 0 2px !default;
$pager-rtl-e-bigger-adaptive-pagermsgbar-margin-top: 0 !default;
$pager-bigger-adaptive-pager-padding: 7px !default;
$pager-adaptive-pagermsgbar-margin-top: -6px !default;
$pager-adaptive-dropdown-margin: 1px 2px 0 4px !default;
$pager-rtl-adaptive-pagermsgbar-margin-top: -4px !default;
$pager-rtl-adaptive-dropdown-margin: 5px 4px 0 2px !default;
$pager-adaptive-constant-pagesizeall-top: 13px !default;
$pager-bigger-adaptive-constant-pagesizeall-top: 14px !default;
$pager-rtl-adaptive-constant-pagesizeall-top: 12px !default;
...
@include export-module('pager-fabric-dark-icons') {
