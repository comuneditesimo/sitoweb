...
$pager-bigger-adaptive-constant-top: 10px !default;
...
$pager-rtl-adaptive-pagermsgbar-margin-top: -7px !default;
$pager-rtl-adaptive-dropdown-margin: 2px 4px 0 2px !default;
$pager-adaptive-constant-pagesizeall-top: 13px !default;
$pager-bigger-adaptive-constant-pagesizeall-top: 15px !default;
...
@include export-module('pager-material3-icons') {
