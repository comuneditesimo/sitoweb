...
$cmenu-caret-color: $grey-dark-font !default;
$cmenu-caret-icon: '\e207' !default;
$cmenu-caret-icon-rtl: '\e990' !default;
$cmenu-caret-li-padding: 36px !default;
$cmenu-caret-right: 7px !default;
$cmenu-color: $grey-dark-font !default;
$cmenu-disable-text: rgba($grey-dark-font, .65) !default;
$cmenu-font-size: 14px !default;
$cmenu-font-weight: normal !default;
$cmenu-icon-margin-right: 12px !default;
$cmenu-li-bgcolor: $grey-88 !default;
$cmenu-li-border-color: $grey-99 !default;
$cmenu-li-border-style: solid !default;
$cmenu-li-border-width: 1px !default;
$cmenu-li-height: 26px !default;
$cmenu-li-padding: 0 14px !default;
$cmenu-li-right-padding: 14px !default;
$cmenu-li-selection-bgcolor: $grey-99 !default;
$cmenu-li-selection-font-color: $grey-dark-font !default;
$cmenu-max-width: 240px !default;
$cmenu-icon-color: $grey-dark-font !default;
$cmenu-icon-disabled-color: rgba($grey-dark-font, .65) !default;
$cmenu-icon-font-size: 16px !default;
$cmenu-icon-bigger-font-size: 16px !default;
$cmenu-min-width: 120px !default;
$cmenu-parent-ul-box-shadow: 0 5px 15px rgba($base-font, .5) !default;
$cmenu-seperator-bigger-padding: 5px 0 !default;
$cmenu-seperator-padding: 3px 0 !default;
$cmenu-selected-color: $grey-dark-font !default;
$cmenu-sub-ul-box-shadow: 0 5px 15px rgba($base-font, .5) !default;
$cmenu-ul-bgcolor: $grey !default;
$cmenu-ul-border: 1px solid $grey-99 !default;
$cmenu-ul-border-radius: 4px !default;
$cmenu-ul-padding: 0 !default;
$cmenu-ul-bigger-padding: 5px 0 !default;
...
@include export-module('context-menu-bootstrap-dark-icons') {
