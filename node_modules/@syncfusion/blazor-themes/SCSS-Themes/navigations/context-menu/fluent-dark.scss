...
$cmenu-li-padding: 0 8px !default;
...
$cmenu-li-selection-bgcolor: $flyout-bg-color-focus !default;
...
$cmenu-selected-color: $cmenu-li-selection-font-color !default;
...
$cmenu-caret-hover-color: $icon-color !default;
$cmenu-hover-icon-color: $icon-color !default;
...
@include export-module('context-menu-fluent-icons') {
