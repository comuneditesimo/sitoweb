...
$cmenu-ul-border-radius: 8px !default;
$cmenu-ul-padding: 4px 6px !default;
$cmenu-ul-bigger-padding: 4px 6px !default;
...
$cmenu-li-bgcolor: $content-bg-color-focus !default;
$cmenu-li-border-color: $border-light !default;
$cmenu-li-border-style: solid !default;
$cmenu-li-selection-bgcolor: $content-bg-color-focus !default;
...
$cmenu-selected-color: $content-text-color-focus !default;
...
@include export-module('context-menu-bds-icons') {
