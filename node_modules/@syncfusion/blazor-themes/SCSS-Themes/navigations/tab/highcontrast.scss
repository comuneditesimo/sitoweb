...
$tab-active-text-item-border: $tab-border-style $selection-bg !default;
$tab-disable-active-text-item-border: $tab-border-style $disable !default;
$tab-active-item-border: 0 !default;
$tab-alt-active-item-border: 0 !default;
$tab-accent-active-item-border: 0 !default;
$tab-fill-hdr-border: $tab-border-style $selection-bg !default;
$tab-fill-disable-hdr-border: $tab-border-style $disable !default;
$tab-anim-border-display: none !default;
$tab-border-color: $selection-bg !default;
$tab-disable-border-color: $disable !default;
$tab-alt-border-color: $selection-bg !default;
...
$tab-ripple-bg-color: rgba($bg-base-0, 0) !default;
...
$tab-fill-focus-bg-color: $selection-bg !default;
$tab-hover-bg-color: $hover-bg !default;
$tab-active-bg-color: $selection-bg !default;
$tab-fill-active-bg-color: $selection-bg !default;
$tab-fill-disable-active-bg-color: $disable !default;
$tab-alt-active-bg-color: $selection-bg !default;
$tab-alt-disable-active-bg-color: $disable !default;
$tab-alt-item-bg-color: $bg-base-20 !default;
$tab-alt-active-focus-bg-color: $selection-bg !default;
$tab-key-alt-active-focus-bg-color: transparent !default;
$tab-alt-focus-top-bottom-bg-color: $selection-bg !default;
$tab-alt-hover-bg-color: $hover-bg !default;
$tab-fill-active-wrap-corner: 3px 3px 0 0 !default;
$tab-fill-even-active-wrap-corner: 0 0 3px 3px !default;
$tab-alt-tb-active-bg-color: $selection-bg !default;
...
$tab-disable-active-text-color: $disable !default;
$tab-focus-text-color: $content-font !default;
$tab-hover-text-color: $content-font !default;
$tab-pop-active-item-text-color: $selection-font !default;
$tab-alt-text-color: $content-font !default;
$tab-alt-disable-text-color: $disable !default;
$tab-alt-active-text-color: $selection-font !default;
...
$tab-close-icon-color: $content-font !default;
$tab-mob-close-icon-color: $content-font !default;
$tab-active-close-icon-color: $content-font !default;
...
$tab-hover-nav-bg-color: $hover-bg !default;
$tab-bg-hover-nav-bg-color: $hover-bg !default;
$tab-nav-icon-color: $content-font !default;
$tab-alt-nav-icon-color: $content-font !default;
$tab-active-nav-icon-color: $content-font !default;
$tab-hover-nav-icon-color: $hover-font !default;
$tab-alt-hover-nav-icon-color: $hover-font !default;
$tab-disable-nav-icon-color: $content-font !default;
$tab-nav-focus-bg-color: transparent !default;
$tab-nav-focus-icon-color: $hover-font !default;
$tab-bg-nav-focus-icon-color: $content-font !default;
...
$tab-fill-active-wrap-border-color: $selection-bg !default;
$tab-fill-focused-active-wrap-focus-border-color: $bg-base-100 !default;
$tab-alt-wrap-border-color: $bg-base-20 !default;
$tab-alt-wrap-hover-color: $hover-font !default;
$tab-alt-wrap-hover-bg-color: $hover-bg !default;
$tab-alt-wrap-hover-border-color: $hover-border !default;
$tab-alt-wrap-hover-close-active-or-hover-color: $selection-bg !default;
$tab-alt-active-wrap-border-color: $selection-bg !default;
$tab-alt-active-wrap-hover-bg-color: $hover-bg !default;
$tab-alt-active-wrap-hover-border-color: $hover-border !default;
$tab-alt-active-wrap-hover-color: $hover-font !default;
$tab-alt-active-wrap-hover-close-hover-or-active-color: $selection-bg !default;
$tab-alt-active-wrap-hover-focus-color: $hover-font !default;
$tab-alt-active-wrap-hover-focus-bg-color: $hover-bg !default;
$tab-fill-pop-item-active-hover-color: $selection-font !default;
$tab-alt-pop-wrap-hover-color: $hover-font !default;
$tab-alt-pop-wrap-active-color: $selection-font !default;
$tab-alt-pop-wrap-active-bg-color: $selection-bg !default;
...
$tab-nav-pop-arrow-active-focus-border: 0 !default;
$tab-alt-nav-border-color: $bg-base-20 !default;
$tab-alt-nav-hover-color: $hover-font !default;
...
$tab-item-hover-bg: $hover-bg-color !default;
...
$tab-item-active-hover-bg: $hover-bg-color !default;
