...
$tbar-popup-nav-active-icons-color: $grey-dark-font !default;
$tbar-popup-nav-hover-bg: $tbar-hover-bg !default;
$tbar-popup-nav-hover-color: $tbar-hover-font !default;
$tbar-popup-nav-hover-icons-color: $grey-dark-font !default;
...
$tbar-popup-nav-hover-active-border-size:  0 0 0 1px !default;
