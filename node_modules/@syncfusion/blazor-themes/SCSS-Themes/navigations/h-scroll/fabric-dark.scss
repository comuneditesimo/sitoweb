...
$hscroll-default-bg: $neutral-lighter !default;
$hscroll-press-bg: $neutral-quintenary !default;
$hscroll-active-bg: $neutral-light !default;
...
$hscroll-default-border: $neutral-light !default;
$hscroll-box-shadow: none !default;
$hscroll-hover-bg: $neutral-light !default;
...
$hscroll-default-icon-color: $theme-primary-font !default;
...
@include export-module('hscroll-fabric-dark-icons') {
