...
//default
$hscroll-skin: 'bootstrap' !default;
$hscroll-default-bg: $grey-darker !default;
...
$hscroll-default-icon-color: $grey-dark-font !default;
$hscroll-hover-bg: $grey-light !default;
$hscroll-press-bg: $grey-dark !default;
$hscroll-default-border: $grey-99 !default;
...
$hscroll-active-box-shadow: inset 0 3px 5px rgba(0, 0, 0, .125) !default;
...
@include export-module('hscroll-bootstrap-dark-icons') {
