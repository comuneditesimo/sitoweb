...
$treeview-text-color: $neutral-light-font !default;
$treeview-item-border-color: transparent !default;
$treeview-item-active-bg: $neutral-quintenary !default;
$treeview-icon-active-color: $neutral-light-fontalt !default;
$treeview-text-active-color: $neutral-light-fontalt !default;
$treeview-item-active-border-color: $neutral-quintenary !default;
$treeview-item-hover-bg: $neutral-light !default;
$treeview-icon-hover-color: $neutral-light-font !default;
$treeview-text-hover-color: $neutral-light-font !default;
$treeview-item-hover-border-color: $neutral-light !default;
$treeview-item-active-hover-bg: $neutral-quintenary !default;
$treeview-icon-active-hover-color: $neutral-light-fontalt !default;
$treeview-text-active-hover-color: $neutral-light-fontalt !default;
$treeview-item-active-hover-border-color: $neutral-secondary-alt !default;
$treeview-text-disable-color: $neutral-tertiary-alt !default;
$treeview-icon-disable-color: $neutral-tertiary-alt !default;
$treeview-drag-line-bg: $theme-primary !default;
$treeview-drag-line-color: $neutral-tertiary !default;
$treeview-popup-bg-color: $theme-primary-font !default;
$treeview-popup-border-color: $neutral-tertiary !default;
$treeview-drop-count-bg: $theme-primary !default;
$treeview-drop-count-border: $neutral-secondary !default;
$treeview-drop-count-color: $theme-dark-font !default;
$treeview-drag-item-bg: $neutral-dark !default;
$treeview-drag-item-color: $grey-dark-font !default;
$treeview-drag-icon-color: $grey-dark-font !default;
...
@include export-module('treeview-fabric-dark-icons') {
