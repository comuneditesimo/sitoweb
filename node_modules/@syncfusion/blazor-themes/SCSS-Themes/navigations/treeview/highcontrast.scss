...
$treeview-text-color: $content-font !default;
$treeview-item-border-color: transparent !default;
$treeview-item-active-bg: $selection-bg !default;
$treeview-icon-active-color: $selection-font !default;
$treeview-text-active-color: $selection-font !default;
$treeview-item-active-border-color: $selection-bg !default;
$treeview-item-hover-bg: $hover-bg !default;
$treeview-icon-hover-color: $hover-font !default;
$treeview-text-hover-color: $hover-font !default;
$treeview-item-hover-border-color: $hover-border !default;
$treeview-item-active-hover-bg: $selection-bg !default;
$treeview-icon-active-hover-color: $selection-font !default;
$treeview-text-active-hover-color: $selection-font !default;
$treeview-item-active-hover-border-color: $hover-border !default;
$treeview-text-disable-color: $disable !default;
$treeview-icon-disable-color: $disable !default;
$treeview-drag-line-bg: $content-font !default;
$treeview-drag-line-color: $content-font !default;
$treeview-popup-bg-color: $hover-bg !default;
$treeview-popup-border-color: $hover-border !default;
$treeview-drop-count-bg: $bg-base-0 !default;
$treeview-drop-count-border: $border-fg !default;
$treeview-drop-count-color: $border-fg !default;
$treeview-drag-item-bg: $selection-bg !default;
$treeview-drag-item-color: $selection-font !default;
$treeview-drag-icon-color: $selection-font !default;

$treeview-checkmark-bgcolor: $selection-font !default;
