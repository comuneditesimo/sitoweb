...
$treeview-item-active-bg: rgba($grey-dark-font, .18) !default;
$treeview-icon-active-color: rgba($grey-dark-font, .70) !default;
$treeview-text-active-color: $accent !default;
$treeview-item-active-border-color: transparent !default;
$treeview-item-hover-bg: rgba($grey-dark-font, .10) !default;
$treeview-icon-hover-color: rgba($grey-dark-font, .70) !default;
$treeview-text-hover-color: $grey-dark-font !default;
$treeview-item-hover-border-color: transparent !default;
$treeview-item-active-hover-bg: rgba($grey-dark-font, .18) !default;
$treeview-icon-active-hover-color: rgba($grey-dark-font, .70) !default;
$treeview-text-active-hover-color: $accent !default;
$treeview-item-active-hover-border-color: transparent !default;
$treeview-text-disable-color: rgba($grey-dark-font, .30) !default;
$treeview-icon-disable-color: rgba($grey-dark-font, .30) !default;
$treeview-drag-line-bg: $accent !default;
$treeview-drag-line-color: rgba($grey-white, .60) !default;
$treeview-popup-bg-color: $grey-700 !default;
