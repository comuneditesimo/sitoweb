...
$acrdn-item-selected-first-child-border-top: 1px none $content-bg-color-alt3 !default;
$acrdn-item-selected-last-child-border-bottom: 1px none $content-bg-color-alt3 !default;
...
$acrdn-item-focus-selected-exp-border-top: 1px none $border-light !default;
$acrdn-item-focus-selected-exp-hdr-focus-border-color: $content-text-color-focus !default;
...
$acrdn-item-focus-exp-hdr-hover-focus-bg-color: $content-bg-color-alt2 !default;
...
$acrdn-item-select-exp-hdr-con-disable-font: $content-text-color !default;
$acrdn-item-header-content-disable-color: $content-text-color !default;
$acrdn-item-hdr-con-text-disabled-font: $content-text-color !default;
$acrdn-item-selected-exp-hdr-focus-border-color: $content-text-color-focus !default;
$acrdn-item-selected-exp-hdr-focus-border-type: solid !default;
$acrdn-item-selected-exp-hdr-focus-border-size: 1px !default;
$acrdn-item-selected-exp-hdr-focus-bg: $content-bg-color-alt2 !default;
$acrdn-item-selected-exp-hdr-hover-bg: $content-bg-color-hover !default;
$acrdn-item-selected-exp-hdr-active-bg: $content-bg-color-pressed !default;
$acrdn-item-nes-pan-con-last-child-border-bottom: 1px none $content-bg-color-alt3 !default;
...
$acrdn-item-header-focus-border: 1px solid $content-text-color !default;
...
$acrdn-item-selected-exp-hdr-hover-focus-color: $content-text-color !default;
$acrdn-item-selected-exp-hdr-icon-color: $content-text-color !default;
...
$acrdn-item-selected-border-color: $content-bg-color-alt3 !default;
$acrdn-item-selected-border-size: 0 !default;
$acrdn-item-selected-select-last-border-bottom: 1px none $content-bg-color-alt3 !default;
$acrdn-item-selected-selected-border-color: $content-bg-color-alt3 !default;
$acrdn-item-selected-selected-border-size: 0 !default;
$acrdn-item-selected-header-background: $content-bg-color-hover !default;
...
$acrdn-item-selected-select-border-color: $content-bg-color-alt3 !default;
$acrdn-item-selected-select-border-size: 0 !default;
$acrdn-item-selected-hdr-icon-font: $icon-color !default;
$acrdn-item-selected-exp-hdr-con-hover-color: $content-text-color !default;
$acrdn-item-selected-exp-hdr-icon-hover-color: $content-text-color !default;
...
$acrdn-item-exp-not-selected-hdr-focus-bg: $content-bg-color-alt2 !default;
$acrdn-item-exp-not-selected-hdr-focus-border: 1px solid $content-text-color !default;
$acrdn-item-exp-not-selected-hdr-focus-border-color: $content-text-color !default;
...
@include export-module('accordion-fluent-icons') {
