...
$acrdn-bg-color: $grey-dark !default;
...
$acrdn-nrml-icn-minwidth: 24px !default;
$acrdn-bgr-icn-minwidth: 30px !default;
$acrdn-active-bg: $grey-dark !default;
$acrdn-active-bg-color: $acrdn-active-bg !default;
$acrdn-bg-color: $grey-dark !default;
$acrdn-selected-header-font-color: $grey-dark-font !default;
$acrdn-selected-header-color: none !default;
$acrdn-icon-color: rgba($grey-dark-font, .7) !default;
$acrdn-selected-icon-color: rgba($grey-dark-font, .7) !default;
$acrdn-content-color: $grey-dark-font !default;
$acrdn-header-font: $accent !default;
$acrdn-nested-header-font:  rgba($grey-dark-font, .7) !default;
...
$acrdn-selected-border-color: $grey-700 !default;
$acrdn-default-border: $grey-700 !default;
$acrdn-header-focus-bg:  rgba($grey-white, .05) !default;
$acrdn-header-hover-bg: rgba($grey-white, .1) !default;
$acrdn-header-active-bg: none !default;
...
$acrdn-item-focus-selected-exp-border-top: 0 !default;
...
$acrdn-item-focus-exp-hdr-hover-focus-bg-color: $acrdn-header-focus-bg !default;
...
$acrdn-item-select-exp-hdr-con-disable-font: $primary-font !default;
$acrdn-item-header-content-disable-color: $accent !default;
$acrdn-item-hdr-con-text-disabled-font: $primary-font !default;
$acrdn-item-icon-disable-color: $primary-font !default;
...
$acrdn-item-selected-exp-hdr-focus-bg: rgba($grey-white, .05) !default;
$acrdn-item-selected-exp-hdr-hover-bg: none !default;
$acrdn-item-selected-exp-hdr-active-bg: none !default;
$acrdn-item-nes-pan-con-last-child-border-bottom: 1px none $grey-700 !default;
...
$acrdn-item-header-focus-bg: $acrdn-header-focus-bg !default;
$acrdn-item-header-focus-active-color: $accent !default;
$acrdn-item-select-exp-hdr-hover-color: $accent !default;
$acrdn-item-selected-exp-hdr-border-color: initial !default;
$acrdn-item-selected-exp-hdr-border-size: 0 !default;
$acrdn-item-selected-exp-hdr-bg: none !default;
$acrdn-item-selected-exp-hdr-hover-color: $acrdn-selected-icon-color !default;
$acrdn-item-selected-exp-hdr-hover-focus-color: $primary-font !default;
$acrdn-item-selected-exp-hdr-icon-color: $primary-font !default;
...
$acrdn-item-selected-hdr-font: $primary-font !default;
$acrdn-item-select-hdr-focus-border-color: $acrdn-header-focus-bg !default;
$acrdn-item-selected-border-color: $grey-700 !default;
$acrdn-item-selected-border-size: 0 0 1px 0 !default;
$acrdn-item-selected-select-last-border-bottom: 0 !default;
$acrdn-item-selected-selected-border-color: transparent transparent $grey-700 !default;
...
$acrdn-item-selected-hdr-con-font: $accent !default;
$acrdn-item-selected-select-border-color: $grey-700 !default;
...
$acrdn-item-selected-exp-hdr-con-hover-color: $primary-font !default;
$acrdn-item-selected-exp-hdr-icon-hover-color: $primary-font !default;
$acrdn-item-selected-select-active-bg: $grey-dark !default;
$acrdn-item-nes-pan-exp-hdr-color: $primary-font !default;
...
$acrdn-item-nes-selected-exp-hover-hdr-con-font: $primary-font !default;
$acrdn-item-exp-not-selected-hdr-focus-bg: $acrdn-header-focus-bg !default;
...
@include export-module('accordion-material-dark-icons') {
