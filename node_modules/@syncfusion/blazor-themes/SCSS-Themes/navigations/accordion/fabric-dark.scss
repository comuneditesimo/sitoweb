...
$acrdn-item-selected-first-child-border-top: 1px solid $neutral-light !default;
$acrdn-item-selected-last-child-border-bottom: 1px solid $neutral-light !default;
...
$acrdn-selected-header-font-color: $neutral-light-fontalt !default;
$acrdn-selected-icon-color: $acrdn-selected-header-font-color !default;
$acrdn-icon-color: $neutral-light-font !default;
$acrdn-content-color: $neutral-light-font !default;
$acrdn-header-font: $neutral-light-font !default;
$acrdn-header-font-weight: normal !default;
$acrdn-header-font-size: 14px !default;
$acrdn-content-font-size: 13px !default;
$acrdn-header-focus-bg: $neutral-light !default;
$acrdn-header-hover-bg: $neutral-light !default;
$acrdn-header-active-bg: $neutral-quintenary !default;
$acrdn-selected-header-color: $neutral-quintenary !default;
$acrdn-border-type: $border-type !default;
$acrdn-border-size: $border-size !default;
$acrdn-border-radius: 0 !default;
$acrdn-default-border: $neutral-light !default;
...
$acrdn-selected-border-color: $neutral-light !default;
$acrdn-item-header-focus-border-color: $acrdn-header-focus-bg !default;

$acrdn-item-border-color: $acrdn-item-border-color !default;
$acrdn-item-border-nav-type: solid !default;
$acrdn-item-border-size: 1px 0 1px 0 !default;
$acrdn-item-select-last-child-border-bottom: 1px solid $acrdn-item-border-color !default;
$acrdn-item-select-last-child-border-radius: 0 !default;
$acrdn-item-first-child-hdr-focus-border-radius: 0 !default;
$acrdn-item-last-child-border-bottom: 1px solid $acrdn-item-border-color !default;
$acrdn-item-last-child-not-exp-hdr-focus-border-radius: 0 !default;
$acrdn-item-focus-border-color: $acrdn-header-focus-bg !default;
$acrdn-item-focus-border-size: 1px 0 1px 0 !default;
$acrdn-item-focus-selected-exp-border-top: 1px solid $acrdn-selected-header-color !default;
$acrdn-item-focus-selected-exp-hdr-focus-border-color: $neutral-secondary !default;
$acrdn-item-focus-selected-exp-hdr-focus-border-type: solid !default;
$acrdn-item-focus-selected-exp-hdr-focus-border-size: 1px !default;
$acrdn-item-focus-exp-hdr-hover-focus-bg-color: $acrdn-selected-header-color !default;
...
$acrdn-item-focus-selected-exp-border-color: $neutral-quintenary $neutral-quintenary $neutral-light !default;
...
$acrdn-item-select-exp-hdr-con-disable-font: $neutral-primary !default;
$acrdn-item-header-content-disable-color: $neutral-light-font !default;
$acrdn-item-hdr-con-text-disabled-font: $neutral-primary !default;
$acrdn-item-icon-disable-color: $neutral-primary !default;
$acrdn-item-selected-exp-hdr-focus-border-color: $neutral-secondary !default;
$acrdn-item-selected-exp-hdr-focus-border-type: solid !default;
$acrdn-item-selected-exp-hdr-focus-border-size: 1px !default;
$acrdn-item-selected-exp-hdr-focus-bg: $neutral-quintenary !default;
$acrdn-item-selected-exp-hdr-hover-bg: $neutral-quintenary !default;
$acrdn-item-selected-exp-hdr-active-bg: $neutral-quintenary !default;
$acrdn-item-nes-pan-con-last-child-border-bottom: 1px none $neutral-light !default;
$acrdn-item-select-bg: none !default;
$acrdn-item-select-border-color: $neutral-white !default;
...
$acrdn-item-header-active-border: 1px solid $neutral-quintenary !default;
$acrdn-item-header-active-border-color: $neutral-quintenary !default;
$acrdn-item-header-focus-border: 1px solid $neutral-light !default;
$acrdn-item-header-focus-box-shadow: none !default;
$acrdn-item-header-focus-bg: $neutral-light !default;
$acrdn-item-header-focus-active-color: $neutral-light-font !default;
$acrdn-item-select-exp-hdr-hover-color: $neutral-light-font !default;
$acrdn-item-selected-exp-hdr-border-color: $neutral-quintenary !default;
$acrdn-item-selected-exp-hdr-border-size: 1px !default;
$acrdn-item-selected-exp-hdr-bg: $neutral-quintenary !default;
$acrdn-item-selected-exp-hdr-hover-color: $neutral-primary !default;
$acrdn-item-selected-exp-hdr-hover-focus-color: $neutral-primary !default;
$acrdn-item-selected-exp-hdr-icon-color: $neutral-primary !default;
$acrdn-item-selected-exp-hdr-hover-border-color: $neutral-quintenary !default;
$acrdn-item-selected-tgl-icon-color: $neutral-primary !default;
$acrdn-item-selected-hdr-font: $neutral-primary !default;
$acrdn-item-select-hdr-focus-border-color: $neutral-light !default;
$acrdn-item-selected-border-color: $neutral-light !default;
$acrdn-item-selected-border-size: 1px 0 1px 0 !default;
$acrdn-item-selected-select-last-border-bottom: 1px solid $neutral-light !default;
$acrdn-item-selected-selected-border-color: $neutral-light !default;
$acrdn-item-selected-selected-border-size: 0 0 1px 0 !default;
$acrdn-item-selected-header-background: none !default;
$acrdn-item-selected-hdr-border-color: $neutral-white !default;
$acrdn-item-selected-hdr-border-size: 1px !default;
$acrdn-item-selected-header-border-radius: 0 !default;
$acrdn-item-selected-hdr-con-font: $neutral-light-font !default;
$acrdn-item-selected-select-border-color: $neutral-light !default;
$acrdn-item-selected-select-border-size: 1px 0 1px 0 !default;
$acrdn-item-selected-hdr-icon-font: $neutral-light-font !default;
$acrdn-item-selected-exp-hdr-con-hover-color: $neutral-primary !default;
$acrdn-item-selected-exp-hdr-icon-hover-color: $neutral-primary !default;
$acrdn-item-selected-select-active-bg: $neutral-white !default;
$acrdn-item-nes-pan-exp-hdr-color: $neutral-primary !default;
$acrdn-item-selected-hdr-hover-border-color: $neutral-light !default;
$acrdn-item-selected-hdr-tgl-icon-hover-font: $neutral-light-font !default;
$acrdn-item-nes-selected-exp-hover-hdr-icons-font: $neutral-primary !default;
$acrdn-item-nes-selected-exp-hover-hdr-con-font: $neutral-primary !default;
$acrdn-item-exp-not-selected-hdr-focus-bg: $neutral-quintenary !default;
...
@include export-module('accordion-fabric-dark-icons') {
