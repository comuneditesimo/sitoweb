...
$diagram-ruler-color: rgba($content-text-color-alt2);
$diagram-ruler-font-size: $text-xxs;
$diagram-ruler-marker-background-color: $content-bg-color-alt1;
$diagram-ruler-label-fill: rgba($content-text-color-alt2);
$diagram-ruler-tick-stroke: rgba($series-3);
...
$diagram-editbox-background: rgba($primary-text-color);
