...
$diagram-border-stroke-disabled: $neutral-secondary-alt;
...
$diagram-symbolpalette-hover: $neutral-secondary-alt;
$diagram-symbolpalette-shape-radius: 4px;
$diagram-symbolpalette-selected: #4a4848;

$diagram-tooltip: none;

$diagram-ruler-color: $neutral-tertiary;
$diagram-ruler-font-size: 10px;
$diagram-ruler-marker-stroke: $theme-primary;
$diagram-ruler-marker-background-color: $neutral-lighter;
$diagram-ruler-label-fill:  $neutral-secondary;
$diagram-ruler-tick-stroke: $neutral-tertiary;

$diagram-background-color: $theme-primary-font;

$palette-background-color: $neutral-secondary;
