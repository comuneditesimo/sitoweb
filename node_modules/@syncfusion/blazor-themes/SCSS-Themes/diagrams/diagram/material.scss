...
$diagram-symbolpalette-hover: $grey-200;
$diagram-symbolpalette-shape-radius: 4px;
$diagram-symbolpalette-selected: $grey-400;
...
$diagram-ruler-marker-background-color: $grey-100;
$diagram-ruler-label-fill: $grey-700;
$diagram-ruler-tick-stroke: $grey-400;
