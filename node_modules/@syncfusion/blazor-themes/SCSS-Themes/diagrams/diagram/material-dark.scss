...
$skin-name: 'material';
$diagram-endpoint-handle-color: $primary-font;
$diagram-endpoint-handle-connected-border: $primary-font;
$diagram-endpoint-handle-connected-color: $accent;

$diagram-resize-handle-color: $accent;
$diagram-resize-handle-stroke: $accent;
$diagram-border-stroke: $accent;

$diagram-resize-handle-disable-color: $grey-400;
$diagram-resize-handle-disable-stroke: $primary-font;
$diagram-border-stroke-disabled: $grey-400;

$diagram-rotate-handle-color: $accent;

$diagram-bezier-handle-color: $primary-font;
$diagram-bezier-line-color: $accent;

$diagram-highlighter-stroke: $accent;
$diagram-selected-region-stroke: $accent;
$diagram-pivot-line-stroke: $accent;

$diagram-helper-stroke: $accent;

$diagram-text-edit-selection-color: $primary-font;
$diagram-text-edit-selection-background: $accent;

$diagram-symbolpalette-hover: $grey-400;
$diagram-symbolpalette-shape-radius: 4px;
$diagram-symbolpalette-selected: $grey-700;

$diagram-tooltip: none;

$diagram-ruler-color: $grey-100;
$diagram-ruler-font-size: 10px;
$diagram-ruler-marker-stroke: $accent;
$diagram-ruler-marker-background-color: $grey-800;
$diagram-ruler-label-fill: $grey-400;
$diagram-ruler-tick-stroke: $grey-500;

$palette-background-color: $grey-300;

$diagram-background-color: $primary-font;

$diagram-editbox-background: $primary-font;
$diagram-editbox-fontcolor: $grey-black;
...
@include export-module('diagram-material-icons') {
  .e-diagram-menu {
  ...
  .e-symbolpalette {
    .e-clear-searchtext::before{ content: '\ec0f'; }
  }
}
