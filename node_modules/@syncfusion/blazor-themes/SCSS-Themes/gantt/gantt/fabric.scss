...
@import '../../layouts/splitter/fabric.scss';
@import '../../navigations/pager/fabric.scss';
@import '../../grids/excel-filter/fabric.scss';
@import '../../grids/grid/fabric.scss';
@import '../../filemanager/file-manager/fabric.scss';
@import '../../treegrid/treegrid/fabric.scss';
...
$gantt-content-color: $neutral-black !default;
...
$event-marker-label-font-color: #005a9e !default;
...
$connector-point-hover-bg-color: $neutral-white !default;
$connector-point-hover-border-color: $theme-darker !default;
...
$gantt-edit-icon-color: $neutral-white !default;
...
$gantt-bigger-event-arrow-color: $alert-bg;
...
$gantt-dialog-active-tab-background: transparent;
...
$gantt-dialog-icon-hover-color: $neutral-light !default;
...
$gantt-tab-header-hover-font-color: lighten($theme-primary-font, 10%) !default;
...
$gantt-baseline-color: $alert-font !default;
...
$progress-handler-outline: $neutral-white !default;
...
$gantt-gridpopup-span: $neutral-black !default;
...
$gantt-clone-prop-box-shadow: 0 0 10px 0 rgba($neutral-black, .2) !default;
$gantt-drag-clone-bg-color: $theme-lighter !default;
$gantt-drag-clone-border-color: $neutral-light !default;
$gantt-drag-clone-color: $theme-light-font !default;
