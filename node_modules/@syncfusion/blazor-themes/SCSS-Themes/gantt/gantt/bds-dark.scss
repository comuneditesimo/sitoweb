...
$connector-point-hover-color: $gantt-connected-task-color !default;
...
$gantt-active-frozen-background: $content-bg-color-selected;
...
$gantt-connected-task: $gantt-connected-task-color !default;
$gantt-active-parent-task: $gantt-active-parent-task-color!default;
...
@include export-module('gantt-bds-icons') {
  #{&}.e-gantt {
    .e-add::before {
      content: '\e805';
    }
