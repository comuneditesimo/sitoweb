...
@import '../../layouts/splitter/bootstrap4.scss';
@import '../../navigations/pager/bootstrap4.scss';
@import '../../grids/excel-filter/bootstrap4.scss';
@import '../../grids/grid/bootstrap4.scss';
@import '../../filemanager/file-manager/bootstrap4.scss';
@import '../../treegrid/treegrid/bootstrap4.scss';
...
$holiday-background: $gray-200 !default;
$progress-handler-outline: $primary-font;
$progress-handler-background: #222;
$holiday-label-color: $gray-900 !default;
$holiday-label-font-size: 13px !default;
$weekend-background: $light !default;
$event-marker-line-color: $primary !default;
$event-marker-label-color: $warning !default;
$event-marker-label-font-color: $black !default;
$event-marker-label-font-size: 14px !default;
$event-marker-label-padding: 4px 12px !default;
$event-marker-label-height: 28px !default;
$event-marker-label-arrow-top: 56px !default;
$connector-line-color: darken($primary, 15%) !default;
$connector-line-hover-color: darken($primary, 15%) !default;
$connector-false-line-color: darken($primary, 15%) !default;
$connector-point-hover-color: #0056b3 !default;
$connector-point-hover-outerline-color: $primary !default;
$connector-point-border-color: $primary-font !default;
$critical-connector-line-color: #d13438 !default;
$critical-connector-line-hover-color: #f3d8da !default;
$connector-point-hover-bg-color: rgba($primary-font, 1) !default;
$connector-point-hover-border-color: darken($primary, 15%) !default;
...
/* stylelint-disable */
$gantt-unscheduled-taskbar-background: linear-gradient(to right, rgba($primary, 0.2), $primary 30%, $primary 70%, $primary 70%, rgba($primary, 0.2) 100%) !default;
...
$gantt-unscheduled-milestone-top-border: $gray-700 !default;
$gantt-unscheduled-milestone-bottom-border: $gray-700 !default;
...
$gantt-manualchild-progress-bar: #6628EE;
...
$gantt-unscheduled-manualtaskbar-background: linear-gradient(to right, rgba(63,81,181, 0.2), #8553F1 30%, #8553F1 70%, #8553F1 70%, rgba(63,81,181, 0.2) 100%) !default;
$gantt-parent-task-bar: $secondary !default;
$gantt-parent-progress-bar: $gray-700 !default;
$gantt-milestone-border-color: $gray-700 !default;
...
$gantt-edit-icon-color: $primary-font !default;
...
$gantt-bigger-event-arrow-color: $warning;
...
$gantt-dialog-padding-bottom: 20px;
$gantt-dialog-active-tab-background: $primary-font !default;
$gantt-dialog-tab-padding-left: 12px;
$gantt-dialog-tab-background: $primary !default;
$gantt-dialog-header-font-color: $primary-font !default;
$gantt-dialog-icon-color: rgba($primary-font, .75) !default;
$gantt-dialog-icon-hover-color: transparent !default;
$gantt-dialog-close-icon-hover-color: rgba($primary-font, 1) !default;
$gantt-dialog-tab-hover-border-color: $gray-300 !default;
$gantt-dialog-tab-header-border-no-color: transparent !default;
$gantt-tab-header-border-width: 1px;
$gantt-depedent-div-border-bottom: 0px;
$gantt-resource-div-border-bottom: 0px;
$gantt-richtext-border-bottom: 0px;
$gantt-richtext-content-border-bottom: 0px;
$gantt-tab-selection-indicator-color: transparent !default;
$gantt-tab-header-hover-color: transparent;
$gantt-tab-header-hover-font-color: $primary-font !default;
...
$gantt-cell-border-color: $gray-300 !default;
...
$gantt-drag-clone-color: $gray-900 !default;
$gantt-content-font-color: rgba($gray-900, 1) !default;
$gantt-table-background-color: $content-bg !default;
$gantt-clone-dragdrop-bg-color: $gantt-table-background-color !default;
$error-elem-color: #e3165b;
$gantt-border-size: 1px !default;
$gantt-active-container-border: #66afe9 !default;
...
@include export-module('gantt-bootstrap4-icons') {
  #{&}.e-gantt {
    .e-add::before {
      content: '\e759';
    }
