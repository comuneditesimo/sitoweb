...
@import '../../layouts/splitter/fluent-dark.scss';
@import '../../navigations/pager/fluent-dark.scss';
@import '../../grids/excel-filter/fluent-dark.scss';
@import '../../grids/grid/fluent-dark.scss';
@import '../../filemanager/file-manager/fluent-dark.scss';
@import '../../treegrid/treegrid/fluent-dark.scss';
...
$gantt-bigger-add-dialog-input-height: 84px !important;
$gantt-bigger-add-dialog-input-width: 254px !important;
$gantt-bigger-add-dialog-input-field-width: 180px !default;
$gantt-bigger-filter-dialog-footer-padding: 28px 28px 28px 28px !important;
$gantt-bigger-add-dialog-footer-padding: 24px 28px 28px 28px !important;
$gantt-bigger-filter-dialog-footer-height: 96px !important;
$gantt-bigger-filter-dialog-input-padding: 28px 0 0 !important;
$gantt-bigger-add-dialog-footer-height: 70px !important;
$gantt-bigger-dialog-width: 580px !important;
$gantt-bigger-filter-dialog-width: 392px !important;
$gantt-dialog-bigger-input-field: 40px !default;
$gantt-dialog-bigger-input-padding-field: 28px 28px 0px 28px !important;
$gantt-bigger-dialog-input-field-height: 38px !important;
$gantt-bigger-dialog-input-icon: 35px !important;
$gantt-dialog-bigger-border-radius: 2px !important;
