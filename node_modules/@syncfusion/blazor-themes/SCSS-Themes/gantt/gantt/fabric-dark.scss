...
@import '../../filemanager/file-manager/fabric-dark.scss';
@import '../../treegrid/treegrid/fabric-dark.scss';
...
$gantt-content-color: $grey-dark-font !default;
$holiday-background: $neutral-lighter !default;
$holiday-label-color: $neutral-light-font !default;
$holiday-label-font-size: 13px !default;
$weekend-background: $neutral-lighter-alt !default;
$event-marker-line-color: $theme-primary !default;
$event-marker-label-color: #cae8ff !default;
$event-marker-label-font-color: #004abc !default;
...
$connector-line-color: $theme-darker !default;
$connector-point-hover-outerline-color: #b7e0ff !default;
$connector-line-hover-color: $theme-dark !default;
$connector-false-line-color: $theme-primary !default;
$connector-point-hover-color: #0d6efd !default;
$critical-connector-line-color: #d13438 !default;
$critical-connector-line-hover-color: #f3d8da !default;
$connector-point-border-color: $neutral-white !default;
$connector-point-hover-bg-color: $neutral-tertiary !default;
$connector-point-hover-border-color: $theme-primary !default;
...
/* stylelint-disable */
$gantt-unscheduled-taskbar-background: linear-gradient(to right, rgba(darken($theme-primary, 10%), 0.2), darken($theme-primary, 10%) 30%, darken($theme-primary, 10%) 70%, darken($theme-primary, 10%) 70%, rgba(darken($theme-primary, 10%), 0.2) 100%) !default;
...
$gantt-unscheduled-milestone-top-border: $neutral-secondary !default;
$gantt-unscheduled-critical-taskbar-background-color: rgba(285,85,85, .2) !default;
$gantt-unscheduled-milestone-bottom-border: $neutral-secondary !default;
$gantt-child-task-bar: $theme-primary !default;
...
$gantt-child-progress-bar: $theme-dark !default;
...
$gantt-edit-icon-color: $neutral-primary !default;
$gantt-icons-color: $neutral-secondary;
...
$gantt-bigger-event-arrow-color: $info-font;
...
$gantt-dialog-tab-background: $theme-primary !default;
$gantt-dialog-header-font-color: $theme-primary-font !default;
$gantt-dialog-icon-color: $theme-primary-font !default;
$gantt-dialog-icon-hover-color: #eaeaea !default;
$gantt-dialog-close-icon-hover-color: $theme-primary !default;
...
$gantt-tab-selection-indicator-color: $theme-primary-font !default;
$gantt-tab-header-hover-color: transparent !default;
$gantt-tab-header-hover-font-color: #f0f0f0 !default;
...
$progress-handler-outline: $neutral-primary !default;
...
$gantt-connected-task: lighten($theme-primary, 20%) !default;
$gantt-active-parent-task: lighten(#000000, 10%) !default;
$gantt-uptail-border:  #e0e0e0 !default;
$gantt-gridpopup-span: $theme-light-font !default;
...
$gantt-cell-border-color: $neutral-light !default;
...
$gantt-clone-prop-box-shadow: 0 3px 8px rgba($shadow, .26) !default;
$gantt-drag-clone-bg-color: $neutral-quintenary !default;
$gantt-drag-clone-border-color: $neutral-light !default;
$gantt-drag-clone-color: $neutral-light-fontalt !default;
$gantt-content-font-color: $neutral-light-font !default;
$gantt-clone-dragdrop-bg-color: $neutral-light !default;
$error-elem-color: #e3165b;
$gantt-border-size: $border-size !default;
$gantt-active-container-border: $neutral-secondary !default;
