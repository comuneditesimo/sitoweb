...
@import '../../filemanager/file-manager/bootstrap.scss';
@import '../../treegrid/treegrid/bootstrap.scss';
...
$event-marker-label-color: $brand-warning-dark !default;
$event-marker-label-font-color: $brand-warning-light !default;
...
$connector-line-color: darken($brand-primary, 15%) !default;
...
$gantt-manualchild-progress-bar: #572A96;
...
$gantt-dialog-active-tab-background: $grey-white !default;
...
$gantt-dialog-close-icon-hover-color: rgba(0, 0, 0, 0.8) !default;
...
$gantt-tab-header-hover-color: lighten($brand-primary, 25%) !default;
$gantt-tab-header-hover-font-color: $brand-primary-font !default;
...
$gantt-clone-prop-box-shadow: 0 6px 12px rgba($grey-base, .175) !default;
$gantt-drag-clone-bg-color: $grey-white !default;
$gantt-drag-clone-border-color: $grey-dd !default;
...
$gantt-active-container-border: $input-border-focus !default;
