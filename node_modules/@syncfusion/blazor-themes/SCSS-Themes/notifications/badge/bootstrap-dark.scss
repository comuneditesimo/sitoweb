...
$badge-primary-bg-color: $brand-primary !default;
$badge-secondary-bg-color: $grey-dark-font !default;
$badge-success-bg-color: $brand-success-dark !default;
$badge-danger-bg-color: $brand-danger-dark !default;
$badge-warning-bg-color: $brand-warning-dark !default;
$badge-info-bg-color: $brand-info-dark !default;
$badge-light-bg-color: $grey-44 !default;
$badge-dark-bg-color: $grey-cc !default;

$badge-primary-font-color: $brand-primary-font !default;
$badge-secondary-font-color: $grey-dark !default;
$badge-light-font-color: $grey-light-font !default;
$badge-dark-font-color: $grey-darker !default;
...
$badge-primary-bg-color: $brand-primary !default;
$badge-secondary-bg-color: $grey-light !default;
$badge-success-bg-color: #218739 !default;
$badge-danger-bg-color: #dc3243 !default;
$badge-warning-bg-color: #aa6708 !default;
$badge-info-bg-color: #1b809e !default;
$badge-light-bg-color: $grey-white !default;
$badge-dark-bg-color: $grey-dark !default;

$badge-primary-font-color: $brand-primary-font !default;
$badge-secondary-font-color: $grey-dark-font !default;
$badge-light-font-color: $grey-light-font !default;
