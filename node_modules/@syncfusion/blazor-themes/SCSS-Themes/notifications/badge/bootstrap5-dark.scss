...
$badge-success-font-color: $success-dark !default;
$badge-danger-font-color: $danger-dark !default;
$badge-info-font-color: $info-dark !default;
$badge-light-font-color: $content-text-color-alt1 !default;
$badge-dark-font-color: $secondary-text-color !default;
$badge-warning-font-color: $warning-dark !default;
