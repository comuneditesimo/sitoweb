...
$toast-close-icon-nrml-height: 16px !default;
$toast-close-icon-nrml-width: 16px !default;
$toast-close-icon-nrml-size: $text-xxs !default;
...
$toast-action-btn-nrml-padding: 12px 0 0 0 !default;
$toast-action-btn-nrml-margin: 10px !default;
$toast-progressbar-nrml-height: 4px !default;
$toast-content-nrml-padding: 12px 16px 16px 0 !default;
$toast-nrml-border-radious: $model-radius !default;
...
$toast-icon-bgr-size: $text-lg !default;
$toast-icon-bgr-right-margin: 16px !default;
$toast-close-icon-bgr-height: 16px !default;
$toast-close-icon-bgr-width: 16px !default;
$toast-close-icon-bgr-size: $text-xxs !default;
$toast-position-bgr-distance: 10px !default;
$multitoast-bgr-gap-distance: 10px !default;
$toast-bgr-min-height: 48px !default;
$toast-action-btn-bgr-padding: 16px 0 0 0 !default;
$toast-action-btn-bgr-margin: 10px !default;
$toast-progressbar-bgr-height: 4px !default;
$toast-content-bgr-padding: 13px 20px 20px 0 !default;
$toast-bgr-border-radious: $model-radius !default;
$toast-font-bgr-size: $text-base !default;
