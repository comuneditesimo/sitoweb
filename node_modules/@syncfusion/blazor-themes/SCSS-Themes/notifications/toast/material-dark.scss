...
$toast-box-shadow: 0 3px 5px -1px rgba($grey-black, .2), 0 6px 10px 0 rgba($grey-black, .14), 0 1px 18px 0 rgba($grey-black, .12) !default;
$toast-hover-box-shadow: 0 3px 5px -1px rgba($grey-black, .2), 0 6px 10px 0 rgba($grey-black, .14), 0 1px 18px 0 rgba($grey-black, .12) !default;
$toast-progress-color: $accent !default;
$toast-bg-color: $grey-800 !default;
$toast-hover-bg-color: #3d3d3d !default;
$toast-active-bg-color: $grey-800 !default;
...
$toast-success-hover-bg-color: #49a84d !default;
$toast-success-hover-color: $message-font !default;
$toast-success-hover-box-shadow: 0 3px 5px -1px rgba($grey-black, .2), 0 6px 10px 0 rgba($grey-black, .14), 0 1px 18px 0 rgba($grey-black, .12) !default;
...
$toast-info-hover-bg-color: #03a2ea !default;
$toast-info-hover-color: $message-font !default;
$toast-info-hover-box-shadow: 0 3px 5px -1px rgba($grey-black, .2), 0 6px 10px 0 rgba($grey-black, .14), 0 1px 18px 0 rgba($grey-black, .12) !default;

$toast-warning-bg-color: $warning-bg !default;
...
$toast-warning-hover-bg-color: #f59200 !default;
$toast-warning-hover-color: $message-font !default;
$toast-warning-hover-box-shadow: 0 3px 5px -1px rgba($grey-black, .2), 0 6px 10px 0 rgba($grey-black, .14), 0 1px 18px 0 rgba($grey-black, .12) !default;
