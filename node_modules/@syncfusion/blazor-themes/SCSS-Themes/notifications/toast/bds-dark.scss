...
$toast-content-nrml-padding: 8px 0 !default;
$toast-nrml-border-radious: 6px !default;
...
$toast-bg-color: $msg-bg-color !default;
$toast-hover-bg-color: $msg-bg-color !default;
$toast-active-bg-color: $msg-bg-color !default;
$toast-font-color: $msg-color !default;
$toast-icon-color: $msg-icon-color !default;
$toast-close-icon-color: $msg-close-icon-color !default;
$toast-title-color: $content-text-color !default;
$toast-content-color: $content-text-color-alt2 !default;

// Toast Type Definitions Start
$toast-success-bg-color: $msg-success-bg-color !default;
$toast-success-color: $msg-success-color !default;
...
$toast-info-bg-color: $msg-info-bg-color !default;
$toast-info-color: $msg-info-color !default;
...
$toast-warning-bg-color: $msg-warning-bg-color !default;
$toast-warning-color: $msg-warning-color !default;
...
$toast-danger-bg-color: $msg-danger-bg-color !default;
$toast-danger-color: $msg-danger-color !default;
