...
$msg-padding: 7px 7px !default;
$msg-border-radius: 0 !default;
$msg-icon-size: 16px !default;
$msg-icon-margin: 0 4px !default;
$msg-close-icon-margin: 0 2px 0 auto !default;
$msg-close-icon-size: $text-xs !default;
$msg-close-icon-padding: 0 2px !default;
$msg-close-icon-height: 16px !default;
$msg-content-font-size: $text-xs !default;
$msg-content-line-height: 16px !default;
$msg-content-padding: 0 4px !default;

$msg-rtl-close-icon-margin: 0 auto 0 2px !default;

$msg-bigger-padding: 8px 9px !default;
$msg-bigger-icon-size: 18px !default;
$msg-bigger-icon-margin: 2px 6px !default;
$msg-bigger-close-icon-margin: 2px 4px 2px auto !default;
$msg-bigger-close-icon-size: $text-sm !default;
$msg-bigger-close-icon-padding: 0 2px !default;
$msg-bigger-close-icon-height: 18px !default;
$msg-bigger-content-font-size: $text-sm !default;
$msg-bigger-content-line-height: 22px !default;
$msg-bigger-content-padding: 0 6px !default;

$msg-bigger-rtl-close-icon-margin: 2px auto 2px 4px !default;
...
@include export-module('message-fluent-icons') {
  .e-message {
    .e-msg-icon::before,
