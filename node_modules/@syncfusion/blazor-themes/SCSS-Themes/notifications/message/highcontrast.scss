...
//Message highcontrast theme variables

// Dimension variables
$msg-font-family: $font-family !default;
$msg-font-weight: 400 !default;
$msg-font-style: normal !default;
$msg-padding: 6px 7px !default;
$msg-border-radius: 0 !default;
$msg-icon-size: 14px !default;
$msg-icon-margin: 2px 4px !default;
$msg-close-icon-margin: 0 1px 0 auto !default;
$msg-close-icon-size: 12px !default;
$msg-close-icon-padding: 3px !default;
$msg-close-icon-height: 18px !default;
$msg-content-font-size: 12px !default;
$msg-content-line-height: 18px !default;
$msg-content-padding: 0 4px !default;

$msg-rtl-close-icon-margin: 0 auto 0 1px !default;

$msg-bigger-padding: 7px 9px !default;
$msg-bigger-icon-size: 16px !default;
$msg-bigger-icon-margin: 4px 6px !default;
$msg-bigger-close-icon-margin: 1px 2px 1px auto !default;
$msg-bigger-close-icon-size: 14px !default;
$msg-bigger-close-icon-padding: 4px !default;
$msg-bigger-close-icon-height: 22px !default;
...
$msg-bigger-rtl-close-icon-margin: 1px 2px 1px auto !default;
  ...
  .e-message {
    ...
    &.e-filled {
      ...
      &.e-error {
        ...
        .e-msg-icon {
          color: $msg-filled-error-icon-color;
        }
...
@include export-module('message-highcontrast-icons') {
  .e-message {
    .e-msg-icon::before,
