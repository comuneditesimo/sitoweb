...
$listview-text-disabled: $neutral-tertiary-alt !default;
$listview-icon-color: $neutral-light-font !default;
$listview-icon-disabled: $neutral-tertiary-alt !default;
...
$listview-icon-collapsible: '\e85c' !default;
$listview-icon-collapsible-rtl: '\e98f' !default;
$listview-icon-back-rtl: '\e830' !default;
...
$listview-text-hover-color: $neutral-light-font !default;
$listview-item-active-bg: $neutral-quintenary !default;
$listview-text-active-color: $neutral-light-fontalt !default;
$listview-header-text-color: $neutral-light-font !default;
$listview-header-text-padding: 16px !default;
$listview-header-text-disabled: $neutral-tertiary-alt !default;
$listview-header-bg: $neutral-white !default;
$listview-header-icon-color: $neutral-light-font !default;
$listview-header-icon-disabled: $neutral-tertiary-alt !default;
...
$listview-header-line-height: 0 !default;
...
$listview-groupheader-text-color: $theme-tertiary !default;
$listview-groupheader-bg: $neutral-white !default;
$listview-groupheader-border: $neutral-light !default;
$listview-groupheader-icon: $neutral-light-font !default;
