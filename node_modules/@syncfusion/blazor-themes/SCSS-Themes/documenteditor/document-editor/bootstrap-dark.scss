...
$de-rp-close-icon-top-bigger: -10px;
...
$de-border-dlg-preview-padding-left: 76px;
$de-tbl-dlg-align-padding-bottom: 4px;

$de-background: #232323 !default;
$search-result-highlight-bg-color: transparent !default;
$search-result-hightlight-bdr-clr-hvr: $brand-primary !default;
$search-result-item-padding-top: 15px !default;
$search-result-item-padding-bottom: 15px !default;
$search-result-hightlight-bdr-clr: $brand-primary !default;
...
$de-style-font-size: 13px !default;
$de-dlg-heading-main-header: $grey-dark-font !default;
...
$de-toc-sub-container-bottom: 15px !default;
$de-toc-list-view-border-color: #c3c3c3 !default;
...
$de-op-border-clr: $grey-99 !default;
$de-op-padding-left: 15px !default;
$de-op-padding-top: 22px !default;
$de-op-title-clr: $grey-dark-font !default;
$de-op-header-font-family: 'Helvetica' !default;
...
$de-op-icon-color: $grey-dark-font !default;
$de-op-close-icon-clr: $grey-dark-font !default;
$de-op-close-icon-width: 20px !default;
$de-op-close-button-top: 18px !default;
$search-result-hightlight-bdr-item: #ddd !default;
$de-op-search-txt: $grey-dark-font !default;
...
$de-border-dlg-border-label-fontsize: 16px !default;
...
$de-table-alignment-label-margin-top: 10px !default;
$de-table-alignment-label-margin-left: 10px !default;
$de-table-separator-line-color: $grey-99 !default;
...
$de-page-setup-dlg-height: 281px !default;
$de-page-setup-ppty-tab-border: 0 !default;
$de-page-setup-sub-container-bottom: 35px !default;
$de-page-setup-sub-container-port-bottom: 20px !default;
$de-page-setup-dlg-left-container-top: 19px !default;
$de-page-setup-dlg-right-container-top: 19px !default;
$de-page-setup-margin-dia-common-font: 12px !default;
$de-page-setup-margin-dia-common-margin-bottom: 8px !default;
$de-page-setup-margin-dia-common-margin-top: 1px !default;
$de-page-setup-common-margin-top: 15px !default;
...
$e-de-list-div-margin-top: 30px !default;
$de-ok-insert-button-margin-right: 8px !default;
$de-options-buttons-left: 339px !default;
$de-op-btn-icon-hover-clr: rgba($grey-base, .5) !default;
$de-tooltip-bg-clr: #1a1a1a !default;
...
$de-op-btn-icon-active-clr: rgba($grey-base, .5) !default;
...
$de-dlg-close-font-size: 12px !default;
$e-de-dlg-border-radius: 1px !default;
$de-dlg-close-icon-left: -1px !default;
$de-dlg-clr-pkr-top: 160px !default;
$de-op-result-container-margin-top: 7px !default;
$de-op-bg-color: $grey-base !default;
$de-op-tab-header-padding: 25px !default;
$de-op-tab-header-margin-bottom: 0 !default;
$de-op-tab-header-margin-top: 20px !default;
$de-font-color-border: 1px $grey-cc !default;
...
$de-font-color-margin-bottom: 5px !default;
$de-font-color-margin-top: 15px !default;
...
$de-font-content-checkbox-left: 42px !default;
$de-font-content-checkbox-left-bg: 64px !default;
$de-font-content-checkbox-right: 61px !default;
...
$de-op-container-messagediv-color: $grey-dark-font !default;
...
$de-insert-table-height: 139px !default;
$de-insert-table-width: 247px !default;
...
$de-list-dlg-height: 450px !default;
...
$de-table-ppty-dlg-width: 410px !default;
...
$de-table-options-dlg-height: 248px !default;
...
$de-op-search-input-width: 178px !default;
...
$de-style-dialog-option-div-bottom-margin: 15px !default;
...
$de-style-toggle-btn-color: '' !default;
...
$de-border-dlg-border-setting-inside-border: $de-table-align-border-color !default;
$de-border-dlg-border-setting-divs-color: $de-table-align-border-color !default;
$de-border-dlg-border-preview-divs-color: $de-table-align-border-color !default;
...
$de-tbl-dlg-border-btn-margin-top: 20px !default;
...
$de-table-ppty-options-break-margin-bottom: 7px !default;
...
$de-toc-dlg-styles-margin-top: 15px !default;
...
$de-op-input-group-height: 34px !default;
...
$de-bookmark-listview-margin-right: 24px !default;
...
$de-numbering-list-background-color: $grey-base !default;
$de-table-ppty-dlg-tabs-height: 320px !default;
...
$e-de-table-ppty-dlg-left-indent-container-bottom: 4px !default;
$de-cell-options-rtl: 123px !default;
$de-font-checkbox-ltr: 58px !default;
$de-font-content-label-width: 68px !default;
...
$e-de-list-div-margin-top-rtl: -138px !default;
...
$de-table-border-margin-top: 10px !default;
$de-table-dlg-separator-line-top: 5px !default;
$de-bookmark-list-margin-right: 14px;
$de-bkmrk-list-margin-left: 20px !default;
$de-paradialog-dir-div: .4 !default;
$de-list-view: #e4e4e4 !default;
$de-rp-btn-bg-color: '' !default;
$de-rp-btn-nav-box-shadow: rgba(0, 0, 0, .14) !default;
$de-rp-btn-nav-box-shadow-next: rgba(0, 0, 0, .5) !default;
$de-cmt-selection: $brand-primary !default;
$de-cmt-selection-rslv: rgba($de-cmt-selection, .5) !default;
$de-cmt-opt-size: 20px !default;
$de-cmt-pant-content-font: $grey-dark-font !default;
$de-cmt-post-btn-ht: 32px !default;
$de-cmt-post-btn-wt: $de-cmt-post-btn-ht !default;
$de-cmt-post-btn-wt-big: 36px !default;
$de-cmt-post-btn-ht-big: 40px !default;
$de-cmt-separator: $grey-99 !default;
$de-reply-footer-margin-top: 8px !default;
$de-rp-btn-enforce-margin: 24px;
$de-rp-btn-enforce-padding-big: 10px;
$e-de-cmt-textarea-padding-top: 7px;
$e-de-cmt-textarea-padding-top-big: 5px;
$de-dlg-table-options-content-div: 504px !default;
$dialog-btn-bg-color: transparent;
$dialog-btn-border-color: transparent;
$dialog-headericon-border-radius: 50%;
$dialog-closeicon-btn-active-color: transparent;
$dialog-closeicon-btn-hover-color: transparent;
$dialog-active-icon-color: #f0f0f0;
$e-de-close-icon-cursor: default;
$dialog-btn-clr: #acacac;
$de-tooltip-color: $grey-dark-font;
$de-blink-cursor-clr: rgba(0, 0, 0, .87);
$de-check-exactnumbr-width: 120px;
$de-tc-btn-padding: 4px;
$de-avatar-clr:  #fff !default;
$de-tc-tlbr-padding-btm: 1px;
$de-pane-color-border:  $brand-primary !default;
$de-font-dlg-font-size: 12px;
$de-tbl-measure-lbl-font-size: 11px;
$de-toc-lbl-mrgn-left: 4px;
$de-toc-lbl-mrgn-rgt: 4px;
...
$de-par-dlg-hdr-weight: 400 !default;
$de-para-dlg-hdr-margin-bottom: 15px;
$de-dlg-heading-opacity: 87%;
$de-para-dlg-hdr-margin-top: 15px;
$de-dlg-heading-main-header: $grey-dark-font !default;
$de-para-dlg-sub-title-bottom-margin: 15px !default;
...
$de-para-dlg-rtl-btn-margin-right: 24px;
$de-para-dlg-rtl-btn-font-size: 12px;
...
@include export-module('documenteditor-bootstrap-icons') {
  .e-documenteditor {
    .e-close::before {
      content: '\e825';
      font-family: 'e-icons';
...
@include export-module('documenteditor-paragraph-dialog') {
  ...
  .e-bigger {
    ...
    .e-de-para-dlg-heading {
      ...
      font-weight: $de-par-dlg-hdr-weight;
      margin-bottom: $de-padding-half-bigger;
      //margin-top: $de-para-dlg-hdr-margin-top;
      @if $skin-name == 'tailwind' {
        line-height: 22px;
      }
    }
  ...
  .e-de-para-dlg-right-sub-container {
    top: $de-para-dlg-right-contaner-top;
    //   bottom: $de-para-dlg-right-contaner-bottom;
  }
  ...
  .e-de-dlg-sub-header {
    ...
    font-weight: $de-header-font-weight;
    margin-bottom: $de-para-dlg-sub-title-bottom-margin;
    //margin-top: $de-para-dlg-sub-title-top-margin;
  }
