...
$de-op-border-clr: $grey-e6 !default;
$de-op-padding-left: 15px !default;
$de-op-padding-top: 22px !default;
$de-op-title-clr: $grey-light !default;
...
$de-table-separator-line-color: $grey-e6 !default;
...
$de-op-bg-color: $grey-white !default;
...
$de-border-dlg-border-setting-inside-border: $grey-dark !default;
...
$de-toc-table-list-view-height: 180px !default;
...
$de-cmt-pant-content-font: $grey-light-font !default;
...
$de-cmt-separator: $grey-cc !default;
...
$dialog-active-icon-color: rgba(0, 0, 0, .8);
