...
$de-toc-dlg-style-label-top: 43px !default;
...
$de-table-separtor-line-top: 63px !default;
...
$de-table-ppty-dlg-height: 384px !default;
...
$de-toc-dlg-styles-margin-left: 46px !default;
...
$de-toc-dlg-style-input-margin-left: 46px !default;
...
$dialog-headericon-border-radius: 0;
$dialog-closeicon-btn-active-color: #ffd939;
$dialog-closeicon-btn-hover-color: #ffd939;
$dialog-active-icon-color: #000;
...
$de-pane-color-border:  $header-font !default;
