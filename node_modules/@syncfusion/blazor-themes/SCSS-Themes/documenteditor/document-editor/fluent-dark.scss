...
$de-padding-half: 12px;
$de-padding-half-bigger: 14px;
$de-padding-full: 16px;
$de-padding-full-bigger: 24px;
...
$de-cmt-avatar-height: 32px;
$de-cmt-avatar-width: 32px;
...
$de-rp-close-icon-right: -11px;
$de-rp-close-icon-right-bigger: -15px;
$de-rp-close-icon-top-bigger: -9px;
$de-rp-close-icon-right-rtl: 11px;
$de-rp-close-icon-right-bigger-rtl: 15px;
...
$de-font-dlg-color-margin-right: 24px !default;
...
$de-font-dlg-margin-top: 24px !default;
$de-font-clr-div-mrgn-top: 24px !default;
$de-font-label-width: 131.5px !default;
$de-font-label-width-bg: 154px !default;

//Table properties dialog
$de-table-options-font-weight: $font-weight-normal !default;
$de-para-dlg-heading-font-weight: $de-table-options-font-weight !default;
$de-cell-margin-dia-common-margin-bottom: 8px !default;
$de-table-align-margin-right: 12px !default;
...
$de-toc-list-view-height: 193px !default;
...
$de-border-dlg-border-label-paddingbottom: 12px !default;
...
$de-page-setup-dlg-sub-label-font-weight: $font-weight-normal !default;
$de-page-setup-dlg-orientation-prop-margin-top: 8px !default;
$de-page-setup-sub-size-container-height: 73px !default;
$de-page-setup-sub-size-container-bottom: 24px !default;
$de-page-setup-layout-sub-container-height: auto !default;
$de-page-setup-layout-sub-container-bottom: 34px !default;
$de-page-setup-layout-sub-container-top: 24px !default;
...
$de-ok-insert-button-margin-right: 24px !default;
...
$de-op-search-tab-content-margin-top-bigger: 16px !default;
...
$de-table-ppty-options-break-margin-bottom: 12px !default;
...
$de-toc-styles-table-div-margin-top: 8px !default;
...
$de-bigger-style-button-height: 40px !default;
$de-bigger-style-button-width: 105px !default;
...
$de-ff-dlg-hdg-small-mrgn-btm: 8px;
$de-ff-seperate-div-mrgn-btm: 16px;
...
$de-ff-dlg-lft-hlf-mrgn-rgt: 24px;
...
$de-par-dlg-hdr-weight: $font-weight-normal !default;
$de-para-dlg-hdr-margin-bottom: 0 !default;
$de-para-dlg-hdr-margin-top: 24px !default;
$de-dlg-heading-opacity: 1 !default;
...
$de-spellcheck-btn-width: 95% !default;
$de-dlg-heading-main-header: $content-text-color !default;
...
$bookmark-listview-border-color: $border-light !default;
...
$de-style-btn-bg-color:  darken($secondary-bg-color, 7.5%) !default;
...
$de-op-border-clr: $border-light !default;
$de-op-search-txt: $primary !default;
$de-border-dlg-border-preview-div-opacity: $border-light !default;
$de-op-btn-icon-hover-clr: $icon-color-hover !default;
