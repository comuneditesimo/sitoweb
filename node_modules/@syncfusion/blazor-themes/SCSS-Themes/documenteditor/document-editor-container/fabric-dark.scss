...
@import '../../documenteditor/document-editor/fabric-dark.scss';
@import '../../navigations/appbar/fabric-dark.scss';
$de-title-bar-bg-clr: $theme-primary !default;
$de-title-bar-font-clr: $neutral-white !default;
$de-ctnr-bg-clr: $neutral-lighter-alt !default;
$de-ctnr-prop-bg-clr: $de-ctnr-bg-clr !default;
$de-ctnr-height: calc(100%) !default;
$de-ctnr-tlbr-height: 82px !default;
...
$de-spellcheck-tlbr-width: 111px !default;
$de-spellcheck-tlbr-width-big: 125px !default;
...
$de-prpty-btn-bg-clr: $neutral-lighter !default;
$de-panel-header-size: 13px;
$de-panel-header-color: $neutral-secondary-alt !default;
$de-panel-sub-label-color: $neutral-secondary-alt !default;
$de-header-line-color: 1px solid $neutral-quintenaryalt !default;
$de-group-btn-hgt: 32px !default;
$de-toc-template-content1: 82px !default;
$de-toc-template-content2: 63px !default;
$de-toc-template-content3: 56px !default;
$de-img-span-top: 7px !default;
$de-img-span-left: 8px !default;
$de-toggle-bg-color: $neutral-quintenary !default;
$de-toggle-btn-outline: $neutral-light 0 solid !default;
...
$de-pane-separator: $neutral-quintenaryalt !default;
...
$de-pageweb-toggle-color: $neutral-quintenary !default;
$de-pageweb-toggle-outline: #fafafa 0 solid !default;
$de-layout-btn-font-size: 14px;
$de-layout-btn-bgr-font-size: 14px;

$de-pagenumber-text-border-radius: 0;
$de-pagenumber-text-margin-top: -1px;
...
$e-de-pagenumber-bg: $neutral-white;
$e-de-status-bar-padding-top: 2.5px;
$e-de-status-bar-big-padding-top: 3px;
$e-de-review-pane-width: 400px;
$e-de-ctnr-linespacing-tick-icon: 12px;
$e-de-bzr-button-bg-color: #333232 !default;
$e-de-bzr-button-font-color: default;
$e-de-bzr-button-border-color: default;
$e-de-bzr-button-hover-bg-color: default;
$e-de-bzr-button-hover-border: default;
$e-de-bzr-button-hover-border-radius: default;
$e-de-bzr-button-hover-font-color: default;
$e-de-bzr-button-active-font-color: default;
$e-de-bzr-button-active-bg-color: default;
$e-de-bzr-button-active-border-color: default;
