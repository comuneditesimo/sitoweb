...
@import '../../documenteditor/document-editor/highcontrast.scss';
@import '../../navigations/appbar/highcontrast.scss';
$de-title-bar-bg-clr: $selection-bg !default;
$de-title-bar-font-clr: $bg-base-0 !default;
$de-ctnr-bg-clr: $bg-base-0 !default;
...
$de-tool-ctnr-editor-height-big: calc(100% - 118px) !default;
...
$de-prpty-btn-bg-clr: $bg-base-0 !default;
$de-panel-header-size: 13px;
$de-panel-header-color: $content-font !default;
$de-panel-sub-label-color: $content-font !default;
$de-header-line-color: 1px solid $bg-base-100 !default;
$de-group-btn-hgt: 32px !default;
...
$de-toggle-bg-color: $selection-bg !default;
$de-toggle-btn-outline: $content-font 0 solid !default;
...
$de-pane-separator: #e0e0e0 !default;
...
$de-list-hover-bg: $hover-bg !default;
...
$de-pageweb-toggle-color: $selection-bg !default;
...
$e-de-pagenumber-bg: $selection-font !default;
$e-de-status-bar-padding-top: 1.5px;
$e-de-status-bar-big-padding-top: 1.5px;
$e-de-review-pane-width: 400px;
$e-de-ctnr-linespacing-tick-icon: 11px;
$e-de-bzr-button-border-color: #000;
$e-de-bzr-button-bg-color: #000;
$e-de-bzr-button-hover-bg-color: #685708;
$e-de-bzr-button-hover-border: 2px solid #fff;
$e-de-bzr-button-hover-border-radius: 0;
$e-de-bzr-button-hover-font-color: #fff;
$e-de-bzr-button-active-font-color: #000;
$e-de-bzr-button-active-bg-color: #ffd939;
$e-de-bzr-button-active-border-color: #ffd939;
$e-de-bzr-button-font-color: #fff;
