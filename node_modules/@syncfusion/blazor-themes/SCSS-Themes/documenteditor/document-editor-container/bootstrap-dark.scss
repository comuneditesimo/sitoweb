...
@import '../../documenteditor/document-editor/bootstrap-dark.scss';
@import '../../navigations/appbar/bootstrap-dark.scss';
$de-title-bar-bg-clr: $brand-primary !default;
$de-title-bar-font-clr: $brand-primary-font !default;
$de-ctnr-bg-clr: $grey-base !default;
$de-ctnr-prop-bg-clr: $de-ctnr-bg-clr !default;
$de-ctnr-height: calc(100%) !default;
$de-ctnr-tlbr-height: 77px !default;
$de-ctnr-tlbt-height-big: 82px !default;
$de-tlbr-margin-first: 12px !default;
...
$de-custom-treeview-text-size-bg: 14px !default;

// Subtract toolbar & statusbar height
$de-tool-ctnr-editor-height: calc(100% - 115px) !default;
$de-tool-ctnr-editor-height-big: calc(100% - 121px) !default;
...
$de-prpty-btn-bg-clr: $grey-darker !default;
$de-panel-header-size: 12px !default;
$de-panel-header-color: $grey-cc !default;
$de-panel-sub-label-color: $grey-cc !default;
$de-header-line-color: 1px solid $grey-99 !default;
$de-group-btn-hgt: 34px !default;
$de-toc-template-content1: 81px !default;
$de-toc-template-content2: 64px !default;
$de-toc-template-content3: 60px !default;
$de-img-span-top: 12px !default;
$de-img-span-left: 12px !default;
$de-toggle-bg-color: $grey !default;
$de-toggle-btn-outline: #fafafa 0 solid !default;
$de-toggle-btn-border: inset 0 3px 5px rgba(0, 0, 0, .125) !default;
$de-panel-border: $grey-99 !default;
...
$de-hover-bg: #313131 !default;
$de-pane-separator: $grey-99 !default;
$de-ctnr-status-bar-hgt: 36px !default;
$de-border-size-button-height-bg: 38px !default;
$de-border-size-button-width-bg: 96px !default;
$de-border-size-button-height: 28px !default;
$de-border-size-button-width: 100px !default;
$de-list-hover-bg: $grey-e6 !default;
$e-de-statusbar-separator-color: #ccc;
$de-pane-margin-right: 12px;
$de-pane-margin-right-big: 16px;
$de-left-panel-width: 153px;
$de-left-panel-width-big: 149px;
$de-right-panel-width: 75px;
$de-text-pane-width: 264px;
$de-text-pane-width-big: 272px;
$de-left-btn-width: 153px * .25;
$de-left-btn-width-big: 149px * .25;
$de-right-btn-width: $de-right-panel-width * .5;
$de-border-btn-width-big: 42px;
$de-img-span-top-big: 14px;
$de-bullet-icon-font-size: 29px;
$de-bullet-icon-line-height: 26px;
$de-list-button-margin-right: 14px;
$de-list-button-margin-right-bigger: 16px;
$de-ctnr-padding: 12px;
$de-pageweb-toggle-color: $grey !default;
$de-pageweb-toggle-outline: #fafafa 0 solid !default;
$de-layout-btn-font-size: 14px;
$de-layout-btn-bgr-font-size: 16px;
$de-pagenumber-text-border-radius: 2px;
$de-pagenumber-text-margin-top: -3px;
$e-de-pagenumber-input-margin-left: -3px;
$e-de-ctnr-pg-no-spellout-padd-top: 9px;
$e-de-ctnr-pg-no-spellout-padd-top-big: $e-de-ctnr-pg-no-spellout-padd-top;
$e-de-pagenumber-bg: $gray-dark;
$e-de-status-bar-padding-top: 2.5px;
$e-de-status-bar-big-padding-top: 2.5px;
$e-de-review-pane-width: 420px;
$e-de-ctnr-linespacing-tick-icon: 6px;
$e-de-bzr-button-bg-color: inherit;
$e-de-bzr-button-font-color: #f0f0f0 !default;
$e-de-bzr-button-border-color: inherit;
$e-de-bzr-button-hover-bg-color: inherit;
$e-de-bzr-button-hover-border: inherit;
$e-de-bzr-button-hover-border-radius: inherit;
$e-de-bzr-button-hover-font-color: #f0f0f0 !default;
$e-de-bzr-btn-font-size: 16px;
$e-de-bzr-btn-font-size-big: 16px;
