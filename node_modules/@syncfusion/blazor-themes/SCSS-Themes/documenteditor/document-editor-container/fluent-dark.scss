...
@import '../../documenteditor/document-editor/fluent-dark.scss';
...
$de-tlbr-margin-first-big: 10px !default;
$de-tlbr-margin-right: 4px !default;
$de-tlbr-margin-right-big: 6px !default;
$de-ctrnr-tblr-separator-margin: 0 12px !default;
$de-ctrnr-tblr-separator-margin-big: 0 14px !default;
$de-ctnr-margin-bottom: 16px !default;
$de-ctnr-margin-bottom-big: 20px !default;
...
$de-ctrnr-tblr-item-margin: 0 8px !default;
$de-ctrnr-tblr-item-margin-big: 0 12px !default;
...
$de-page-no-width: 110px !default;
$de-page-no-width-spellout: calc(100% - 165px) !default;
$de-page-no-width-spellout-big: calc(100% - 225px) !default;
...
$de-pane-margin-right: 16px;
$de-pane-margin-right-big: 20px;
$de-left-panel-width: 151px;
$de-left-panel-width-big: 184px;
$de-right-panel-width: 73px;
$de-text-pane-width: 273px;
$de-text-pane-width-big: 345px;
$de-btn-icon-margin: 0 !default;
$de-left-btn-width: 38.75px;
$de-left-btn-width-big: 47px;
...
$de-prop-style-padding: 16px;
$de-prop-div-padding-top: 16px;
...
$e-de-bzr-button-active-font-color: $content-text-color !default;
...
$e-de-bzr-button-active-bg-color:  $content-bg-color-alt2 !default;
$e-de-bzr-button-active-border-color: $white !default;
