...
$qrybldr-brdr-color: $content-font-alt !default;
$qrybldr-bg-color: #000 !default;
$qrybldr-color: $content-font !default;
$qrybldr-rule-list-border-color: #ccc !default;
$qrybldr-btngroup-active-bgcolor: $selection-bg !default;
$qrybldr-btngroup-active-color: $selection-font !default;
$groupborder-color: $content-font-alt !default;
$groupfill-color: $bg-base-0 !default;
...
$qrybldr-val-error-bg-color: $error-bg !default;
$qrybldr-val-error-color: $message-font !default;
...
$qrybldr-rule-list-first-top: -12px !default;
...
$qrybldr-collapse-brdr-color: $border-default !default;
