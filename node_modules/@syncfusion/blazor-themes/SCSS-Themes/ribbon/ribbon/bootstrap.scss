...
$ribbon-items-label-size: 12px !default;
...
$ribbon-groupbutton-header-padding: 2px !default;
...
$ribbon-bigger-tab-text-padding: 14px 20px !default;
$ribbon-bigger-tab-text-height: 24px !default;
$ribbon-bigger-large-items-icon-padding: 12px 8px !default;
...
$ribbon-bigger-items-label-size: 14px !default;
...
$ribbon-bigger-button-icon-padding: 11px 10px 11px 16px !default;
$ribbon-bigger-rtl-button-icon-padding: 11px 16px 11px 10px !default;
...
$ribbon-group-seperator-color: $grey-cc !default;
$ribbon-group-border-color: $grey-cc !default;
$ribbon-input-group-border-color: $grey-cc !default;
$ribbon-input-group-background-color: $grey-white !default;
$ribbon-items-icon-color: $grey-light-font !default;
$ribbon-items-background-color: $grey-f8 !default;
$ribbon-items-hover-background-color: $grey-e6 !default;
$ribbon-items-focus-background-color: $grey-e6 !default;
$ribbon-items-hover-color: $gray-dark !default;
$ribbon-items-active-color: $gray-dark !default;
$ribbon-items-focus-color: $gray-dark !default;
$ribbon-items-active-background-color: $grey-e6 !default;
$ribbon-items-hover-border-color: unset !default;
$ribbon-items-focus-border-color: unset !default;
$ribbon-items-disabled-color: rgba($grey-dark, .65) !default;
$ribbon-collapse-btn-background: $grey-f8 !default;
$ribbon-text-color: $grey-light-font !default;
$ribbon-tab-text-focus-color: $brand-primary-darken-25 !default;
$ribbon-tab-text-hover-color: $brand-primary-darken-25 !default;
$ribbon-active-tab-color: $brand-primary !default;
$ribbon-active-tab-indicator-color: $brand-primary !default;
$ribbon-active-file-menu-color: $brand-primary-font !default;
$ribbon-active-file-menu-background: $brand-primary !default;
$ribbon-menu-border-color: $grey-cc !default;
$ribbon-menu-hover-background-color: $grey-f5 !default;
$ribbon-menu-items-color: $grey-light-font !default;
$ribbon-menu-items-icon-color: $gray-dark !default;
$ribbon-menu-background-color: $grey-white !default;
$ribbon-menu-items-background-color: $grey-white !default;
$ribbon-hscroll-border-color: $grey-cc !default;
$ribbon-hscroll-color: $gray-dark !default;
$ribbon-hscroll-background-color: $grey-f8 !default;
$ribbon-hscroll-hover-border-color: $grey-cc !default;
$ribbon-hscroll-hover-background-color: $grey-e6 !default;
$ribbon-hscroll-hover-color: $gray-dark !default;
$ribbon-hscroll-active-border-color: $grey-cc !default;
$ribbon-hscroll-active-background-color: $grey-e6 !default;
$ribbon-hscroll-active-color: $gray-dark !default;
$ribbon-hscroll-focus-border-color: $grey-cc !default;
$ribbon-hscroll-focus-background-color: $grey-e6 !default;
$ribbon-hscroll-focus-color: $gray-dark !default;
$ribbon-tooltip-background-color: $gray-base !default;
$ribbon-tooltip-text-color: $grey-white !default;
$ribbon-overflow-box-shadow: 0 6px 12px rgba($grey-base, .175) !default;
$ribbon-backstage-menu-bg-color: $brand-primary !default;
$ribbon-backstage-menu-items-bg-color: $brand-primary !default;
$ribbon-backstage-items-color: $grey-white !default;
$ribbon-backstage-menu-icon-color: $grey-white !default;
$ribbon-backstage-menu-hover-bg-color: $brand-primary !default;
$ribbon-backstage-menu-hover-border-color: $brand-primary-darken-35 !default;
$ribbon-backstage-menu-items-hover-color: $grey-white !default;
$ribbon-backstage-menu-icon-hover-color: $grey-white !default;
...
$ribbon-backstage-menu-items-active-color: $grey-white !default;
$ribbon-backstage-menu-icon-active-color: $grey-white !default;
$ribbon-backstage-separator-color: $grey-white !default;
$ribbon-backstage-btn-bg-color: $brand-primary !default;
$ribbon-backstage-btn-color: $grey-white !default;
$ribbon-backstage-btn-focus-bg-color: $brand-primary !default;
$ribbon-backstage-btn-focus-color: $grey-white !default;
...
$ribbon-backstage-btn-hover-color: $grey-white !default;
...
$ribbon-group-button-icon-hover-color: $grey-light-font !default;
$ribbon-group-button-hover-background: $grey-f5 !default;
$ribbon-group-button-text-hover-color: $grey-light-font !default;
$ribbon-group-button-active-background: $grey-e6 !default;
$ribbon-group-button-text-active-color: $grey-light-font !default;
$ribbon-group-button-selected-background: $grey-e6 !default;
$ribbon-group-button-border-color: $grey-light-font !default;
$ribbon-group-button-dropdown-popup-border-color: $grey-cc !default;
$ribbon-group-button-dropdown-popup-box-shadow: none !default;
$ribbon-popup-common-bg-color: $grey-white !default;
$ribbon-popup-common-border-radius: unset !default;
$ribbon-popup-common-border-color: $grey-cc !default;
...
$ribbon-keytip-background-color: $base-font !default;
...
$ribbon-gallery-hover-background-color: $grey-lighter !default;
$ribbon-gallery-item-selected-color: $brand-primary !default;
...
$ribbon-gallery-item-focus-border-color: $grey-lighter !default;
$ribbon-gallery-item-border-color: $grey-dd !default;
$ribbon-gallery-header-color: $ribbon-text-color !default;
$ribbon-gallery-item-text-color: $ribbon-text-color !default;
$ribbon-gallery-item-disabled-text-color: $grey-ad !default;
$ribbon-gallery-icons-color: $ribbon-items-icon-color !default;
$ribbon-gallery-item-disabled-icons-color: $grey-ad !default;
$ribbon-gallery-item-selected-text-color: $grey-white !default;
$ribbon-gallery-item-selected-icons-color: $grey-white !default;
$ribbon-gallery-popup-box-shadow: 0 6px 12px rgba($grey-base, .175) !default;
...
@include export-module('ribbon-bootstrap-icons') {
  .e-ribbon {
    & .e-drop-icon {
      &::before {
        content: '\e95d';
