...
$ribbon-overflow-header-height: 28px !default;
$ribbon-overflow-header-line-height: 18px !default;
$ribbon-overflow-header-font-size: 14px !default;
$ribbon-overflow-header-padding: 7px 0 7px 12px !default;
$ribbon-rtl-overflow-header-padding: 7px 12px 7px 0 !default;
...
$ribbon-items-btn-icon-size: $text-lg !default;
$ribbon-items-caret-icon-size: $text-lg !default;
...
$ribbon-bigger-items-btn-icon-size: $text-lg !default;
...
$ribbon-bigger-medium-item-height: 36px !default;
...
$ribbon-gallery-item-focus-border-color: $flyout-bg-color !default;
$ribbon-gallery-item-border-color: $cool-gray-300 !default;
...
@include export-module('ribbon-tailwind-icons') {
  .e-ribbon {
    & .e-drop-icon {
      &::before {
        content: '\e729';
