...
$ribbon-overflow-header-weight: $font-weight-medium !default;
...
$ribbon-tab-text-padding: 8px 12px !default;
...
$ribbon-bigger-tab-text-height: 125% !default;
$ribbon-bigger-large-items-icon-padding: 8px 3px !default;
$ribbon-bigger-large-items-icon-size: $text-4xl !default;
...
$ribbon-bigger-menu-blank-icon-padding: 38px !default;
...
$ribbon-bigger-gallery-header-padding: 7px 0 11px !default;
...
$ribbon-group-seperator-color: $border-dark !default;
$ribbon-group-border-color: $border-dark !default;
...
$ribbon-items-hover-background-color: $content-bg-color-alt4 !default;
$ribbon-items-focus-background-color: $content-bg-color-alt4 !default;
$ribbon-items-hover-color: $content-text-color !default;
$ribbon-items-active-background-color: $content-bg-color-alt4 !default;
$ribbon-items-hover-border-color: unset !default;
$ribbon-items-focus-border-color: unset !default;
$ribbon-items-active-color: $content-text-color !default;
$ribbon-items-focus-color: $content-text-color !default;
$ribbon-items-disabled-color: $gray120 !default;
...
$ribbon-menu-items-color: $flyout-text-color-hover !default;
$ribbon-menu-items-icon-color: $icon-color !default;
$ribbon-menu-background-color: $flyout-bg-color !default;
$ribbon-menu-items-background-color: $flyout-bg-color !default;
...
$ribbon-hscroll-hover-border-color: $border !default;
$ribbon-hscroll-hover-background-color: $content-bg-color-alt4 !default;
$ribbon-hscroll-hover-color: $icon-color !default;
$ribbon-hscroll-active-border-color: $border !default;
$ribbon-hscroll-active-background-color: $content-bg-color-alt4 !default;
$ribbon-hscroll-active-color: $icon-color !default;
$ribbon-hscroll-focus-border-color: $border !default;
$ribbon-hscroll-focus-background-color: $content-bg-color-alt4 !default;
...
$ribbon-backstage-menu-hover-bg-color: $primary-bg-color-focus !default;
$ribbon-backstage-menu-hover-border-color: unset !default;
$ribbon-backstage-menu-items-hover-color: $primary-text-color !default;
$ribbon-backstage-menu-icon-hover-color: $primary-text-color !default;
...
$ribbon-backstage-menu-items-active-color: $primary-text-hover !default;
$ribbon-backstage-menu-icon-active-color: $primary-text-hover !default;
...
$ribbon-backstage-btn-focus-bg-color: $primary-bg-color-focus !default;
$ribbon-backstage-btn-focus-color: $primary-text-color !default;
...
$ribbon-backstage-btn-hover-color: $primary-text-hover !default;
...
$ribbon-group-button-icon-hover-color: $flyout-text-color-hover !default;
$ribbon-group-button-hover-background: $flyout-bg-color-hover !default;
$ribbon-group-button-text-hover-color: $flyout-text-color-hover !default;
$ribbon-group-button-active-background: $flyout-bg-color-selected !default;
$ribbon-group-button-text-active-color: $flyout-text-color-selected !default;
$ribbon-group-button-selected-background: $flyout-bg-color-selected !default;
$ribbon-group-button-border-color: $secondary-border-color !default;
$ribbon-group-button-dropdown-popup-border-color: $flyout-border !default;
...
$ribbon-keytip-background-color: $content-text-color-dragged !default;
$ribbon-keytip-color: $content-bg-color !default;
$ribbon-gallery-popup-background-color: $flyout-bg-color !default;
$ribbon-gallery-item-background-color: $transparent !default;
$ribbon-gallery-hover-background-color: $content-bg-color-hover !default;
...
$ribbon-gallery-item-focus-border-color: $content-bg-color-focus !default;
$ribbon-gallery-item-border-color: $border-dark !default;
$ribbon-gallery-header-color: $ribbon-text-color !default;
$ribbon-gallery-item-text-color: $ribbon-text-color !default;
$ribbon-gallery-item-disabled-text-color: $content-text-color-disabled !default;
$ribbon-gallery-icons-color: $ribbon-items-icon-color !default;
$ribbon-gallery-item-disabled-icons-color: $icon-color-disabled !default;
...
$ribbon-gallery-popup-box-shadow: $shadow-lg !default;
...
@include export-module('ribbon-fluent-icons') {
  .e-ribbon {
    & .e-drop-icon {
      &::before {
        content: '\e729';
