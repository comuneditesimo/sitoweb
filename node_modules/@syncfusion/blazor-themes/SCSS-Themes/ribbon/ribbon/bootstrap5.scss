...
$ribbon-caret-icon-padding: 0 8px !default;
$ribbon-rtl-caret-icon-padding: 0 8px !default;
...
$ribbon-gallery-wrapper-height: 60px !default;
$ribbon-gallery-simplified-wrapper-height: 26px !default;
...
$ribbon-bigger-tab-text-padding: 12px 15px !default;
...
$ribbon-items-focus-color: $secondary-text-color-focus !default;
...
$ribbon-collapse-btn-background: $content-bg-color-alt1 !default;
$ribbon-text-color: $content-text-color !default;
$ribbon-tab-text-focus-color: $primary-bg-color-pressed !default;
$ribbon-tab-text-hover-color: $primary-bg-color-pressed !default;
...
$ribbon-hscroll-hover-border-color: $secondary-border-color-hover !default;
$ribbon-hscroll-hover-background-color: $secondary-bg-color-hover !default;
$ribbon-hscroll-hover-color: $secondary-text-color-hover !default;
...
$ribbon-hscroll-focus-border-color: $secondary-border-color-focus !default;
$ribbon-hscroll-focus-background-color: $secondary-bg-color-focus !default;
$ribbon-hscroll-focus-color: $secondary-text-color-focus !default;
...
$ribbon-backstage-menu-items-hover-color: $secondary-text-color-hover !default;
$ribbon-backstage-menu-icon-hover-color: $secondary-text-color-hover !default;
...
$ribbon-backstage-btn-focus-color: $secondary-text-color-hover !default;
...
$ribbon-group-button-active-background: shade-color($secondary-bg-color, 25%) !default;
$ribbon-group-button-text-active-color: $secondary-text-color !default;
$ribbon-group-button-selected-background: shade-color($secondary-bg-color, 25%) !default;
...
$ribbon-keytip-color: $toooltip-text-color !default;
...
$ribbon-gallery-item-selected-text-color: $primary-text-color !default;
$ribbon-gallery-item-selected-icons-color: $primary-text-color !default;
...
@include export-module('ribbon-bootstrap5-icons') {
  .e-ribbon {
    & .e-drop-icon {
      &::before {
        content: '\e729';
