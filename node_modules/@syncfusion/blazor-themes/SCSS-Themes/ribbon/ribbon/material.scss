...
$ribbon-file-menu-border: 1px solid !default;
$ribbon-file-menu-border-width: 0 0 1px 0 !default;
...
$ribbon-toolbar-items-height: 42px !default;
$ribbon-horizontal-nav-height: 42px !default;
$ribbon-group-header-padding: 9px 11px 2px !default;
...
$ribbon-group-content-margin: 20px !default;
$ribbon-group-padding: 6px !default;
$ribbon-group-height: 140px !default;
$ribbon-simplified-group-padding: 2px !default;
$ribbon-simplified-group-content-padding: 0 7px 0 8px !default;
$ribbon-simplified-group-content-height: 42px !default;
...
$ribbon-overflow-wrapper-item-margin: 3px 8px !default;
$ribbon-overflow-item-btn-height: 12px !default;
...
$ribbon-overall-overflow-btn-position: 5px !default;
...
$ribbon-menu-border: none !default;
...
$ribbon-backstage-menu-hover-border: 0 !default;
...
$ribbon-group-button-ddb-border: none !default;
$ribbon-groupbutton-header-padding: 3px !default;
$ribbon-items-label: 34px !default;
$ribbon-combobox-height: 32px !default;
$ribbon-medium-item-height: 32px !default;
$ribbon-button-icon-padding: 10px 8px 10px 12px !default;
$ribbon-rtl-button-icon-padding: 10px 12px 10px 8px !default;
...
$ribbon-gallery-header-line-height: 18px !default;
$ribbon-gallery-header-fontsize: 12px !default;
...
$ribbon-gallery-wrapper-height: 72px !default;
$ribbon-gallery-simplified-wrapper-height: 24px !default;
$ribbon-gallery-simplified-items-wrapper-height: 20px !default;

$ribbon-bigger-content-height: 120px !default;
$ribbon-bigger-group-overflow-content-height: 120px !default;
$ribbon-bigger-group-height: 159px !default;
...
$ribbon-bigger-horizontal-nav-height: 56px !default;
$ribbon-bigger-collapse-btn-padding: 2px !default;
$ribbon-bigger-collapse-btn-height: 20px !default;
$ribbon-bigger-collapse-btn-font-size: 20px !default;
...
$ribbon-bigger-overall-overflow-btn-position: 9px !default;
$ribbon-bigger-overflow-wrapper-item-margin: 3px 8px !default;
$ribbon-bigger-group-header-padding: 11px 11px 4px !default;
...
$ribbon-bigger-tab-text-padding: 16px 18px !default;
$ribbon-bigger-tab-text-height: 24px !default;
$ribbon-bigger-large-items-icon-padding: 12px 8px 0 !default;
...
$ribbon-bigger-items-checkbox-size: 16px !default;
...
$ribbon-bigger-input-padding: 7px 0 7px 13px !default;
$ribbon-bigger-input-icon-padding: 10px 2px !default;
$ribbon-bigger-input-group-margin: 4px !default;
$ribbon-bigger-dropdown-btn-padding: 0 18px !default;
$ribbon-bigger-menu-blank-icon-padding: 42px !default;
...
$ribbon-bigger-backstage-btn-icon-padding: 8px 12px 8px 16px !default;
...
$ribbon-bigger-group-button-padding: 0 8px 0 0 !default;
$ribbon-bigger-items-label: 44px !default;
...
$ribbon-bigger-overflow-header-height: 36px !default;
...
$ribbon-bigger-overflow-header-padding: 10px 0 10px 16px !default;
$ribbon-bigger-rtl-overflow-header-padding: 10px 16px 10px 0 !default;
$ribbon-bigger-button-icon-padding: 12px 12px 12px 16px !default;
$ribbon-bigger-rtl-button-icon-padding: 12px 16px 12px 12px !default;
...
$ribbon-group-seperator-color: $grey-400 !default;
$ribbon-group-border-color: $grey-400 !default;
$ribbon-input-group-border-color: $grey-400 !default;
$ribbon-input-group-background-color: $grey-white !default;
$ribbon-items-icon-color: rgba($grey-light-font, .54) !default;
$ribbon-items-background-color: $grey-50 !default;
$ribbon-items-hover-background-color: rgba($grey-black, .12) !default;
$ribbon-items-focus-background-color: $grey-300 !default;
$ribbon-items-hover-color: rgba($grey-light-font, .54) !default;
$ribbon-items-active-color: rgba($grey-light-font, .54) !default;
$ribbon-items-focus-color: rgba($grey-light-font, .54) !default;
$ribbon-items-active-background-color: $grey-200 !default;
$ribbon-items-hover-border-color: unset !default;
$ribbon-items-focus-border-color: unset !default;
$ribbon-items-disabled-color: $grey-600 !default;
$ribbon-collapse-btn-background: $grey-50 !default;
$ribbon-text-color: rgba($grey-light-font, .87) !default;
$ribbon-tab-text-focus-color: rgba($accent, 1) !default;
$ribbon-tab-text-hover-color: rgba($accent, 1) !default;
$ribbon-active-tab-color: $primary !default;
$ribbon-active-tab-indicator-color: $primary !default;
$ribbon-active-file-menu-color: $primary-font !default;
$ribbon-active-file-menu-background: $primary !default;
$ribbon-menu-border-color: $grey-300 !default;
$ribbon-menu-hover-background-color: $grey-200 !default;
$ribbon-menu-items-color: $grey-light-font !default;
$ribbon-menu-items-icon-color: $grey-light-font !default;
$ribbon-menu-background-color: $grey-50 !default;
$ribbon-menu-items-background-color: $grey-50 !default;
$ribbon-hscroll-border-color: $grey-400 !default;
$ribbon-hscroll-color: $grey-light-font !default;
$ribbon-hscroll-background-color: $grey-100 !default;
$ribbon-hscroll-hover-border-color: $grey-400 !default;
$ribbon-hscroll-hover-background-color: $grey-200 !default;
$ribbon-hscroll-hover-color: $grey-light-font !default;
$ribbon-hscroll-active-border-color: $grey-400 !default;
$ribbon-hscroll-active-background-color: $grey-200 !default;
$ribbon-hscroll-active-color: $grey-light-font !default;
$ribbon-hscroll-focus-border-color: $grey-400 !default;
$ribbon-hscroll-focus-background-color: $grey-300 !default;
$ribbon-hscroll-focus-color: $grey-light-font !default;
$ribbon-tooltip-background-color: $grey-700 !default;
$ribbon-tooltip-text-color: $grey-dark-font !default;
$ribbon-overflow-box-shadow: 0 5px 5px -3px rgba($grey-black, .2), 0 8px 10px 1px rgba($grey-black, .14), 0 3px 14px 2px rgba($grey-black, .12) !default;
...
$ribbon-backstage-menu-hover-bg-color: $primary-300 !default;
...
$ribbon-backstage-menu-active-bg-color: $primary-200 !default;
$ribbon-backstage-menu-active-border-color: unset !default;
$ribbon-backstage-menu-items-active-color: $primary-font !default;
$ribbon-backstage-menu-icon-active-color: $primary-font !default;
$ribbon-backstage-separator-color: $grey-300 !default;
$ribbon-backstage-btn-bg-color: $primary !default;
$ribbon-backstage-btn-color: $grey-dark-font !default;
$ribbon-backstage-btn-focus-bg-color: $primary-300 !default;
$ribbon-backstage-btn-focus-color: $grey-dark-font !default;
$ribbon-backstage-btn-focus-border-color: unset !default;
$ribbon-backstage-btn-hover-bg-color: $primary-200 !default;
$ribbon-backstage-btn-hover-color: $primary-font !default;
$ribbon-backstage-btn-hover-border-color: unset !default;
$ribbon-backstage-close-btn-font-weight: 400 !default;
$ribbon-group-button-dropdown-popup-background: $grey-white !default;
$ribbon-group-button-icon-hover-color: rgba($grey-black, .54) !default;
$ribbon-group-button-hover-background: rgba($grey-black, .12) !default;
$ribbon-group-button-text-hover-color: rgba($grey-black, .84) !default;
$ribbon-group-button-active-background: rgba($grey-black, .16) !default;
$ribbon-group-button-text-active-color: rgba($grey-black, .84) !default;
$ribbon-group-button-selected-background: rgba($grey-black, .16) !default;
$ribbon-group-button-border-color: $grey-700 !default;
$ribbon-group-button-dropdown-popup-border-color: unset !default;
$ribbon-group-button-dropdown-popup-box-shadow: 0 6px 6px 0 rgba(0, 0, 0, .23), 0 10px 20px 0 rgba(0, 0, 0, .19) !default;
$ribbon-popup-common-bg-color: $content-bg-color !default;
$ribbon-popup-common-border-radius: unset !default;
$ribbon-popup-common-border-color: unset !default;
$ribbon-popup-common-box-shadow: 0 5px 5px -3px rgba($grey-light-font, .2), 0 8px 10px 1px rgba($grey-light-font, .14), 0 3px 14px 2px rgba($grey-light-font, .12) !default;
...
$ribbon-keytip-background-color: $grey-black !default;
$ribbon-keytip-color: $grey-white !default;
$ribbon-gallery-popup-background-color: $grey-white !default;
$ribbon-gallery-item-background-color: $grey-white !default;
$ribbon-gallery-hover-background-color: $grey-200 !default;
$ribbon-gallery-item-selected-color: $grey-200 !default;
$ribbon-gallery-button-selected-color: $ribbon-gallery-item-selected-color !default;
$ribbon-gallery-item-disabled-color: $grey-white !default;
$ribbon-gallery-item-focus-border-color: $grey-400 !default;
$ribbon-gallery-item-border-color: $grey-200 !default;
$ribbon-gallery-header-color: $ribbon-text-color !default;
$ribbon-gallery-item-text-color: $ribbon-text-color !default;
$ribbon-gallery-item-disabled-text-color: rgba($grey-light-font, .38) !default;
$ribbon-gallery-icons-color: rgba($grey-light-font, .54) !default;
$ribbon-gallery-item-disabled-icons-color: rgba($grey-light-font, .38) !default;
$ribbon-gallery-item-selected-text-color: $ribbon-text-color !default;
$ribbon-gallery-item-selected-icons-color: rgba($grey-light-font, .54) !default;
$ribbon-gallery-popup-box-shadow: 0 5px 5px -3px rgba($grey-black, .2), 0 8px 10px 1px rgba($grey-black, .14), 0 3px 14px 2px rgba($grey-black, .12) !default;
...
@include export-module('ribbon-material-icons') {
  .e-ribbon {
    & .e-drop-icon {
      &::before {
        content: '\e94d';
