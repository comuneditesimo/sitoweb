$ribbon-border: 1px solid !default;
...
$ribbon-group-height: 133px !default;
$ribbon-simplified-group-padding: 4px !default;
...
$ribbon-large-items-icon-padding: 12px 5px 4px !default;
...
$ribbon-input-padding: 5px 0 5px 13px !default;
...
$ribbon-menu-border-radius: 2px !default;
...
$ribbon-bigger-group-height: 162px !default;
...
$ribbon-group-seperator-color: $neutral-tertiary !default;
$ribbon-group-border-color: $neutral-tertiary !default;
$ribbon-input-group-border-color: $neutral-tertiary-alt !default;
$ribbon-input-group-background-color: $neutral-white !default;
$ribbon-items-icon-color: $neutral-light-font !default;
$ribbon-items-background-color: $neutral-white !default;
$ribbon-items-hover-background-color: $neutral-lighter !default;
$ribbon-items-focus-background-color: $neutral-lighter !default;
...
$ribbon-items-active-background-color: $neutral-lighter !default;
$ribbon-items-hover-border-color: unset !default;
$ribbon-items-focus-border-color: unset !default;
$ribbon-items-disabled-color: $neutral-tertiary !default;
$ribbon-collapse-btn-background: $neutral-white !default;
$ribbon-text-color: $neutral-light-font !default;
$ribbon-tab-text-focus-color: $theme-primary !default;
$ribbon-tab-text-hover-color: $theme-primary !default;
$ribbon-active-tab-color: $theme-primary !default;
$ribbon-active-tab-indicator-color: $theme-primary !default;
$ribbon-active-file-menu-color: $neutral-white !default;
$ribbon-active-file-menu-background: $theme-primary !default;
$ribbon-menu-border-color: $neutral-light !default;
$ribbon-menu-hover-background-color: $neutral-lighter !default;
$ribbon-menu-items-color: $neutral-light-font !default;
$ribbon-menu-items-icon-color: $neutral-light-font !default;
$ribbon-menu-background-color: $neutral-white !default;
$ribbon-menu-items-background-color: $neutral-white !default;
$ribbon-hscroll-border-color: $neutral-tertiary-alt !default;
$ribbon-hscroll-color: $neutral-light-font !default;
$ribbon-hscroll-background-color: $neutral-white !default;
$ribbon-hscroll-hover-border-color: $neutral-tertiary-alt !default;
$ribbon-hscroll-hover-background-color: $neutral-lighter !default;
$ribbon-hscroll-hover-color: $neutral-light-font !default;
$ribbon-hscroll-active-border-color: $neutral-tertiary-alt !default;
$ribbon-hscroll-active-background-color: $neutral-lighter !default;
$ribbon-hscroll-active-color: $neutral-light-font !default;
$ribbon-hscroll-focus-border-color: $neutral-tertiary-alt !default;
$ribbon-hscroll-focus-background-color: $neutral-lighter !default;
$ribbon-hscroll-focus-color: $neutral-light-font !default;
$ribbon-tooltip-background-color: $neutral-white !default;
$ribbon-tooltip-text-color: $neutral-light-font !default;
$ribbon-overflow-box-shadow: 0 0 10px 0 rgba($neutral-black, .2) !default;
$ribbon-backstage-menu-bg-color: $theme-primary !default;
$ribbon-backstage-menu-items-bg-color: $theme-primary !default;
$ribbon-backstage-items-color: $grey-dark-font !default;
$ribbon-backstage-menu-icon-color: $grey-dark-font !default;
$ribbon-backstage-menu-hover-bg-color: $theme-primary !default;
...
$ribbon-backstage-menu-active-bg-color: $theme-dark !default;
...
$ribbon-backstage-separator-color: $neutral-white !default;
$ribbon-backstage-btn-bg-color: $theme-primary !default;
$ribbon-backstage-btn-color: $grey-dark-font !default;
$ribbon-backstage-btn-focus-bg-color: $theme-primary !default;
$ribbon-backstage-btn-focus-color: $grey-dark-font !default;
$ribbon-backstage-btn-focus-border-color: $theme-lighter-alt !default;
$ribbon-backstage-btn-hover-bg-color: $theme-dark !default;
...
$ribbon-group-button-hover-background: $neutral-lighter !default;
$ribbon-group-button-text-hover-color: $neutral-light-font !default;
$ribbon-group-button-active-background: $neutral-light !default;
$ribbon-group-button-text-active-color: $neutral-light-font !default;
$ribbon-group-button-selected-background: $neutral-light !default;
$ribbon-group-button-border-color: $neutral-quintenary !default;
$ribbon-group-button-dropdown-popup-border-color: $neutral-quintenaryalt !default;
...
$ribbon-gallery-popup-background-color: $ribbon-header-bg-color !default;
$ribbon-gallery-item-background-color: transparent !default;
$ribbon-gallery-hover-background-color: $neutral-lighter !default;
$ribbon-gallery-item-selected-color: $theme-lighter !default;
$ribbon-gallery-button-selected-color: $ribbon-gallery-item-selected-color !default;
$ribbon-gallery-item-disabled-color: transparent !default;
...
$ribbon-gallery-popup-box-shadow: 0 0 10px 0 rgba($neutral-black, .2) !default;
