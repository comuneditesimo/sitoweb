...
$ribbon-backstage-btn-icon-font-size: 20px !default;
$ribbon-backstage-btn-icon-line-height: 20px !default;
$ribbon-backstage-btn-icon-padding: 9px 16px 9px 14px !default;
$ribbon-backstage-btn-hover-border: 0 !default;
$ribbon-group-button-icon-margin: 5px !default;
$ribbon-group-button-ddb-padding: 4px 9px !default;
$ribbon-group-button-icon-padding: 0 1px 0 0 !default;
...
$ribbon-gallery-header-padding: 8px 0 !default;
...
$ribbon-gallery-text-line-height: 20px !default;
...
$ribbon-bigger-backstage-btn-icon-font-size: 24px !default;
$ribbon-bigger-backstage-btn-icon-line-height: 24px !default;
$ribbon-bigger-backstage-btn-icon-padding: 12px 12px 12px 16px !default;
...
$ribbon-bigger-group-button-ddb-padding: 12px !default;
$ribbon-bigger-group-button-padding: 0 8px 0 0 !default;
$ribbon-bigger-items-label: 48px !default;
...
$ribbon-backstage-menu-bg-color: rgba($primary) !default;
$ribbon-backstage-menu-items-bg-color: rgba($primary) !default;
$ribbon-backstage-items-color: rgba($surface) !default;
$ribbon-backstage-menu-icon-color: rgba($surface) !default;
...
$ribbon-backstage-menu-items-hover-color: rgba($surface) !default;
$ribbon-backstage-menu-icon-hover-color: rgba($surface) !default;
...
$ribbon-backstage-menu-items-active-color: rgba($surface) !default;
$ribbon-backstage-menu-icon-active-color: rgba($surface) !default;
$ribbon-backstage-separator-color: rgba($flyout-border) !default;
$ribbon-backstage-separator-color: $border-light !default;
$ribbon-backstage-btn-bg-color: rgba($primary) !default;
$ribbon-backstage-btn-color: rgba($surface) !default;
$ribbon-backstage-btn-focus-bg-color: $primary-bg-color-hover !default;
$ribbon-backstage-btn-focus-color: rgba($surface) !default;
...
$ribbon-backstage-btn-hover-color: rgba($surface) !default;
...
$ribbon-group-button-icon-hover-color: $icon-color-hover !default;
...
$ribbon-group-button-active-background: rgba($content-bg-color-selected) !default;
$ribbon-group-button-text-active-color: $content-text-color-selected !default;
$ribbon-group-button-selected-background: rgba($content-bg-color-selected) !default;
$ribbon-group-button-border-color: rgba($secondary-outline-border) !default;
...
$ribbon-popup-common-box-shadow: $shadow-md !default;
...
$ribbon-gallery-item-focus-border-color: rgba($border-focus) !default;
$ribbon-gallery-item-border-color: rgba($border-light) !default;
$ribbon-gallery-header-color: rgba($content-text-color-alt1) !default;
$ribbon-gallery-item-text-color: rgba($content-text-color) !default;
...
$ribbon-gallery-item-disabled-icons-color: $content-text-color-disabled !default;
$ribbon-gallery-item-selected-text-color: rgba($content-text-color) !default;
$ribbon-gallery-item-selected-icons-color: $ribbon-items-icon-color !default;
$ribbon-gallery-popup-box-shadow: $shadow-sm !default;
...
@include export-module('ribbon-material3-icons') {
  .e-ribbon {
    & .e-drop-icon {
      &::before {
        content: '\e729';
