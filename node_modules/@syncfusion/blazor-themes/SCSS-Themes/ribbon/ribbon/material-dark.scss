...
$ribbon-group-header-padding: 9px 11px 2px 11px !default;
...
$ribbon-menu-border: unset !default;
...
$ribbon-groupbutton-header-padding: 7px !default;
...
$ribbon-gallery-simplified-wrapper-height: 34px !default;
$ribbon-gallery-simplified-items-wrapper-height: 30px !default;
...
$ribbon-bigger-overflow-btn-icon-padding: 8px !default;
$ribbon-bigger-overflow-collapse-btn-right: 28px !default;
$ribbon-bigger-overall-overflow-btn-height: 36px !default;
$ribbon-bigger-overall-overflow-btn-position: 8px !default;
$ribbon-bigger-overflow-wrapper-item-margin: 7px 8px !default;
...
$ribbon-bigger-input-icon-padding: 10px 2px 10px 2px !default;
...
$ribbon-bigger-gallery-header-fontsize: 14px !default;
$ribbon-bigger-gallery-header-line-height: 22px !default;
...
$ribbon-bigger-overflow-header-padding: 10px 0 8px 16px !default;
$ribbon-bigger-rtl-overflow-header-padding: 10px 16px 8px 0 !default;
...
$ribbon-group-seperator-color: $grey-600 !default;
$ribbon-group-border-color: $grey-600 !default;
$ribbon-input-group-border-color: $grey-600 !default;
$ribbon-input-group-background-color: $grey-900 !default;
$ribbon-items-icon-color: $grey-dark-font !default;
$ribbon-items-background-color: $grey-900 !default;
$ribbon-items-hover-background-color: $grey-600 !default;
$ribbon-items-focus-background-color: $grey-600 !default;
...
$ribbon-items-active-background-color: $grey-600 !default;
...
$ribbon-collapse-btn-background: $grey-900 !default;
$ribbon-text-color: $grey-dark-font !default;
$ribbon-tab-text-focus-color: rgba($accent, 1) !default;
$ribbon-tab-text-hover-color: rgba($accent, 1) !default;
$ribbon-active-tab-color: $accent !default;
$ribbon-active-tab-indicator-color: $accent !default;
$ribbon-active-file-menu-color: $accent-font !default;
$ribbon-active-file-menu-background: $accent !default;
$ribbon-menu-border-color: unset !default;
$ribbon-menu-hover-background-color: $grey-600 !default;
$ribbon-menu-items-color: $grey-dark-font !default;
$ribbon-menu-items-icon-color: $grey-dark-font !default;
$ribbon-menu-background-color: $grey-800 !default;
$ribbon-menu-items-background-color: $grey-800 !default;
$ribbon-hscroll-border-color: $grey-600 !default;
$ribbon-hscroll-color: $grey-dark-font !default;
$ribbon-hscroll-background-color: $grey-800 !default;
$ribbon-hscroll-hover-border-color: $grey-600 !default;
$ribbon-hscroll-hover-background-color: $grey-800 !default;
$ribbon-hscroll-hover-color: $grey-dark-font !default;
$ribbon-hscroll-active-border-color: $grey-600 !default;
$ribbon-hscroll-active-background-color: $grey-800 !default;
$ribbon-hscroll-active-color: $grey-dark-font !default;
$ribbon-hscroll-focus-border-color: $grey-600 !default;
$ribbon-hscroll-focus-background-color: $grey-800 !default;
...
$ribbon-overflow-box-shadow: 0 3px 8px 0 rgba($grey-black, .26) !default;
$ribbon-backstage-menu-bg-color: $primary !default;
$ribbon-backstage-menu-items-bg-color: $primary !default;
$ribbon-backstage-items-color: $primary-font !default;
$ribbon-backstage-menu-icon-color: $primary-font !default;
$ribbon-backstage-menu-hover-bg-color: $primary-300 !default;
$ribbon-backstage-menu-hover-border-color: unset !default;
$ribbon-backstage-menu-items-hover-color: $primary-font !default;
$ribbon-backstage-menu-icon-hover-color: $primary-font !default;
...
$ribbon-backstage-separator-color: $grey-600 !default;
$ribbon-backstage-btn-bg-color: $primary !default;
$ribbon-backstage-btn-color: $primary-font !default;
$ribbon-backstage-btn-focus-bg-color: $primary-300 !default;
$ribbon-backstage-btn-focus-color: $primary-font !default;
...
$ribbon-group-button-dropdown-popup-background: $grey-800 !default;
$ribbon-group-button-icon-hover-color: rgba($grey-white, .64) !default;
$ribbon-group-button-hover-background: rgba($grey-white, .12) !default;
$ribbon-group-button-text-hover-color: rgba($grey-white, 1) !default;
$ribbon-group-button-active-background: rgba($grey-white, .16) !default;
$ribbon-group-button-text-active-color: rgba($grey-white, 1) !default;
$ribbon-group-button-selected-background: rgba($grey-white, .16) !default;
$ribbon-group-button-border-color: $grey-700 !default;
$ribbon-group-button-dropdown-popup-border-color: unset !default;
$ribbon-group-button-dropdown-popup-box-shadow: 0 3px 8px 0 rgba($grey-black, .26) !default;
$ribbon-popup-common-bg-color: $grey-900 !default;
$ribbon-popup-common-border-radius: unset !default;
$ribbon-popup-common-border-color: unset !default;
$ribbon-popup-common-box-shadow: 0 6px 6px 0 rgba($grey-black, .23), 0 10px 20px 0 rgba($grey-black, .19) !default;
...
$ribbon-keytip-background-color: $primary-font !default;
$ribbon-keytip-color: $primary-50-font !default;
$ribbon-gallery-popup-background-color: $grey-800 !default;
$ribbon-gallery-item-background-color: $grey-800 !default;
$ribbon-gallery-hover-background-color: $grey-700 !default;
$ribbon-gallery-item-selected-color: $grey-600 !default;
$ribbon-gallery-button-selected-color: $ribbon-gallery-item-selected-color !default;
$ribbon-gallery-item-disabled-color: $grey-800 !default;
$ribbon-gallery-item-focus-border-color: $grey-700 !default;
$ribbon-gallery-item-border-color: $grey-700 !default;
$ribbon-gallery-header-color: rgba($grey-dark-font, .6) !default;
$ribbon-gallery-item-text-color: $ribbon-text-color !default;
$ribbon-gallery-item-disabled-text-color: rgba($grey-dark-font, .38) !default;
$ribbon-gallery-icons-color: rgba($grey-dark-font, .6) !default;
$ribbon-gallery-item-disabled-icons-color: rgba($grey-dark-font, .38) !default;
...
$ribbon-gallery-popup-box-shadow: 0 3px 8px 0 rgba($grey-black, .26) !default;
