...
$ribbon-group-header-padding: 0 11px 5px 11px !default;
$ribbon-group-header-height: 15px !default;
$ribbon-group-header-font-size: 10px !default;
$ribbon-group-overflow-padding: 2px 7px !default;
$ribbon-group-content-padding: 0 7px !default;
$ribbon-group-content-height: 108px !default;
$ribbon-group-overflow-height: 108px !default;
$ribbon-group-header-margin: 15px !default;
$ribbon-group-content-margin: 15px !default;
$ribbon-group-padding: 6px !default;
$ribbon-group-height: 134px !default;
$ribbon-simplified-group-padding: 2px !default;
$ribbon-simplified-group-content-padding: 0 4px !default;
...
$ribbon-overflow-item-btn-height: 16px !default;
...
$ribbon-overflow-header-height: 24px !default;
$ribbon-overflow-header-line-height: 18px !default;
$ribbon-overflow-header-font-size: 14px !default;
$ribbon-overflow-header-padding: 5px 0 5px 12px !default;
$ribbon-rtl-overflow-header-padding: 5px 12px 5px 0 !default;
...
$ribbon-input-icon-padding: 8px 2px 8px 2px !default;
...
$ribbon-tab-text-padding: 13px 12px !default;
$ribbon-tab-text-height: 22px !default;
$ribbon-tab-text-weight: 400 !default;
$ribbon-nav-arrow-size: 20px !default;
$ribbon-nav-arrow-height: 20px !default;
$ribbon-hscroll-padding: 0 !default;
$ribbon-hscroll-nav-arrow-padding: 0 2px !default;
...
$ribbon-backstage-menu-icon-padding: 16px 12px 16px 16px !default;
...
$ribbon-backstage-btn-icon-padding: 16px 12px 16px 16px !default;
...
$ribbon-group-button-ddb-border-radius: 4px !default;
...
$ribbon-items-label: 36px !default;
$ribbon-combobox-height: 30px !default;
$ribbon-medium-item-height: 30px !default;
...
$ribbon-bigger-group-height: 153px !default;
...
$ribbon-bigger-horizontal-nav-height: 52px !default;
...
$ribbon-bigger-overflow-btn-icon-padding: 9px !default;
$ribbon-bigger-overflow-collapse-btn-right: 28px !default;
$ribbon-bigger-overall-overflow-btn-height: 38px !default;
$ribbon-bigger-overall-overflow-btn-position: 5px !default;
$ribbon-bigger-overflow-wrapper-item-margin: 3px 9px !default;
$ribbon-bigger-group-header-padding: 4px 11px 8px !default;
$ribbon-bigger-group-header-height: 15px !default;
$ribbon-bigger-group-header-font-size: 12px !default;
$ribbon-bigger-simplified-group-content-height: 48px !default;
...
$ribbon-bigger-large-items-icon-padding: 8px 5px 6px !default;
...
$ribbon-bigger-items-margin: 9px !default;
...
$ribbon-bigger-items-checkbox-padding: 0 9px !default;
$ribbon-bigger-input-group-height: 38px !default;
...
$ribbon-bigger-input-padding: 8px 0 8px 8px !default;
$ribbon-bigger-input-icon-padding: 11px 4px 11px 2px !default;
$ribbon-bigger-input-group-margin: 6px !default;
$ribbon-bigger-dropdown-btn-padding: 0 13px !default;
$ribbon-bigger-menu-blank-icon-padding: 44px !default;
...
$ribbon-bigger-backstage-btn-icon-padding: 16px !default;
...
$ribbon-bigger-group-button-padding: 0 9px 0 0 !default;
...
$ribbon-bigger-overflow-header-height: 28px !default;
$ribbon-bigger-combobox-height: 38px !default;
$ribbon-bigger-medium-item-height: 32px !default;
$ribbon-bigger-overflow-header-font-size: 16px !default;
$ribbon-bigger-overflow-header-padding: 5px 0 5px 16px !default;
$ribbon-bigger-rtl-overflow-header-padding: 5px 16px 5px 0 !default;
$ribbon-bigger-button-icon-padding: 7px 10px 7px 16px !default;
$ribbon-bigger-rtl-button-icon-padding: 7px 16px 7px 10px !default;
...
$ribbon-group-seperator-color: $gray-400 !default;
$ribbon-group-border-color: $gray-400 !default;
$ribbon-input-group-border-color: $gray-400 !default;
$ribbon-input-group-background-color: $content-bg !default;
$ribbon-items-icon-color: $gray-700 !default;
$ribbon-items-background-color: $gray-100 !default;
$ribbon-items-hover-background-color: $gray-600 !default;
$ribbon-items-focus-background-color: $gray-600 !default;
$ribbon-items-hover-color: $secondary-font !default;
$ribbon-items-active-color: $secondary-font !default;
$ribbon-items-focus-color: $secondary-font !default;
$ribbon-items-active-background-color: $gray-600 !default;
$ribbon-items-hover-border-color: unset !default;
$ribbon-items-focus-border-color: unset !default;
$ribbon-items-disabled-color: $gray-600 !default;
$ribbon-collapse-btn-background: $gray-100 !default;
$ribbon-text-color: $gray-900 !default;
$ribbon-tab-text-focus-color: darken($primary, 15%) !default;
$ribbon-tab-text-hover-color: darken($primary, 15%) !default;
$ribbon-active-tab-color: $primary !default;
$ribbon-active-tab-indicator-color: $primary !default;
$ribbon-active-file-menu-color: $content-bg !default;
$ribbon-active-file-menu-background: $primary !default;
$ribbon-menu-border-color: $gray-400 !default;
$ribbon-menu-hover-background-color: $gray-300 !default;
$ribbon-menu-items-color: $gray-700 !default;
$ribbon-menu-items-icon-color: $gray-700 !default;
$ribbon-menu-background-color: $content-bg !default;
$ribbon-menu-items-background-color: $content-bg !default;
$ribbon-hscroll-border-color: $gray-400 !default;
$ribbon-hscroll-color: $gray-700 !default;
$ribbon-hscroll-background-color: $gray-100 !default;
$ribbon-hscroll-hover-border-color: $gray-700 !default;
$ribbon-hscroll-hover-background-color: $gray-600 !default;
$ribbon-hscroll-hover-color: $secondary-font !default;
$ribbon-hscroll-active-border-color: $gray-700 !default;
$ribbon-hscroll-active-background-color: $gray-600 !default;
$ribbon-hscroll-active-color: $secondary-font !default;
$ribbon-hscroll-focus-border-color: $gray-300 !default;
$ribbon-hscroll-focus-background-color: $gray-600 !default;
$ribbon-hscroll-focus-color: $secondary-font !default;
$ribbon-tooltip-background-color: $black !default;
$ribbon-tooltip-text-color: $gray-100 !default;
...
$ribbon-backstage-items-color: $content-bg !default;
$ribbon-backstage-menu-icon-color: $content-bg !default;
$ribbon-backstage-menu-hover-bg-color: $primary !default;
$ribbon-backstage-menu-hover-border-color: $content-bg !default;
$ribbon-backstage-menu-items-hover-color: $content-bg !default;
$ribbon-backstage-menu-icon-hover-color: $content-bg !default;
$ribbon-backstage-menu-active-bg-color: $content-bg !default;
$ribbon-backstage-menu-active-border-color: unset !default;
$ribbon-backstage-menu-items-active-color: $primary !default;
$ribbon-backstage-menu-icon-active-color: $primary !default;
$ribbon-backstage-separator-color: $gray-400 !default;
$ribbon-backstage-btn-bg-color: $primary !default;
$ribbon-backstage-btn-color: $content-bg !default;
$ribbon-backstage-btn-focus-bg-color: $primary !default;
$ribbon-backstage-btn-focus-color: $content-bg !default;
$ribbon-backstage-btn-focus-border-color: $content-bg !default;
$ribbon-backstage-btn-hover-bg-color: $content-bg !default;
$ribbon-backstage-btn-hover-color: $primary !default;
$ribbon-backstage-btn-hover-border-color: unset !default;
$ribbon-backstage-close-btn-font-weight: 400 !default;
$ribbon-group-button-dropdown-popup-background: $white !default;
$ribbon-group-button-icon-hover-color: $gray-700 !default;
$ribbon-group-button-hover-background: darken($gray-100, 2%) !default;
$ribbon-group-button-text-hover-color: $gray-900 !default;
$ribbon-group-button-active-background: $gray-600 !default;
$ribbon-group-button-text-active-color: $gray-100 !default;
$ribbon-group-button-selected-background: $gray-600 !default;
$ribbon-group-button-border-color: $gray-600 !default;
$ribbon-group-button-dropdown-popup-border-color: $gray-400 !default;
$ribbon-group-button-dropdown-popup-box-shadow: none !default;
$ribbon-popup-common-bg-color: $content-bg !default;
$ribbon-popup-common-border-radius: 4px !default;
$ribbon-popup-common-border-color: $gray-400 !default;
...
$ribbon-keytip-background-color: $black !default;
$ribbon-keytip-color: $white !default;
$ribbon-gallery-popup-background-color: $white !default;
$ribbon-gallery-item-background-color: transparent !default;
$ribbon-gallery-hover-background-color: $ribbon-header-bg-color !default;
$ribbon-gallery-item-selected-color: $primary !default;
...
$ribbon-gallery-item-focus-border-color: $gray-100 !default;
$ribbon-gallery-item-border-color: $gray-300 !default;
$ribbon-gallery-header-color: $ribbon-text-color !default;
$ribbon-gallery-item-text-color: $ribbon-text-color !default;
$ribbon-gallery-item-disabled-text-color: $gray-500 !default;
$ribbon-gallery-icons-color: $ribbon-items-icon-color !default;
$ribbon-gallery-item-disabled-icons-color: $gray-500 !default;
$ribbon-gallery-item-selected-text-color: $white !default;
$ribbon-gallery-item-selected-icons-color: $white !default;
$ribbon-gallery-popup-box-shadow: 0 6px 12px rgba($black, .175) !default;
...
@include export-module('ribbon-bootstrap4-icons') {
  .e-ribbon {
    & .e-drop-icon {
      &::before {
        content: '\e705';
