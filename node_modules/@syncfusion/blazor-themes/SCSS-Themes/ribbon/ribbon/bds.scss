...
$ribbon-group-header-padding: 4px 11px 4px 11px !default;
$ribbon-group-header-height: $text-base !default;
...
$ribbon-overflow-item-btn-height: $text-xl !default;
$ribbon-overflow-item-btn-margin: 0 8px 0 0 !default;
$ribbon-overflow-btn-height: 26px !default;
...
$ribbon-overflow-header-padding: 3px 5px !default;
$ribbon-rtl-overflow-header-padding: 4px 12px 4px 0 !default;
...
$ribbon-input-icon-size: $text-xs !default;
$ribbon-input-icon-height: 12px !default;
$ribbon-input-icon-padding: 7px 3px 7px 2px !default;
...
$ribbon-tab-text-padding: 8px 8px !default;
...
$ribbon-backstage-btn-line-height: 38px !default;
...
$ribbon-items-label: 28px !default;
$ribbon-combobox-height: 32px !default;
$ribbon-medium-item-height: 32px !default;
$ribbon-button-icon-padding: 8px 8px 8px 12px !default;
$ribbon-rtl-button-icon-padding: 8px 12px 8px 8px !default;
$ribbon-caret-icon-padding: 0 9px 12px !default;
$ribbon-rtl-caret-icon-padding: 12px 9px 0 !default;
$ribbon-gallery-items-padding: 15px 22px !default;
$ribbon-gallery-popup-items-padding: 8px 0 !default;
$ribbon-gallery-header-padding: 9px !default;
$ribbon-gallery-header-font-weight: 400 !default;
$ribbon-gallery-header-line-height: 24px !default;
$ribbon-gallery-header-fontsize: 12px !default;
$ribbon-gallery-text-size: 12px !default;
...
$ribbon-gallery-popup-padding: 10px !default;
...
$ribbon-gallery-items-width: 100px !default;
$ribbon-gallery-simplified-items-width: 100px !default;
$ribbon-gallery-popup-items-width: 100px !default;
$ribbon-gallery-wrapper-height: 80px !default;
...
$ribbon-bigger-items-label-size: $text-base !default;
...
$ribbon-bigger-input-items-btn-size: $text-xs !default;
...
$ribbon-bigger-items-label: 36px !default;
$ribbon-bigger-gallery-popup-padding: 14px !default;
$ribbon-bigger-gallery-header-fontsize: 14px !default;
$ribbon-bigger-gallery-header-line-height: 20px !default;
$ribbon-bigger-gallery-header-padding: 6px !default;
...
$ribbon-bigger-overflow-header-padding: 8px 0 8px 16px !default;
$ribbon-bigger-rtl-overflow-header-padding: 8px 16px 8px 0 !default;
$ribbon-bigger-button-icon-padding: 10px 12px 10px 16px !default;
$ribbon-bigger-rtl-button-icon-padding: 10px 16px 10px 12px !default;
$ribbon-bigger-caret-icon-padding: 0 12px 12px !default;
$ribbon-bigger-rtl-caret-icon-padding: 12px 12px 0 !default;

$ribbon-header-bg-color: $content-bg-color-alt2 !default;
$ribbon-border-color: unset !default;
$ribbon-group-seperator-color: $border-light !default;
...
$ribbon-items-hover-background-color: $secondary-bg-color-pressed !default;
$ribbon-items-focus-background-color: $secondary-bg-color-pressed !default;
$ribbon-items-hover-color: $secondary-text-color-pressed !default;
$ribbon-items-active-color: $secondary-text-color-pressed !default;
$ribbon-items-focus-color: $secondary-text-color-pressed !default;
...
$ribbon-items-disabled-color: $secondary-text-color-disabled !default;
$ribbon-collapse-btn-background: $content-bg-color-alt2 !default;
$ribbon-text-color: $content-text-color !default;
...
$ribbon-active-file-menu-color: $primary-text-color !default;
$ribbon-active-file-menu-background: $primary !default;
$ribbon-menu-border-color: $border-light !default;
$ribbon-menu-hover-background-color: $content-bg-color-hover !default;
$ribbon-menu-items-color: $content-text-color !default;
$ribbon-menu-items-icon-color: $icon-color !default;
$ribbon-menu-background-color: $content-bg-color !default;
$ribbon-menu-items-background-color: $content-bg-color !default;
$ribbon-hscroll-border-color: $border !default;
$ribbon-hscroll-color: $icon-color !default;
$ribbon-hscroll-background-color: $content-bg-color-alt2 !default;
$ribbon-hscroll-hover-border-color: $secondary-border-color-pressed !default;
$ribbon-hscroll-hover-background-color: $secondary-bg-color-pressed !default;
$ribbon-hscroll-hover-color: $secondary-text-color-pressed !default;
$ribbon-hscroll-active-border-color: $secondary-border-color-pressed !default;
$ribbon-hscroll-active-background-color: $secondary-bg-color-pressed !default;
$ribbon-hscroll-active-color: $secondary-text-color-pressed !default;
$ribbon-hscroll-focus-border-color: $secondary-border-color-pressed !default;
$ribbon-hscroll-focus-background-color: $secondary-bg-color-pressed !default;
$ribbon-hscroll-focus-color: $secondary-text-color-pressed !default;
$ribbon-tooltip-background-color: $tooltip-bg-color !default;
$ribbon-tooltip-text-color: $toooltip-text-color !default;
...
$ribbon-backstage-menu-hover-border-color: $primary-lighter !default;
...
$ribbon-backstage-separator-color: $border-light !default;
...
$ribbon-group-button-dropdown-popup-background: $content-bg-color !default;
$ribbon-group-button-icon-hover-color: $content-text-color-hover !default;
$ribbon-group-button-hover-background: $content-bg-color-hover !default;
$ribbon-group-button-text-hover-color: $content-text-color-hover !default;
$ribbon-group-button-active-background: $content-bg-color-selected !default;
$ribbon-group-button-text-active-color: $content-text-color-selected !default;
$ribbon-group-button-selected-background: $content-bg-color-selected !default;
$ribbon-group-button-border-color: $content-bg-color !default;
$ribbon-group-button-dropdown-popup-border-color: $border-light !default;
...
$ribbon-popup-common-border-color: $border-light !default;
$ribbon-popup-common-box-shadow: $shadow-lg !default;
$ribbon-filemenu-popup-border-radius: 2px !default;
...
$ribbon-keytip-background-color: $ribbon-menu-items-icon-color !default;
$ribbon-keytip-color: $ribbon-header-bg-color !default;
$ribbon-gallery-popup-background-color: $content-bg-color !default;
$ribbon-gallery-item-background-color: $content-bg-color-selected !default;
$ribbon-gallery-hover-background-color: $secondary-bg-color-pressed !default;
...
$ribbon-gallery-item-disabled-color: $ribbon-header-bg-color !default;
$ribbon-gallery-item-focus-border-color: $ribbon-header-bg-color !default;
$ribbon-gallery-item-border-color: $ribbon-header-bg-color !default;
$ribbon-gallery-header-color: $ribbon-text-color !default;
$ribbon-gallery-item-text-color: $ribbon-text-color !default;
$ribbon-gallery-item-disabled-text-color: $ribbon-text-color !default;
$ribbon-gallery-icons-color: $ribbon-items-icon-color !default;
$ribbon-gallery-item-disabled-icons-color: $ribbon-items-icon-color !default;
...
@include export-module('ribbon-bds-icons') {
  .e-ribbon {
    & .e-drop-icon {
      &::before {
        content: '\e729';
