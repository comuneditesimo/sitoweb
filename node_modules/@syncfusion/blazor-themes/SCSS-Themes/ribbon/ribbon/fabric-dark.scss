...
$ribbon-toolbar-items-height: 40px !default;
$ribbon-horizontal-nav-height: 40px !default;
$ribbon-group-header-padding: 2px 11px 4px 11px !default;
...
$ribbon-group-height: 135px !default;
$ribbon-simplified-group-padding: 2px !default;
$ribbon-simplified-group-content-padding: 0 8px !default;
...
$ribbon-overflow-wrapper-item-margin: 7px 8px !default;
...
$ribbon-overflow-btn-border-radius: unset !default;
$ribbon-overflow-header-height: 26px !default;
$ribbon-overflow-header-line-height: 18px !default;
$ribbon-overflow-header-font-size: 14px !default;
...
$ribbon-overflow-dropdown-btn-padding: 0 15px !default;
$ribbon-overall-overflow-btn-position: 0 !default;
$ribbon-dropdown-btn-padding: 0 15px !default;
...
$ribbon-large-items-icon-padding: 12px 7px 4px !default;
$ribbon-large-items-btn-gap: 6px !default;
...
$ribbon-input-padding: 5px 0 5px 12px !default;
...
$ribbon-input-icon-padding: 10px 4px 10px 2px !default;
...
$ribbon-tab-text-padding: 8px 8px 10px !default;
...
$ribbon-menu-border-radius: unset !default;
...
$ribbon-backstage-btn-line-height: 40px !default;
$ribbon-backstage-btn-icon-font-size: 16px !default;
$ribbon-backstage-btn-icon-line-height: 16px !default;
$ribbon-backstage-btn-icon-padding: 12px 16px !default;
$ribbon-backstage-btn-hover-border: 0 !default;
$ribbon-group-button-icon-margin: $ribbon-items-margin !default;
$ribbon-group-button-ddb-padding: 8px !default;
$ribbon-group-button-icon-padding: 0 2px 0 0 !default;
$ribbon-group-button-ddb-border-radius: unset !default;
$ribbon-group-button-padding: 0 8px 0 0 !default;
$ribbon-group-button-ddb-border: 1px solid !default;
$ribbon-groupbutton-header-padding: 6px !default;
$ribbon-items-label: 34px !default;
$ribbon-combobox-height: 32px !default;
$ribbon-medium-item-height: 32px !default;
$ribbon-button-icon-padding: 9px 8px 9px 12px !default;
$ribbon-rtl-button-icon-padding: 9px 12px 9px 8px !default;
$ribbon-caret-icon-padding: 0 12px !default;
$ribbon-rtl-caret-icon-padding: 0 12px !default;
$ribbon-gallery-items-padding: 15px 22px !default;
$ribbon-gallery-popup-items-padding: 5px 0 !default;
$ribbon-gallery-header-padding: 8px 0 10px !default;
$ribbon-gallery-header-font-weight: 600 !default;
...
$ribbon-gallery-simplified-items-padding: 5px 0 !default;
$ribbon-gallery-popup-padding: 0 12px 12px !default;
...
$ribbon-gallery-simplified-items-width: 78px !default;
$ribbon-gallery-popup-items-width: 73px !default;
$ribbon-gallery-wrapper-height: 78px !default;
$ribbon-gallery-simplified-wrapper-height: 30px !default;
$ribbon-gallery-simplified-items-wrapper-height: 26px !default;
...
$ribbon-bigger-overall-overflow-btn-position: 0 !default;
$ribbon-bigger-overflow-wrapper-item-margin: 7px 10px !default;
...
$ribbon-bigger-tab-text-padding: 13px 8px !default;
$ribbon-bigger-tab-text-height: 24px !default;
$ribbon-bigger-large-items-icon-padding: 12px 10px 4px !default;
...
$ribbon-bigger-items-label-size: 18px !default;
...
$ribbon-bigger-input-padding: 9px 0 9px 13px !default;
$ribbon-bigger-input-icon-padding: 14px 4px 14px 2px !default;
$ribbon-bigger-input-group-margin: 4px !default;
$ribbon-bigger-dropdown-btn-padding: 0 18px !default;
$ribbon-bigger-menu-blank-icon-padding: 36px !default;
...
$ribbon-bigger-caret-dropdown-btn-padding: 0 18px !default;
...
$ribbon-bigger-backstage-btn-icon-padding: 15px 16px !default;
...
$ribbon-bigger-gallery-popup-padding: 0 16px 16px !default;
$ribbon-bigger-gallery-header-fontsize: 16px !default;
$ribbon-bigger-gallery-header-line-height: 24px !default;
$ribbon-bigger-gallery-header-padding: 9px 0 13px !default;
$ribbon-bigger-overflow-header-line-height: 22px !default;
$ribbon-bigger-overflow-header-height: 32px !default;
$ribbon-bigger-combobox-height: 40px !default;
$ribbon-bigger-medium-item-height: 40px !default;
$ribbon-bigger-overflow-header-font-size: 16px !default;
$ribbon-bigger-overflow-header-padding: 7px 0 7px 16px !default;
$ribbon-bigger-rtl-overflow-header-padding: 7px 16px 7px 0 !default;
$ribbon-bigger-button-icon-padding: 11px 12px 11px 16px !default;
$ribbon-bigger-rtl-button-icon-padding: 11px 16px 11px 12px !default;
...
$ribbon-input-group-border-color: $neutral-quintenaryalt !default;
$ribbon-input-group-background-color: $neutral-white !default;
$ribbon-items-icon-color: $neutral-light-font !default;
$ribbon-items-background-color: $neutral-lighter !default;
$ribbon-items-hover-background-color: $neutral-light !default;
$ribbon-items-focus-background-color: $neutral-light !default;
$ribbon-items-hover-color: $neutral-light-font !default;
$ribbon-items-active-color: $neutral-light-font !default;
$ribbon-items-focus-color: $neutral-light-font !default;
$ribbon-items-active-background-color: $neutral-light !default;
$ribbon-items-hover-border-color: unset !default;
$ribbon-items-focus-border-color: unset !default;
$ribbon-items-disabled-color: $neutral-tertiary-alt !default;
$ribbon-collapse-btn-background: $neutral-lighter !default;
$ribbon-text-color: $neutral-light-font !default;
$ribbon-tab-text-focus-color: $neutral-light-fontalt !default;
$ribbon-tab-text-hover-color: $neutral-light-fontalt !default;
$ribbon-active-tab-color: $theme-tertiary !default;
$ribbon-active-tab-indicator-color: $theme-tertiary !default;
$ribbon-active-file-menu-color: $theme-primary-font !default;
$ribbon-active-file-menu-background: $theme-tertiary !default;
$ribbon-menu-border-color: $neutral-light !default;
$ribbon-menu-hover-background-color: $neutral-light !default;
$ribbon-menu-items-color: $neutral-light-font !default;
$ribbon-menu-items-icon-color: $neutral-light-font !default;
$ribbon-menu-background-color: $neutral-lighter-alt !default;
$ribbon-menu-items-background-color: $neutral-lighter-alt !default;
$ribbon-hscroll-border-color: $neutral-quintenaryalt !default;
$ribbon-hscroll-color: $neutral-light-font !default;
$ribbon-hscroll-background-color: $neutral-lighter !default;
$ribbon-hscroll-hover-border-color: $neutral-quintenaryalt !default;
$ribbon-hscroll-hover-background-color: $neutral-light !default;
$ribbon-hscroll-hover-color: $neutral-light-font !default;
$ribbon-hscroll-active-border-color: $neutral-quintenaryalt !default;
$ribbon-hscroll-active-background-color: $neutral-light !default;
$ribbon-hscroll-active-color: $neutral-light-font !default;
$ribbon-hscroll-focus-border-color: $neutral-quintenaryalt !default;
$ribbon-hscroll-focus-background-color: $neutral-light !default;
$ribbon-hscroll-focus-color: $neutral-light-font !default;
$ribbon-tooltip-background-color: $theme-light-font !default;
$ribbon-tooltip-text-color: $neutral-light-font !default;
$ribbon-overflow-box-shadow: 0 2px 5px 0 rgba($shadow, .26) !default;
$ribbon-backstage-menu-bg-color: $theme-tertiary !default;
$ribbon-backstage-menu-items-bg-color: $theme-tertiary !default;
$ribbon-backstage-items-color: $theme-dark-font !default;
$ribbon-backstage-menu-icon-color: $theme-dark-font !default;
$ribbon-backstage-menu-hover-bg-color: $theme-tertiary !default;
$ribbon-backstage-menu-hover-border-color: $theme-lighter-alt !default;
$ribbon-backstage-menu-items-hover-color: $theme-dark-font !default;
$ribbon-backstage-menu-icon-hover-color: $theme-dark-font !default;
$ribbon-backstage-menu-active-bg-color: $theme-primary !default;
$ribbon-backstage-menu-active-border-color: unset !default;
$ribbon-backstage-menu-items-active-color: $theme-primary-font !default;
$ribbon-backstage-menu-icon-active-color: $theme-primary-font !default;
$ribbon-backstage-separator-color: $neutral-black !default;
$ribbon-backstage-btn-bg-color: $theme-tertiary !default;
$ribbon-backstage-btn-color: $theme-dark-font !default;
$ribbon-backstage-btn-focus-bg-color: $theme-tertiary !default;
$ribbon-backstage-btn-focus-color: $theme-dark-font !default;
$ribbon-backstage-btn-focus-border-color: $theme-lighter-alt !default;
$ribbon-backstage-btn-hover-bg-color: $theme-primary !default;
$ribbon-backstage-btn-hover-color: $theme-primary-font !default;
$ribbon-backstage-btn-hover-border-color: unset !default;
$ribbon-backstage-close-btn-font-weight: 400 !default;
$ribbon-group-button-dropdown-popup-background: $neutral-white !default;
$ribbon-group-button-icon-hover-color: $neutral-light-font !default;
$ribbon-group-button-hover-background: $neutral-light !default;
$ribbon-group-button-text-hover-color: $neutral-light-font !default;
$ribbon-group-button-active-background: $neutral-quintenary !default;
$ribbon-group-button-text-active-color: $neutral-light-font !default;
$ribbon-group-button-selected-background: $neutral-quintenary !default;
$ribbon-group-button-border-color: $neutral-tertiary !default;
$ribbon-group-button-dropdown-popup-border-color: $neutral-light !default;
$ribbon-group-button-dropdown-popup-box-shadow: 0 0 6px 0 rgba(0, 0, 0, .25) !default;
$ribbon-popup-common-bg-color: $neutral-white !default;
$ribbon-popup-common-border-radius: unset !default;
$ribbon-popup-common-border-color: $neutral-light !default;
$ribbon-popup-common-box-shadow: 0 0 6px 0 rgba($shadow, .25) !default;
$ribbon-filemenu-popup-border-radius: unset !default;
$ribbon-contextual-tab-color: $ribbon-active-tab-indicator-color !default;
$ribbon-contextual-tab-background: $ribbon-header-bg-color !default;
$ribbon-keytip-background-color: $neutral-black !default;
$ribbon-keytip-color: $neutral-white !default;
$ribbon-gallery-popup-background-color: $neutral-white !default;
$ribbon-gallery-item-background-color: $neutral-white !default;
$ribbon-gallery-hover-background-color: $neutral-quintenary !default;
$ribbon-gallery-item-selected-color: $neutral-tertiary-alt !default;
$ribbon-gallery-button-selected-color: $ribbon-gallery-item-selected-color !default;
$ribbon-gallery-item-disabled-color: $neutral-white !default;
$ribbon-gallery-item-focus-border-color: $neutral-light !default;
$ribbon-gallery-item-border-color: $neutral-light !default;
$ribbon-gallery-header-color: $ribbon-text-color !default;
$ribbon-gallery-item-text-color: $ribbon-text-color !default;
$ribbon-gallery-item-disabled-text-color: $neutral-tertiary !default;
$ribbon-gallery-icons-color: $ribbon-items-icon-color !default;
$ribbon-gallery-item-disabled-icons-color: $neutral-tertiary !default;
$ribbon-gallery-item-selected-text-color: $ribbon-text-color !default;
$ribbon-gallery-item-selected-icons-color: $ribbon-items-icon-color !default;
$ribbon-gallery-popup-box-shadow: 0 2px 5px 0 rgba($shadow, .26) !default;
...
@include export-module('ribbon-layout') {
  ...
  .e-ribbon-group-overflow-ddb {
    ...
    .e-ribbon-item {
      ...
      .e-ribbon-gallery-wrapper {
        ...
        .e-ribbon-gallery-container {
          .e-ribbon-gallery-item {
            max-height: $ribbon-gallery-wrapper-height;
          }
        }
      }
  ...
  .e-dropdown-popup.e-ribbon-dropdown-group-button {
    ...
    .e-btn-group {
      ...
      .e-btn.e-ribbon-group-button {
        ...
        font-weight: $ribbon-items-font-weight;
        font-size: $ribbon-items-btn-size;
        border: 1px solid $ribbon-group-button-border-color;
        text-transform: none;
    ...
    .e-ribbon-gallery-container {
      ...
      .e-ribbon-gallery-item {
        ...
        .e-ribbon-gallery-icons {
          font-size: $ribbon-gallery-icons-size;
  ...
  .e-bigger.e-ribbon-group-overflow-ddb {
    .e-ribbon-overflow-target {
      ...
      .e-ribbon-overflow-header {
        line-height: $ribbon-bigger-overflow-header-line-height;
  ...
  .e-bigger .e-ribbon-gallery-dropdown.e-popup {
    ...
    .e-ribbon-gallery-header {
      padding-bottom: $ribbon-bigger-gallery-header-padding;
      font-size: $ribbon-bigger-gallery-header-fontsize;
...
@include export-module('ribbon-theme') {
  ...
  .e-ribbon.e-rbn {
    .e-ribbon-tab {
      ...
      .e-hscroll .e-scroll-nav {
        border-color: $ribbon-hscroll-border-color;
        background: $ribbon-hscroll-background-color;

        .e-nav-arrow {
          color: $ribbon-hscroll-color;
        }

        &:hover {
          border-color: $ribbon-hscroll-hover-border-color;
          background: $ribbon-hscroll-hover-background-color;

          .e-nav-arrow {
            color: $ribbon-hscroll-hover-color;
          }
        }

        &:active {
          border-color: $ribbon-hscroll-active-border-color;
          background: $ribbon-hscroll-active-background-color;

          .e-nav-arrow {
            color: $ribbon-hscroll-active-color;
          }
        }

        &:focus {
          border-color: $ribbon-hscroll-focus-border-color;
          background: $ribbon-hscroll-focus-background-color;

          .e-nav-arrow {
            color: $ribbon-hscroll-focus-color;
          }
        }
      }
      ...
      .e-ribbon-template {
        ...
        &:focus-visible {
          ...
          color: $ribbon-items-focus-color;
          border-color: $ribbon-items-focus-border-color;
        }
      }
    }
    ...
    .e-ribbon-collapse-btn {
      ...
      background: $ribbon-collapse-btn-background;
  ...
  .e-ribbon-backstage-popup {
    ...
    .e-btn {
      ...
      &:focus {
        background: $ribbon-backstage-btn-focus-bg-color;
        color: $ribbon-backstage-btn-focus-color;
        border-color: $ribbon-backstage-btn-focus-border-color;
      }

      &:hover {
        background: $ribbon-backstage-btn-hover-bg-color;
        color: $ribbon-backstage-btn-hover-color;
        border-color: $ribbon-backstage-btn-hover-border-color;
      }
    ...
    .e-ribbon-backstage-menu {
      ...
      &.e-menu-wrapper ul.e-ul {
        ...
        .e-menu-item {
          ...
          &:focus {
            background: $ribbon-backstage-menu-hover-bg-color;
            border-color: $ribbon-backstage-menu-hover-border-color;
            color: $ribbon-backstage-menu-items-hover-color;
          ...
          &.e-selected,
          &:hover {
            background: $ribbon-backstage-menu-active-bg-color;
            border-color: $ribbon-backstage-menu-active-border-color;
            color: $ribbon-backstage-menu-items-active-color;
  ...
  .e-ribbon-group-overflow-ddb {
    ...
    .e-ribbon-item:not(.e-disabled) {
      ...
      .e-split-btn-wrapper {
        ...
        &.e-vertical:hover .e-split-btn:not(:hover) {
          border-color: transparent;
        }
      }
    }
    ...
    .e-ribbon-item {
      .e-split-btn-wrapper {
        &.e-vertical:hover .e-split-btn:disabled {
          border-color: transparent;
        }
      }
    }
    ...
    &.e-ribbon-overflow {
      ...
      .e-ribbon-group-of-btn {
        ...
        &:hover {
          ...
          color: $ribbon-items-hover-color;
          border-color: $ribbon-items-hover-border-color;
        ...
        &:active {
          ...
          color: $ribbon-items-active-color;
  ...
  .e-ribbon-gallery-item {
    background: $ribbon-gallery-item-background-color;
    border-color: transparent;
    &:hover {
    ...
    &.e-ribbon-gallery-selected {
      ...
      .e-ribbon-gallery-text {
        color: $ribbon-gallery-item-selected-text-color;
      }
      .e-ribbon-gallery-icons {
        color: $ribbon-gallery-item-selected-icons-color;
      }
    }
    &.e-disabled {
      background: $ribbon-gallery-item-disabled-color;
      .e-ribbon-gallery-text {
        color: $ribbon-gallery-item-disabled-text-color;
      }
      .e-ribbon-gallery-icons {
        color: $ribbon-gallery-item-disabled-icons-color;
      }
    }
    &:focus,
    &:focus-visible {
    ...
    .e-ribbon-gallery-text {
      color: $ribbon-gallery-item-text-color;
    }
    .e-ribbon-gallery-icons {
      color: $ribbon-gallery-icons-color;
    }
  }
  ...
  .e-dropdown-popup.e-ribbon-dropdown-group-button {
    ...
    .e-btn.e-ribbon-group-button {
      ...
      &.e-icon-btn:focus {
        ...
        .e-btn-icon {
          color: $ribbon-group-button-icon-hover-color;
        }
      }
      &:hover,
      &:focus {
