...
$ddl-list-border-color: rgba($black, .15) !default;
...
$mention-chip-bg-color: $gray-200 !default;
...
$ddl-list-hover-bg-color: darken($gray-100, 2%) !default;
$ddl-list-hover-border-color: $white !default;
$ddl-list-hover-font-color: $gray-900 !default;
$ddl-nodata-font-color: $gray-900 !default;
...
$ddl-list-header-font-color: $gray-600 !default;
...
$ddl-multi-column-border-color: rgba($black, .12) !default;
...
$ddl-small-list-font-color: $gray-900 !default;
