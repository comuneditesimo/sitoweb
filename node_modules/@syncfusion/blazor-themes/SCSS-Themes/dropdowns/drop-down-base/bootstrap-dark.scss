...
$mention-gradient-color: $brand-primary-font !default;
$mention-list-box-shadow-color: 0 6px 12px rgba($base-font, .5) !default;
$mention-chip-bg-color: $gray-dark !default;
