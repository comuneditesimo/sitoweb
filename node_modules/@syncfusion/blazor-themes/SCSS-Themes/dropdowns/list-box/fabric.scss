...
$listbox-icon-color: $theme-light-font !default;
$listbox-icon-disabled: rgba($neutral-light-font, .54) !default;
...
$listbox-text-hover-color: $theme-light-font !default;
$listbox-item-active-bg: $theme-lighter !default;
$listbox-text-active-color: $theme-light-font !default;
$listbox-header-text-color: $theme-light-font !default;
$listbox-header-text-padding: 16px !default;
$listbox-header-text-disabled: $theme-light-font !default;
$listbox-header-bg: $neutral-white !default;
$listbox-header-icon-color: $neutral-light-font !default;
$listbox-header-icon-disabled: $neutral-light-font !default;
...
$listbox-groupheader-text-color: $theme-primary !default;
$listbox-groupheader-bg: $neutral-white !default;
$listbox-groupheader-border: $neutral-light !default;
$listbox-groupheader-icon: $theme-primary !default;
