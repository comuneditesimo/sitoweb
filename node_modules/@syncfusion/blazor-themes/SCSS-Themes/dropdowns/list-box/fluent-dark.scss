...
$listbox-groupheader-item-line-height: 8px !default;
$listbox-groupheader-font-size: $text-sm !default;
...
$listbox-groupheader-text-color: $primary-outline !default;
$listbox-groupheader-bg: $transparent !default;
$listbox-groupheader-border: $border-light !default;
