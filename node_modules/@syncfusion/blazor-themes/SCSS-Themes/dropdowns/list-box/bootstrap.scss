...
$listbox-icon-color: rgba(0, 0, 0, .75) !default;
...
$listbox-item-hover-bg: $grey-f5 !default;
...
$listbox-border-bottom-color: rgba($grey-base, .1) !default;
...
$listbox-item-active-bg: $grey-e6 !default;
...
$listbox-header-border: rgba($grey-base, .12) !default;
...
$listbox-groupheader-text-color: $grey-light-font !default;
$listbox-groupheader-bg: $grey-white !default;
$listbox-groupheader-border: $grey-base !default;
