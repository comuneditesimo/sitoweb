...
$ddt-dd-icon-margin: 0 !default;
$ddt-dd-icon-width: 30px !default;
$ddt-dd-icon-radius: 16px !default;
$ddt-dd-icon-bg: rgba(28, 27, 31, $opacity8) !default;
$ddt-close-icon-width: 20px !default;
$ddt-dd-icon-bigger-bottom: 0 !default;
$ddt-filter-border: 1px solid rgba($border-light) !default;
...
$ddt-select-all-padding: 0 16px !default;
...
$ddt-icon-bg-color: rgba($content-bg-color) !default;
...
$ddt-popup-border-color: rgba($border-light) !default;
$ddt-chip-close: rgba($secondary-text-color) !default;
$ddt-chip-font-color: rgba($secondary-text-color) !default;
$ddt-chip-hover-bg-color: $content-bg-color-hover !default;
$ddt-chip-hover-font-color: rgba($secondary-text-color-hover) !default;
$ddt-nodata-font-color: rgba($content-text-color) !default;
