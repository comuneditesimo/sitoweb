...
$ddt-filter-padding: 4px 12px !default;
...
$ddt-last-chip-right-margin: 54px !default;
$ddt-last-chip-bigger-right-margin: 58px !default;
...
$ddt-chip-width: calc(100% - 8px) !default;
...
$ddt-big-chip-ddi-ci-width: calc(100% - 78px) !default;
...
$ddt-chip-icon-line-height: 20px !default;
$ddt-list-filter-text-indent: 0 20px !default;
$ddt-treeview-fullrow-height: 38px !default;
...
$ddt-chip-hover-font-color: $content-text-color-hover !default;
