...
/* stylelint-disable */
$ddt-skin-name: 'highcontrast' !default;
...
$ddt-close-icon-min-height: 30px !default;
$ddt-close-icon-bigger-min-height: 38px !default;
$ddt-close-icon-width: 30px !default;
...
$ddt-filter-border: 1px solid $border-fg !default;
$ddt-filter-top-border: 0 !default;
$ddt-filter-padding: 5px !default;
$ddt-filter-box-shadow: none !default;
$ddt-filter-background-color: $bg-base-0 !default;
$ddt-chip-margin: 2px 1px !default;
$ddt-chip-padding: 0 4px 0 4px !default;
$ddt-chip-bg-color:  $bg-base-75 !default;
$ddt-chip-radius: 0 !default;
$ddt-chip-height: 26px !default;
$ddt-chip-bigger-height: 34px !default;
$ddt-chip-content-padding: 0 4px 0 4px !default;
$ddt-chip-close-font: 10px !default;
$ddt-chip-close-height: 26px !default;
$ddt-chip-close-width: 18px !default;
$ddt-chip-icon-line-height: 21px !default;
...
$ddt-treeview-fullrow-height: 40px !default;
$ddt-treeview-fullrow-bigger-height: 48px !default;
$ddt-treeview-content-padding-top: 4px !default;
$ddt-treeview-content-padding-bottom: 4px !default;
$ddt-popup-border-color: $border-default !default;
$ddt-chip-close:  $invert-font !default;
$ddt-chip-font-color:  $invert-font !default;
$ddt-chip-hover-bg-color: $hover-bg !default;
$ddt-chip-hover-font-color: $hover-font !default;
$ddt-nodata-font-color: $content-font !default;
$ddt-select-all-font-color: $content-font !default;
...
$ddt-chip-ddi-ci-width: calc(100% - 61px) !default;
...
$ddt-icon-bg-color: $bg-base-0 !default;
$ddt-remains-font-color:  $content-font !default;
...
@include export-module('dropdowntree-highcontrast-icons') {
  .e-ddt {
    .e-ddt-icon::before {
      content: '\e966';
    }
