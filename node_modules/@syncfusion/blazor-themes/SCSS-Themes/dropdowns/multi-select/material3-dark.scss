...
$ddl-multiselect-skin-name: 'Material3' !default;
$ddl-delim-font-size: $text-sm !default;
$ddl-rtl-wrapper: 0 2px 0 32px !default;
$ddl-chip-mobile-bg: rgba($primary) !default;
$ddl-chip-mobile-font: $grey-white !default;
$ddl-list-box-shadow-color: rgba(0, 0, 0, .21) !default;
$ddl-chip-bg-color:  $transparent !default;
$ddl-chip-hover-bg-color: ($content-bg-color-hover, .05) !default;
$ddl-chip-hover-font-color: rgba($content-text-color-alt1) !default;
$ddl-sel-hover-chip-bg-color: ($content-bg-color-hover, .05) !default;
$ddl-sel-chip-hover-font-color: rgba($content-text-color-alt1) !default;
$ddl-chip-font-color: rgba($content-text-color-alt1) !default;
$ddl-chip-close: rgba($icon-color) !default;
$ddl-sel-chip-font-color: rgba($content-text-color-alt1) !default;
$ddl-sel-chip-close: rgba($icon-color) !default;
$ddl-sel-chip-color: rgba($icon-color) !default;
$ddl-sel-chip-bg-color: $transparent !default;
...
$ddl-popup-shadow-value: $shadow-md !default;
$ddl-remains-font-color: rgba($content-text-color) !default;
$ddl-remains-padding-left: 16px !default;
$ddl-chip-margin: 0 8px 4px 0 !default;
$ddl-chip-margin-bigger: 0 8px 5px 0 !default;
$ddl-chip-radius: 8px !default;
$ddl-chip-content-padding: 2px 6px 2px 2px !default;
...
$ddl-closer-hooker-font: 16px !default;
$ddl-chip-font-family: inherit !default;
$ddl-closer-margin-top: -1.8em !default;
$ddl-closer-margin-top-bigger: -2.5em !default;
$ddl-small-close-hooker-margin-top: -1.7em !default;
$ddl-icon-margin-top: -2em !default;
...
$ddl-closer-hooker-top-margin: 100% !default;
$ddl-bigger-chip-down-icon-font: 16px !default;
$ddl-chip-hooker-right: 5px !default;
$ddl-chip-hooker-bigger-small-right: 34px !default;
...
$ddl-control-placholder-padding: 4px 32px 0 0 !default;
$ddl-overall-close-top: 7px !default;
$ddl-overall-close-left: 8px !default;
...
$ddl-popup-active-focus-bg-color: $flyout-bg-color-selected !default;
$ddl-popup-focus-bg-color: $flyout-bg-color-focus !default;
$ddl-popup-active-focus-font-color: rgba($flyout-text-color-selected) !default;
...
$ddl-filterbar-padding: 4px 12px 4px !default;
$ddl-bigger-filterbar-padding: 4px 0 !default;
$ddl-delimviewheight-check-bigger: 34px !default;
$ddl-popup-reorder-border: rgba($flyout-border) !default;
...
$ddl-close-icon-bigger-right: 38px !default;
$ddl-close-icon-bigger-small-right: 34px !default;
$ddl-check-icon-top: 6px !default;
$ddl-bigger-check-right: 17px !default;
$ddl-multi-list-default-font-color: rgba($flyout-text-color) !default;
$ddl-multi-list-hover-bg-color: ($flyout-bg-color-hover, .05) !default;
...
$multiselect-disable-font-color: rgba($content-text-color, .38) !default;
$ddl-bigger-closer-hooker-bg-color: rgba($content-text-color, .08) !default;
$ddl-bigger-closer-hooker-border-radius: 20px !default;
$ddl-bigger-closer-hooker-width: 38px !default;
$ddl-bigger-closer-hooker-height: 38px !default;
$ddl-bigger-small-closer-hooker-height: 34px !default;
$ddl-bigger-small-closer-hooker-width: 34px !default;
...
$ddl-small-chip-close-hooker-height: 22px !default;
$ddl-small-chip-close-hooker-width: 22px !default;
...
$ddl-small-closer-margin-top: -1.5em !default;
...
$ddl-small-clear-icon-height: 22px !default;
$ddl-small-clear-icon-width: 22px !default;
$ddl-closer-hooker-font-small: 14px !default;
$ddl-small-ddl-icon-top: -1.4em !default;
...
$ddl-bigger-small-close-hooker-height: 34px !default;
$ddl-bigger-small-close-hooker-width: 34px !default;
...
$ddl-bigger-small-ddl-icon-top: -1.7em !default;
...
$outline-multiselect-chip-bg-color: transparent !default;
...
$outline-multiselect-disabled-chip-bg-color: transparent !default;
...
$ddl-chip-bigger-content-padding: 0 !default;
...
.e-bigger .e-ddl.e-popup.e-multi-select-list-wrapper .e-filter-parent .e-input-group.e-input-focus {
  @if $ddl-multiselect-skin-name != 'bootstrap5' and $ddl-multiselect-skin-name != 'tailwind' and $ddl-multiselect-skin-name != 'Material3' {
