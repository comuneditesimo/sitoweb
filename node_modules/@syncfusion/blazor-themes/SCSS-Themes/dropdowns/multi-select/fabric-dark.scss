...
$ddl-multiselect-skin-name: 'fabric' !default;
$ddl-delim-font-size: 14px !default;
$ddl-rtl-wrapper: 0 2px 0 32px !default;
$ddl-chip-mobile-bg: $neutral-light !default;
$ddl-chip-mobile-font: $neutral-light-font !default;
$ddl-chip-bg-color: $neutral-light !default;
$ddl-chip-hover-bg-color: $neutral-quintenary !default;
$ddl-chip-hover-font-color: $neutral-light-fontalt !default;
$ddl-chip-font-color: $neutral-light-font !default;
$ddl-chip-close: $neutral-light-font !default;
$ddl-sel-chip-font-color: $neutral-light-fontalt !default;
$ddl-sel-chip-close: $neutral-light-fontalt !default;
$ddl-sel-chip-bg-color: $neutral-tertiary-alt !default;
$ddl-sel-hover-chip-bg-color: $neutral-quintenaryalt !default;
$ddl-sel-chip-hover-font-color: $neutral-light-fontalt !default;
$ddl-chip-selected-shadow-value: 0 2px 5px 0 rgba(0, 0, 0, .26) !default;
$ddl-popup-shadow-value: 0 2px 5px 0 rgba(0, 0, 0, .26) !default;
$ddl-remains-font-color: $neutral-tertiary !default;
...
$ddl-chip-margin: 1.5px 2px 2px 0 !default;
$ddl-chip-margin-bigger: 4px 2px 2px 0 !default;
$ddl-chip-content-padding: 0 0 3px 0 !default;
$ddl-chip-mobile-content-padding: 4px 8px 6px 0 !default;
...
$ddl-delimviewheight: 30px !default;
...
$ddl-popup-active-focus-border-color: $neutral-secondary !default;
$ddl-popup-active-focus-border-width: 1px !default;
$ddl-popup-active-focus-shadow-item: none !default;
$ddl-input-placeholder: $neutral-tertiary-alt !default;
$ddl-popup-active-border-color: $neutral-secondary !default;
...
$ddl-popup-reorder-border: $neutral-light !default;
...
$ddl-multi-list-default-font-color: $neutral-light-font !default;
$ddl-multi-list-hover-bg-color: $neutral-lighter !default;
$ddl-delim-text-padding-right: 0 !default;
$ddl-list-rtl-padding-right: 19px !default;
$ddl-close-rtl-icon-left: 30px !default;
$ddl-chip-close-rtl-left: -10px !default;
$ddl-delim-font-color: $neutral-light-font !default;
$ddl-close-icon-color: $neutral-light-font !default;
...
$multiselect-disable-font-color: $neutral-tertiary-alt !default;
...
//dimensions
@include export-module('multiselect-fabric-dark') {
