...
$ddl-default-border-color: $neutral-light !default;
$ddl-popup-background-color: $neutral-lighter-alt !default;
$ddl-filter-border: 1px solid $neutral-light !default;
$ddl-list-box-shadow-color: rgba($shadow, .26) !default;
$ddl-filter-top-border: 0 !default;
$ddl-filter-padding: 5px !default;
$ddl-filter-box-shadow: 0 2px 5px 0 rgba($shadow, .26) !default;
$ddl-filter-background-color: $neutral-white !default;
...
@include export-module('dropdownlist-fabric-dark') {
  .e-ddl#{&}.e-popup {
    border: 0;
