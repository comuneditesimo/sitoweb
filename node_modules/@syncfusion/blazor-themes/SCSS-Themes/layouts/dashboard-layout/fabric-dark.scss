...
$panel-header-color: $neutral-secondary !default;
...
$panel-bigger-header-color: $neutral-light-font !default;
...
$panel-hover-border: 1px $neutral-tertiary-alt solid !default;
...
$panel-drop-border: 2px $theme-primary dotted !default;
$panel-drop-background: rgba($theme-primary, .2) !default;
...
$gridline-border: #3A3A3A !default;
