...
$panel-header-border-radius: 8px !default;
$panel-header-color: rgba($content-text-color) !default;
...
$panel-header-border-bottom: 1px solid rgba($border-light) !default;
