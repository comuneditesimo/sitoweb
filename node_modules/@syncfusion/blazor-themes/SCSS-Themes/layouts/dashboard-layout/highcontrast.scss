...
$panel-header-color: $bg-base-100 !default;
$panel-header-font-size: 15px !default;
$panel-header-font-weight: 300 !default;
...
$panel-resize-two-dimensional-icon-color: $content-font !default !default;
...
$panel-drop-border: 1px $selection-bg dotted !default;
$panel-drop-background: rgba($selection-bg, .3) !default;
