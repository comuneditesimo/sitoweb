...
$panel-header-color: $gray-dark !default;
$panel-header-font-size: 14px !default;
$panel-header-font-weight: 500 !default;
$panel-header-border-bottom: 1px solid $grey-e6 !default;
...
$panel-bigger-header-color: $gray-dark !default;
...
$panel-border: 1px rgba($grey-white, .8) solid !default;
$panel-hover-border: 1px $grey-d4 solid !default;
...
$panel-resize-two-dimensional-icon-color: rgba($base-font, .5) !default;
...
$panel-drop-border: 1px $brand-primary dotted !default;
...
$gridline-border: $grey-ad !default;
