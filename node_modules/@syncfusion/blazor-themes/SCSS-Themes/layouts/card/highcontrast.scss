...
$card-bg-color: $bg-base-0 !default;
$card-brdr-size: 1px !default;
$card-brdr-type: solid !default;
$card-brdr-color: $border-default !default;
$card-sep-brdr-size: 1px !default;
$card-sep-brdr-type: solid !default;
$card-sep-brdr-color: $border-default !default;
$card-image-title-color: $content-font !default;
$card-image-title-bg: rgba($bg-base-0, .7) !default;

$card-action-btn-bg-color: $bg-base-0 !default;
$card-action-btn-font-color: $content-font !default;
$card-action-btn-border: 1px solid $selection-bg !default;
$card-action-btn-hover-bg: $hover-bg !default;
$card-action-btn-hover-border: 1px solid $hover-border !default;
$card-action-btn-hover-font: $content-font !default;
$card-action-btn-focus-bg: $selection-bg !default;
$card-action-btn-focus-border: 1px solid $border-fg !default;
$card-action-btn-focus-font: $content-font !default;
$card-action-btn-pressed-bg: $selection-bg !default;
$card-action-btn-pressed-border: 1px solid $selection-bg !default;
$card-action-btn-pressed-font: $content-font !default;

$card-font-color: $content-font !default;
$card-header-txt-title-color: $content-font !default;
$card-header-txt-subtitle-color: $content-font !default;
$card-content-font-color: $content-font !default;
$card-box-shadow: none !default;

$card-focus-bg-color: $bg-base-0 !default;
$card-hover-bg-color: $bg-base-0 !default;
$card-active-bg-color: $bg-base-0 !default;
$card-focus-brdr-color: $border-default !default;
$card-hover-brdr-color: $border-fg !default;
$card-active-brdr-color: $border-fg-alt !default;
$card-action-btn-icon-color: $content-font !default;
