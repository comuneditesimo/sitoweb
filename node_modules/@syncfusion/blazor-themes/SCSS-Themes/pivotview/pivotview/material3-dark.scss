...
@import '../../grids/grid/material3-dark.scss';
...
$pivotview-bigger-grid-header-font-size: $text-sm !default;
$pivotview-grid-header-font-weight: 500 !default;
...
$pivotgrid-summary-font-weight: 500 !default;
$pivotgrid-prompt-line-height: 24px !default;
$field-list-toggle-size: 30px !default;
$pivotgrid-drag-clone-font-size: 14px !default;
$pivotgrid-default-border-radius: 8px !default;
$pivotgrid-button-icon-size: 14px !default;
...
$pivotgrid-expand-icon-fontsize: 16px !default;
$pivotgrid-expcoldiv-fontsize: 10px !default;
$pivotgrid-drill-margintop: 3px !default;
$pivotgrid-bigger-drill-margintop: 4px !default;
$pivotgrid-rtl-expand-icon-font-size: 10px !default;
$pivotgrid-collapse-icon-fonsize: 16px !default;
$pivotgrid-vsort-column-margin: -15px 0 !default;
$pivotgrid-vsort-column-parent-margin: 0 !default;
...
$pivotgrid-member-filter-list-height: 154px !default;
$pivotgrid-member-filter-list-bigger-height: 117px !default;
...
$pivotgrid-excel-member-filter-height: 148px !default;
$pivotgrid-excel-member-filter-node-limit-height: 145px !default;
$pivotgrid-excel-filter-height: 244px !default;
$pivotgrid-excel-member-filter-bigger-height: 135px !default;
$pivotgrid-excel-filter-bigger-height: 220px !default;
$pivotgrid-editor-label-padding-size: 12px 10px 16px 20px !default;
$pivotgrid-editor-label-font: 500 13px $font-family !default;
...
$pivotgrid-drillthrough-header-font-weight: 600 !default;
...
$pivotgrid-expand-collapse-margin-top: 3px !default;
$pivotgrid-expand-collapse-margin-bottom: 3px !default;
...
// $pivotview-filter-toolbar-indicator-margin-right: 20px !default;
$pivotview-filter-toolbar-items-margin-right: 20px !default;
$pivotgrid-header-text-margin-top: 3px !default;
$pivotgrid-border: rgba($border-light) !default;
$pivotgrid-bg-color: $content-bg-color-alt1;
$pivotgrid-border-color: rgba($border);
$pivotgrid-active-border-color: rgba($border-focus);
$pivotgrid-box-shadow-color: rgba($primary-light);
...
$pivotgrid-default-border-color: rgba($border-light) !default;
...
$pivotgrid-button-background-color: $transparent !default;
$pivotgrid-button-drag-color: rgba($icon-color) !default;
$pivotgrid-hover-color: $content-bg-color-hover !default;
$pivotgrid-focus-color: $secondary-bg-color-pressed !default;
$pivotgrid-button-icon-color: rgba($content-text-color-alt1) !default;
$pivotgrid-button-active-icon-color: $pivotgrid-button-icon-color !default;
$pivotgrid-icon-hover-color: rgba($icon-color-hover) !default;
$pivotgrid-icon-focus-color: $pivotgrid-icon-hover-color !default;
$pivotgrid-tooltip-fontcolor: rgba($tooltip-text-color) !default;
$pivotgrid-button-font-color: rgba($content-text-color-alt1) !default;
...
$pivotgrid-drillthrough-header-font-color: rgba($content-text-color) !default;
$pivotgrid-drillthrough-header-value-font-color: rgba($content-text-color) !default;
...
$pivotgrid-member-editor-search-padding: 0 15px 10px !default;
...
$pivotgrid-member-editor-bigger-height: 455px !default;
$pivotgrid-expand-bigger-icon-fontsize: 24px !default;
$pivotgrid-collapse-bigger-icon-fontsize: 22px !default;
...
/* pivot-pager */
$pivotpager-padding: 4px 12px !default;
$pivotpage-touch-padding: 8px 16px !default;
$pivotpager-separator-border: 1px solid rgba($border-light) !default;
$pivotpager-title-font-size: 12px !default;
$pivotpager-single-title-font-size: 14px !default;
...
$pivotpager-axis-title-font-color: rgba($content-text-color-alt1) !default;
$pivotpager-size-title-font-color: rgba($content-text-color) !default;
...
$pivotpager-single-size-title-padding: 12px !default;
$pivotpager-numeric-font-size: $text-base !default;
$pivotpager-string-maindiv-font-color: rgba($content-text-color-alt1) !default;
