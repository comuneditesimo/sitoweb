...
@import '../../grids/grid/material-dark.scss';
...
@import '../../pivotview/pivotfieldlist/material-dark.scss';
...
$pivotgrid-grp-bg-color: $grey-900 !default;
$pivotgrid-grp-bg-hover-color: rgba(255, 255, 255, .1) !default;
$pivotgrid-cell-hover-color: rgba(0, 0, 0, 0) !default;
$pivotgrid-drag-clone-color: $grey-200 !default;
$pivotgrid-drop-hover-color: $grey-600 !default;
...
$pivotgrid-button-border-color: none !default;
$pivotgrid-drag-clone-text-color: $content-font-color !default;
...
$pivotgrid-drill-margintop: 8px !default;
...
$pivotgrid-hover-color: rgba($grey-white, .18) !default;
$pivotgrid-focus-color: rgba($grey-white, .18) !default;
$pivotgrid-button-icon-color: rgba($grey-dark-font, .7) !default;
...
$pivotgrid-editor-label-padding-size: 14px 10px 16px 20px !default;
$pivotgrid-editor-label-font: 500 13px Roboto !default;
$pivotgrid-editor-label-opacity: .87 !default;
$pivotgrid-editor-label-color: $grey-dark-font !default;
$pivotgrid-editor-label-fill: $grey-100 !default;
...
$pivotgrid-drillthrough-header-font-weight: 500 !default;
$pivotgrid-drillthrough-value-opacity: .54 !default;
$pivotgrid-header-selection-bg-color: rgba($grey-white, .28) !default;
$pivotgrid-header-selection-color: $grey-dark-font !default;
$pivotgrid-menubar-height: 40px !default;
$pivotgrid-bigger-menubar-height: 52px !default;
$pivotgrid-sort-wrapper-padding-size: 10px !default;
$pivotgrid-sort-select-background-color: mix($grey-dark-font, $grey-700, 18%) !default;
$pivotgrid-sort-select-border-color: transparent !default;
$pivotgrid-sort-select-color: $grey-dark-font !default;
$pivotgrid-group-chart-values-dropdown-margin: 0 !default;
$pivotgrid-group-chart-values-dropdown-margin-bigger: 0 !default;
$pivotgrid-sort-select-color: $grey-dark-font !default;
$pivotgrid-header-background-color: $grey-900 !default;
$pivotgrid-gtot-background-color: $grey-900 !default;
$pivotgrid-gtot-font-color: $grey-dark-font 87% !default;
$pivotgrid-report-label-margin-top: 8px !default;
...
$pivotgrid-border: $grey-300 !default;
...
$pivotpager-separator-border: 1px solid #e4e4e4 !default;
...
$pivotpager-v-separator-margin-top: 9px !default;
...
$pivotpager-adaptive-page-container-marging-top: 6px !default;
$pivotpager-numeric-box-margin: 0 8px 0 20px !default;
$pivotpager-adaptive-numeric-box-margin: 0 20px 0 8px !default;
$pivotpager-touch-numeric-boc-margin: -1px 12px 0 20px !default;
$pivotpager-single-size-title-padding: 14px !default;
