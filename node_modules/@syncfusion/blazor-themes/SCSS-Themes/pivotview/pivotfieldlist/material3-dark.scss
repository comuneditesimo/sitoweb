...
@import '../../calendars/daterangepicker/material3-dark.scss';
...
@import '../../calendars/timepicker/material3-dark.scss';
@import '../../navigations/appbar/material3-dark.scss';
/*! component's theme wise override definitions and variables */
// layout variables
$field-list-skin: 'Material3' !default;
...
$field-list-title-font-size: 22px !default;
...
$field-list-default-border-radius: 2px !default;
$field-list-drag-clone-border-radius: 2px !default;
...
$field-list-toggle-padding-size: 7px !default;
$field-list-editor-dialog-footer-padding: 8px !default;
$field-list-toggle-size: 30px !default;
$field-list-toggle-bigger-size: 34px !default;
$field-list-member-filter-list-bigger-height: 117px !default;
...
$pivot-calculated-font-weight: normal !default;
$pivot-dialog-content-opacity: .54 !default;
$pivot-dialog-content-padding: 0 !default;
$pivot-dialog-footer-padding: 8px !default;
$pivot-dialog-footer-paddingright: 8px !default;
$field-list-header-height: 36px !default;
$field-list-bigger-header-height: $field-list-header-height !default;
$field-list-tree-outer-div-height: 303px !default;
$field-list-icon-container-size: 20px !default;
$field-list-bigger-icon-container-size: 20px !default;
$field-list-bigger-icon-size: 16px !default;
$field-list-icon-to-text-padding: 8px !default;
$field-list-bigger-icon-to-text-padding: 10px !default;
$field-list-icon-to-icon-padding: 8px !default;
...
$field-list-header-icon-wrapper-padding: 4px !default;
$field-list-bigger-header-icon-wrapper-padding: 7px !default;
$field-list-static-header-icon-wrapper-padding: 5px !default;
$field-list-static-bigger-header-icon-wrapper-padding: 0 !default;
$pivot-calculated-icon-opacity: .87 !default;
$field-list-bigger-button-line-height: 1.1em !default;
$field-list-excel-member-filter-height: 148px !default;
$field-list-excel-member-filter-node-limit-height: 145px !default;
$field-list-excel-filter-height: 244px !default;
$field-list-excel-member-filter-bigger-height: 130px !default;
$field-list-excel-filter-bigger-height: 240px !default;
...
$field-list-editor-label-font: 500 14px $font-family !default;
...
$field-list-static-field-table-height: 202px !default;
$field-list-static-field-table-outer-div-height: 163px !default;
$field-list-search-popup-min-height: 540px !default;
$field-list-search-popup-table-height: 392px !default;
$field-list-search-popup-table-outer-div-height: 303px !default;
$field-list-search-popup-axis-content-height: 154px !default;
$field-list-search-popup-container-bigger-height: 585px !default;
$field-list-search-popup-table-bigger-height: 400px !default;
$field-list-search-popup-axis-table-bigger-height: 400px !default;
$field-list-search-popup-axis-content-bigger-height: 158px !default;
$field-list-axis-content-height: 128px !default;
$field-list-popup-axis-content-bigger-height: $field-list-axis-content-height !default;
$field-list-search-static-field-table-height: 256px !default;
$field-list-filter-toolbar-items-margin: 20px !default;
$field-list-treeview-ul-padding: 4px !default;
$field-list-treeview-li-padding: 2px !default;
$field-list-treeview-bigger-ul-padding: 5px !default;
$field-list-treeview-bigger-li-padding: 0 !default;
$field-list-treeview-mobile-ul-padding: 48px !default;
$field-list-treeview-mobile-li-padding: 0 !default;
$field-list-calc-list-icon: 8px !default;
$field-list-calc-list-icon-rtl: 3px !default;
$pivot-formatting-format-table-data-padding-right: 16px !default;
$field-list-default-header-font-size: $text-xxs !default;
$field-list-header-padding: 18px !default;
$field-list-value-field-caption-font-size: 14px !default;
$field-list-value-field-option-text-font-size: 10px !default;
$field-list-dialog-radius: $shape-small !default;
$field-list-table-header-padding: 0 0 0 $field-list-header-padding !default;
$field-list-table-header-font-weight: 500 !default;
$field-list-calculated-field-border: 1px solid rgba($secondary-outline) !default;
$field-list-calc-dialog-iconspace-margin-right: 8px !default;
$field-list-member-editor-search-padding: 0 15px 10px !default;
$field-list-member-editor-node-limit-outer-div-bigger-height: 100px !default;
$field-list-member-editor-bigger-height: 430px !default;
$field-list-member-editor-node-limit-bigger-height: 455px !default;
$field-list-separator-border: 1px solid rgba($border-light) !default;
$field-list-member-sort-border-radius: $text-xl !default;

// normal variables
$field-list-active-color: rgba($icon-color) !default;
$field-list-default-font-color: rgba($content-text-color) !default;
$field-list-default-formula-font-color: $field-list-default-font-color !default;
$field-list-default-border-color: rgba($border-light) !default;
$field-list-drag-default-border-color: $field-list-default-border-color !default;
$field-list-default-prompt-color: rgba($content-text-color-alt1) !default;
$field-list-toggle-border-color: $transparent !default;
$field-list-table-background-color: $transparent !default;
$field-list-default-bg-color: rgba($content-bg-color) !default;
...
$field-list-toggle-bg-color: rgba($primary-light) !default;
$field-list-toggle-bg-color-dark: $content-bg-color-alt4 !default;
$field-list-default-fill-color: rgba($content-bg-color) !default;
$field-list-drop-hover-color: $grey-500 !default;
$field-list-button-font-color: $grey-900 !default;
$field-list-button-border-color: $transparent !default;
$field-list-button-hover-color: $content-bg-color-hover !default;
$field-list-button-focus-color: $content-bg-color-focus !default;
$field-list-button-active-color: rgba($content-text-color) !default;
$field-list-drag-clone-text-color: rgba($content-text-color, .87) !default;
...
$pivot-formula-background: rgba($content-bg-color) !default;
$pivot-formula-border: rgba($border-light) !default;
$pivot-text-area-background: $base-font !default;
$field-list-drag-icon-color: rgba($icon-color) !default;
$field-list-default-header-font-color: rgba($content-text-color-alt1) !default;
$field-list-tree-icon-color: $field-list-drag-icon-color !default;
$field-list-default-header-icon-font-color: rgba($icon-color) !default;
$field-list-button-icon-color: rgba($icon-color) !default;
$field-list-icon-hover-color: rgba($icon-color-hover) !default;
$field-list-toggle-font-color: rgba($icon-color) !default;
$error-font-color: rgba($danger) !default;
$format-label-font-color: rgba($content-text-color-alt1) !default;
$format-preview-border-color: rgba($icon-color) !default;
$format-outer-border-color: rgba($border-light) !default;
$format-outer-fill-color: rgba($content-bg-color) !default;
$field-list-editor-label-color: rgba($content-text-color) !default;
$field-list-editor-label-fill: $content-bg-color-alt1 !default;
$field-list-back-font-color: rgba($icon-color) !default;
$field-list-mobile-header-color: rgba($content-bg-color) !default;
$field-list-mobile-header-font-color: rgba($content-text-color-alt1) !default;
$field-list-sort-select-background-color: rgba($icon-color) !default;
$field-list-sort-select-border-color: $transparent !default;
$field-list-sort-select-color: rgba($base-font, .87) !default;
$field-list-cal-button-text-color: rgba($secondary-text-color) !default;

/*! component's common definitions and variables */
$field-list-static-padding-size: 20px !default;
...
$field-list-selected-color: ($content-bg-color-hover, .87) !default;
$field-list-button-color: rgba($content-bg-color) !default;
$field-list-button-back-color: rgba($icon-color) !default;
$field-list-header-font-size: $text-sm !default;
$field-list-header-text-transform: none !default;
$field-list-icon-size: 16px !default;
...
$field-list-member-filter-list-height: 160px !default;
$field-list-member-field-list-height: 235px !default;
$field-list-treeview-drag-padding: 6px !default;
$field-list-treeview-drag-margin: 8px !default;
$field-list-treeview-drag-bigger-padding: 8px !default;
$field-list-button-height: 40px !default;
...
$field-list-button-padding: 12px 12px !default;
$field-list-bigger-button-padding: 9px 16px !default;
$field-list-header-icon-size: 16px !default;
$field-list-bigger-header-icon-size: 16px !default;
$field-list-tree-header-padding: 9px !default;
...
$field-list-toggle-left-shadow-color: $shadow-sm !default;
...
$format-preview-height: 32px !default;
$format-preview-width: 80px !default;
$olap-tree-wrapper-height: 489px;
$olap-tree-outer-div-height: 458px;
$olap-bigger-tree-wrapper-height: 521px;
$olap-bigger-tree-outer-div-height: 483px;
...
$field-list-device-footer-button-border-radius: $shape-Large !default;
$field-list-device-footer-button-box-shadow: $shadow-lg !default;
