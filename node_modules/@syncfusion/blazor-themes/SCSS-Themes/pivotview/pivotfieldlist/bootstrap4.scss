...
@import '../../calendars/daterangepicker/bootstrap4.scss';
...
$field-list-skin: 'bootstrap4' !default;
$field-list-active-color: $primary !default;
$field-list-default-font-color: $gray-900 !default;
$field-list-default-formula-font-color: $field-list-default-font-color !default;
$field-list-default-border-color: $gray-300 !default;
$field-list-drag-default-border-color: $field-list-default-border-color !default;
$field-list-default-prompt-color: $gray-600 !default;
$field-list-toggle-border-color: #ccc !default;
...
$field-list-content-font-size: 14px !default;
$field-list-button-font-weight: bold !default;
$field-list-font-family: $font-family !default;
$field-list-header-background-color: $gray-200 !default;
$field-list-axis-header-color: $field-list-header-background-color !default;
$field-list-default-fill-color: $white !default;
$field-list-default-border-radius: 4px !default;
$field-list-drop-hover-color: #999 !default;
$field-list-toggle-bg-color: #f5f5f5 !default;
$field-list-button-font-color: $gray-900 !default;
$field-list-button-border-color: $gray-300 !default;
$field-list-button-back-color: #f5f5f5 !default;
$field-list-drag-clone-text-color: $gray-100 !default;
$field-list-drag-clone-border-radius: 4px !default;
$field-list-editor-dialog-footer-padding: 15px !default;
$field-list-member-filter-list-height: 155px !default;
$field-list-member-filter-list-bigger-height: 128px !default;
...
$field-list-button-font-size: 14px !default;
...
$field-list-toggle-hover-color: #999 !default;
$pivot-formula-background: $white !default;
$pivot-formula-border: $gray-400 !default;
$pivot-text-area-background: #333 !default;
$pivot-calculated-header-opacity: 1 !default;
$pivot-dialog-font-weight: bold !default;
$pivot-dialog-content-opacity: 1 !default;
$pivot-dialog-content-padding: 14px !default;
$pivot-dialog-footer-padding: 16px !default;
$pivot-dialog-footer-paddingright: 16px !default;
...
$field-list-bigger-header-icon-wrapper-padding: 9px !default;
$field-list-static-header-icon-wrapper-padding: 4px !default;
$field-list-static-bigger-header-icon-wrapper-padding: 9px !default;
$field-list-default-header-font-color: $gray-900 !default;
$field-list-tree-icon-color: $gray-700 !default;
$field-list-default-header-icon-font-color: #555 !default;
$field-list-button-hover-color: darken($gray-100, 2%) !default;
$field-list-button-focus-color: darken($gray-100, 4%) !default;
$field-list-button-icon-color: $gray-700 !default;
$field-list-icon-hover-color: #333 !default;
$field-list-treeview-font-weight: bold !default;
$error-font-color: #a94442 !default;
$field-list-excel-member-filter-height: 158px !default;
$field-list-excel-member-filter-node-limit-height: 155px !default;
$field-list-excel-filter-height: 234px !default;
$field-list-excel-member-filter-bigger-height: 120px !default;
...
$format-preview-border-color: $gray-300 !default;
$format-outer-border-color: $gray-300 !default;
$format-outer-fill-color: $white !default;
$format-outer-border-radius: 4px !default;
$format-dialog-width: 625px !default;
$format-dialog-bigger-width: 670px !default;
$field-list-editor-label-padding-size: 17px 10px 16px 20px !default;
$field-list-editor-label-font: 500 13px Helvetica !default;
$field-list-editor-label-opacity: 1 !default;
$field-list-editor-label-color: #333 !default;
$field-list-editor-label-fill: #f8f8f8 !default;
...
$field-list-back-font-color: #333 !default;
$field-list-mobile-header-color: #eee !default;
$field-list-mobile-header-font-color: #333 !default;
$field-list-back-margin: 5px !default;
$field-list-sort-wrapper-padding-size: 10px !default;
$field-list-sort-select-background-color: darken($gray-600, 10%) !default;
...
$field-list-popup-axis-content-bigger-height: 126px !default;
$field-list-search-static-field-table-height: 263px !default;
$field-list-filter-toolbar-items-margin: 20px !default;
$field-list-treeview-ul-padding: 2px !default;
$field-list-treeview-li-padding: 0 !default;
$field-list-treeview-bigger-ul-padding: 1px !default;
$field-list-treeview-bigger-li-padding: 0 !default;
$field-list-treeview-mobile-ul-padding: 42px !default;
$field-list-treeview-mobile-li-padding: 0 !default;
$field-list-calc-list-icon: 8px !default;
$field-list-calc-list-icon-rtl: 4px !default;
$field-list-header-font-size: 13px !default;
$field-list-header-padding: 8px !default;
...
$field-list-table-header-padding: 0 0 0 12px !default;
$field-list-table-header-font-weight: normal !default;
$field-list-calc-dialog-iconspace-margin-right: 13px !default;
...
$field-list-selected-color: rgba($white, .87) !default;
$field-list-button-color: $gray-100 !default;
$field-list-header-text-transform: none !default;
$field-list-icon-size: 14px !default;
$field-list-toggle-icon-size: 17px !default;
$field-list-member-filter-list-padding-size: -25px !default;
...
$field-list-button-padding: 9px 8px !default;
$field-list-bigger-button-padding: 9px 12px !default;
$field-list-header-icon-size: 14px !default;
$field-list-bigger-header-icon-size: 16px !default;
$field-list-bigger-tree-header-padding: 9px !default;
...
$field-list-toggle-font-color: $gray-700 !default;
$field-list-toggle-shadow-color: -1px 1px 4px 0 rgba($black, .12) !default;
$field-list-toggle-left-shadow-color: 1px 1px 4px 0 rgba($black, .12) !default;
$field-list-drag-clone-shadow-color: 0 2px 3px 0 rgba($black, 25%) !default;
...
$field-list-button-active-color: #333 !default;
$field-list-drag-clone-bg-color: rgba($black, .7) !default;
$field-list-drag-icon-color: $gray-500 !default;
$field-list-header-height: 31px !default;
$field-list-tree-outer-div-height: 310px !default;
$field-list-bigger-header-height: 31px !default;
...
$field-list-bigger-icon-to-icon-padding: 8px !default;
$field-list-default-bigger-padding-size: 16px !default;
$field-list-bigger-button-font-size: 16px !default;
