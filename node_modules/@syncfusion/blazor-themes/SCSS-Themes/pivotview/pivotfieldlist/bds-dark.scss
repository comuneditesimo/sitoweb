...
$field-list-excel-member-filter-height: 180px !default;
...
$field-list-toggle-font-color: rgba($content-text-color, .54) !default;
...
$field-list-member-filter-list-height: 164px !default;
