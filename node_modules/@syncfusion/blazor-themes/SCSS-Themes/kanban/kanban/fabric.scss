...
@import '../../layouts/card/fabric.scss';
...
$kanban-default-font-color: $theme-light-font !default;
$kanban-content-font: $neutral-secondary-alt !default;
$kanban-border-color: $neutral-quintenaryalt !default;
$kanban-card-selection-bg-color: $theme-lighter !default;
...
$kanban-icons-color: rgba($theme-light-font, .54) !default;
...
$kanban-swl-frozen-header-row-icon-hover-bg-color: $neutral-quintenaryalt !default;
$kanban-swl-frozen-header-row-icon-focus-bg-color: $neutral-quintenaryalt !default;
...
$kanban-swl-frozen-header-row-icon-hover-color: rgba($theme-light-font, .54) !default;
...
$kanban-collapse-header-text-color: $theme-light-font !default;
...
$kanban-swl-header-icon-hover-background: $neutral-quintenaryalt !default;
...
//Color Start
$kanban-header-text-color: $theme-light-font !default;
$kanban-header-item-count-color: $theme-light-font !default;
$kanban-header-limits-color: inherit !default;
$kanban-col-expand-collapse-bg-color: $neutral-quintenaryalt;
