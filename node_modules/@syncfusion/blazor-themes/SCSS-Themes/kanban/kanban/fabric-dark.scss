...
@import '../../layouts/card/fabric-dark.scss';
...
$kanban-column-bg-color: $neutral-lighter !default;
$kanban-default-font-color: $neutral-light-font !default;
$kanban-content-font: $neutral-secondary-alt !default;
$kanban-border-color: $neutral-quintenaryalt !default;
$kanban-card-selection-bg-color: $neutral-tertiary-alt !default;
$kanban-dropped-clone-bg-color: rgba($theme-primary, .1) !default;
$kanban-dropped-clone-border-color: $theme-primary !default;
$kanban-dragged-clone-border-color: $neutral-quintenaryalt !default;
$kanban-icons-color: $theme-primary-font !default;
$kanban-bg-color: $neutral-white !default;
$kanban-text-area-bg-color: initial !default;
$kanban-text-area-color: $base-font !default;
$kanban-popup-overlay-bg-color: #383838 !default;
$kanban-min-color: #ffe082 !default;
$kanban-max-color: #ffcdd2 !default;
$kanban-header-border-color: $neutral-quintenaryalt !default;
...
$kanban-tags-bg-color: #eceaff !default;
$kanban-tags-color: #3225c9 !default;
...
$kanban-swl-frozen-header-row-icon-padding: 4px 6px !default;
$kanban-swl-frozen-header-row-icon-font-size: 12px !default;
$kanban-swl-frz-head-row-icon-hover-margin: 0 0 0 8px !default;
$kanban-swl-frz-header-row-icon-hover-padding: 4px 6px !default;
$kanban-swl-frozen-header-row-icon-hover-bg-color: $neutral-light !default;
$kanban-swl-frozen-header-row-icon-focus-bg-color: $neutral-light !default;
...
$kanban-swl-frozen-header-row-icon-hover-color: $theme-primary-font !default;
...
$kanban-stacked-header-cell-border-btm: 1px solid $neutral-quintenaryalt !default;
...
$kanban-collapse-header-text-color: $neutral-light-font !default;
...
$kanban-card-selection-border: 1px solid $neutral-quintenaryalt !default;
...
$kanban-multi-card-text-bg-color: $neutral-white !default;
...
$kanban-target-dragged-clone-bg-color: $neutral-lighter !default;
...
$kanban-swl-header-icon-padding: 4px 6px !default;
...
$kanban-swl-header-icon-hover-color: $kanban-icons-color !default;
$kanban-swl-header-icon-hover-margin: 0 0 0 8px !default;
$kanban-swl-header-icon-hover-padding: 4px 6px !default;
$kanban-swl-header-icon-hover-font-size: 12px !default;
$kanban-swl-header-icon-hover-background: $neutral-light !default;
...
//Color Start
$kanban-header-text-color: $neutral-light-font !default;
$kanban-header-item-count-color: $neutral-light-font !default;
$kanban-header-limits-color: inherit !default;
$kanban-col-expand-collapse-bg-color: $neutral-light;
$kanban-col-expand-collapse-color: $kanban-icons-color;
