...
@import '../../layouts/card/material-dark.scss';
...
$kanban-column-bg-color:  rgba($grey-black, 16%) !default;
$kanban-default-font-color: $grey-dark-font !default;
$kanban-content-font: rgba($grey-white, .7) !default;
$kanban-border-color: $grey-500 !default;
$kanban-card-selection-bg-color: $grey-600 !default;
$kanban-dropped-clone-bg-color: rgba($primary, .1) !default;
$kanban-dropped-clone-border-color: $primary !default;
$kanban-dragged-clone-border-color: $grey-500 !default;
$kanban-icons-color: rgba($grey-light-font, .54) !default;
$kanban-bg-color: $grey-dark !default;
$kanban-text-area-bg-color: initial !default;
$kanban-text-area-color: $grey-white !default;
$kanban-popup-overlay-bg-color: #383838 !default;
$kanban-min-color: #ffe082 !default;
$kanban-max-color: #ffcdd2 !default;
$kanban-header-border-color: $grey-300 !default;
...
$kanban-swl-frozen-header-row-icon-hover-bg-color: rgba($grey-white, .1) !default;
$kanban-swl-frozen-header-row-icon-focus-bg-color: rgba($grey-white, .1) !default;
...
$kanban-swl-frozen-header-row-icon-hover-color: rgba($grey-light-font, .54) !default;
...
$kanban-stacked-header-cell-border-btm: 1px solid $grey-500 !default;
...
$kanban-collapse-header-text-color: rgba($grey-light-font, .87) !default;
...
$kanban-card-border: 1px solid transparent !default;
...
$kanban-card-tag-border-radius: 12px !default;
...
$kanban-card-focus-border: 1px solid $grey-300 !default;
...
$kanban-target-dragged-clone-bg-color: $grey-100 !default;
...
$kanban-swl-header-icon-hover-background: rgba($grey-white, .1) !default;
...
$kanban-content-cells-focus-border: 1px solid $grey-300;
...
//Color Start
$kanban-header-text-color: $grey-dark-font !default;
$kanban-header-item-count-color: $grey-300 !default;
$kanban-header-limits-color: inherit !default;
$kanban-col-expand-collapse-bg-color: rgba($grey-white, .1);
