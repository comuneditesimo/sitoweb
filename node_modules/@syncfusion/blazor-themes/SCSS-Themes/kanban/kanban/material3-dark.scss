...
@import '../../layouts/card/material3-dark.scss';
...
$kanban-text-base: $text-sm !default;
$kanban-mb-popup-container-box-shadow: $shadow-md !default;

//Layout Variables End
//Theme Variables Start
$kanban-column-bg-color: $content-bg-color-alt1 !default;
$kanban-default-font-color: rgba($content-text-color) !default;
$kanban-content-font: rgba($content-text-color) !default;
$kanban-border-color: $border-dark !default;
$kanban-dialog-text-areas-border-color: rgba($border) !default;
$kanban-card-selection-bg-color: rgba($content-bg-color) !default;
$kanban-dropped-clone-bg-color: rgba($primary-lighter) !default;
$kanban-dropped-clone-border-color: rgba($primary) !default;
$kanban-dragged-clone-border-color: $border-dark !default;
$kanban-icons-color: rgba($icon-color) !default;
$kanban-bg-color: rgba($content-bg-color) !default;
$kanban-card-bg-color: $content-bg-color-alt1 !default;
$kanban-text-area-bg-color: initial !default;
$kanban-text-area-color: rgba($content-text-color-alt1) !default;
$kanban-popup-overlay-bg-color: $overlay-bg-color !default;
$kanban-min-color: rgba($warning-light) !default;
$kanban-max-color: rgba($danger-light-alt) !default;
$kanban-header-border-color: $gray-300 !default;
$kanban-tags-bg-color: $content-bg-color-alt1 !default;
$kanban-tags-color: rgba($content-text-color) !default;
...
$kanban-swl-frozen-header-item-count-color: rgba($on-secondary-container) !default;
$kanban-swl-frozen-header-row-icon-border: 1px solid transparent !default;
$kanban-swl-frozen-header-row-icon-height: 18px !default;
...
$kanban-swl-frozen-header-row-icon-hover-color: rgba($white) !default;
$kanban-swl-frozen-header-row-icon-focus-box-shadow: $secondary-shadow-focus !default;
$kanban-header-cell-height: 40px !default;
$kanban-header-cell-bgr-height: 44px !default;
$kanban-header-cell-padding: 8px !default;
$kanban-stacked-header-cell-border-btm: 1px solid rgba($border) !default;
...
$kanban-collapse-header-text-color: rgba($content-text-color) !default;
...
$kanban-empty-card-color: $content-bg-color-alt2 !default;
...
$kanban-card-border: 1px solid rgba($border-light) !default;
$kanban-card-border-radius: 8px !default;
$kanban-card-normal-box-shadow: $shadow-md !default;
...
$kanban-color-card-border-left: 2px solid rgba($success-dark) !default;
$kanban-color-card-hover-border: 1px solid $content-text-color-disabled !default;
$kanban-color-card-hover-border-left: 2px solid rgba($success-dark) !default;
$kanban-color-card-hover-box-shadow: $shadow-md !default;
$kanban-color-card-focus-border: 1px solid $border-dark !default;
$kanban-color-card-focus-border-left: 2px solid rgba($success-dark) !default;
$kanban-color-card-tags-padding: 8px 14px 0 12px !default;
$kanban-card-tags-padding: 12px 12px 0 !default;
$kanban-color-card-selection-border: 1px solid rgba($primary) !default;
$kanban-color-card-selection-border-left: 2px solid rgba($success-dark) !default;
$kanban-color-card-selection-box-shadow: $kanban-card-normal-box-shadow !default;
$kanban-color-card-selection-hover-border: 1px solid rgba($primary) !default;
$kanban-color-card-selection-hover-border-left: 2px solid rgba($success-dark) !default;
...
$kanban-card-selection-border: 1px solid rgba($primary) !default;
$kanban-card-selection-box-shadow: $kanban-card-normal-box-shadow !default;
$kanban-card-selection-hover-border: 1px solid rgba($primary) !default;
...
$kanban-card-tag-border-radius: 2px !default;
...
$kanban-multi-card-text-bg-color: rgba($content-bg-color) !default;
$kanban-target-drag-drop-clone-margin-bottom: 12px !default;
$kanban-target-drag-drop-clone-bgr-margin-bottom: 16px !default;
$kanban-target-drag-drop-clone-border-radius: 6px !default;
...
$kanban-swl-header-icon-height: 16px !default;
...
$kanban-swl-header-icon-hover-color: rgba($primary) !default;
...
$kanban-swl-header-icon-hover-border-radius: 1px !default;
$kanban-swl-header-icon-hover-box-shadow: $secondary-shadow-focus !default;
$kanban-swl-header-text-line-height: $leading-normal !default;
$kanban-swl-header-text-bgr-line-height: $leading-normal !default;
$kanban-swl-header-text-padding: 0 0 0 8px !default;
$kanban-swl-header-text-bgr-font-size: $text-base !default;
$kanban-swl-header-item-count-font-size: $text-xs !default;
$kanban-swl-header-item-count-line-height: 20px !default;
$kanban-swl-header-item-count-font-opacity: .8 !default;
$kanban-swl-header-item-count-padding: 1px 2px !default;
$kanban-swl-header-item-count-color: rgba($on-secondary-container) !default;
$kanban-swl-header-item-count-font-weight: $font-weight-medium !default;
$kanban-swl-header-item-count-bgr-font-size: $text-xs !default;
$kanban-swl-header-item-count-bgr-line-height: $leading-normal !default;
$kanban-swl-header-item-count-bgr-padding: 5px !default;
$kanban-content-cells-focus-border: 1px solid $transparent !default;
$kanban-content-cells-focus-box-shadow: $shadow-focus-ring1 !default;
$kanban-mb-swl-name-font-size: $text-base !default;
$kanban-mb-swl-name-padding: 5px !default;
$kanban-mb-swl-name-color: inherit !default;
$kanban-mb-swl-name-font-weight: $font-weight-medium !default;
$kanban-mb-swl-name-line-height: $leading-normal !default;
$kanban-mb-swl-menu-icon-font-size: $text-lg !default;
$kanban-mb-swl-menu-icon-bgr-font-size: $text-xl !default;
$kanban-mb-swl-menu-icon-color: inherit !default;
$kanban-mb-swl-overlay-opacity: 1 !default;
$kanban-dialog-form-table-td-line-height: $leading-normal !default;
$kanban-dialog-form-table-td-opacity: 1 !default;
$kanban-dialog-form-table-td-padding: 8px 0 !default;
$kanban-dialog-form-table-td-color: rgba($content-text-color-alt1) !default;
$kanban-dialog-form-table-td-font-weight: $font-weight-medium !default;
$kanban-mb-popup-content-padding: 5px !default;
$kanban-mb-popup-content-color: inherit !default;
$kanban-dialog-text-area-focus-shadow: $shadow-lg !default;

//Color Start
$kanban-header-text-color: rgba($content-text-color) !default;
$kanban-header-item-count-color: rgba($content-text-color) !default;
$kanban-header-limits-color: rgba($content-text-color) !default;
$kanban-col-expand-collapse-bg-color: none !default;
$kanban-col-expand-collapse-color: rgba($primary) !default;
$kanban-col-expand-collapse-border: 1px solid $transparent !default;
$kanban-col-expand-collapse-box-shadow: $secondary-shadow-focus !default;
