...
@import '../../layouts/card/fluent-dark.scss';
...
$kanban-icons-border-radius: $model-radius !default;
...
$kanban-dialog-text-area-focus-shadow: $shadow-md !default;
$kanban-dialog-text-areas-border-color: $primary-border-color !default;
$kanban-card-selection-bg-color: $flyout-bg-color !default;
...
$kanban-icons-color: $icon-color !default;
$kanban-bg-color: $content-bg-color !default;
$kanban-card-bg-color: $flyout-bg-color !default;
$kanban-text-area-bg-color: $content-bg-color !default;
$kanban-text-area-color: $content-text-color-alt1 !default;
$kanban-popup-overlay-bg-color: $overlay-bg-color !default;
$kanban-min-color: $warning-light-alt !default;
$kanban-max-color: $danger-light-alt !default;
$kanban-header-border-color: $border-light !default;
$kanban-tags-bg-color: $content-bg-color-alt3 !default;
$kanban-tags-color: $content-text-color !default;
$kanban-card-selection-box-shadow: $shadow-md !default;
$kanban-border-color: $border-dark !default;
$kanban-mb-popup-container-box-shadow: $shadow-xl !default;
$kanban-table-border-spacing: 10px 1px !default;
$kanban-table-bigger-border-spacing: 10px 2px !default;
...
$kanban-frozen-swimlane-row-padding: 12px 0 0 0 !default;
$kanban-frozen-swimlane-row-bgr-padding: 13px 0 0 0 !default;
...
$kanban-frozen-swl-row-head-item-count-bgr-font-size: $text-sm !default;
$kanban-frozen-swl-row-head-item-count-line-height: $leading-tight !default;
$kanban-frozen-swl-row-head-item-count-bgr-line-height: $leading-normal !default;
$kanban-frozen-swl-row-head-item-count-padding: 3px 0 0 4px !default;
$kanban-frozen-swl-row-head-item-count-bgr-padding: 4px 0 0 4px !default;
$kanban-frozen-swl-row-head-item-count-opacity: 1 !default;
...
$kanban-swl-frozen-header-row-icon-padding: 3px 6px !default;
$kanban-swl-frozen-header-row-icon-font-size: $text-base !default;
$kanban-swl-frz-head-row-icon-hover-margin: 0 0 0 8px !default;
$kanban-swl-frz-header-row-icon-hover-padding: 3px 6px !default;
$kanban-swl-frozen-header-row-icon-hover-bg-color: $content-bg-color-alt2 !default;
$kanban-swl-frozen-header-row-icon-focus-bg-color: $content-bg-color-alt3 !default;
...
$kanban-swl-frozen-header-row-icon-hover-color: $icon-color !default;
$kanban-header-cell-height: 42px !default;
$kanban-header-cell-bgr-height: 48px !default;
$kanban-header-cell-padding: 10px 12px !default;
$kanban-stacked-header-cell-border-btm: 1px solid $border-light !default;
$kanban-toggle-header-icon-font-size: $text-base !default;
$kanban-toggle-header-icon-bgr-font-size: $text-base !default;
$kanban-toggle-header-expand-icon-padding: 6px !default;
$kanban-toggle-header-collapse-icon-padding: 6px !default;
$kanban-toggle-header-collapse-width: 42px !default;
$kanban-header-text-font-size: $text-sm !default;
$kanban-header-text-font-weight: $font-weight-medium !default;
...
$kanban-header-text-bgr-line-height: $leading-relaxed !default;
$kanban-header-text-bgr-transform: capitalize !default;
$kanban-header-item-count-font-size: $text-xs !default;
$kanban-header-item-count-font-weight: $font-weight-medium !default;
$kanban-header-item-count-line-height: $leading-normal !default;
$kanban-header-item-count-opacity: 1 !default;
$kanban-header-item-count-margin-top: 2px !default;
$kanban-header-item-count-text-transform: capitalize !default;
$kanban-header-item-count-bgr-font-size: $text-sm !default;
$kanban-header-item-count-bgr-font-weight: $font-weight-medium !default;
$kanban-header-item-count-bgr-line-height: $leading-relaxed !default;
$kanban-header-item-count-bgr-margin-top: 2px !default;
...
$kanban-collapse-header-text-font-size: $text-sm !default;
$kanban-collapse-header-text-font-weight: $font-weight-medium !default;
$kanban-collapse-header-text-padding: 12px 10px !default;
$kanban-collapse-header-text-transform: capitalize !default;
...
$kanban-empty-card-padding: 50px 0 !default;
$kanban-empty-card-color: $content-text-color-alt3 !default;
...
$kanban-card-border-radius: $model-radius !default;
$kanban-card-normal-box-shadow: $shadow-sm !default;
$kanban-card-header-padding: 16px 16px 0 !default;
$kanban-card-header-bgr-padding: 20px 20px 0 !default;
$kanban-color-card-header-padding: 16px 16px 0 16px !default;
$kanban-color-card-header-bgr-padding: 20px 20px 0 20px !default;
$kanban-card-header-title-font-size: $text-sm !default;
$kanban-card-header-title-line-height: $leading-normal !default;
...
$kanban-card-footer-padding: 0 16px 16px !default;
$kanban-card-footer-bgr-padding: 0 20px 20px !default;
$kanban-color-card-footer-padding: 0 16px 16px 16px !default;
$kanban-color-card-footer-bgr-padding: 0 20px 20px 20px !default;
$kanban-card-content-font-size: $text-sm !default;
$kanban-card-content-line-height: $leading-normal !default;
$kanban-card-content-padding: 4px 16px 16px 16px !default;
$kanban-color-card-content-padding: 4px 16px 16px 16px !default;
$kanban-card-content-bgr-font-size: $text-base !default;
$kanban-card-content-bgr-line-height: $leading-normal !default;
$kanban-card-content-bgr-padding: 8px 20px 20px 20px !default;
$kanban-color-card-content-bgr-padding: 8px 20px 20px 20px !default;
$kanban-color-card-tags-padding: 0 16px 16px 16px !default;
$kanban-card-tags-padding: 0 16px 16px !default;
$kanban-color-card-border: 1px solid $transparent !default;
$kanban-color-card-border-left: 3px solid !default;
$kanban-color-card-hover-border: 1px solid $transparent !default;
...
$kanban-color-card-selection-box-shadow: $shadow-md !default;
...
$kanban-color-card-selection-hover-box-shadow: $shadow-lg !default;
...
$kanban-card-selection-hover-box-shadow: $shadow-lg !default;
$kanban-card-selection-hover-padding: 0 !default;
$kanban-card-hover-border: 1px solid $transparent !default;
$kanban-card-normal-hover-box-shadow: $shadow-lg !default;
$kanban-card-focus-border: 1px solid $primary !default;
$kanban-card-tag-border-radius: $model-radius !default;
$kanban-card-tag-font-size: $text-sm !default;
$kanban-card-tag-line-height: $leading-normal !default;
...
$kanban-target-drag-drop-clone-border-radius: $model-radius !default;
$kanban-target-dragged-clone-bg-color: $content-bg-color-alt2 !default;
$kanban-swl-row-height: 42px !default;
...
$kanban-swl-header-icon-color: $icon-color !default;
...
$kanban-swl-header-icon-font-size: $text-base !default;
$kanban-swl-header-icon-bgr-font-size: $text-base !default;
$kanban-swl-header-icon-hover-padding: 4px 6px !default;
$kanban-swl-header-icon-hover-font-size: $text-base !default;
$kanban-swl-header-icon-hover-margin: 0 0 0 8px !default;
$kanban-swl-header-icon-hover-border: 1px solid $transparent !default;
$kanban-swl-header-icon-hover-color: $icon-color !default;
$kanban-swl-header-icon-hover-background: $content-bg-color-alt2 !default;
$kanban-swl-header-icon-hover-border-radius: $model-radius !default;
...
$kanban-swl-header-item-count-bgr-font-size: $text-sm;
$kanban-swl-header-item-count-line-height: $leading-tight;
$kanban-swl-header-item-count-font-opacity: 1;
$kanban-swl-header-item-count-padding: 5px 2px 2px 2px;
...
$kanban-swl-header-item-count-bgr-padding: 4px 2px 2px 2px;
...
$kanban-dialog-form-table-td-color: $content-text-color-alt2;
$kanban-dialog-form-table-td-font-weight: $font-weight-medium;
$kanban-mb-swl-name-font-size: $text-base;
$kanban-mb-swl-name-padding: 6px;
$kanban-mb-swl-name-color: $content-text-color;
$kanban-mb-swl-name-font-weight: $font-weight-normal;
$kanban-mb-swl-name-line-height: $leading-normal;
$kanban-mb-swl-menu-icon-font-size: 15px;
$kanban-mb-swl-menu-icon-bgr-font-size: $text-lg;
$kanban-mb-swl-menu-icon-color: $icon-color;
...
$kanban-col-expand-collapse-bg-color: $content-bg-color-alt3;
