...
@import '../../layouts/card/bds-dark.scss';
...
$kanban-column-bg-color: $content-bg-color-alt2 !default;
...
$kanban-dialog-text-areas-border-color: $cool-gray-300 !default;
$kanban-card-selection-bg-color: $content-bg-color-alt2 !default;
...
$kanban-icons-color: $cool-gray-500 !default;
...
$kanban-min-color: $warning-light !default;
$kanban-max-color: $danger-light !default;
$kanban-header-border-color: $cool-gray-300 !default;
...
$kanban-table-border-spacing: 8px 0 !default;
$kanban-table-swimlane-border-spacing: $kanban-table-border-spacing !default;
$kanban-table-bigger-border-spacing: 12px 0 !default;
...
$kanban-frozen-swl-row-head-item-count-font-size: $text-xxs !default;
...
$kanban-swl-frozen-header-row-icon-padding: 0 !default;
$kanban-swl-frozen-header-row-icon-font-size: $text-lg !default;
$kanban-swl-frz-head-row-icon-hover-margin: 1px !default;
$kanban-swl-frz-header-row-icon-hover-padding: 0 !default;
$kanban-swl-frozen-header-row-icon-hover-bg-color: $transparent !default;
$kanban-swl-frozen-header-row-icon-focus-bg-color: $transparent !default;
$kanban-swl-frozen-header-row-icon-hover-border: 1px solid $transparent !default;
$kanban-swl-frozen-header-row-icon-hover-box-shadow: $shadow-focus-ring1 !default;
$kanban-swl-frozen-header-row-icon-hover-color: $primary !default;
$kanban-swl-frozen-header-row-icon-focus-box-shadow: $shadow-focus-ring1 !default;
$kanban-header-cell-height: 42px !default;
$kanban-header-cell-bgr-height: 48px !default;
$kanban-header-cell-padding: 12px !default;
$kanban-header-cell-bgr-padding: 16px !default;
$kanban-stacked-header-cell-border-btm: 1px solid $border !default;
$kanban-toggle-header-icon-font-size: $text-lg !default;
$kanban-toggle-header-icon-bgr-font-size: $text-xl !default;
$kanban-toggle-header-expand-icon-padding: 0 !default;
$kanban-toggle-header-collapse-icon-padding: 0 !default;
...
$kanban-header-text-bgr-font-size: $text-sm !default;
...
$kanban-header-item-count-text-transform: uppercase !default;
...
$kanban-header-item-count-bgr-text-transform: uppercase !default;
$kanban-header-min-max-count-font-size: $text-xxs !default;
$kanban-header-min-max-count-font-weight: $font-weight-medium !default;
$kanban-header-min-max-count-opacity: 1 !default;
$kanban-collapse-header-text-color: $content-text-color-alt2 !default;
...
$kanban-card-border-radius: 6px !default;
$kanban-card-normal-box-shadow: $shadow !default;
$kanban-card-header-padding: 18px 18px 0 !default;
$kanban-card-header-bgr-padding: 24px 24px 0 !default;
$kanban-color-card-header-padding: 18px 18px 0 18px !default;
$kanban-color-card-header-bgr-padding: 24px 24px 0 24px !default;
...
$kanban-card-footer-padding: 8px 18px !default;
$kanban-card-footer-bgr-padding: 0 24px 12px !default;
$kanban-color-card-footer-padding: 8px 18px 18px 18px !default;
$kanban-color-card-footer-bgr-padding: 0 24px 12px 24px !default;
$kanban-card-content-font-size: $text-sm !default;
$kanban-card-content-line-height: $leading-relaxed !default;
$kanban-card-content-padding: 12px 18px !default;
$kanban-color-card-content-padding: 12px 18px 8px 18px !default;
...
$kanban-color-card-content-bgr-padding: 8px 24px 12px 24px !default;
...
$kanban-color-card-selection-border: 1px solid $border-light !default;
$kanban-color-card-selection-border-left: 2px solid !default;
$kanban-color-card-selection-box-shadow: $shadow !default;
...
$kanban-card-selection-border: 1px solid $border-light !default;
$kanban-card-selection-box-shadow: $shadow !default;
...
$kanban-swl-row-header-bgr-padding: 16px !default;
...
$kanban-swl-header-icon-font-size: $text-lg !default;
...
$kanban-swl-header-icon-hover-color: $primary !default;
$kanban-swl-header-icon-hover-margin: 1px !default;
$kanban-swl-header-icon-hover-padding: 0 !default;
$kanban-swl-header-icon-hover-font-size: $text-lg !default;
...
$kanban-swl-header-icon-hover-box-shadow: $shadow-focus-ring1 !default;
...
$kanban-swl-header-item-count-font-size: $text-xxs;
$kanban-swl-header-item-count-line-height: $leading-relaxed;
$kanban-swl-header-item-count-font-opacity: 1;
$kanban-swl-header-item-count-padding: 3px;
$kanban-swl-header-item-count-color: $content-text-color-alt3;
...
$kanban-swl-header-item-count-bgr-padding: 4px;
$kanban-content-cells-focus-border: 1px solid $transparent;
$kanban-content-cells-focus-box-shadow: $shadow-lg;
...
//Color Start
$kanban-header-text-color: $content-text-color-alt2 !default;
