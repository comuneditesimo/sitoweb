...
@import '../../layouts/card/bootstrap4.scss';
...
$kanban-column-bg-color: darken($gray-100, 2%) !default;
$kanban-border-color: $gray-300 !default;
$kanban-default-font-color: $gray-900 !default;
$kanban-content-font: $gray-800 !default;
$kanban-card-selection-bg-color: $gray-200 !default;
$kanban-dropped-clone-bg-color: rgba($primary, .1) !default;
$kanban-dropped-clone-border-color: $primary !default;
$kanban-dragged-clone-border-color: $gray-400 !default;
$kanban-icons-color: $gray-600 !default;
$kanban-bg-color: $white !default;
$kanban-text-area-bg-color: initial !default;
$kanban-text-area-color: $gray-700 !default;
...
$kanban-icons-border-radius: 4px !default;
$kanban-border-hover-color: darken($gray-600, 12.5%) !default;
...
$kanban-swl-frozen-header-row-icon-hover-bg-color: darken($gray-600, 7.5%) !default;
$kanban-swl-frozen-header-row-icon-focus-bg-color: darken($gray-600, 7.5%) !default;
$kanban-swl-frozen-header-row-icon-hover-border: 1px solid darken($gray-600, 12.5%) !default;
$kanban-swl-frozen-header-row-icon-hover-box-shadow: none !default;
$kanban-swl-frozen-header-row-icon-hover-color: $primary-font !default;
...
$kanban-stacked-header-cell-border-btm: 1px solid $gray-300 !default;
...
$kanban-collapse-header-text-color: $gray-900 !default;
...
$kanban-card-border-radius: 4px !default;
...
$kanban-color-card-hover-border-left: 3px solid !default;
...
$kanban-card-tag-border-radius: 4px !default;
...
$kanban-multi-card-text-bg-color: $white !default;
...
$kanban-target-dragged-clone-bg-color: darken($gray-100, 2%) !default;
...
$kanban-swl-header-icon-hover-border: 1px solid darken($gray-600, 12.5%) !default;
$kanban-swl-header-icon-hover-color: $primary-font !default;
...
$kanban-swl-header-icon-hover-background: darken($gray-600, 7.5%) !default;
...
//Color Start
$kanban-header-text-color: $gray-900 !default;
$kanban-header-item-count-color: $gray-900 !default;
$kanban-header-limits-color: inherit !default;
$kanban-col-expand-collapse-bg-color: darken($gray-600, 7.5%);
$kanban-col-expand-collapse-color: $primary-font;
$kanban-col-expand-collapse-border: 1px solid darken($gray-600, 12.5%);
