...
$drop-down-btn-color: $content-font !default;
$drop-down-btn-disable-text: $disable !default;
...
$drop-down-btn-li-border-color: $hover-border !default;
...
$drop-down-btn-li-box-shadow: 0 0 0 1px $border-fg inset !default;
$drop-down-btn-li-selection-bgcolor: $selection-bg !default;
$drop-down-btn-li-selection-font-color: $content-font !default;
$drop-down-btn-max-width: 240px !default;
$drop-down-btn-menu-icon-bigger-font-size: 18px !default;
$drop-down-btn-menu-icon-color: $content-font !default;
$drop-down-btn-menu-icon-disabled-color: $disable !default;
$drop-down-btn-menu-icon-font-size: 16px !default;
$drop-down-btn-min-width: 120px !default;
$drop-down-btn-parent-ul-box-shadow: 0 6px 12px rgba($bg-base-0, .175) !default;
$drop-down-btn-seperator-padding: 0 !default;
$drop-down-btn-selected-color: $selection-font !default;
$drop-down-btn-ul-bgcolor: $bg-base-0 !default;
$drop-down-btn-ul-border: 1px solid $border-default !default;
