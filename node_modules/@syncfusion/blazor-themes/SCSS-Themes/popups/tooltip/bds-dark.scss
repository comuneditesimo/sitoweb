...
$tooltip-close-icon-border: 1px solid $border !default;
...
$tooltip-mobile-horizontal-padding: 8px !default;
$tooltip-mobile-vertical-padding: 12px !default;
...
$tooltip-icon-bg-hover: $secondary-bg-color !default;
$tooltip-icon-border-color: $border !default;
