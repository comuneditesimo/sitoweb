...
$tooltip-content-bg-color: $grey-dark-font !default;
$tooltip-content-border-color: $grey-99 !default;
$tooltip-content-font-color: $grey-base !default;
$tooltip-default-icon-color: $grey-dark-font !default;
$tooltip-icon-bg-normal: $grey-base !default;
$tooltip-hover-icon-color: $grey-cc !default;
$tooltip-icon-bg-hover: $grey-base !default;
$tooltip-font-size: 12px !default;
$tooltip-mobile-font-size: 13px !default;
...
$tooltip-mobile-vertical-padding: 10px !default;
$tooltip-line-height: 17px !default;
$tooltip-arrow-icon-font-size: 16px !default;
$tooltip-icon-border-color: $grey-base !default;
