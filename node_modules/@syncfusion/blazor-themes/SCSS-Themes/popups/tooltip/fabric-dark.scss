...
$tooltip-shadow-color: rgba(0, 0, 0, .3) !default;
$tooltip-drop-shadow: drop-shadow(0 6px 10px $tooltip-shadow-color) !default;
$tooltip-content-bg-color: $neutral-dark !default;
$tooltip-content-border-color: $neutral-dark !default;
$tooltip-content-font-color:  $grey-dark-font !default;
$tooltip-default-icon-color: $neutral-dark !default;
$tooltip-icon-bg-normal: $neutral-light !default;
$tooltip-hover-icon-color: $neutral-light-font !default;
$tooltip-icon-bg-hover: $neutral-light !default;
...
$tooltip-icon-border-color: $neutral-light !default;
