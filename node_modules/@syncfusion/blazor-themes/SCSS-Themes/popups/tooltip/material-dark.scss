...
$tooltip-content-bg-color: $grey-200 !default;
$tooltip-content-border-color: $grey-200 !default;
$tooltip-content-font-color: $grey-light-font !default;
$tooltip-default-icon-color: $grey-200 !default;
$tooltip-icon-bg-normal: $grey-dark !default;
$tooltip-hover-icon-color: $grey-400 !default;
$tooltip-icon-bg-hover: $grey-dark !default;
...
$tooltip-icon-border-color: $grey-200 !default;
