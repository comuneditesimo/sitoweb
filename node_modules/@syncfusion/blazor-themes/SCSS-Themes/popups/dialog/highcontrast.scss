...
$dialog-border: 1px solid $border-default !default;
...
$dialog-hover-icon-color: $selection-font !default;
$dialog-icon-bg-normal: $content-font !default;
$dialog-header-bg-color: $bg-base-0 !default;
$dialog-content-bg-color: $bg-base-0 !default;
$dialog-footer-bg-color: $bg-base-0 !default;
$dialog-shadow-color: 0 0 5px rgba($shadow, .4) !default;
$dialog-header-font-size: 21px !default;
$dialog-header-font-weight: 100 !default;
$dialog-header-font-color: $content-font !default;
...
$dialog-content-font-color: $content-font !default;
...
$dialog-closeicon-btn-hover-color: $selection-font !default;
...
$dialog-hover-focus-btn-bg-color: $selection-bg !default;
$dialog-active-btn-bg-color: $selection-bg !default;
