...
$dialog-close-icon-font-size: $text-sm !default;
$dialog-bigger-close-icon-font-size: $text-base !default;
...
$dialog-header-icon-hover-border-radius: $model-radius-small !default;
...
$dialog-content-padding: 24px 24px 0 24px !default;
...
$dialog-bigger-header-content-padding: 20px 20px 24px 28px !default;
$dialog-bigger-content-padding: 28px 28px 0 28px !default;
$dialog-bigger-content-margin-bottom: 14px !default;
$dialog-bigger-footer-content-padding: 28px !default;
...
$dialog-bigger-close-button-left: 10px !default;
...
$dialog-device-content-font-size: $text-lg !default;
...
$dialog-shadow-color: $shadow-xl !default;
...
$dialog-hover-focus-btn-bg-color: $content-bg-color-alt2 !default;
$dialog-active-btn-bg-color: $content-bg-color-alt3 !default;
...
$dialog-header-btn-padding: 4px 9px !default;
$dialog-bigger-header-btn-padding: 4px 8px !default;
...
@include export-module('dialog-fluent-icons') {
  .e-dialog {
