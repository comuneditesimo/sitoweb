...
$dialog-header-border: 0 !default;
...
$footer-content-border-radius: 12px !default;
$header-content-border-radius: 12px !default;
...
$dialog-border-radius: 12px !default;
...
$dialog-header-content-padding: 20px 20px 0 20px !default;
$dialog-content-padding: 20px 20px 8px 20px !default;
$dialog-footer-content-padding: 20px 20px 20px 20px !default;
$dialog-footer-content-border-top: none !default;
$dialog-alert-footer-content-border-top: none !default;
$dialog-bigger-header-content-padding: 24px 24px 0 24px !default;
$dialog-bigger-content-padding: 24px 24px 8px 24px !default;
$dialog-bigger-footer-content-padding: 24px 24px 24px 24px !default;
...
$dialog-close-icon-width: 10px !default;
$dialog-bigger-close-icon-height: 10px !default;
$dialog-bigger-close-icon-width: 10px !default;
...
$dialog-bigger-close-button-height: 10px !default;
$dialog-bigger-close-button-left: 7px !default;
$dialog-bigger-close-button-width: 10px !default;
...
$dialog-active-icon-color: $icon-color-hover !default;
$dialog-hover-icon-color: $icon-color-hover !default;
$dialog-icon-bg-normal: $transparent !default;
$dialog-header-bg-color: $content-bg-color !default;
$dialog-content-bg-color: $content-bg-color !default;
$dialog-footer-bg-color: $content-bg-color !default;
...
$dialog-footer-btn-bg-color: $primary;
$dialog-footer-btn-color: $primary-text-color;
...
@include export-module('dialog-bds-icons') {
  .e-dialog {
