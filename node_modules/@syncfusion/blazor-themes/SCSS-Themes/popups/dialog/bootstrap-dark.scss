...
//default
$dialog-bg-color: $grey-base !default;
$dialog-icon-color: $grey-cc !default;
...
$dialog-header-border: 1px solid $grey-99 !default;
$dialog-hover-icon-color: $grey-dark-font !default;
$dialog-icon-bg-normal: transparent !default;
$dialog-header-bg-color: $grey-base !default;
$dialog-content-bg-color: $grey-base !default;
$dialog-footer-bg-color: $grey-base !default;
$dialog-shadow-color: 0 6px 12px rgba($base-font, .5) !default;
$dialog-header-font-color: $grey-dark-font !default;
$dialog-border: 1px solid $grey-99 !default;
$dialog-content-font-color: $grey-dark-font !default;
$dialog-overlay-bg-color: rgba($shadow, .8) !default;
$dialog-closeicon-btn-hover-color: transparent !default;
$dialog-closeicon-btn-active-color: transparent !default;
$dialog-footer-content-border-top: 1px solid $grey-99 !default;
$dialog-alert-footer-content-border-top: 1px solid $grey-99 !default;
...
$dialog-close-icon-content: '\e361' !default;
