...
//default
$treegrid-right-arrow-icon: '\e22f' !default;
$treegrid-toolbar-expand-icon: '\e558' !default;
$treegrid-toolbar-collapse-icon: '\e557' !default;
$treegrid-right-arrow-icon-color: $grey-dark-font !default;
...
$treegrid-right-arrow-hover-color: $grey-dark-font !default;
$treegrid-toolbar-indent-icon: '\e33f' !default;
$treegrid-toolbar-outdent-icon: '\e35d' !default;
$treegrid-rowdrag-childborder-border: 1px solid $brand-primary !default;
$childborder-color: $brand-primary;
...
$treegrid-rowdd-topbottom-border: 1px solid #0070f0 !default;
$treegrid-rowdd-boxshadow:  #0070f0 !default;
...
@include export-module('treegrid-bootstrap-dark-icons') {
  #{&}.e-treegrid,
  .e-grid-menu {
    .e-indent::before {
      content: '\e33f';
