...
//default
$treegrid-right-arrow-icon: '\e22e' !default;
$treegrid-toolbar-expand-icon: '\e555' !default;
$treegrid-toolbar-collapse-icon: '\e559' !default;
$treegrid-right-arrow-icon-color: $content-font !default;
...
$treegrid-right-arrow-hover-color: $content-font !default;
$treegrid-toolbar-indent-icon: '\e33f' !default;
$treegrid-toolbar-outdent-icon: '\e35d' !default;
$treegrid-rowdrag-childborder-border: 1px solid $selection-bg !default;
$childborder-color: $selection-bg;
...
$treegrid-rowdd-topbottom-border: 1px solid #ffd939 !default;
$treegrid-rowdd-boxshadow: #ffd939 !default;
...
@include export-module('treegrid-highcontrast-icons') {
  #{&}.e-treegrid,
  .e-grid-menu {
    .e-indent::before {
      content: '\e33f';
