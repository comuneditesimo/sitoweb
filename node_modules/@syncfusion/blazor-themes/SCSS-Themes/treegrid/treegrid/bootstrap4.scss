...
//default
$treegrid-right-arrow-icon: '\e70b' !default;
$treegrid-toolbar-expand-icon: '\e7db' !default;
$treegrid-toolbar-collapse-icon: '\e7dc' !default;
$treegrid-right-arrow-icon-color: $gray-700 !default;
$treegrid-right-arrow-hover-color: $gray-800 !default;
...
$treegrid-bigger-icon-size: 16px !default;
$treegrid-smaller-icon-size: 16px !default;
$treegrid-bigger-icon-font-size: 10px !default;
$treegrid-toolbar-indent-icon: '\e702' !default;
$treegrid-toolbar-outdent-icon: '\e722' !default;
$treegrid-rowdrag-childborder-border: 1px solid !default;
$childborder-color: #e3165b;
$error-elem-color: #e3165b;
$error-elem-content: '\e797' !default;
...
@include export-module('treegrid-bootstrap4-icons') {
  #{&}.e-treegrid,
  .e-grid-menu {
    .e-indent::before {
      content: '\e702';
