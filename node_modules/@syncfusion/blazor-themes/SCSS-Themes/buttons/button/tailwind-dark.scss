...
$btn-text-line-height: 1.429em !default;
...
$btn-padding: 4px 12px !default;
$btn-small-padding: 3px 8px !default;
$btn-bigger-padding: 6px 16px !default;
$btn-bigger-small-padding: 5px 14px !default;
$btn-icon-padding: 3px 11px !default;
$btn-small-icon-padding: 3px 7px !default;
$btn-bigger-icon-padding: 5px 15px !default;
