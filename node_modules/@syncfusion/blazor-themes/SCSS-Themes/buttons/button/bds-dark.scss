...
$btn-bigger-small-round-font-size: $text-sm !default;
...
$btn-round-icon-line-height: 0 !default;
$btn-small-round-icon-line-height: 0 !default;
...
$btn-bigger-text-line-height: 1.572em !default;
$btn-small-text-line-height: 1.667em !default;
$btn-bigger-small-text-line-height: 1.7145em !default;
$btn-padding: 4px 11px !default;
$btn-small-padding: 3px 9px !default;
$btn-bigger-padding: 8px 15px !default;
$btn-bigger-small-padding: 5px 13px !default;
...
$btn-hover-focus-box-shadow: $shadow-sm !default;
...
.e-btn.e-success:focus{
  box-shadow: $btn-success-focus-box-shadow !important;
}

.e-btn.e-info:focus{
  box-shadow: $btn-info-focus-box-shadow !important;
}

.e-btn.e-warning:focus{
  box-shadow: $btn-warning-focus-box-shadow !important;
}

.e-btn.e-danger:focus{
  box-shadow: $btn-danger-focus-box-shadow !important;
}

.e-btn.e-primary:hover{
  border-color: $primary-border-color-hover !important;
}

.e-btn.e-info:hover{
  border-color: $info-border-color-hover !important;
}

.e-btn.e-warning:hover{
  border-color: $warning-border-color-hover !important;
}

.e-btn.e-danger:hover{
  border-color: $danger-border-color-hover !important;
}
...
.e-btn.e-outline.e-info:hover{
  background: $info-bg-color-hover !important;
  border-color: $info-border-color-hover !important;
  color: $info-text-hover !important;
}

.e-btn.e-outline.e-info:active{
  background: $info-bg-color-pressed !important;
  border-color: $info-border-color-pressed !important;
  color: $info-text-pressed !important;
}
