...
$btn-border-color: $border-fg !default;
$btn-color: $content-font !default;
$btn-border: 1px solid !default;
$btn-bgcolor: $bg-base-0 !default;
$btn-hover-bgcolor: $hover-bg !default;
$btn-hover-color: $hover-font !default;
$btn-hover-border-color: $hover-border !default;
$btn-focus-border-color: $border-fg !default;
$btn-focus-bgcolor: $btn-bgcolor !default;
$btn-focus-color: $content-font !default;
$btn-active-border-color: $selection-bg !default;
$btn-active-bgcolor: $selection-bg !default;
$btn-active-box-shadow: 0 8px 17px 0 rgba(0, 0, 0, .2) !default;
$btn-active-color: $selection-font !default;
$btn-disabled-color: $disable !default;
$btn-disabled-bgcolor: $btn-bgcolor !default;
$btn-disabled-border-color: $disable !default;
$btn-primary-color: $selection-font !default;
$btn-primary-hover-color: $hover-font !default;
$btn-primary-focus-color: $selection-font !default;
$btn-primary-focus-bgcolor: $selection-bg !default;
$btn-primary-active-color:  $selection-font !default;
$btn-primary-bgcolor: $selection-bg !default;
$btn-primary-hover-bgcolor: $hover-bg !default;
$btn-primary-active-bgcolor: $selection-bg !default;
$btn-primary-border-color: $selection-bg !default;
$btn-primary-hover-border-color: $hover-border !default;
$btn-primary-focus-border-color: $selection-bg !default;
$btn-primary-active-border-color: $selection-bg !default;
$btn-primary-disabled-bgcolor: $btn-bgcolor !default;
$btn-primary-disabled-color: $disable !default;
$btn-primary-disabled-border-color: $disable !default;
...
$btn-flat-border-color: $btn-bgcolor !default;
$btn-flat-hover-bgcolor: $hover-bg !default;
$btn-flat-hover-color: $hover-font !default;
$btn-flat-focus-color: $btn-focus-color !default;
$btn-flat-focus-bgcolor: $btn-bgcolor !default;
$btn-flat-active-color: $selection-font !default;
$btn-flat-active-bgcolor: $selection-bg !default;
$btn-flat-active-border-color: $selection-bg !default;
...
$btn-flat-disabled-color: $disable !default;
$btn-flat-primary-disabled-color: $disable !default;
$btn-flat-disabled-border-color: $btn-bgcolor !default;
...
$btn-flat-danger-disabled-color: #b71c1c !default;
...
$btn-round-color: $content-font !default;
$btn-round-border-color: $btn-border-color !default;
$btn-round-hover-bgcolor: $hover-bg !default;
$btn-round-hover-border-color: $hover-border !default;
$btn-round-hover-color: $hover-font !default;
$btn-round-focus-color: $content-font !default;
$btn-round-active-color: $selection-font !default;
$btn-round-height: 36px !default;
$btn-round-width: 36px !default;
$btn-round-bigger-height: 46px !default;
$btn-round-bigger-width: 46px !default;
$btn-round-font-size: 16px !default;
$btn-small-round-font-size: 14px !default;
$btn-bigger-round-font-size: 20px !default;
$btn-bigger-small-round-font-size: 18px !default;
$btn-round-icon-line-height: 26px !default;
$btn-small-round-icon-line-height: 16px !default;
$btn-outline-bgcolor: $btn-bgcolor !default;
$btn-outline-color: $content-font !default;
$btn-outline-hover-bgcolor: $hover-bg !default;
$btn-outline-hover-color: $content-font !default;
$btn-outline-hover-border-color: $hover-border !default;
$btn-outline-focus-bgcolor: $btn-bgcolor !default;
$btn-outline-focus-color: $content-font !default;
$btn-outline-active-color: $selection-font !default;
$btn-outline-active-bgcolor: $selection-bg !default;
$btn-outline-active-border-color: $selection-bg !default;
...
$btn-outline-primary-disabled-border-color: $btn-disabled-border-color !default;
$btn-outline-success-disabled-border-color: $btn-disabled-border-color !default;
$btn-outline-info-disabled-border-color: $btn-disabled-border-color !default;
$btn-outline-warning-disabled-border-color: $btn-disabled-border-color !default;
$btn-outline-danger-disabled-border-color: $btn-disabled-border-color !default;
$btn-outline-active-box-shadow: $btn-flat-box-shadow !default;
$btn-outline-hover-border-color: $btn-outline-border-color !default;
$btn-outline-focus-border-color: $selection-bg !default;
$btn-outline-active-border-color: $selection-bg !default;
$btn-outline-primary-hover-border-color: $btn-outline-border-color !default;
$btn-outline-primary-focus-border-color: $selection-bg !default;
$btn-outline-primary-active-border-color: $selection-bg !default;
$btn-outline-default-focus-border-color: $content-font !default;
$btn-danger-bgcolor: $error-bg !default;
$btn-danger-color: $content-font !default;
$btn-danger-hover-bgcolor: $error-bg !default;
$btn-danger-hover-color: $content-font !default;
$btn-danger-hover-border-color: $hover-border !default;
$btn-danger-focus-bgcolor: $btn-danger-hover-bgcolor !default;
$btn-danger-active-bgcolor: $content-font !default;
$btn-danger-active-color: $error-bg !default;
$btn-danger-border-color: $btn-danger-bgcolor !default;
$btn-danger-focus-border-color: $error-bg !default;
$btn-danger-active-border-color: $content-font !default;
$btn-flat-danger-active-bgcolor: $btn-danger-active-bgcolor !default;
$btn-flat-danger-color: $btn-danger-color !default;
$btn-flat-danger-bgcolor: $btn-danger-bgcolor !default;
$btn-flat-danger-hover-color: $btn-danger-hover-color !default;
$btn-flat-danger-focus-color:  $btn-danger-color !default;
$btn-flat-danger-focus-bgcolor: $btn-danger-bgcolor !default;
$btn-flat-danger-active-color: $error-bg !default;
$btn-flat-danger-hover-border-color: $btn-danger-bgcolor !default;
$btn-flat-danger-focus-border-color: $btn-danger-bgcolor !default;
$btn-flat-danger-active-border-color: $content-font !default;
...
$btn-success-bgcolor: $success-bg !default;
$btn-success-color: $content-font !default;
$btn-success-hover-bgcolor: $success-bg !default;
$btn-success-hover-color: $content-font !default;
$btn-success-focus-bgcolor: $btn-success-hover-bgcolor !default;
$btn-success-focus-color: $btn-success-color !default;
$btn-success-active-bgcolor: $content-font !default;
$btn-success-active-color: $btn-success-bgcolor !default;
$btn-success-border-color: $btn-success-bgcolor !default;
$btn-success-hover-border-color: $hover-border !default;
$btn-success-focus-border-color: $success-bg !default;
$btn-success-active-border-color: $content-font !default;
$btn-flat-success-active-bgcolor: $btn-success-active-bgcolor !default;
$btn-flat-success-color:  $btn-success-color !default;
$btn-flat-success-hover-color:  $btn-success-hover-color !default;
$btn-flat-success-focus-color: $btn-success-hover-color !default;
$btn-flat-success-active-color: $btn-success-active-color !default;
...
$btn-outline-success-disabled-color: $btn-disabled-color !default;
$btn-outline-success-disabled-border-color: $btn-disabled-border-color !default;
$btn-flat-success-bgcolor: $btn-success-bgcolor !default;
$btn-flat-success-focus-bgcolor: $btn-success-hover-bgcolor !default;
$btn-flat-success-border-color: $btn-success-border-color !default;
$btn-flat-success-hover-border-color: $btn-success-bgcolor !default;
$btn-flat-success-active-border-color: $btn-success-color !default;
$btn-flat-success-focus-border-color: $btn-success-bgcolor !default;
$btn-flat-success-disabled-border-color: $btn-success-disabled-border-color !default;
$btn-warning-bgcolor: $alert-bg !default;
$btn-warning-color: $content-font !default;
$btn-warning-border-color: $btn-warning-bgcolor !default;
$btn-warning-hover-bgcolor: $btn-warning-bgcolor !default;
$btn-warning-hover-border-color: $hover-border !default;
$btn-warning-hover-color: $btn-warning-color !default;
$btn-warning-focus-bgcolor: $btn-warning-hover-bgcolor !default;
$btn-warning-focus-color: $content-font !default;
$btn-warning-focus-border-color: $alert-bg !default;
$btn-warning-active-bgcolor: $content-font !default;
$btn-warning-active-border-color: $content-font !default;
$btn-warning-active-color: $alert-bg !default;
...
$btn-flat-warning-color:  $btn-warning-color !default;
$btn-flat-warning-hover-color:  $btn-warning-hover-color !default;
$btn-flat-warning-focus-color: $btn-warning-hover-color !default;
...
$btn-outline-warning-disabled-color: $btn-disabled-color !default;
$btn-outline-warning-disabled-border-color: $btn-disabled-border-color !default;
$btn-flat-warning-bgcolor: $btn-warning-bgcolor !default;
$btn-flat-warning-focus-bgcolor: $btn-warning-hover-bgcolor !default;
$btn-flat-warning-border-color: $btn-warning-border-color !default;
$btn-flat-warning-hover-border-color: $btn-warning-border-color !default;
$btn-flat-warning-active-border-color: $btn-warning-active-border-color !default;
$btn-flat-warning-focus-border-color: $btn-warning-border-color !default;
$btn-flat-warning-disabled-border-color: $btn-warning-disabled-border-color !default;
$btn-info-bgcolor: $info-bg !default;
$btn-info-color: $content-font !default;
$btn-info-border-color: $btn-info-bgcolor !default;
$btn-info-hover-bgcolor: $btn-info-bgcolor !default;
$btn-info-hover-border-color: $hover-border !default;
$btn-info-hover-color: $btn-info-color !default;
$btn-info-focus-bgcolor: $btn-info-hover-bgcolor !default;
$btn-info-focus-border-color: $info-bg !default;
$btn-info-focus-color: $btn-info-hover-color !default;
$btn-info-active-bgcolor: $content-font !default;
$btn-info-active-border-color: $content-font !default;
$btn-info-active-color: $btn-info-bgcolor !default;
...
$btn-flat-info-color:  $btn-info-color !default;
$btn-flat-info-hover-color: $btn-info-hover-color !default;
$btn-flat-info-focus-color: $btn-info-hover-color !default;
$btn-flat-info-active-color: $btn-info-active-color !default;
...
$btn-outline-info-disabled-color: $btn-disabled-color !default;
$btn-outline-info-disabled-border-color: $btn-disabled-border-color !default;
$btn-flat-info-bgcolor: $btn-info-bgcolor !default;
$btn-flat-info-focus-bgcolor: $btn-info-hover-bgcolor !default;
$btn-flat-info-border-color: $btn-info-border-color !default;
$btn-flat-info-hover-border-color: $btn-info-bgcolor !default;
$btn-flat-info-active-border-color: $btn-info-active-border-color !default;
$btn-flat-info-focus-border-color: $btn-info-bgcolor !default;
$btn-flat-primary-bgcolor: $btn-primary-bgcolor !default;
$btn-flat-primary-border-color: $btn-primary-border-color !default;
$btn-flat-primary-color: $btn-primary-color !default;
$btn-flat-primary-hover-bgcolor: $btn-primary-hover-bgcolor !default;
$btn-flat-primary-hover-border-color: $btn-primary-hover-bgcolor !default;
$btn-flat-primary-hover-color: $btn-primary-hover-color !default;
$btn-flat-primary-focus-color: $btn-primary-color !default;
$btn-flat-primary-focus-border-color: $btn-primary-bgcolor !default;
$btn-flat-primary-focus-bgcolor: $btn-flat-primary-bgcolor !default;
$btn-flat-primary-active-bgcolor: $btn-primary-active-bgcolor !default;
$btn-flat-primary-active-border-color: $btn-primary-active-bgcolor !default;
$btn-flat-primary-active-color: $btn-primary-active-color !default;
$btn-flat-focus-border-color: $btn-bgcolor !default;
$btn-focus-outline: $border-fg 1px solid !default;
$btn-focus-outline-round: none !default;
$btn-focus-outline-offset: 2px !default;
$btn-active-outline: $border-fg 0 solid !default;
...
$btn-bigger-small-font-size: $btn-bigger-font-size !default;
$btn-icon-font-size: $btn-font-size !default;
$btn-small-icon-font-size: 11px !default;
$btn-bigger-icon-font-size: $btn-bigger-font-size !default;
$btn-bigger-small-icon-font-size: 15px !default;
$btn-border-radius: 0 !default;
$btn-text-transform: none !default;
$btn-padding: 2px 20px !default;
$btn-small-padding: 3px 16px !default;
$btn-bigger-padding: 3px 24px !default;
$btn-bigger-small-padding: 1px 22px !default;
$btn-icon-padding: 2px 8px !default;
$btn-small-icon-padding: 3px 6px !default;
$btn-bigger-icon-padding: 3px 11px !default;
$btn-bigger-small-icon-padding: 1px 9px !default;
$btn-top-icon-padding: 8px 20px !default;
$btn-top-icon-bigger-padding: 10px 24px !default;
$btn-icon-top-bottom-padding: 8px !default;
$btn-small-icon-top-bottom-padding: 6px !default;
$btn-bigger-icon-top-bottom-padding: 10px !default;
$btn-box-shadow: none !default;
$btn-hover-focus-box-shadow: none !default;
$btn-round-height: 2.57143em !default;
$btn-round-width: 2.57143em !default;
$btn-round-bigger-height: 2.875em !default;
$btn-round-bigger-width: 2.875em !default;
$btn-round-small-height: 2.5em !default;
$btn-round-small-width: 2.5em !default;
$btn-round-bigger-small-height: 2.5em !default;
$btn-round-bigger-small-width: 2.5em !default;
$btn-round-font-size: 16px !default;
$btn-small-round-font-size: 14px !default;
$btn-bigger-round-font-size: 20px !default;
$btn-bigger-small-round-font-size: 18px !default;
$btn-icon-margin-top: -3px !default;
$btn-icon-margin: -.5714em !default;
$btn-small-icon-margin: -.7273em !default;
$btn-bigger-icon-margin: -.688em !default;
$btn-bigger-small-icon-margin: -.5334em !default;
$btn-icon-width: 1.929em !default;
$btn-small-icon-width: 2.182em !default;
$btn-bigger-icon-width: 2.25em !default;
$btn-bigger-small-icon-width: 2.1334em !default;
$btn-icon-btn-width: 1em !default;
$btn-icon-small-width: .91em !default;
$btn-icon-bigger-width: 1em !default;
$btn-icon-bigger-small-width: 1.0667em !default;
$btn-round-icon-line-height: 2.125em !default;
$btn-small-round-icon-line-height: 2em !default;
$btn-bigger-round-icon-line-height: 2.2em !default;
$btn-bigger-small-round-icon-line-height: 2.11111em !default;
$btn-text-line-height: 1.8572em !default;
...
$btn-primary-outline: $selection-bg 1px solid !default;
$btn-link-color: #8a8aff !default;
$btn-link-hover-color: #8a8aff !default;
...
@include export-module('button-layout') {
    ...
    @at-root {
      ...
      &.e-small {
        ...
        &.e-round {
          ...
          @if $skin-name == 'bootstrap5' or $skin-name == 'FluentUI' or $skin-name == 'Material3' {
            border-radius: 50%;
          }
  ...
  .e-small.e-css.e-btn {
    ...
    &.e-round {
      ...
      padding: 0;
      width: $btn-round-small-width;
      @if $skin-name == 'bootstrap5' or $skin-name == 'FluentUI' or or $skin-name == 'Material3' {
        border-radius: 50%;
      }
...
@mixin outline-disabled {
  ...
  @else if $skin-name == 'bootstrap5' {
    border-color: $btn-outline-disabled-border-color;
    color: $btn-outline-active-bgcolor;
  }
  @else {
