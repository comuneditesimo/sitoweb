...
$btn-font-siz: 14px !default;
$btn-small-font-size: 12px !default;
$btn-bigger-font-size: 16px !default;
$btn-bigger-small-font-size: $btn-bigger-font-size !default;
$btn-color: $neutral-light-fontalt !default;
$btn-bgcolor: $neutral-light !default;
$btn-border-color: $neutral-light !default;
$btn-hover-bgcolor: $neutral-quintenary !default;
$btn-hover-border-color: $neutral-quintenary !default;
$btn-hover-color: $neutral-light-fontalt !default;
$btn-focus-border-color: $neutral-white !default;
$btn-focus-color: $neutral-light-fontalt !default;
$btn-focus-bgcolor: $neutral-light !default;
$btn-active-border-color: $neutral-tertiary-alt !default;
$btn-active-bgcolor: $neutral-tertiary-alt !default;
$btn-active-color: $neutral-light-fontalt !default;
...
$btn-disabled-color: $neutral-tertiary-alt !default;
...
$btn-primary-color: $theme-primary-font !default;
$btn-primary-hover-color: $theme-primary-font !default;
$btn-primary-focus-color: $theme-primary-font !default;
$btn-primary-active-color: $theme-primary-font !default;
$btn-primary-bgcolor: $theme-primary !default;
$btn-primary-hover-bgcolor: $theme-dark !default;
$btn-primary-focus-bgcolor: $theme-primary !default;
$btn-primary-active-bgcolor: $theme-darker !default;
$btn-primary-border-color: $theme-primary !default;
$btn-primary-hover-border-color: $theme-dark !default;
$btn-primary-focus-border-color: $neutral-white !default;
$btn-primary-active-border-color: $theme-darker !default;
$btn-flat-color: $btn-color !default;
$btn-flat-border: $btn-border !default;
$btn-flat-border-color: $btn-border-color !default;
$btn-flat-hover-color: $btn-hover-color !default;
$btn-flat-focus-color: $btn-focus-color !default;
$btn-flat-active-color: $neutral-light-fontalt !default;
$btn-flat-box-shadow: $btn-box-shadow !default;
$btn-outline-bgcolor: transparent !default;
$btn-outline-color: $neutral-light-fontalt !default;
$btn-outline-hover-bgcolor: $neutral-quintenary !default;
$btn-outline-hover-color: $neutral-light-fontalt !default;
$btn-outline-focus-bgcolor: $neutral-light !default;
$btn-outline-default-focus-border-color: $neutral-white !default;
$btn-outline-focus-color: $neutral-light-fontalt !default;
$btn-outline-active-color: $neutral-light-fontalt !default;
$btn-outline-active-bgcolor: $neutral-tertiary-alt !default;
$btn-outline-border-color: $neutral-light !default;
$btn-outline-primary-color: $theme-tertiary !default;
...
$btn-success-hover-bgcolor: darken($success-bg, 6%) !default;
$btn-success-focus-bgcolor: $success-bg !default;
$btn-success-active-bgcolor: darken($success-bg, 12%) !default;
$btn-success-border-color: $success-bg !default;
$btn-success-hover-border-color: darken($success-bg, 6%) !default;
$btn-success-focus-border-color: $neutral-white !default;
$btn-success-active-border-color: darken($success-bg, 12%) !default;
$btn-success-active-color: $message-font !default;
$btn-ripple-success-bgcolor: transparent !default;
$btn-info-color: #fff !default;
$btn-info-bgcolor: $info-bg !default;
$btn-info-hover-bgcolor: darken($info-bg, 6%) !default;
$btn-info-focus-bgcolor: $info-bg !default;
$btn-info-active-bgcolor: darken($info-bg, 12%) !default;
$btn-info-border-color: $info-bg !default;
$btn-info-hover-border-color: darken($info-bg, 6%) !default;
$btn-info-focus-border-color: $neutral-white !default;
$btn-info-active-border-color: darken($info-bg, 12%) !default;
...
$btn-warning-hover-bgcolor: darken($alert-bg, 6%) !default;
$btn-warning-focus-bgcolor: $alert-bg !default;
$btn-warning-active-bgcolor: darken($alert-bg, 12%) !default;
$btn-warning-border-color: $alert-bg !default;
$btn-warning-hover-border-color: darken($alert-bg, 6%) !default;
$btn-warning-focus-border-color: $neutral-white !default;
$btn-warning-active-border-color: darken($alert-bg, 12%) !default;
$btn-danger-color: #fff !default;
$btn-danger-bgcolor: $error-bg !default;
$btn-danger-hover-bgcolor: darken($error-bg, 6%) !default;
$btn-danger-focus-bgcolor: $error-bg !default;
$btn-danger-active-bgcolor: darken($error-bg, 12%) !default;
$btn-danger-active-color: $message-font !default;
$btn-danger-border-color: $error-bg !default;
$btn-danger-hover-border-color: darken($error-bg, 6%) !default;
$btn-danger-focus-border-color: $neutral-white !default;
$btn-danger-active-border-color: darken($error-bg, 12%) !default;
...
$btn-flat-active-bgcolor: $neutral-tertiary-alt !default;
...
$btn-flat-primary-focus-color: $btn-primary-hover-color !default;
...
$btn-flat-danger-focus-color: $btn-danger-hover-color !default;
...
$btn-bigger-small-round-icon-line-height: 2.1112em !default;
...
$btn-flat-active-border-color: $neutral-tertiary-alt !default;
$btn-flat-focus-border-color: $btn-focus-border-color !default;
...
$btn-flat-primary-disabled-border-color: $btn-primary-disabled-border-color !default;
...
$btn-flat-danger-border-color: $btn-danger-border-color !default;
...
$btn-flat-active-box-shadow: $btn-box-shadow !default;
$btn-outline-hover-border-color: $neutral-quintenary !default;
$btn-outline-focus-border-color: $neutral-light !default;
$btn-outline-active-border-color: $neutral-tertiary-alt !default;
$btn-outline-primary-hover-border-color: $theme-dark !default;
$btn-outline-primary-focus-border-color: $btn-info-focus-border-color !default;
$btn-outline-primary-active-border-color: $theme-darker !default;
...
$btn-focus-outline: $neutral-secondary-alt 1px solid !default;
$btn-focus-outline-offset: 0 !default;
$btn-focus-outline-round: $btn-bgcolor 0 solid !default;
$btn-active-outline: $neutral-light 0 solid !default;
$btn-active-outline-offset: 0 !default;
$btn-primary-outline: $neutral-secondary-alt 1px solid !default;
$btn-link-color: #5091f1 !default;
$btn-link-hover-color: #639df3 !default;
