...
$cbox-bgcolor: $bg-base-0 !default;
...
$cbox-border-color: $border-fg !default;
$cbox-border-radius: 0 !default;
$cbox-check-fontsize: 12px !default;
$cbox-checkmark-bgcolor: $selection-bg !default;
$cbox-checkmark-border-color: $selection-bg !default;
$cbox-checkmark-color: $selection-font !default;
$cbox-checkmark-disabled-bgcolor: $disable !default;
$cbox-checkmark-disabled-border-color: $disable !default;
$cbox-checkmark-disabled-color: $cbox-bgcolor !default;
$cbox-checkmark-hover-bgcolor: $selection-bg !default;
$cbox-checkmark-hover-border-color: $selection-bg !default;
$cbox-checkmark-hover-color: $selection-font !default;
$cbox-color: $content-font !default;
$cbox-disabled-bgcolor: $disable !default;
$cbox-disabled-border-color: $disable !default;
$cbox-disabled-color: #d6d7d7 !default;
$cbox-focussed-bgcolor: $cbox-bgcolor !default;
$cbox-focussed-border-color: $content-font !default;
$cbox-focussed-box-shadow: none !default;
$cbox-focussed-checkmark-bgcolor: $selection-bg !default;
$cbox-focussed-checkmark-border-color: $selection-bg !default;
$cbox-focussed-checkmark-color: $selection-font !default;
$cbox-focussed-color: $selection-font !default;
$cbox-focussed-indeterminate-color: $selection-font !default;
$cbox-font-size: 14px !default;
$cbox-height: 20px !default;
$cbox-hover-bgcolor: $cbox-bgcolor !default;
$cbox-hover-border-color: $selection-bg !default;
$cbox-hover-color: $content-font !default;
$cbox-indeterminate-bgcolor: $cbox-bgcolor !default;
$cbox-indeterminate-border-color: $border-fg !default;
$cbox-indeterminate-color: $bg-base-100 !default;
$cbox-indeterminate-content: '\e934' !default;
$cbox-indeterminate-disabled-bgcolor: $cbox-bgcolor !default;
...
$cbox-indeterminate-hover-color: $border-fg-alt !default;
...
$cbox-focus-outline: $border-fg 1px solid !default;
...
@include export-module('check-box-highcontrast-icons') {
  .e-checkbox-wrapper,
  .e-css.e-checkbox-wrapper {
    @at-root {
      & .e-check {
