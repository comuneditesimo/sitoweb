...
//General
$chip-bg-color: $bg-base-100 !default;
$chip-hover-bg-color: $hover-bg !default;
$chip-focus-bg-color: $bg-base-100 !default;
$chip-choice-active-bg-color: $selection-bg !default;
$chip-active-bg-color: $selection-bg !default;
...
$chip-pressed-bg-color: $selection-bg !default;
$chip-disabled-bg-color: $invert-font !default;
$chip-pressed-active-bg-color: $selection-bg !default;
...
$chip-font-color: $invert-font !default;
$chip-hover-font-color: $hover-font !default;
$chip-focus-font-color: $invert-font !default;
$chip-active-font-color: $chip-focus-font-color !default;
$chip-choice-active-font-color: $invert-font !default;
...
$chip-pressed-font-color: $invert-font !default;
$chip-disabled-font-color: $disable !default;
$chip-close-icon-font-color: $invert-font !default;
$chip-close-icon-hover-font-color: $hover-font !default;
$chip-close-icon-pressed-font-color: $selection-font !default;
$chip-icon-font-color: $invert-font !default;
$chip-icon-hover-font-color: $hover-font !default;
$chip-icon-focus-font-color: $invert-font !default;
...
$chip-icon-pressed-font-color: $invert-font !default;
...
$chip-hover-border-color: $hover-border !default;
$chip-focus-border-color: $chip-font-color !default;
...
$chip-disabled-border-color: $disable !default;
$chip-focus-box-shadow: 0 0 0 1pt $border-fg !default;
$chip-pressed-box-shadow: none !default;
$chip-list-padding: 4px !default;
$chip-height: 28px !default;
$chip-border-radius: 0 !default;
$chip-box-shadow: 0 0 0 1pt transparent !default;
...
//outline
$chip-outline-hover-bg-color: $hover-bg !default;
$chip-outline-focus-bg-color: $bg-base-100 !default;
$chip-outline-choice-active-bg-color: $selection-bg !default;
$chip-outline-active-bg-color: $selection-bg !default;
...
$chip-outline-pressed-bg-color: $selection-bg !default;
$chip-outline-pressed-active-bg-color: $selection-bg !default;
$chip-outline-disabled-bg-color: $invert-font !default;
$chip-outline-avatar-bg-color: $border-fg !default;
$chip-outline-avatar-hover-bg-color: darken($chip-outline-hover-bg-color, 12%) !default;
...
$chip-outline-font-color: $content-font !default;
$chip-outline-hover-font-color: $hover-font !default;
$chip-outline-focus-font-color: $invert-font !default;
$chip-outline-active-font-color: $chip-outline-focus-font-color;
$chip-outline-choice-active-font-color: $invert-font !default;
...
$chip-outline-pressed-font-color: $invert-font !default;
$chip-outline-disabled-font-color: $disable !default;
$chip-outline-close-icon-font-color: $content-font !default;
...
$chip-outline-icon-font-color: $content-font !default;
$chip-outline-icon-hover-font-color: $chip-hover-font-color !default;
$chip-outline-icon-focus-font-color: $invert-font !default;
...
$chip-outline-icon-pressed-font-color: $invert-font !default;
$chip-outline-avatar-font-color: $chip-outline-focus-font-color !default;
$chip-outline-avatar-hover-font-color: $chip-outline-icon-hover-font-color !default;
...
$chip-outline-border-color: $border-fg !default;
$chip-outline-hover-border-color: $border-fg !default;
$chip-outline-focus-border-color: $chip-font-color !default;
$chip-outline-choice-active-border-color: transparent !default;
$chip-outline-active-border-color: transparent !default;
...
$chip-outline-pressed-border-color: transparent !default;
$chip-outline-disabled-border-color: $disable !default;
...
//theme
//primary
$chip-primary-bg-color: $selection-bg !default;
$chip-primary-hover-bg-color: $hover-bg !default;
$chip-primary-focus-bg-color: $selection-bg !default;
$chip-primary-active-bg-color: $selection-bg !default;
$chip-primary-focus-active-bg-color: $chip-primary-active-bg-color !default;
$chip-primary-pressed-bg-color: $selection-bg !default;
...
$chip-primary-font-color: $selection-font !default;
$chip-primary-hover-font-color: $hover-font !default;
$chip-primary-focus-font-color: $selection-font !default;
$chip-primary-active-font-color: $selection-font !default;
$chip-primary-focus-active-font-color: $chip-primary-active-font-color !default;
$chip-primary-pressed-font-color: $selection-font !default;
$chip-primary-disabled-font-color: $chip-disabled-font-color !default;
$chip-primary-close-icon-font-color: $selection-font !default;
$chip-primary-close-icon-hover-font-color: $hover-font !default;
$chip-primary-close-icon-pressed-font-color: $selection-font !default;
...
$chip-primary-hover-border-color: $hover-border !default;
$chip-primary-focus-border-color: $chip-font-color !default;
...
$chip-success-hover-bg-color: $success-bg !default;
$chip-success-focus-bg-color: $success-bg !default;
$chip-success-active-bg-color: $content-font !default;
$chip-success-focus-active-bg-color: $chip-success-active-bg-color !default;
$chip-success-pressed-bg-color: $content-font !default;
...
$chip-success-font-color: $content-font !default;
$chip-success-hover-font-color: $content-font !default;
$chip-success-focus-font-color: $content-font !default;
$chip-success-active-font-color: $success-bg !default;
$chip-success-focus-active-font-color: $chip-success-active-font-color !default;
$chip-success-pressed-font-color: $success-bg !default;
...
$chip-success-hover-border-color: $hover-border !default;
$chip-success-focus-border-color: $chip-font-color !default;
...
$chip-info-hover-bg-color: $info-bg !default;
$chip-info-focus-bg-color: $info-bg !default;
$chip-info-active-bg-color: $content-font !default;
$chip-info-focus-active-bg-color: $chip-info-active-bg-color !default;
$chip-info-pressed-bg-color: $content-font !default;
...
$chip-info-font-color: $content-font !default;
$chip-info-hover-font-color: $content-font !default;
$chip-info-focus-font-color: $content-font !default;
$chip-info-active-font-color: $info-bg !default;
$chip-info-focus-active-font-color: $chip-info-active-font-color !default;
$chip-info-pressed-font-color: $info-bg !default;
...
$chip-info-hover-border-color: $hover-border !default;
$chip-info-focus-border-color: $chip-font-color !default;
...
$chip-warning-hover-bg-color: $alert-bg !default;
$chip-warning-focus-bg-color: $alert-bg !default;
$chip-warning-active-bg-color: $content-font !default;
$chip-warning-focus-active-bg-color: $chip-warning-active-bg-color !default;
$chip-warning-pressed-bg-color: $content-font !default;
...
$chip-warning-font-color: $content-font !default;
$chip-warning-hover-font-color: $content-font !default;
$chip-warning-focus-font-color: $content-font !default;
$chip-warning-active-font-color: $alert-bg !default;
$chip-warning-focus-active-font-color: $chip-warning-active-font-color !default;
$chip-warning-pressed-font-color: $alert-bg !default;
...
$chip-warning-hover-border-color: $hover-border !default;
$chip-warning-focus-border-color: $chip-font-color !default;
...
$chip-danger-hover-bg-color: $error-bg !default;
$chip-danger-focus-bg-color: $error-bg !default;
$chip-danger-active-bg-color: $content-font !default;
$chip-danger-focus-active-bg-color: $chip-danger-active-bg-color !default;
$chip-danger-pressed-bg-color: $content-font !default;
...
$chip-danger-font-color: $content-font !default;
$chip-danger-hover-font-color: $content-font !default;
$chip-danger-focus-font-color: $content-font !default;
$chip-danger-active-font-color: $error-bg !default;
$chip-danger-focus-active-font-color: $chip-danger-active-font-color !default;
$chip-danger-pressed-font-color: $error-bg !default;
...
$chip-danger-hover-border-color: $hover-border !default;
$chip-danger-focus-border-color: $chip-font-color !default;
...
$chip-outline-primary-hover-bg-color: $hover-bg !default;
$chip-outline-primary-focus-bg-color: $selection-bg !default;
$chip-outline-primary-active-bg-color: $selection-bg !default;
$chip-outline-primary-focus-active-bg-color: $chip-outline-primary-active-bg-color !default;
$chip-outline-primary-pressed-bg-color: $selection-bg !default;
$chip-outline-primary-disabled-bg-color: $chip-outline-disabled-bg-color !default;
$chip-outline-primary-avatar-bg-color: $selection-bg !default;
$chip-outline-primary-avatar-hover-bg-color: darken($chip-outline-primary-hover-bg-color, 12%) !default;
...
$chip-outline-primary-font-color: $selection-bg !default;
$chip-outline-primary-hover-font-color: $hover-font !default;
$chip-outline-primary-focus-font-color: $selection-font !default;
$chip-outline-primary-active-font-color: $selection-font !default;
$chip-outline-primary-focus-active-font-color: $chip-outline-primary-active-font-color !default;
$chip-outline-primary-pressed-font-color: $selection-font !default;
...
$chip-outline-primary-avatar-hover-font-color: $chip-outline-primary-hover-font-color !default;
...
$chip-outline-primary-border-color: $selection-bg !default;
$chip-outline-primary-hover-border-color: $hover-border !default;
$chip-outline-primary-focus-border-color: $chip-font-color !default;
...
$chip-outline-success-hover-bg-color: $success-bg !default;
$chip-outline-success-focus-bg-color: $success-bg !default;
$chip-outline-success-active-bg-color: $content-font !default;
$chip-outline-success-focus-active-bg-color: $chip-outline-success-active-bg-color !default;
$chip-outline-success-pressed-bg-color: $content-font !default;
$chip-outline-success-disabled-bg-color: $chip-outline-disabled-bg-color !default;
$chip-outline-success-avatar-bg-color: $success-bg !default;
$chip-outline-success-avatar-hover-bg-color: darken($chip-outline-success-hover-bg-color, 12%) !default;
...
$chip-outline-success-font-color: $success-alt !default;
$chip-outline-success-hover-font-color: $content-font !default;
$chip-outline-success-focus-font-color: $content-font !default;
$chip-outline-success-active-font-color: $success-bg !default;
$chip-outline-success-focus-active-font-color: $chip-outline-success-active-font-color !default;
$chip-outline-success-pressed-font-color: $success-bg !default;
...
$chip-outline-success-border-color: $success-alt !default;
$chip-outline-success-hover-border-color: $hover-border !default;
$chip-outline-success-focus-border-color: $chip-font-color !default;
...
$chip-outline-info-hover-bg-color: $info-bg !default;
$chip-outline-info-focus-bg-color: $info-bg !default;
$chip-outline-info-active-bg-color: $content-font !default;
$chip-outline-info-focus-active-bg-color: $chip-outline-info-active-bg-color !default;
$chip-outline-info-pressed-bg-color: $content-font !default;
$chip-outline-info-disabled-bg-color: $chip-outline-disabled-bg-color !default;
$chip-outline-info-avatar-bg-color: $info-bg !default;
$chip-outline-info-avatar-hover-bg-color: darken($chip-outline-info-hover-bg-color, 12%) !default;
...
$chip-outline-info-font-color: $info-alt !default;
$chip-outline-info-hover-font-color: $content-font !default;
$chip-outline-info-focus-font-color: $content-font !default;
$chip-outline-info-active-font-color: $info-bg !default;
$chip-outline-info-focus-active-font-color: $chip-outline-info-active-font-color !default;
$chip-outline-info-pressed-font-color: $info-bg !default;
...
$chip-outline-info-border-color: $info-alt !default;
$chip-outline-info-hover-border-color: $hover-border !default;
$chip-outline-info-focus-border-color: $chip-font-color !default;
...
$chip-outline-warning-hover-bg-color: $alert-bg !default;
$chip-outline-warning-focus-bg-color: $alert-bg !default;
$chip-outline-warning-active-bg-color: $content-font !default;
$chip-outline-warning-focus-active-bg-color: $chip-outline-warning-active-bg-color !default;
$chip-outline-warning-pressed-bg-color: $content-font !default;
$chip-outline-warning-disabled-bg-color: $chip-outline-disabled-bg-color !default;
$chip-outline-warning-avatar-bg-color: $alert-bg !default;
$chip-outline-warning-avatar-hover-bg-color: darken($chip-outline-warning-hover-bg-color, 12%) !default;
...
$chip-outline-warning-font-color: $alert-alt !default;
$chip-outline-warning-hover-font-color: $content-font !default;
$chip-outline-warning-focus-font-color: $content-font !default;
$chip-outline-warning-active-font-color: $alert-bg !default;
$chip-outline-warning-focus-active-font-color: $chip-outline-warning-active-font-color !default;
$chip-outline-warning-pressed-font-color: $alert-bg !default;
...
$chip-outline-warning-border-color: $alert-alt !default;
$chip-outline-warning-hover-border-color: $hover-border !default;
$chip-outline-warning-focus-border-color: $chip-font-color !default;
...
$chip-outline-danger-hover-bg-color: $error-bg !default;
$chip-outline-danger-focus-bg-color: $error-bg !default;
$chip-outline-danger-active-bg-color: $content-font !default;
$chip-outline-danger-focus-active-bg-color: $chip-outline-danger-active-bg-color !default;
$chip-outline-danger-pressed-bg-color: $content-font !default;
$chip-outline-danger-disabled-bg-color: $chip-outline-disabled-bg-color !default;
$chip-outline-danger-avatar-bg-color: $error-bg !default;
$chip-outline-danger-avatar-hover-bg-color: darken($chip-outline-danger-hover-bg-color, 12%) !default;
...
$chip-outline-danger-font-color: $error-alt !default;
$chip-outline-danger-hover-font-color: $content-font !default;
$chip-outline-danger-focus-font-color: $content-font !default;
$chip-outline-danger-active-font-color: $error-bg !default;
$chip-outline-danger-focus-active-font-color: $chip-outline-danger-active-font-color !default;
$chip-outline-danger-pressed-font-color: $error-bg !default;
...
$chip-outline-danger-border-color: $error-alt !default;
$chip-outline-danger-hover-border-color: $hover-border !default;
$chip-outline-danger-focus-border-color: $chip-font-color !default;
