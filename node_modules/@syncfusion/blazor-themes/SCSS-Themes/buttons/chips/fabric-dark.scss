...
$chip-hover-bg-color: $neutral-quintenary !default;
$chip-focus-bg-color: $neutral-light !default;
$chip-choice-active-bg-color: $theme-primary !default;
$chip-active-bg-color: $neutral-tertiary-alt !default;
...
$chip-pressed-bg-color: $neutral-tertiary-alt !default;
...
$chip-font-color: $neutral-light-fontalt !default;
$chip-hover-font-color: $neutral-light-fontalt !default;
$chip-focus-font-color: $neutral-light-fontalt !default;
$chip-active-font-color: $chip-focus-font-color !default;
$chip-choice-active-font-color: $theme-dark-font !default;
$chip-focus-active-font-color: $chip-focus-font-color !default;
$chip-pressed-font-color: $neutral-light-fontalt !default;
...
$chip-icon-font-color: $neutral-light-fontalt !default;
$chip-icon-hover-font-color: $neutral-light-fontalt !default;
$chip-icon-focus-font-color: $neutral-light-fontalt !default;
...
$chip-icon-pressed-font-color: $neutral-light-fontalt !default;
...
$chip-outline-active-bg-color: $neutral-tertiary-alt !default;
...
$chip-outline-pressed-bg-color: $neutral-tertiary-alt !default;
$chip-outline-pressed-active-bg-color: $neutral-tertiary-alt !default;
...
$chip-outline-font-color: $neutral-light-fontalt !default;
$chip-outline-hover-font-color: $neutral-light-fontalt !default;
$chip-outline-focus-font-color: $neutral-light-fontalt !default;
$chip-outline-active-font-color: $chip-outline-focus-font-color;
$chip-outline-choice-active-font-color: $theme-dark-font !default;
...
$chip-outline-pressed-font-color: $neutral-light-fontalt !default;
...
$chip-outline-icon-font-color: $neutral-light-fontalt !default;
$chip-outline-icon-hover-font-color: $neutral-light-fontalt !default;
$chip-outline-icon-focus-font-color: $neutral-light-fontalt !default;
...
$chip-outline-icon-pressed-font-color: $neutral-light-fontalt !default;
...
$chip-outline-focus-border-color: $neutral-secondary-alt !default;
$chip-outline-choice-active-border-color: $theme-tertiary !default;
...
$chip-primary-hover-bg-color: $theme-dark !default;
$chip-primary-focus-bg-color: $theme-primary !default;
$chip-primary-active-bg-color: $theme-darker !default;
$chip-primary-focus-active-bg-color: $chip-primary-active-bg-color !default;
$chip-primary-pressed-bg-color: $theme-darker !default;
...
$chip-primary-font-color: $theme-dark-font !default;
...
$chip-primary-close-icon-font-color: rgba($theme-primary-font, .8) !default;
...
//success
$chip-success-bg-color: $success-bg !default;
$chip-success-hover-bg-color: darken($chip-success-bg-color, 6%) !default;
$chip-success-focus-bg-color: $chip-success-bg-color !default;
$chip-success-active-bg-color: darken($chip-success-bg-color, 12%) !default;
$chip-success-focus-active-bg-color: $chip-success-active-bg-color !default;
$chip-success-pressed-bg-color: darken($chip-success-bg-color, 12%) !default;
...
$chip-success-focus-border-color: $neutral-white !default;
...
//info
$chip-info-bg-color: $info-bg !default;
$chip-info-hover-bg-color: darken($chip-info-bg-color, 6%) !default;
$chip-info-focus-bg-color: $chip-info-bg-color !default;
$chip-info-active-bg-color: darken($chip-info-bg-color, 12%) !default;
$chip-info-focus-active-bg-color: $chip-info-active-bg-color !default;
$chip-info-pressed-bg-color: darken($chip-info-bg-color, 12%) !default;
...
$chip-info-focus-border-color: $neutral-white !default;
...
//warning
$chip-warning-bg-color: $alert-bg !default;
$chip-warning-hover-bg-color: darken($chip-warning-bg-color, 6%) !default;
$chip-warning-focus-bg-color: $chip-warning-bg-color !default;
$chip-warning-active-bg-color: darken($chip-warning-bg-color, 12%) !default;
$chip-warning-focus-active-bg-color: $chip-warning-active-bg-color !default;
$chip-warning-pressed-bg-color: darken($chip-warning-bg-color, 12%) !default;
...
$chip-warning-focus-border-color: $neutral-white !default;
...
//danger
$chip-danger-bg-color: $error-bg !default;
$chip-danger-hover-bg-color: darken($chip-danger-bg-color, 6%) !default;
$chip-danger-focus-bg-color: $chip-danger-bg-color !default;
$chip-danger-active-bg-color: darken($chip-danger-bg-color, 12%) !default;
$chip-danger-focus-active-bg-color: $chip-danger-active-bg-color !default;
$chip-danger-pressed-bg-color: darken($chip-danger-bg-color, 12%) !default;
...
$chip-danger-focus-border-color: $neutral-white !default;
...
$chip-outline-primary-hover-bg-color: $theme-dark !default;
...
$chip-outline-primary-pressed-bg-color: $theme-darker !default;
$chip-outline-primary-disabled-bg-color: $chip-outline-disabled-bg-color !default;
$chip-outline-primary-avatar-bg-color: $theme-tertiary !default;
...
$chip-outline-primary-font-color: $theme-tertiary !default;
$chip-outline-primary-hover-font-color: $theme-dark-font !default;
$chip-outline-primary-focus-font-color: $theme-dark-font !default;
...
$chip-outline-primary-border-color: $theme-tertiary !default;
$chip-outline-primary-hover-border-color: transparent !default;
...
$chip-outline-success-font-color: $success-font !default;
...
$chip-outline-success-border-color: $success-font !default;
$chip-outline-success-hover-border-color: $chip-success-bg-color !default;
$chip-outline-success-focus-border-color: $neutral-white !default;
...
$chip-outline-info-font-color: $info-font !default;
...
$chip-outline-info-border-color: $info-font !default;
$chip-outline-info-hover-border-color: $chip-info-bg-color !default;
$chip-outline-info-focus-border-color: $neutral-white !default;
...
$chip-outline-warning-font-color: $alert-font !default;
...
$chip-outline-warning-border-color: $alert-font !default;
$chip-outline-warning-hover-border-color: $chip-warning-bg-color !default;
$chip-outline-warning-focus-border-color: $neutral-white !default;
...
$chip-outline-danger-font-color: $error-font !default;
...
$chip-outline-danger-border-color: $error-font !default;
$chip-outline-danger-hover-border-color: $chip-danger-bg-color !default;
$chip-outline-danger-focus-border-color: $neutral-white !default;
