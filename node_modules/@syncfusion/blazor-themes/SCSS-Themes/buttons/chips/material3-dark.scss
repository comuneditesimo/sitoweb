...
$chip-touch-padding: 0 10px !default;
$chip-touch-avatar-size: 24px !default;
$chip-touch-avatar-margin: 0 6px 0 -6px !default;
...
$chip-touch-leading-icon-margin: 0 8px 0 -6px !default;
$chip-touch-multi-selection-icon-margin: 0 6px 0 -6px !default;
$chip-touch-delete-icon-font-size: 16px !default;
$chip-touch-delete-icon-size: 16px !default;
$chip-touch-delete-icon-height: 18px !default;
$chip-touch-delete-icon-margin: 0 -4px 0 8px !default;

//Touch-RTL
$chip-touch-rtl-avatar-wrapper-border-radius: 16px !default;
$chip-touch-rtl-avatar-margin: 0 -6px 0 6px !default;
...
$chip-pressed-active-bg-color: rgba($primary) !default;
...
$chip-font-color: rgba($content-text-color-alt1) !default;
...
$chip-border-color: rgba($border) !default;
...
$chip-outline-warning-close-icon-font-color: rgba($warning-bg-color) !default; //not added
...
// box shadows
// primary
$chip-primary-box-shadow: none !default;

// success
$chip-success-box-shadow: none !default;

// danger
$chip-danger-box-shadow: none !default;

// warning
$chip-warning-box-shadow: none !default;

// info
$chip-info-box-shadow: none !default;
