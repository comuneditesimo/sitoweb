@import '../../base/bootstrap-dark.scss';
//General
$chip-bg-color: $grey-light !default;
$chip-hover-bg-color: $grey !default;
$chip-focus-bg-color: $grey-dark !default;
$chip-choice-active-bg-color: $brand-primary !default;
$chip-active-bg-color: $grey-44 !default;
$chip-focus-active-bg-color: $chip-focus-bg-color !default;
$chip-choice-focus-active-bg-color: darken($brand-primary, 10%) !default;
$chip-pressed-bg-color: $grey-44 !default;
$chip-disabled-bg-color: transparent !default;
$chip-pressed-active-bg-color: $grey-44 !default;
$chip-avatar-bg-color: lighten($chip-bg-color, 12%) !default;
$chip-avatar-hover-bg-color: lighten($chip-hover-bg-color, 12%) !default;
$chip-avatar-focus-bg-color: lighten($chip-focus-bg-color, 12%) !default;
$chip-avatar-active-bg-color: lighten($chip-active-bg-color, 12%) !default;
$chip-avatar-choice-active-bg-color: lighten($chip-choice-active-bg-color, 12%) !default;
$chip-avatar-focus-active-bg-color: lighten($chip-focus-active-bg-color, 12%) !default;
$chip-avatar-choice-focus-active-bg-color: lighten($chip-choice-focus-active-bg-color, 12%) !default;
$chip-avatar-pressed-bg-color: lighten($chip-pressed-bg-color, 12%) !default;
$chip-avatar-pressed-active-bg-color: lighten($chip-pressed-active-bg-color, 12%);
$chip-avatar-disabled-bg-color: lighten($chip-disabled-bg-color, 12%) !default;
$chip-font-color: $grey-dark-font !default;
$chip-hover-font-color: $grey-dark-font !default;
$chip-focus-font-color: $grey-dark-font !default;
$chip-active-font-color: $chip-focus-font-color !default;
$chip-choice-active-font-color: $brand-primary-font !default;
$chip-focus-active-font-color: $chip-focus-font-color !default;
$chip-choice-focus-active-font-color: $brand-primary-font !default;
$chip-pressed-font-color: $grey-dark-font !default;
$chip-disabled-font-color: rgba($grey-white, .65) !default;
$chip-close-icon-font-color: rgba($chip-font-color, .8) !default;
$chip-close-icon-hover-font-color: $chip-font-color !default;
$chip-close-icon-pressed-font-color: $chip-font-color !default;
$chip-icon-font-color: $grey-dark-font !default;
$chip-icon-hover-font-color: $grey-dark-font !default;
$chip-icon-focus-font-color: $grey-dark-font !default;
...
$chip-choice-icon-focus-active-font-color: $brand-primary-font !default;
$chip-icon-pressed-font-color: $grey-dark-font !default;
...
$chip-border-color: $grey-8c !default;
$chip-hover-border-color: $grey-99 !default;
$chip-focus-border-color: $grey-8c !default;
$chip-choice-active-border-color: $brand-primary-lighten-10 !default;
$chip-active-border-color: $grey-ad !default;
$chip-focus-active-border-color: $chip-focus-border-color !default;
$chip-choice-focus-active-border-color: lighten($brand-primary, 20%) !default;
$chip-pressed-border-color: $grey-8c !default;
$chip-disabled-border-color: rgba($grey-8c, .65) !default;
...
$chip-delete-icon-margin: 1px -2px 0 8px !default;
...
$chip-outline-choice-active-bg-color: $brand-primary !default;
$chip-outline-active-bg-color: $grey-44 !default;
$chip-outline-focus-active-bg-color: $chip-outline-focus-bg-color !default;
$chip-outline-choice-focus-active-bg-color: darken($brand-primary, 10%) !default;
$chip-outline-pressed-bg-color: $grey-44 !default;
$chip-outline-pressed-active-bg-color: $grey-44 !default;
$chip-outline-disabled-bg-color: transparent !default;
$chip-outline-avatar-bg-color: $chip-avatar-bg-color !default;
$chip-outline-avatar-hover-bg-color: $chip-outline-avatar-bg-color !default;
$chip-outline-avatar-focus-bg-color: lighten($chip-outline-focus-bg-color, 12%) !default;
$chip-outline-avatar-active-bg-color: lighten($chip-outline-active-bg-color, 12%) !default;
$chip-outline-avatar-choice-active-bg-color: lighten($chip-outline-choice-active-bg-color, 12%) !default;
$chip-outline-avatar-focus-active-bg-color: lighten($chip-outline-focus-active-bg-color, 12%) !default;
$chip-outline-avatar-choice-focus-active-bg-color: lighten($chip-outline-choice-focus-active-bg-color, 12%) !default;
$chip-outline-avatar-pressed-bg-color: lighten($chip-outline-pressed-bg-color, 12%) !default;
$chip-outline-avatar-pressed-active-bg-color: lighten($chip-outline-pressed-active-bg-color, 12%);
$chip-outline-avatar-disabled-bg-color: lighten($chip-outline-disabled-bg-color, 12%) !default;
$chip-outline-font-color: $grey-dark-font !default;
$chip-outline-hover-font-color: $grey-dark-font !default;
$chip-outline-focus-font-color: $grey-dark-font !default;
$chip-outline-active-font-color: $chip-outline-focus-font-color;
$chip-outline-choice-active-font-color: $brand-primary-font !default;
$chip-outline-focus-active-font-color: $chip-outline-focus-font-color !default;
$chip-outline-choice-focus-active-font-color: $brand-primary-font !default;
$chip-outline-pressed-font-color: $grey-dark-font !default;
$chip-outline-disabled-font-color: rgba($grey-dark, .65) !default;
...
$chip-outline-icon-font-color: $grey-dark-font !default;
$chip-outline-icon-hover-font-color: $grey-dark-font !default;
$chip-outline-icon-focus-font-color: $grey-dark-font !default;
...
$chip-outline-choice-icon-focus-active-font-color: $brand-primary-font !default;
$chip-outline-icon-pressed-font-color: $grey-dark-font !default;
...
$chip-outline-border-color: $chip-border-color !default;
$chip-outline-hover-border-color: $chip-hover-border-color !default;
$chip-outline-focus-border-color: $chip-focus-border-color !default;
$chip-outline-choice-active-border-color: $brand-primary-lighten-10 !default;
$chip-outline-active-border-color: $chip-active-border-color !default;
$chip-outline-focus-active-border-color: $chip-outline-focus-border-color !default;
$chip-outline-choice-focus-active-border-color: lighten($brand-primary, 20%) !default;
$chip-outline-pressed-border-color: $chip-pressed-border-color !default;
$chip-outline-disabled-border-color: rgba($grey-8c, .65) !default;
...
//theme
//primary
$chip-primary-bg-color: $brand-primary !default;
$chip-primary-hover-bg-color: darken($chip-primary-bg-color, 10%) !default;
$chip-primary-focus-bg-color: darken($chip-primary-bg-color, 10%) !default;
$chip-primary-active-bg-color: darken($chip-primary-bg-color, 20%) !default;
$chip-primary-focus-active-bg-color: $chip-primary-focus-bg-color !default;
$chip-primary-pressed-bg-color: darken($chip-primary-bg-color, 20%) !default;
$chip-primary-disabled-bg-color: transparent !default;
$chip-primary-avatar-bg-color: lighten($chip-primary-bg-color, 12%) !default;
$chip-primary-avatar-hover-bg-color: lighten($chip-primary-hover-bg-color, 12%) !default;
$chip-primary-avatar-focus-bg-color: lighten($chip-primary-focus-bg-color, 12%) !default;
$chip-primary-avatar-active-bg-color: lighten($chip-primary-active-bg-color, 12%) !default;
$chip-primary-avatar-focus-active-bg-color: lighten($chip-primary-focus-active-bg-color, 12%) !default;
$chip-primary-avatar-pressed-bg-color: lighten($chip-primary-pressed-bg-color, 12%) !default;
$chip-primary-avatar-disabled-bg-color: lighten($chip-primary-disabled-bg-color, 12%) !default;
$chip-primary-font-color: $brand-primary-font !default;
...
$chip-primary-disabled-font-color: rgba($brand-primary-lighten-10, .65) !default;
...
$chip-primary-border-color: lighten($chip-primary-bg-color, 10%) !default;
$chip-primary-hover-border-color: $brand-primary !default;
$chip-primary-focus-border-color: lighten($chip-primary-bg-color, 20%) !default;
$chip-primary-active-border-color: darken($chip-primary-bg-color, 10%) !default;
$chip-primary-focus-active-border-color: $chip-primary-focus-border-color !default;
$chip-primary-pressed-border-color: darken($chip-primary-bg-color, 10%) !default;
$chip-primary-disabled-border-color: rgba($chip-primary-border-color, .65) !default;

//success
$chip-success-bg-color: $brand-success-dark !default;
$chip-success-hover-bg-color: darken($chip-success-bg-color, 5%) !default;
$chip-success-focus-bg-color: darken($chip-success-bg-color, 10%) !default;
$chip-success-active-bg-color: darken($chip-success-bg-color, 15%) !default;
$chip-success-focus-active-bg-color: $chip-success-focus-bg-color !default;
$chip-success-pressed-bg-color: darken($chip-success-bg-color, 15%) !default;
$chip-success-disabled-bg-color: transparent !default;
$chip-success-avatar-bg-color: lighten($chip-success-bg-color, 12%) !default;
$chip-success-avatar-hover-bg-color: lighten($chip-success-hover-bg-color, 12%) !default;
$chip-success-avatar-focus-bg-color: lighten($chip-success-focus-bg-color, 12%) !default;
$chip-success-avatar-active-bg-color: lighten($chip-success-active-bg-color, 12%) !default;
$chip-success-avatar-focus-active-bg-color: lighten($chip-success-focus-active-bg-color, 12%) !default;
$chip-success-avatar-pressed-bg-color: lighten($chip-success-pressed-bg-color, 12%) !default;
$chip-success-avatar-disabled-bg-color: lighten($chip-success-disabled-bg-color, 12%) !default;
...
$chip-success-disabled-font-color: rgba($chip-success-bg-color, .65) !default;
...
$chip-success-border-color: darken($chip-success-bg-color, 10%) !default;
$chip-success-hover-border-color: darken($chip-success-bg-color, 0%) !default;
$chip-success-focus-border-color: darken($chip-success-bg-color, 10%) !default;
$chip-success-active-border-color: darken($chip-success-bg-color, 10%) !default;
$chip-success-focus-active-border-color: $chip-success-focus-border-color !default;
$chip-success-pressed-border-color: darken($chip-success-bg-color, 10%) !default;
$chip-success-disabled-border-color: rgba($chip-success-border-color, .65) !default;

//info
$chip-info-bg-color: $brand-info-dark !default;
$chip-info-hover-bg-color: darken($chip-info-bg-color, 5%) !default;
$chip-info-focus-bg-color: darken($chip-info-bg-color, 10%) !default;
$chip-info-active-bg-color: darken($chip-info-bg-color, 15%) !default;
$chip-info-focus-active-bg-color: $chip-info-focus-bg-color !default;
$chip-info-pressed-bg-color: darken($chip-info-bg-color, 15%) !default;
$chip-info-disabled-bg-color: transparent !default;
$chip-info-avatar-bg-color: lighten($chip-info-bg-color, 12%) !default;
$chip-info-avatar-hover-bg-color: lighten($chip-info-hover-bg-color, 12%) !default;
$chip-info-avatar-focus-bg-color: lighten($chip-info-focus-bg-color, 12%) !default;
$chip-info-avatar-active-bg-color: lighten($chip-info-active-bg-color, 12%) !default;
$chip-info-avatar-focus-active-bg-color: lighten($chip-info-focus-active-bg-color, 12%) !default;
$chip-info-avatar-pressed-bg-color: lighten($chip-info-pressed-bg-color, 12%) !default;
$chip-info-avatar-disabled-bg-color: lighten($chip-info-disabled-bg-color, 12%) !default;
...
$chip-info-disabled-font-color: rgba($grey-dark-font, .65) !default;
...
$chip-info-border-color: darken($chip-info-bg-color, 10%) !default;
$chip-info-hover-border-color: darken($chip-info-bg-color, 0%) !default;
$chip-info-focus-border-color: darken($chip-info-bg-color, 10%) !default;
$chip-info-active-border-color: darken($chip-info-bg-color, 10%) !default;
$chip-info-focus-active-border-color: $chip-info-focus-border-color !default;
$chip-info-pressed-border-color: darken($chip-info-bg-color, 10%) !default;
$chip-info-disabled-border-color: rgba($chip-info-border-color, .65) !default;

//warning
$chip-warning-bg-color: $brand-warning-dark !default;
$chip-warning-hover-bg-color: darken($chip-warning-bg-color, 5%) !default;
$chip-warning-focus-bg-color: darken($chip-warning-bg-color, 10%) !default;
$chip-warning-active-bg-color: darken($chip-warning-bg-color, 15%) !default;
$chip-warning-focus-active-bg-color: $chip-warning-focus-bg-color !default;
$chip-warning-pressed-bg-color: darken($chip-warning-bg-color, 15%) !default;
$chip-warning-disabled-bg-color: transparent !default;
$chip-warning-avatar-bg-color: lighten($chip-warning-bg-color, 12%) !default;
$chip-warning-avatar-hover-bg-color: lighten($chip-warning-hover-bg-color, 12%) !default;
$chip-warning-avatar-focus-bg-color: lighten($chip-warning-focus-bg-color, 12%) !default;
$chip-warning-avatar-active-bg-color: lighten($chip-warning-active-bg-color, 12%) !default;
$chip-warning-avatar-focus-active-bg-color: lighten($chip-warning-focus-active-bg-color, 12%) !default;
$chip-warning-avatar-pressed-bg-color: lighten($chip-warning-pressed-bg-color, 12%) !default;
$chip-warning-avatar-disabled-bg-color: lighten($chip-warning-disabled-bg-color, 12%) !default;
...
$chip-warning-disabled-font-color: rgba($chip-warning-bg-color, .65) !default;
...
$chip-warning-border-color: darken($chip-warning-bg-color, 10%) !default;
$chip-warning-hover-border-color: darken($chip-warning-bg-color, 0%) !default;
$chip-warning-focus-border-color: darken($chip-warning-bg-color, 10%) !default;
$chip-warning-active-border-color: darken($chip-warning-bg-color, 10%) !default;
$chip-warning-focus-active-border-color: $chip-warning-focus-border-color !default;
$chip-warning-pressed-border-color: darken($chip-warning-bg-color, 10%) !default;
$chip-warning-disabled-border-color: rgba($chip-warning-border-color, .65) !default;

//danger
$chip-danger-bg-color: $brand-danger-dark !default;
$chip-danger-hover-bg-color: darken($chip-danger-bg-color, 5%) !default;
$chip-danger-focus-bg-color: darken($chip-danger-bg-color, 10%) !default;
$chip-danger-active-bg-color: darken($chip-danger-bg-color, 15%) !default;
$chip-danger-focus-active-bg-color: $chip-danger-focus-bg-color !default;
$chip-danger-pressed-bg-color: darken($chip-danger-bg-color, 15%) !default;
$chip-danger-disabled-bg-color: transparent !default;
$chip-danger-avatar-bg-color: lighten($chip-danger-bg-color, 12%) !default;
$chip-danger-avatar-hover-bg-color: lighten($chip-danger-hover-bg-color, 12%) !default;
$chip-danger-avatar-focus-bg-color: lighten($chip-danger-focus-bg-color, 12%) !default;
$chip-danger-avatar-active-bg-color: lighten($chip-danger-active-bg-color, 12%) !default;
$chip-danger-avatar-focus-active-bg-color: lighten($chip-danger-focus-active-bg-color, 12%) !default;
$chip-danger-avatar-pressed-bg-color: lighten($chip-danger-pressed-bg-color, 12%) !default;
$chip-danger-avatar-disabled-bg-color: lighten($chip-danger-disabled-bg-color, 12%) !default;
...
$chip-danger-disabled-font-color: rgba($chip-danger-bg-color, .65) !default;
...
$chip-danger-border-color: darken($chip-danger-bg-color, 10%) !default;
$chip-danger-hover-border-color: darken($chip-danger-bg-color, 0%) !default;
$chip-danger-focus-border-color: darken($chip-danger-bg-color, 10%) !default;
$chip-danger-active-border-color: darken($chip-danger-bg-color, 10%) !default;
$chip-danger-focus-active-border-color: $chip-danger-focus-border-color !default;
$chip-danger-pressed-border-color: darken($chip-danger-bg-color, 10%) !default;
$chip-danger-disabled-border-color: rgba($chip-danger-border-color, .65) !default;

//outline-theme
//primary
$chip-outline-primary-bg-color: transparent !default;
$chip-outline-primary-hover-bg-color: darken($chip-primary-bg-color, 10%) !default;
$chip-outline-primary-focus-bg-color: darken($chip-primary-bg-color, 10%) !default;
...
$chip-outline-primary-pressed-bg-color: darken($chip-primary-bg-color, 20%) !default;
$chip-outline-primary-disabled-bg-color: transparent !default;
$chip-outline-primary-avatar-bg-color: lighten($chip-primary-bg-color, 10%) !default;
$chip-outline-primary-avatar-hover-bg-color: $chip-outline-primary-avatar-bg-color !default;
$chip-outline-primary-avatar-focus-bg-color: lighten($chip-outline-primary-focus-bg-color, 12%) !default;
$chip-outline-primary-avatar-active-bg-color: lighten($chip-outline-primary-active-bg-color, 12%) !default;
$chip-outline-primary-avatar-focus-active-bg-color: lighten($chip-outline-primary-focus-active-bg-color, 12%) !default;
$chip-outline-primary-avatar-pressed-bg-color: lighten($chip-outline-primary-pressed-bg-color, 12%) !default;
$chip-outline-primary-avatar-disabled-bg-color: lighten($chip-outline-primary-disabled-bg-color, 12%) !default;
$chip-outline-primary-font-color: lighten($chip-primary-bg-color, 10%) !default;
$chip-outline-primary-hover-font-color: $chip-primary-font-color !default;
...
$chip-outline-primary-disabled-font-color: rgba($chip-primary-bg-color, .65) !default;
...
$chip-outline-primary-border-color: lighten($chip-primary-bg-color, 10%) !default;
$chip-outline-primary-hover-border-color: $brand-primary !default;
$chip-outline-primary-focus-border-color: lighten($chip-primary-bg-color, 20%) !default;
$chip-outline-primary-active-border-color: darken($chip-primary-bg-color, 10%) !default;
$chip-outline-primary-focus-active-border-color: $chip-outline-primary-focus-border-color !default;
$chip-outline-primary-pressed-border-color: darken($chip-primary-bg-color, 10%) !default;
$chip-outline-primary-disabled-border-color: rgba($chip-primary-bg-color, .65) !default;

//success
$chip-outline-success-bg-color: transparent !default;
$chip-outline-success-hover-bg-color: darken($chip-success-bg-color, 5%) !default;
$chip-outline-success-focus-bg-color: darken($chip-success-bg-color, 10%) !default;
...
$chip-outline-success-pressed-bg-color: darken($chip-success-bg-color, 15%) !default;
$chip-outline-success-disabled-bg-color: transparent !default;
$chip-outline-success-avatar-bg-color: lighten($chip-success-bg-color, 10%) !default;
$chip-outline-success-avatar-hover-bg-color: $chip-outline-success-avatar-bg-color !default;
$chip-outline-success-avatar-focus-bg-color: lighten($chip-outline-success-focus-bg-color, 12%) !default;
$chip-outline-success-avatar-active-bg-color: lighten($chip-outline-success-active-bg-color, 12%) !default;
$chip-outline-success-avatar-focus-active-bg-color: lighten($chip-outline-success-focus-active-bg-color, 12%) !default;
$chip-outline-success-avatar-pressed-bg-color: lighten($chip-outline-success-pressed-bg-color, 12%) !default;
$chip-outline-success-avatar-disabled-bg-color: lighten($chip-outline-success-disabled-bg-color, 12%) !default;
$chip-outline-success-font-color: $brand-success !default;
...
$chip-outline-success-disabled-font-color: rgba($chip-success-bg-color, .65) !default;
...
$chip-outline-success-border-color: $brand-success !default;
$chip-outline-success-hover-border-color: darken($chip-success-bg-color, 0%) !default;
$chip-outline-success-focus-border-color: darken($chip-success-bg-color, 10%) !default;
$chip-outline-success-active-border-color: darken($chip-success-bg-color, 10%) !default;
$chip-outline-success-focus-active-border-color: $chip-outline-success-focus-border-color !default;
$chip-outline-success-pressed-border-color: darken($chip-success-bg-color, 10%) !default;
$chip-outline-success-disabled-border-color: rgba($chip-success-bg-color, .65) !default;

//info
$chip-outline-info-bg-color: transparent !default;
$chip-outline-info-hover-bg-color: darken($chip-info-bg-color, 5%) !default;
$chip-outline-info-focus-bg-color: darken($chip-info-bg-color, 10%) !default;
...
$chip-outline-info-pressed-bg-color: darken($chip-info-bg-color, 15%) !default;
$chip-outline-info-disabled-bg-color: transparent !default;
$chip-outline-info-avatar-bg-color: lighten($chip-info-bg-color, 10%) !default;
$chip-outline-info-avatar-hover-bg-color: $chip-outline-info-avatar-bg-color !default;
$chip-outline-info-avatar-focus-bg-color: lighten($chip-outline-info-focus-bg-color, 12%) !default;
$chip-outline-info-avatar-active-bg-color: lighten($chip-outline-info-active-bg-color, 12%) !default;
$chip-outline-info-avatar-focus-active-bg-color: lighten($chip-outline-info-focus-active-bg-color, 12%) !default;
$chip-outline-info-avatar-pressed-bg-color: lighten($chip-outline-info-pressed-bg-color, 12%) !default;
$chip-outline-info-avatar-disabled-bg-color: lighten($chip-outline-info-disabled-bg-color, 12%) !default;
$chip-outline-info-font-color: $brand-info !default;
...
$chip-outline-info-border-color: $brand-info !default;
$chip-outline-info-hover-border-color: darken($chip-info-bg-color, 0%) !default;
$chip-outline-info-focus-border-color: darken($chip-info-bg-color, 10%) !default;
$chip-outline-info-active-border-color: darken($chip-info-bg-color, 10%) !default;
$chip-outline-info-focus-active-border-color: $chip-outline-info-focus-border-color !default;
$chip-outline-info-pressed-border-color: darken($chip-info-bg-color, 10%) !default;
...
$chip-outline-warning-hover-bg-color: darken($chip-warning-bg-color, 5%) !default;
$chip-outline-warning-focus-bg-color: darken($chip-warning-bg-color, 10%) !default;
...
$chip-outline-warning-pressed-bg-color: darken($chip-warning-bg-color, 15%) !default;
$chip-outline-warning-disabled-bg-color: transparent !default;
$chip-outline-warning-avatar-bg-color: lighten($chip-warning-bg-color, 10%) !default;
$chip-outline-warning-avatar-hover-bg-color: $chip-outline-warning-avatar-bg-color !default;
$chip-outline-warning-avatar-focus-bg-color: lighten($chip-outline-warning-focus-bg-color, 12%) !default;
$chip-outline-warning-avatar-active-bg-color: lighten($chip-outline-warning-active-bg-color, 12%) !default;
$chip-outline-warning-avatar-focus-active-bg-color: lighten($chip-outline-warning-focus-active-bg-color, 12%) !default;
$chip-outline-warning-avatar-pressed-bg-color: lighten($chip-outline-warning-pressed-bg-color, 12%) !default;
$chip-outline-warning-avatar-disabled-bg-color: lighten($chip-outline-warning-disabled-bg-color, 12%) !default;
$chip-outline-warning-font-color: $brand-warning !default;
...
$chip-outline-warning-disabled-font-color: rgba($chip-warning-bg-color, .65) !default;
...
$chip-outline-warning-border-color: $brand-warning !default;
$chip-outline-warning-hover-border-color: darken($chip-warning-bg-color, 0%) !default;
$chip-outline-warning-focus-border-color: darken($chip-warning-bg-color, 10%) !default;
$chip-outline-warning-active-border-color: darken($chip-warning-bg-color, 10%) !default;
$chip-outline-warning-focus-active-border-color: $chip-outline-warning-focus-border-color !default;
$chip-outline-warning-pressed-border-color: darken($chip-warning-bg-color, 10%) !default;
$chip-outline-warning-disabled-border-color: rgba($chip-warning-bg-color, .65) !default;

//danger
$chip-outline-danger-bg-color: transparent !default;
$chip-outline-danger-hover-bg-color: darken($chip-danger-bg-color, 5%) !default;
$chip-outline-danger-focus-bg-color: darken($chip-danger-bg-color, 10%) !default;
...
$chip-outline-danger-pressed-bg-color: darken($chip-danger-bg-color, 15%) !default;
$chip-outline-danger-disabled-bg-color: transparent !default;
$chip-outline-danger-avatar-bg-color: lighten($chip-danger-bg-color, 10%) !default;
$chip-outline-danger-avatar-hover-bg-color: $chip-outline-danger-avatar-bg-color !default;
$chip-outline-danger-avatar-focus-bg-color: lighten($chip-outline-danger-focus-bg-color, 12%) !default;
$chip-outline-danger-avatar-active-bg-color: lighten($chip-outline-danger-active-bg-color, 12%) !default;
$chip-outline-danger-avatar-focus-active-bg-color: lighten($chip-outline-danger-focus-active-bg-color, 12%) !default;
$chip-outline-danger-avatar-pressed-bg-color: lighten($chip-outline-danger-pressed-bg-color, 12%) !default;
$chip-outline-danger-avatar-disabled-bg-color: lighten($chip-outline-danger-disabled-bg-color, 12%) !default;
$chip-outline-danger-font-color: $brand-danger !default;
...
$chip-outline-danger-disabled-font-color: rgba($chip-danger-bg-color, .65) !default;
...
$chip-outline-danger-border-color: $brand-danger !default;
$chip-outline-danger-hover-border-color: darken($chip-danger-bg-color, 0%) !default;
$chip-outline-danger-focus-border-color: darken($chip-danger-bg-color, 10%) !default;
$chip-outline-danger-active-border-color: darken($chip-danger-bg-color, 10%) !default;
$chip-outline-danger-focus-active-border-color: $chip-outline-danger-focus-border-color !default;
$chip-outline-danger-pressed-border-color: darken($chip-danger-bg-color, 10%) !default;
$chip-outline-danger-disabled-border-color: rgba($chip-danger-bg-color, .65) !default;
