...
$chip-delete-icon-font-size: $text-xxs !default;
$chip-delete-icon-size: 24px !default;
$chip-delete-icon-margin: 2px -4px 0 4px !default;
...
$chip-touch-font-size: $text-lg !default;
$chip-touch-height: 32px !default;
$chip-touch-text-line-height: 27px !default;
...
$chip-touch-delete-icon-font-size: $text-xs !default;
...
//normal
$chip-bg-color: $content-bg-color-alt2 !default;
$chip-hover-bg-color: $content-bg-color-alt3 !default;
$chip-focus-bg-color: $content-bg-color-alt3 !default;
$chip-choice-active-bg-color: $primary !default;
$chip-active-bg-color: $content-bg-color-alt5 !default;
$chip-focus-active-bg-color: $content-bg-color-alt5 !default;
$chip-choice-focus-active-bg-color: $primary !default;
$chip-pressed-bg-color: $content-bg-color-alt5 !default;
$chip-disabled-bg-color: $secondary-bg-color-disabled !default;
$chip-pressed-active-bg-color: $primary !default;
$chip-avatar-bg-color: $content-bg-color-alt2 !default;
$chip-avatar-hover-bg-color: $content-bg-color-alt2 !default;
$chip-avatar-focus-bg-color: $content-bg-color-alt2 !default;
$chip-avatar-active-bg-color: $content-bg-color-alt2 !default;
...
$chip-avatar-pressed-bg-color: $content-bg-color-alt2 !default;
$chip-avatar-pressed-active-bg-color: $content-bg-color-alt2 !default;
...
$chip-close-icon-font-color: $content-text-color !default;
$chip-close-icon-hover-font-color: $content-text-color !default;
$chip-close-icon-pressed-font-color: $content-text-color !default;
$chip-icon-font-color: $content-text-color !default;
$chip-icon-hover-font-color: $content-text-color !default;
$chip-icon-focus-font-color: $content-text-color !default;
$chip-icon-active-font-color: $content-text-color !default;
$chip-icon-focus-active-font-color: $content-text-color !default;
$chip-choice-icon-focus-active-font-color: $primary-text-color !default;
$chip-icon-pressed-font-color: $content-text-color !default;
$chip-avatar-font-color: $icon-color !default;
$chip-avatar-hover-font-color: $icon-color !default;
$chip-avatar-focus-font-color: $icon-color !default;
$chip-avatar-active-font-color: $icon-color !default;
...
$chip-avatar-pressed-font-color: $icon-color !default;
$chip-avatar-pressed-active-font-color: $icon-color !default;
$chip-avatar-disabled-font-color: $chip-disabled-font-color !default;
$chip-border-color: $content-bg-color-alt2 !default;
$chip-hover-border-color: $content-bg-color-alt3 !default;
$chip-focus-border-color: $content-bg-color-alt3 !default;
...
$chip-pressed-border-color: $content-bg-color-alt5 !default;
$chip-disabled-border-color: $content-bg-color-alt2 !default;
...
$chip-outline-hover-bg-color: $content-bg-color-alt3 !default;
$chip-outline-focus-bg-color: $content-bg-color-alt2 !default;
$chip-outline-choice-active-bg-color: $primary !default;
$chip-outline-active-bg-color: $content-bg-color-alt5 !default;
...
$chip-outline-pressed-bg-color: $content-bg-color-alt5 !default;
$chip-outline-pressed-active-bg-color: $content-bg-color-alt5 !default;
$chip-outline-disabled-bg-color: transparent !default;
$chip-outline-avatar-bg-color: $content-bg-color-alt2 !default;
$chip-outline-avatar-hover-bg-color: $content-bg-color-alt2 !default;
$chip-outline-avatar-focus-bg-color: $content-bg-color-alt2 !default;
$chip-outline-avatar-active-bg-color: $content-bg-color-alt2 !default;
$chip-outline-avatar-choice-active-bg-color: $primary !default;
$chip-outline-avatar-focus-active-bg-color: $content-bg-color-alt2 !default;
$chip-outline-avatar-choice-focus-active-bg-color: $primary !default;
$chip-outline-avatar-pressed-bg-color: $content-bg-color-alt2 !default;
$chip-outline-avatar-pressed-active-bg-color: $content-bg-color-alt2 !default;
...
$chip-outline-close-icon-hover-font-color: $content-text-color !default;
$chip-outline-close-icon-pressed-font-color: $content-text-color !default;
$chip-outline-icon-font-color: $icon-color !default;
$chip-outline-icon-hover-font-color: $content-text-color !default;
$chip-outline-icon-focus-font-color: $content-text-color !default;
$chip-outline-icon-active-font-color: $content-text-color !default;
$chip-outline-icon-focus-active-font-color: $content-text-color !default;
$chip-outline-choice-icon-focus-active-font-color: $primary-text-color !default;
$chip-outline-icon-pressed-font-color: $content-text-color !default;
...
$chip-outline-border-color: $content-text-color !default;
$chip-outline-hover-border-color: $content-bg-color-alt3 !default;
$chip-outline-focus-border-color: $content-bg-color-alt3 !default;
$chip-outline-choice-active-border-color: $primary !default;
$chip-outline-active-border-color: $content-bg-color-alt5 !default;
$chip-outline-focus-active-border-color: $content-bg-color-alt5 !default;
$chip-outline-choice-focus-active-border-color: $primary !default;
$chip-outline-pressed-border-color: $content-bg-color-alt5 !default;
$chip-outline-disabled-border-color: $content-bg-color-alt3 !default;
$chip-outline-border-size: 1px !default;
$chip-outline-border-style: solid !default;
...
$chip-outline-avatar-size: 22px !default;
...
$chip-success-border-color: $success-border-color !default;
...
$chip-danger-disabled-font-color: $danger-text-disabled !default;
