...
$switch-active-background: initial !default;
$switch-wrapper-height: 20px !default;
$switch-handle-bg-color: $bg-base-100 !default;
$switch-off-bg-color: #000 !default;
...
$switch-inner-border-style: 1px solid #a6a6a6 !default;
$switch-handle-margin: auto 0 !default;
$switch-inner-active: $selection-bg !default;
...
$switch-focused-outline: $border-fg 1px solid !default;
$switch-focused-outline-active: $border-fg 1px solid !default;
$switch-focused-outline-offset: 1px !default;
$switch-handle-shadow: none !default;
$switch-active-handle-bg: $bg-base-0 !default;
$switch-inner-active-bg: $selection-bg !default;
$switch-inner-active-border-color: $selection-bg !default;
$active-bar-opacity: 1 !default;
$switch-focus-border-color-active: $selection-bg !default;
$switch-off-opacity: 1 !default;
$switch-font-family: $font-family !default;
$switch-font-size: 12px !default;
$switch-on-off-disabled-bg-color: #000 !default;
$switch-on-disabled-bg-color: $switch-on-off-disabled-bg-color !default;
$switch-on-off-disabled-bg-color-opacity: 1 !default;
$switch-handle-disabled-bg-color: $disable !default;
$switch-handle-on-disabled-bg-color: $switch-handle-disabled-bg-color !default;
$switch-border-disabled-bg-color: $disable !default;
$switch-disabled-font-color: $disable !default;
$switch-on-off-hover-bg-color: $selection-bg !default;
$switch-inner-focus-bg-color: $selection-bg !default;
$switch-on-hover-bg-color: $hover-bg !default;
$switch-inner-hover-bg-color: $hover-bg !default;
$switch-inner-hover-border-color: $hover-border !default;
$switch-inner-focus-border: $hover-border !default;
$switch-hover-border: initial !default;
...
$switch-inner-on-font-color: #000 !default;
$switch-inner-off-font-color: $content-font !default;
...
$switch-handle-off-hover-bg-color: $bg-base-100 !default;
...
$switch-bigger-off-text-indent: 16px !default;
...
$switch-bigger-small-on-text-indent: -11px !default;
...
$bigger-small-padding-top: 1px !default;
