...
$switch-handle-bg-color: $neutral-tertiary !default;
...
$switch-active-handle-bg: $theme-primary-font !default;
...
$switch-on-off-disabled-bg-color: $neutral-white !default;
...
$switch-inner-focus-bg-color: $theme-primary !default;
$switch-on-disabled-bg-color: $neutral-white !default;
$switch-inner-focus-border: $neutral-secondary !default;
$switch-on-hover-bg-color: $theme-dark !default;
$switch-inner-hover-bg-color: $theme-dark !default;
$switch-inner-hover-border-color: $theme-dark !default;
...
$switch-inner-on-font-color: $theme-primary-font !default;
$switch-inner-off-font-color: #a6a6a6 !default;
$switch-inner-hover-on-font-color: $theme-primary-font !default;
$switch-handle-hover-bg-color: $theme-primary-font !default;
$switch-handle-off-hover-bg-color: $theme-primary-font !default;
