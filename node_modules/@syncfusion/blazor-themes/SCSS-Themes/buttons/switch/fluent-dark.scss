...
//layout variables
$switch-wrapper-width: 40px !default;
...
$switch-bigger-wrapper-width: 48px !default;
...
$switch-bigger-handle-left: 4px !default;
...
$switch-bigger-small-wrapper-width: 46px !default;
...
$switch-checked-ripple-bg-color: rgba(0, 0, 0, 0) !default;
$switch-ripple-bg-color: rgba(255, 64, 129, 0) !default;
$switch-on-disabled-bg-color: $content-bg-color-alt6 !default;
$switch-inner-hover-on-font-color: $primary-text-color !default;
$switch-handle-off-hover-bg-color: $border-alt !default;
