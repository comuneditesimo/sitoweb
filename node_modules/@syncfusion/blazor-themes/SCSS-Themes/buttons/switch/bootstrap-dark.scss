...
$switch-inner-border-style: 2px solid $grey-white !default;
...
$switch-inner-bg: $grey-white !default;
$switch-handle-bg-color: $brand-primary-font !default;
$switch-hover-bg-color: $grey-8c !default;
...
$switch-inner-hover-bg-color: darken($brand-primary, 15%) !default;
$switch-inner-hover-border-color: darken($brand-primary, 15%) !default;
$switch-inner-on-font-color: $brand-primary-font !default;
$switch-inner-off-font-color: $grey-light-font !default;
$switch-inner-focus-border: $grey-99 !default;
$switch-on-hover-bg-color: transparent !default;
$switch-on-off-disabled-bg-color: $grey-88 !default;
$switch-on-disabled-bg-color: $switch-on-off-disabled-bg-color !default;
$switch-on-off-disabled-bg-color-opacity: 1 !default;
$switch-handle-disabled-bg-color: $grey-white !default;
$switch-handle-on-disabled-bg-color: $switch-handle-disabled-bg-color !default;
$switch-border-disabled-bg-color: $grey-88 !default;
$switch-disabled-font-color: $grey-8c !default;
$switch-on-off-hover-bg-color: darken($brand-primary, 15%) !default;
$switch-inner-focus-bg-color: darken($brand-primary, 15%) !default;
$switch-inner-focus-off-bg: $grey-99 !default;
$switch-on-disabled-bg-color: transparent !default;
$switch-focus-border-color-active: darken($brand-primary, 15%) !default;
$switch-hover-border: $grey-8c !default;
$switch-hover-active-border: darken($brand-primary, 15%) !default;
