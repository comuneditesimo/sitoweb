...
$radio-btn-background-color: $bg-base-0 !default;
$radio-btn-border: 2px solid !default;
$radio-btn-border-color: $border-fg !default;
...
$radio-btn-checked-border-color: $selection-bg !default;
$radio-btn-checked-color: $selection-bg !default;
...
$radio-btn-font-color: $bg-base-100 !default;
$radio-btn-font-size: 14px !default;
$radio-btn-focussed-box-shadow: none !default;
$radio-btn-hover-bgcolor: $bg-base-0 !default;
$radio-btn-hover-border-color: $selection-bg !default;
$radio-btn-hover-check-bg-color: $selection-bg !default;
$radio-btn-hover-check-border-color: $selection-bg !default;
$radio-btn-focus-check-bg-color: $selection-bg !default;
$radio-btn-focus-check-border-color: $selection-bg !default;
...
$radio-btn-focus-outline: $border-fg 1px solid !default;
