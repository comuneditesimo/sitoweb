...
$sd-overlay-bg: rgba(107, 114, 128, .75) !default;
$sd-li-shadow: 0 4px 6px -1px rgba(0, 0, 0, .05), 0 10px 15px -3px rgba(0, 0, 0, .1) !default;

$sd-li-bg: $grey-800 !default;
$sd-li-border-color: $grey-800 !default;
$sd-font-color: $grey-dark-font !default;

$sd-disabled-li-bg: $grey-800 !default;
$sd-disabled-li-border-color: $grey-800 !default;
$sd-disabled-font-color: $grey-dark-font !default;

$sd-focus-li-bg: $grey-600 !default;
$sd-focus-li-border-color: $grey-600 !default;
$sd-focus-font-color: $sd-font-color !default;

$sd-hover-li-bg: $grey-600 !default;
$sd-hover-li-border-color: $grey-600 !default;
$sd-hover-font-color: $sd-font-color !default;

$sd-active-li-bg: $grey-500 !default;
