...
$sd-li-icon-border-radius: 8px !default;
...
$sd-li-bg: $content-bg-color-alt2 !default;
$sd-li-border-color: $content-bg-color-alt2 !default;
$sd-font-color: rgba($secondary-text-color) !default;

$sd-disabled-li-bg: $content-bg-color-alt2 !default;
$sd-disabled-li-border-color: $content-bg-color-alt2 !default;
$sd-disabled-font-color: $sd-font-color !default;

$sd-focus-li-bg: $content-bg-color-alt2 !default;
$sd-focus-li-border-color: $content-bg-color-alt2 !default;
$sd-focus-font-color: $sd-font-color !default;
$sd-focus-box-shadow: $sd-li-shadow, $shadow-focus-ring1 !default;

$sd-hover-li-bg: $content-bg-color-alt3 !default;
$sd-hover-li-border-color: $content-bg-color-alt3 !default;
$sd-hover-font-color: $sd-font-color !default;

$sd-active-li-bg: $content-bg-color-alt4 !default;
