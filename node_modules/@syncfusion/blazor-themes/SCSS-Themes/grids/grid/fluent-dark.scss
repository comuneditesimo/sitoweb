...
@import '../../dropdowns/drop-down-list/fluent-dark.scss';
@import '../../inputs/input/fluent-dark.scss';
@import '../../popups/popup/fluent-dark.scss';
@import '../../popups/spinner/fluent-dark.scss';
...
@import '../../inputs/numerictextbox/fluent-dark.scss';
@import '../../popups/tooltip/fluent-dark.scss';
@import '../../navigations/context-menu/fluent-dark.scss';
@import '../../calendars/datepicker/fluent-dark.scss';
@import '../../buttons/radio-button/fluent-dark.scss';
@import '../../lists/list-view/fluent-dark.scss';
@import '../../lists/sortable/fluent-dark.scss';
@import '../../calendars/datetimepicker/fluent-dark.scss';
@import '../../popups/dialog/fluent-dark.scss';
@import '../../navigations/h-scroll/fluent-dark.scss';
@import '../../navigations/v-scroll/fluent-dark.scss';
@import '../../navigations/toolbar/fluent-dark.scss';
@import '../../navigations/pager/fluent-dark.scss';
@import '../../grids/excel-filter/fluent-dark.scss';
// Color
...
$grid-header-bg-color: $transparent !default;
...
$group-row-bg-color: $content-bg-color-alt2 !default;
...
$grid-drag-clone-bg-color: $content-bg-color-alt2 !default;
...
$grid-val-error-color: $danger-dark !default;
...
$grid-responsive-btn-background: $content-bg-color !default;
...
$grid-headecell-height: 36px !default;
...
$grid-header-bottom-padding: 7px !default;
$grid-header-top-padding: 7px !default;
...
$grid-headercelldiv-line-height: 22px !default;
...
$grid-rtl-textwrap-srotnumber-rightalign-margin: 3px 5px 0 32px !default;
...
$grid-bigger-grightarrow-icon-font-size: $text-lg !default;
$group-bigger-sorticon-margin-right: 0 !default;
$grid-bigger-groupdroparea-padding: 14.5px 24px !default;
$grid-bigger-group-headercell-height: 36px !default;
...
$grid-touch-device-hdrcell-ungroup-line-height: 26px !default;
...
$grid-checkbox-wrapper-top: -4.5px !default;
...
$grid-header-first-last-cell-padding: 7px !default;
$grid-headercell-both-border-width: 0 0 0 1px !default;
$grid-headercelldiv-margin: -5px !default;
$grid-icon-font-size: $text-base !default;
$grid-border-size: 1px !default;
$grid-header-padding: 7px !default;
$grid-header-wrap-sortfilter-div-margin: -34px 5px !default;
$grid-rtl-textwrap-sorticon-margin: -30px 5px !default;
$grid-rtl-textwrap-sorticon-rightalign-margin: -30px 17px !default;
$grid-headercelldiv-right-align-padding: 0 5px 0 20px !default;
$grid-headercell-line-height: 36px !default;
$grid-header-font-weight: $font-weight-medium !default;
...
$grid-bigger-toolbar-search-clear-icon-font-size: $text-lg !default;
...
$grid-responsive-toolbar-search-clear-icon-font-size: $text-lg !default;
...
$grid-bigger-command-column-padding-bottom: 4.5px !default;
$grid-bigger-command-column-padding-top: 4.5px !default;
...
$grid-sortdiv-right-align-margin: -30px 5px !default;
$grid-sortdiv-margin:  -30px 5px !default;
$grid-sortdiv-padding: 15px 0 !default;
$grid-ungroup-button-line-height: 22px !default;
$grid-ungroup-button-font-size: $text-xs !default;
$grid-grouparea-first-cell-margin: 0 6px 0 12px !default;
$grid-grouparea-font-size: $text-xs !default;
$grid-grouparea-margin: 4px 0 4px 4px !default;
$grid-group-headercell-line-height: 30px !default;
$grid-grouped-headercell-padding: 3px 0 !default;
$grid-grouped-headercell-span-padding: 4px 8px 4px 12px !default;
$grid-group-unpgroupicon-padding-right: 12px !default;
$grid-grouped-padding: 0 !default;
$group-area-padding: 13px 0 14px 0 !default;
...
$grid-group-down-arrow-icon-padding: 9px 7px 9px 7px !default;
$group-expand-icon-text-indent: 11px !default;
$group-sorticon-font-size: $text-xs !default;
...
$grid-group-right-arrow-icon-padding: 8px 7px 11px 7px !default;
$grid-group-unpgroupicon-padding-top: 8px !default;
...
$grid-group-height: 44px !default;
$grid-ungroup-rtl-padding-top: 8px !default;
$grid-bigger-ungroup-rtl-padding-top: $grid-ungroup-rtl-padding-top !default;
$grid-rtl-group-headercell-margin-right: 4px !default;
$grid-rtl-group-headercell-margin-left: 0 !default;
$grid-fltr-rtl-sortnumber-margin: 2px 0 0 15px !default;
$grid-rtl-sortnumber-margin: 2px 0 0 8px !default;
$grid-fltr-rtl-sortnumber-rightalign-margin: 2px 0 0 14px !default;
$grid-rtl-sortnumber-rightalign-margin: 3px 0 0 8px !default;
$grid-rtl-sortcelldiv-margin: -30px 10px !default;
$grid-rtl-sortcelldiv-right-align-margin: -30px 3px !default;
$grid-rtl-bigger-sortcelldiv-right-align-margin: -31px 6px !default;
$grid-rtl-bigger-sortcelldiv-margin: -33px 5px !default;
...
$grid-bigger-rowcell-autofill-top-line-height: 14px !default;
$grid-bigger-rowcell-autofill-top-bottom-line-height: 12px !default;
$grid-bigger-font-size: $text-base !default;
$group-unpgrouicon-margin-left: -11px !default;
$grid-group-ungroupicon-margin-left: -9px !default;
$grid-group-clone-text-align: left !default;
$grid-clone-padding: 2px 8px 2px !default;
...
$grid-bigger-groupedcell-padding: 0 !default;
$grid-bigger-group-headercell-margin: 6px 0 6px 8px !default;
$grid-bigger-group-headercell-padding: 6px 0 !default;
$grid-device-group-headercell-padding: 3px 0 6px !default;
...
$grid-bigger-grouparea-font-size: $text-sm !default;
...
$grid-bigger-ungroupbutton-icon-margin-top: -4px !default;
$grid-device-ungroupbutton-icon-margin-top: 0 !default;
$grid-bigger-groupcell-span-line-height: 30px !default;
$grid-bigger-groupcell-span-height: $grid-bigger-groupcell-span-line-height !default;
$grid-bigger-gdownarrow-icon-font-size: $text-lg !default;
...
$grid-columnchooser-content-padding: 24px 24px 0 24px !default;
$grid-bigger-columnchooser-content-padding: 28px 28px 0 28px !default;
...
$grid-bigger-columnchooser-btn-font-size: $text-lg !default;
$grid-bigger-sortdiv-rightalign-margin: -32px -5px !default;
$grid-bigger-sortdiv-margin: -32px -2px !default;
...
$grid-device-ungroupbutton-line-height: 28px !default;
$grid-device-groupheadercell-span-line-height: 28px !default;
...
$grid-headercelldiv-rightalign-fltricon-margin: -5px 14px -5px 0 !default;
...
$grid-rtl-fltrdiv-margin: -21px 0 -20px -35px !default;
$grid-rtl-bigger-fltrdiv-margin: -23px 2px -18px -10px !default;
$grid-bigger-rtl-headercelldiv-fltricon-padding: -5px -10px -5px 0 !default;
$grid-bigger-fltrdiv-margin: -19px -6px !default;
$grid-sortdiv-filtericon-margin: -30px 20px -29px 0 !default;
$grid-sortdiv-filtericon-rightalign-margin: $grid-sortdiv-right-align-margin !default;
$grid-rtl-sortdiv-filtericon-rightalign-margin: -30px -4px 1px 16px !default;
$grid-rtl-sortdiv-filtericon-margin: -30px -4px 1px 16px !default;
$grid-bigger-fltricon-sortdiv-rightalign-margin: -31px -20px 0 -4px !default;
$grid-bigger-fltricon-sortdiv-margin: -31px 18px -31px 0 !default;
$grid-rtl-bigger-fltricon-sortdiv-margin: -32px 0 0 15px !default;
$grid-rtl-bigger-fltricon-sortdiv-rightalign-margin: -32px 0 3px 18px !default;
...
$grid-column-menu-margin: -20px -21px -3px -19px !default;
$grid-column-menu-padding: 6px !default;
$grid-textwrap-column-menu-margin: -19px -20px -20px -20px !default;
$grid-bigger-column-menu-margin: -20.5px -21px -3px -19px !default;
$grid-bigger-device-column-menu-margin: -25px !default;
$grid-column-menu-top-touch: 10px !default;
$grid-column-menu-bottom-touch: 28px !default;
...
$grid-header-wrap-rightalign-sortfilter-div-margin: -34px -5px !default;
$grid-header-wrap-filtericon-sortfilter-div-margin: -33px 18px 0 16px !default;
...
$grid-header-wrap-filtericon-rightalign-sortfilter-div-margin: -33px 14px !default;
$grid-drag-font-size: $text-base !default;
...
$grid-bigger-flmenu-padding: 15px 0 1px !default;
...
$grid-bigger-ungroupbutton-icon-margin-right: 4px !default;
$grid-bigger-ungroupbutton-icon-padding-top: 0 !default;
$grid-bigger-font-size: $text-base !default;
$grid-rtl-bigger-rightalign-fltrdiv-margin: -23px 0 -18px -42px !default;
$grid-bigger-rtl-ungroup-icon-margin-left: -9px !default;
...
$grid-rtl-column-menu-margin: -21px -18px -1px -22px !default;
...
$grid-responsive-header-search: 6px !default;
...
$grid-responsive-icon-filter-clear: 16px !default;
...
$grid-responsive-header-padding-top: 3px !default;
...
$grid-responsive-btn-top: -4px !default;
$grid-responsive-apply-btn-top: 5px !default;
...
$grid-sortnumber-font-size: $text-xs !default;
...
$grid-sort-number-font-size: $font-icon-9 !default;
...
$grid-bigger-sort-margin: -31px 3px !default;
$grid-bigger-sort-right-margin: 2px 2px 0 0 !default;
$grid-skin: 'fluent' !default;
...
$grid-bigger-check-select-all-font-size: $text-lg !default;
$grid-adaptive-sort-clear-button-padding: 6px !default;
$grid-cc-margin-top: 2px !default;
$grid-bigger-rtl-cm-margin: -21px -18px -5px -22px !default;
$grid-bigger-device-rtl-cm-margin: -25px -18px -5px -22px !default;
$grid-bigger-rtl-group-span-padding: 11.5px 4px 14px 4px !default;
$grid-device-rtl-grouped-headercell-span-padding: $grid-device-grouped-headercell-span-padding !default;
$grid-rtl-group-span-padding: 4px 12px 4px 8px !default;
...
@include export-module('grid-fluent-icons') {
