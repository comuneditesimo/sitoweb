...
@import '../../calendars/datepicker/material-dark.scss';
...
@import '../../calendars/datetimepicker/material-dark.scss';
...
@import '../../navigations/pager/material-dark.scss';
@import '../../grids/excel-filter/material-dark.scss';
...
$grid-rtl-group-text-margin-left: 18px !default;
...
$grid-rtl-bigger-fltricon-sortdiv-margin: -17px 30px 0 8px !default;
$grid-rtl-bigger-fltricon-sortdiv-rightalign-margin: -17px 10px !default;
...
$grid-header-bg-color: $grey-dark !default;
$grid-header-color: rgba($grey-dark-font, .7) !default;
$grid-sorted-header-color: $grey-dark-font !default;
$grid-content-font-color: $grey-dark-font !default;
$grid-header-border-color: $grey-700 !default;
...
$grid-cell-border-color: $grey-700 !default;
...
$grid-drag-clone-bg-color: $grey-800 !default;
$grid-drag-clone-border-color: $grey-800 !default;
$grid-drag-clone-opacity: 1 !default;
$grid-drag-clone-color: $grey-dark-font !default;
$group-droparea-bg-color: $grey-900 !default;
$group-droparea-color: rgba($grey-dark-font, .7) !default;
$grid-grouparea-font-size: 14px !default;
$group-header-bg-color: $grey-800 !default;
$group-header-hover-bg-color: rgba($grey-white, .1) !default;
$group-border-width: 0 !default;
$grouped-droparea-bg-color: $grey-900 !default;
$group-droparea-hover-bg-color: $grey-900 !default;
$group-expand-icon-text-indent: 12px !default;
$group-collapse-icon-text-indent: 12px !default;
$group-row-bg-color: $grey-800 !default;
$grid-group-broder-color: $grey-700 !default;
...
$grid-default-color: $grey-dark !default;
$group-text-align: left !default;
$grid-icon-default-color: rgba($grey-white, .7) !default;
...
$grid-fltr-sortnumber-rightalign-margin: 7px 2px 0 5px !default;
...
$grid-fltr-sortnumber-margin: 7px -3px 0 2px !default;
...
$grid-device-headercell-padding: 0 22px $grid-header-bottom-padding !default;
...
$grid-resize-helper-color: $accent !default;
...
$frozen-border-color: rgba($grey-white, .8) !default;
$grid-frozenborder-disabled-color: $grey-dark !default;
$grid-freezeline-right-border: rgba($grey-300, .6) !default;
$grid-freezeline-border: 2px solid !default;
$grid-cell-focus-shadow: 0 0 0 1px rgba($grey-white, .5) inset !default;
$grid-cell-focus-border-color: rgba($grey-white, .5) !default;
...
$grid-textwrap-column-menu-margin: -14px -18px -18px -18px !default;
$grid-bigger-column-menu-margin: -18.5px -18px !default;
$grid-bigger-device-column-menu-margin:  -17px !default;
...
$grid-table-background-color: $grey-dark !default;
$grid-icon-color: $grey-dark-font !default;
$grid-command-icon-color: $grey-dark-font !default;
...
$grid-summary-row-bg-color: $grey-800 !default;
...
$grid-dragcell-border-color: $grey-700 !default;
...
$grid-clone-dropitemscount-color: $accent-font !default;
$grid-clone-row-border-color: $grey-300 !default;
$grid-dropitemscount-color: $accent-font !default;
$grid-clone-prop-box-shadow: 0 3px 8px 0 rgba($grey-black, .26) !default;
$grid-drag-icon-opacity: $grid-conent-font-opacity !default;
$grid-clone-dropitemscount-border: $grey-600 !default;
$grid-clone-dragdrop-bg-color: $grey-800 !default;
...
$grid-rtl-column-menu-margin: -19px -18px -18px 1px !default;
...
$grid-responsive-close-icon-margin: 10px !default;
...
$grid-responsive-search-icon-margin: 10px !default;
...
$grid-responsive-header-background: $grey-800 !default;
...
$grid-responsive-search-place-holder-margin-top: 5px !default;
$grid-responsive-search-width: 18px !default;
$grid-responsive-search-left-padding: 0 !default;
$grid-responsive-filter-clear-margin: 4px !default;
...
$grid-rtl-sort-num-left-align-margin: 7px -4px 0 0 !default;
...
$grid-btn-disabled-bgcolor: rgba($grey-white, .1) !default;
...
$grid-bigger-sort-margin: -15px 3px !default;
...
$grid-toolbar-placeholder-text-color: rgba($grey-dark-font, .6) !default;
