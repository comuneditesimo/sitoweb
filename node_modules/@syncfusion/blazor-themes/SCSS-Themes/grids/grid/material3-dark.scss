...
@import '../../calendars/calendar/material3-dark.scss';
...
@import '../../calendars/datepicker/material3-dark.scss';
...
@import '../../calendars/datetimepicker/material3-dark.scss';
...
@import '../../navigations/pager/material3-dark.scss';
@import '../../grids/excel-filter/material3-dark.scss';
$grid-content-padding: 8px !default;
$grid-headecell-height: 24px !default;
$grid-font-size: 14px !default;
$grid-icon-color: rgba($icon-color) !default;
$grid-command-icon-color: rgba($icon-color) !default;
...
$grid-sorted-header-color: rgba($content-text-color) !default;
...
$grid-table-background-color: rgba($content-bg-color) !default;

$grid-row-selection-color: rgba($icon-color-pressed) !default;
$grid-cell-selection-color: rgba($content-bg-color-selected) !default;

$grid-drag-clone-color: rgba($content-text-color-alt1) !default;

$group-droparea-hover-color: rgba($black) !default;

$grid-group-broder-color:  rgba($border) !default;
$grid-group-hover-broder-color: rgba($border) !default;
$grid-group-text-line-height: 13px !default;

$grid-wrap-line-height: 18px !default;
$grid-wrap-margin-bottom: 2px !default;
$grid-wrap-margin-top: 0 !default;

$grid-header-bottom-padding: 6px !default;
$grid-header-top-padding: 6px !default;
...
$grid-bigger-headercelldiv-line-height: 23px !default;
...
$grid-columnchooser-search-border-fcolor: rgba($border-focus) !default;
...
$grid-bigger-headercell-bootom-padding: 7px !default;
$grid-bigger-grightarrow-icon-font-size: 20px !default;
$group-bigger-sorticon-margin-right: 0 !default;
$grid-bigger-groupdroparea-padding: 14px 15px !default;
...
$grid-device-gridheader-row-span-padding: 13px !default;
$grid-touch-device-hdrcell-span-line-height: 14px !default;
$grid-touch-device-hdrcell-ungroup-line-height: 13px !default;
...
$grid-header-bg-color: rgba($content-bg-color) !default;
$grid-header-color: rgba($content-text-color) !default;
...
$grid-header-border-color: rgba($border-light) !default;
...
$grid-cell-border-color: rgba($border-light) !default;
...
$grid-toolbar-search-width: 160px !default;
$grid-bigger-toolbar-search-width: 200px !default;
$grid-toolbar-search-icon-min-width: 32px !default;
$grid-toolbar-search-clear-icon-min-width: 32px !default;
$grid-toolbar-search-clear-icon-font-size: 16px !default;
...
$grid-bigger-toolbar-search-clear-icon-min-width: 40px !default;
$grid-bigger-toolbar-search-clear-icon-margin: 0 !default;
$grid-bigger-toolbar-search-clear-icon-font-size: 20px !default;
$grid-rtl-bigger-toolbar-search-clear-icon-padding: 0 !default;
$grid-rtl-bigger-toolbar-search-clear-icon-min-width: 40px !default;
...
$grid-filterbarcell-padding: 0 8px 3px !default;
$grid-filterbar-input-border-width: 0 !default;
$grid-border-radius: 1px !default;
$grid-bottom-border-size: 1px !default;
$group-droparea-bg-color: $content-bg-color-alt2 !default;
$group-header-bg-color: $content-bg-color-alt2 !default;
...
$grid-fltr-sortnumber-margin: 0 8px 0 8px !default;
...
$grid-group-headercell-line-height: 12px !default;
$grid-grouped-headercell-padding: 5px 0 !default;

$grid-grouped-headercell-span-padding: 6px !default;
$grid-group-unpgroupicon-padding-right: 6px !default;
$group-droparea-hover-bg-color: rgba($content-bg-color) !default;
$group-header-hover-bg-color: $content-bg-color-hover !default;
$grid-grouped-padding: 0 8px 8px !default;
$group-area-padding: 11px 0 !default;
$grid-grouptext-margin-right: 0 !default;
$group-header-color: rgba($content-text-color-alt1) !default;
$group-grouped-droparea-bg-color: rgba($content-bg-color) !default;
$group-border-width: 1px !default;

$grouped-text-font-size: 12px !default;
$group-header-border-radius: 5px !default;
$grid-hover-icon-color: rgba($icon-color-hover) !default;
$grid-headecell-span-height: 22px !default;
$grid-drag-clone-opacity: 1 !default;
$grouped-droparea-bg-color: $content-bg-color-alt2 !default;
$grid-drag-clone-border-color: $content-bg-color-alt5 !default;
$grid-drag-clone-bg-color: $content-bg-color-alt5 !default;
$group-caption-font-color: rgba($content-text-color-alt1) !default;
$grid-group-down-arrow-icon-font-size: 16px !default;
$grid-group-down-arrow-icon-padding: 6px 11px 6px 8px !default;
$group-expand-icon-text-indent: 11px !default;
$group-droparea-color: rgba($content-text-color-alt1) !default;
...
$grid-group-right-arrow-icon-padding: 6px 11px 6px 8px !default;
$grid-group-unpgroupicon-padding-top: 6px !default;
$grid-summary-cell-line-height: 20px !default;
$grid-batch-updated-bg-color: rgba($success-light) !default;
$grid-val-error-color: rgba($danger) !default;
$grid-val-error-bg-color: rgba($danger-light) !default;
$grid-edit-input-padding-bottom: 1px !default;
$grid-edit-input-padding-top: 2px !default;
$grid-edit-input-margin: 3px !default;
$grid-edit-cell-padding: 2px !default;
$grid-group-height: 41px !default;
$grid-ungroup-rtl-padding-top: 6px !default;
$grid-bigger-ungroup-rtl-padding-top: 8px !default;
$grid-rtl-group-headercell-margin-right: 8px !default;
$grid-rtl-group-headercell-margin-left: 0 !default;
$grid-fltr-rtl-sortnumber-margin: 0 0 0 12px !default;
...
$grid-rtl-headercelldiv-padding: 0 .4em 0 3.1em !default;
...
$group-sorticon-margin-left: -5px !default;
$group-sorticon-margin-top: 0 !default;
$grid-bigger-headercell-line-height: 38px !default;
$grid-bigger-rhandler-height: $grid-bigger-headercell-line-height !default;
$grid-bigger-rowcell-line-height: 20px !default;
$grid-bigger-font-size: 16px !default;
$group-unpgrouicon-margin-left: -7px !default;
...
$grid-bigger-content-padding: 14px !default;
$grid-bigger-group-line-height: 49px !default;
$grid-bigger-content-right-padding: 12px !default;
$grid-bigger-headercell-font-size: 14px !default;
...
$grid-bigger-groupedcell-padding: 0 8px 8px !default;
$grid-bigger-group-headercell-margin: 8px 0 0 8px !default;
$grid-bigger-group-headercell-padding: 0 !default;
...
$grid-bigger-icons-font-size: 20px !default;
$group-collapse-icon-text-indent: 11px !default;
$grid-bigger-grouparea-font-size: $grid-bigger-content-font-size !default;
$grid-bigger-grouped-headercell-border-radius: 8px !default;
$grid-bigger-groupedcell-icons-marign-left: -5px !default;
$grid-bigger-ungroupbutton-icons-font-size: 16px !default;
$grid-bigger-groupcell-span-padding: 6px 7px !default;
$grid-device-grouped-headercell-span-padding: 6px 7px !default;
$grid-bigger-ungroupbutton-icon-margin-left: -9px !default;
$grid-bigger-ungroupbutton-icon-margin-top: 2px !default;
$grid-device-ungroupbutton-icon-margin-top: 0 !default;
$grid-bigger-groupcell-span-line-height: 16px !default;
$grid-bigger-groupcell-span-height: 30px !default;
$grid-bigger-gdownarrow-icon-font-size: 20px !default;
...
$grid-column-chooser-searchdiv: 0 0 1px 0 !default;
...
$grid-columnchooser-content-padding: 14px 12px 0 12px !default;
$grid-bigger-columnchooser-content-padding: 16px 16px 0 16px !default;
...
$grid-bigger-columnchooser-content-margin: 25px 0 0 !default;
$grid-bigger-columnchooser-btn-font-size: 16px !default;
$grid-bigger-sortdiv-rightalign-margin: -17px 4px -12px -2px !default;
$grid-bigger-sortdiv-margin: -17px -2px -12px 12px !default;
...
$grid-bigger-filterbarcell-text-input: 32px !default;
$grid-columnchooser-li-padding: 7px 0 !default;
$grid-edit-input-bigger-margin: 5px !default;
$grid-device-ungroupbutton-line-height: 17px !default;
$grid-device-groupheadercell-span-line-height: 18px !default;
$frozen-border-color: rgba($border-light) !default;
...
$grid-frozenborder-disabled-color: rgba($content-bg-color) !default;
$grid-cell-focus-shadow: 0 0 0 1px rgba($primary) inset !default;
$grid-cell-focus-border-color: rgba($primary) !default;
$grid-headercelldiv-fltricon-margin: -5px 20px -5px -5px !default;
$grid-headercelldiv-rightalign-fltricon-margin: -5px 20px -5px 10px !default;
...
$grid-e-firstrow-dragborder-bcolor: rgba($primary) !default;
...
$grid-rtl-bigger-fltricon-sortdiv-rightalign-margin: -19px 4px -14px 23px !default;
...
$grid-bigger-device-column-menu-margin: -14px !default;
$grid-column-menu-top-touch: 21px !default;
$grid-column-menu-bottom-touch: 21px !default;
$grid-column-menu-right-touch: 22px !default;
...
$grid-content-batch-font-color: rgba($success) !default;
...
$grid-drag-area-border: 1px solid rgba($primary) !default;
$grid-dragdrop-padding: 2px !default;
$grid-dragborder-box-shadow: 0 2px 0 0 rgba($primary-border-color) !default;
$grid-dragborder-cell-dashed: 1px dashed rgba($primary-border-color) !default;
...
$grid-dragcell-border-color: rgba($border-light) !default;
$grid-drap-drop-icon-color: rgba($icon-color) !default;
$grid-clone-dropitemscount-bg-color: rgba($primary) !default;
$grid-clone-dropitemscount-color: rgba($content-text-color-alt2) !default;
$grid-clone-row-border-color: rgba($border-light) !default;
$grid-dropitemscount-color: rgba($white) !default;
$grid-clone-prop-box-shadow: $shadow-md !default;
$grid-drag-icon-opacity: 1 !default;
$grid-clone-dropitemscount-border: rgba($border-light) !default;
$grid-clone-dragdrop-bg-color: $content-bg-color-alt3 !default;
$grid-group-clone-box-shadow: $shadow-md !default;
...
$grid-bigger-fltr-sortnumber-rightalign-margin: 0 3px 0 5px !default;
$grid-bigger-sortnumber-rightalign-margin: 0 2px 0 8px !default;
$grid-bigger-columnmenu-bottom: 13px !default;
$grid-bigger-sortnumber-margin: 0 12px 0 12px !default;
$grid-bigger-fltr-sortnumber-margin: 0 12px 0 12px !default;
...
$grid-bigger-ungroupbutton-icon-padding-top: 8px !default;
$grid-bigger-font-size: 14px !default;
$grid-rtl-bigger-rightalign-fltrdiv-margin: -19px 4px -14px -2px !default;
...
// group animator
$grid-group-animator-bigger-cell-margin: 8px 0 8px 8px !default;
$grid-group-animator-bigger-drop-height: 54px !default;
$grid-animator-bigger-area-margin: 8px !default;
...
$grid-animator-drag-icon: 22px !default;
$grid-animator-drag-icon-line-height: 24px !default;
...
$grid-animator-first-group: 8px 0 8px 8px !default;
$grid-animator-rtl-first-group: 8px 8px 8px 0 !default;
$grid-animator-margin-top-rtl: 15px !default;
$grid-filterbar-dropdown: 32px !default;
...
$grid-responsive-header-background: $content-bg-color-alt2 !default;
$grid-bigger-res-dlg-hdr-padding: 8px 28px 8px 16px !default;
...
$grid-responsive-btn-background: rgba($content-text-color-alt3) !default;
$grid-responsive-res-apply-btn-font-size: 14px !default;
$grid-responsive-res-apply-btn-margin-top: 0 !default;
$grid-responsive-sort-clear-btn-font-size: 14px !default;
$grid-responsive-sort-clear-margin-top: 0 !default;
$grid-responsive-icon-filter-clear: 20px !default;
$grid-responsive-icon-filter-clear-bottom: 10px !default;
$grid-responsive-btn-icon-font-size: 20px !default;
...
$grid-responsive-filter-clear-margin: 7px !default;
...
$grid-rtl-sort-num-left-align-margin: 0 8px 0 0 !default;
...
// bootstrap 5 support
$grid-outter-border: rgba($border-light) !default;
$grid-btn-disabled-bgcolor: $secondary-bg-color-disabled !default;
$grid-sort-number-size: 20px !default;
$grid-bigger-sort-number-size: 24px !default;
$grid-sort-number-font-size: 14px !default;
$grid-filter-border-radius: 8px !default;
$grid-bigger-filter-border-radius: 16px !default;
$grid-adaptive-toolbar-icon-hover-bottom: 0 !default;
$grid-adaptive-cell-padding-bottom: 10px !default;
$grid-adaptive-cell-padding-top: 10px !default;
$grid-bigger-adaptive-cell-position-top: 10px !default;
$grid-bigger-sort-margin: -10px 2px !default;
$grid-bigger-sort-right-margin: 1px 8px 0 0 !default;
$grid-skin: 'material3' !default;
$grid-biggerreorderarrow-font-size: 14px !default;
$grid-bigger-drag-count-padding: 3px 8px 4px !default;
$grid-bigger-drag-count-top: -13px !default;
$grid-bigger-check-select-all-font-size: 14px !default;
$grid-adaptive-sort-clear-button-padding: 1px !default;
$grid-cc-margin-top: 0 !default;
$grid-bigger-rtl-cm-margin: -14px 4px -12px -16px !default;
$grid-bigger-device-rtl-cm-margin: $grid-bigger-rtl-cm-margin !default;
$grid-bigger-rtl-group-span-padding: 6px 8px !default;
$grid-device-rtl-grouped-headercell-span-padding: $grid-device-grouped-headercell-span-padding !default;
$grid-rtl-group-span-padding: 6px !default;
$grid-ungroup-rtl-padding-left: 8px !default;
$grid-column-reorder-icon-color: rgba($primary) !default;
$grid-bigger-headercell-top-padding: 7px !default;
$grid-bigger-headercell-autofit-padding: 7px 8px 7px !default;
$grid-bigger-icon-font-size: 20px !default;
$grid-rtl-mselect-dd-indicator-left: -3px !default;

$grid-toolbar-text-opacity: 1 !default;
$grid-toolbar-placeholder-text-color: rgba($placeholder-text-color) !default;
$grid-toolbar-searchbar-text-opacity: 1 !default;
$grid-dropitems-count-margin-left: -9px !default;
$grid-checkmark-color: rgba($primary-text-color) !default;
