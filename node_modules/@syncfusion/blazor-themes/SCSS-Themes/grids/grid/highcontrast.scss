@import '../../base/highcontrast.scss';
@import '../../dropdowns/drop-down-list/highcontrast.scss';
@import '../../inputs/input/highcontrast.scss';
@import '../../popups/popup/highcontrast.scss';
@import '../../popups/spinner/highcontrast.scss';
...
@import '../../inputs/numerictextbox/highcontrast.scss';
@import '../../popups/tooltip/highcontrast.scss';
@import '../../navigations/context-menu/highcontrast.scss';
@import '../../calendars/datepicker/highcontrast.scss';
@import '../../buttons/radio-button/highcontrast.scss';
@import '../../lists/list-view/highcontrast.scss';
@import '../../lists/sortable/highcontrast.scss';
@import '../../calendars/datetimepicker/highcontrast.scss';
@import '../../popups/dialog/highcontrast.scss';
@import '../../navigations/h-scroll/highcontrast.scss';
@import '../../navigations/v-scroll/highcontrast.scss';
@import '../../navigations/toolbar/highcontrast.scss';
@import '../../navigations/pager/highcontrast.scss';
@import '../../grids/excel-filter/highcontrast.scss';
...
$grid-header-bg-color: $bg-base-0 !default;
$grid-rows-bg-color: $bg-base-0 !default;
$grid-header-color: $content-font !default;
$grid-sorted-header-color: $content-font !default;
$grid-headerconent-font-opacity: 1 !default;
$grid-header-border-color: $border-default !default;
...
$grid-sortdiv-margin: -21px 0 !default;
...
$group-row-bg-color: $bg-base-10 !default;
$grid-summary-template-row-bg-color: $bg-base-10 !default;
$grid-summary-row-bg-color: $bg-base-10 !default;
...
$grid-cell-border-color: $border-default !default;
$grid-drag-clone-border-color: $border-default !default;
$grid-drag-clone-opacity: 1 !default;
$grid-content-font-color: $content-font !default;
$grid-hover-content-font-color: $hover-font !default;
$grid-conent-font-opacity: 1 !default;
$grid-row-selection-bg-color: $selection-bg !default;
$grid-row-selection-color: $selection-font !default;
$grid-hover-bg-color: $hover-bg !default;
$grid-cell-selection-bg-color: $selection-bg !default;
$grid-cell-selection-color: $selection-font !default;
$group-droparea-bg-color: $bg-base-10 !default;
$group-droparea-color: $content-font !default;
$grid-grouparea-font-size: 17px !default;
$group-header-border-radius: 0 !default;
$grid-drag-clone-color: $selection-font !default;
$grid-drag-clone-bg-color: $selection-bg !default;
$grouped-droparea-bg-color: $bg-base-10 !default;
$group-droparea-hover-bg-color: $bg-base-10 !default;
$group-header-bg-color: $bg-base-0 !default;
$group-header-color: $content-font !default;
$grid-group-height: 59px !default;
$grid-grouparea-margin: 8px 0 0 8px !default;
$group-area-padding: 16px 0 8px !default;
$grid-group-broder-color: $border-fg !default;
...
$grid-header-icon-color: $content-font !default;
$grid-grouptext-margin-right: 8px !default;
$grouped-text-font-size: 14px !default;
$group-sorticon-font-size: 12px !default;
$group-header-hover-bg-color: $hover-bg !default;
$grid-group-hover-broder-color: $hover-border !default;
...
$group-caption-font-color: $content-font !default;
$grid-group-captioncell-line-height: 20px !default;
$grid-bigger-groupcell-span-line-height: 29px !default;
$grid-bigger-groupcell-span-height: $grid-bigger-groupcell-span-line-height !default;
$grid-bigger-group-text-line-height: 29px !default;
$grid-group-down-arrow-icon-font-size: 12px !default;
$grid-group-down-arrow-icon-padding: 16px 9px 13px 8px !default;
$grid-group-right-arrow-icon-font-size: 12px !default;
$grid-group-right-arrow-icon-padding: 15px 9px 15px 8px !default;
...
$grid-sortnumber-margin: 8px 5px 0 2px !default;
$grid-fltr-sortnumber-margin: 8px -3px 0 2px !default;
$grid-fltr-sortnumber-rightalign-margin: 8px 2px 0 5px !default;
$grid-sortnumber-rightalign-margin: $grid-fltr-sortnumber-rightalign-margin !default;
$grid-icon-default-color: $content-font !default;
$grid-columnchooser-footer-border-color: $border-default !default;
$grid-columnchooser-footer-border-opacity: 1 !default;
$grid-columnchooser-search-border-fcolor: $selection-bg !default;
...
$grid-bigger-columnchooser-li-padding: 11px 0 10px !default;
...
$grid-rtl-sortcelldiv-margin: -22px 0 0 10px !default;
$grid-rtl-sortcelldiv-right-align-margin: -22px 0 0 0 !default;
...
$grid-bigger-group-headercell-height: round($grid-headecell-height*1.25) - 2 !default;
...
$grid-bigger-group-headercell-margin: 10px 0 0 10px !default;
$grid-bigger-group-headercell-padding: 1px 10px !default;
$grid-device-group-headercell-padding: 1px 10px !default;
...
$grid-val-error-color: $message-font !default;
$grid-val-error-bg-color: $error-bg !default;
$grid-resize-helper-color: $content-font !default;
...
$grid-rtl-fltrdiv-margin: -18px -7px !default;
$grid-rtl-bigger-fltrdiv-margin: -19px -7px !default;
$grid-cell-focus-shadow: 0 0 0 1px $border-default inset !default;
$grid-cell-focus-border-color: $border-default !default;

$grid-filtered-color: $selection-bg !default;
$grid-autofill-color: $selection-bg !default;
$grid-e-firstrow-dragborder-bcolor: $selection-bg !default;
$grid-filtermenu-icon: 'e21c' !default;
$grid-bigger-fltrdiv-margin: -25px -7px !default;
...
$grid-sortdiv-filtericon-rightalign-margin: -21px 0 0 8px !default;
$grid-sortdiv-filtericon-margin: -21px 15px 0 0 !default;
$grid-rtl-sortdiv-filtericon-rightalign-margin: -16px 0 0 12px !default;
$grid-rtl-sortdiv-filtericon-margin: -16px 0 0 10px !default;
...
$grid-bigger-column-menu-margin: -25px -24px !default;
$grid-bigger-device-column-menu-margin: -26px -20px !default;
$grid-column-menu-top-touch: 31px !default;
$grid-column-menu-bottom-touch: 38px !default;
$grid-column-menu-right-touch: 23px !default;
$grid-rtl-bigger-fltricon-sortdiv-margin: -16px 0 0 7px !default;
$grid-rtl-bigger-fltricon-sortdiv-rightalign-margin: -16px 0 0 8px !default;
$grid-selection-font-weight: normal !default;
$group-hover-border: 2px solid !default;
$grid-drag-clone-font-weight: $grid-selection-font-weight !default;
$grid-resize-border-width: 2px !default;
$grid-grouped-headercell-hover-padding: 0 7px !default;
$grid-table-background-color: $bg-base-0 !default;
$grid-sortnumber-bg-color: $bg-base-75 !default;
$grid-sortnumber-color: $invert-font !default;
$grid-batch-updated-bg-color: #56b873 !default;
$grid-content-batch-font-color: $selection-font !default;
$grid-bigger-group-headercell-hover-padding: 0 9px !default;

$grid-header-wrap-sortfilter-div-margin: -18px 11px !default;
$grid-header-wrap-rightalign-sortfilter-div-margin: -17px 10px 0 0 !default;
$grid-header-wrap-filtericon-sortfilter-div-margin: -17px 18px !default;
$grid-bigger-wrap-sortdiv-margin: -19px 6px !default;
$grid-bigger-wrap-rightalign-sortdiv-margin: -19px -4px !default;
$grid-bigger-wrap-fltricon-sortdiv-margin: -17px 11px !default;
$grid-bigger-wrap-rightalign-fltricon-sortdiv-margin: -18px 11px !default;
$grid-header-wrap-filtericon-rightalign-sortfilter-div-margin: -17px 8px !default;
...
$grid-dragborder-box-shadow: 0 2px 0 0 $selection-bg !default;
$grid-dragborder-cell-dashed: 1px dashed $selection-bg !default;
...
$grid-dragcell-border-color: $border-default !default;
$grid-drap-drop-icon-color: $content-font !default;
$grid-clone-dropitemscount-bg-color: $selection-bg !default;
$grid-clone-dropitemscount-color: $content-font-color !default;
$grid-clone-row-border-color: $border-default !default;
$grid-dropitemscount-color: $content-font !default;
$grid-clone-prop-box-shadow: 0 0 10px 0 rgba($bg-base-0, .2) !default;
$grid-drag-icon-opacity: $grid-conent-font-opacity !default;
$grid-clone-dropitemscount-border: $border-default !default;
...
$grid-rtl-column-menu-margin: -18px -18px -18px -6px !default;
...
// group animator
$grid-group-animator-bigger-cell-margin: 21px 0 20px 0;
$grid-group-animator-bigger-drop-height: 72px !default;
...
$grid-animator-margin-top-rtl: 21px !default;
$grid-filterbar-dropdown: 29px !default;
...
$grid-responsive-search-padding-left: 14px !default;
$grid-responsive-header-background: $bg-base-0 !default;
...
$grid-responsive-res-apply-btn-margin-top: -2px !default;
...
$grid-btn-disabled-bgcolor: $bg-base-0 !default;
...
$grid-bigger-sort-margin: -22px 3px !default;
$grid-bigger-sort-right-margin: 7px 2px 0 0 !default;
$grid-skin: 'highcontrast' !default;
...
$grid-cc-margin-top: 5px !default;
$grid-bigger-rtl-cm-margin: -26px -18px -18px -6px !default;
$grid-bigger-device-rtl-cm-margin: -26px -18px -18px -6px !default;
...
$grid-toolbar-placeholder-text-color: $content-font-alt !default;
$grid-toolbar-searchbar-text-opacity: 1 !default;
$grid-dropitems-count-margin-left: -8px !default;
$grid-checkmark-color: $selection-font !default;
