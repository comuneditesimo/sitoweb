@import '../../base/fabric-dark.scss';
@import '../../dropdowns/drop-down-list/fabric-dark.scss';
@import '../../inputs/input/fabric-dark.scss';
@import '../../popups/popup/fabric-dark.scss';
@import '../../popups/spinner/fabric-dark.scss';
...
@import '../../inputs/numerictextbox/fabric-dark.scss';
@import '../../popups/tooltip/fabric-dark.scss';
@import '../../navigations/context-menu/fabric-dark.scss';
@import '../../calendars/datepicker/fabric-dark.scss';
@import '../../buttons/radio-button/fabric-dark.scss';
@import '../../lists/list-view/fabric-dark.scss';
@import '../../lists/sortable/fabric-dark.scss';
@import '../../calendars/datetimepicker/fabric-dark.scss';
@import '../../popups/dialog/fabric-dark.scss';
@import '../../navigations/h-scroll/fabric-dark.scss';
@import '../../navigations/v-scroll/fabric-dark.scss';
@import '../../navigations/toolbar/fabric-dark.scss';
@import '../../navigations/pager/fabric-dark.scss';
@import '../../grids/excel-filter/fabric-dark.scss';
$grid-font-size: 13px !default;
$grid-icon-color: $default-icon-color !default;
$grid-command-icon-color: $default-icon-color !default;
$grid-hover-icon-color: $hover-icon-color !default;
...
$grid-vertical-border-size: $border-size !default;
...
$grid-frozen-shadow-background-color: rgba(95, 87, 87, .16) !default;
$grid-frozen-row-shadow-background-color: rgba(95, 87, 87, .26) !default;
...
$grid-filterbar-input-border-width: 1px !default;
$grid-filterbar-border-radius: 0 !default;
$group-border-width: 1px solid !default;
$group-collapse-icon-text-indent: 8px !default;
$group-expand-icon-text-indent: 8px !default;
$grid-clone-padding: 4px 5px !default;
$group-text-padding-right: 3px !default;
$group-sorticon-margin-left: 0 !default;
$group-sorticon-margin-top: 0 !default;
$group-ungroupicon-padding: 5px 3px !default;
$group-unpgrouicon-margin-left: 0 !default;
$grid-group-ungroupicon-margin-left: 0 !default;
$grid-rtl-group-sorticon-margin-left: 0 !default;
$grid-grouped-padding: 8px 8px 5px !default;
...
$grid-grouparea-first-cell-margin: '' !default;
...
$grid-gd-clone-border-radius: 0 !default;
...
$grid-bigger-groupedcell-padding: 11px 11px 12px !default;
...
$grid-touch-device-hdrcell-ungroup-line-height: 28px !default;
...
$grid-header-bg-color: $neutral-white !default;
$grid-header-color: $neutral-light-fontalt !default;
$grid-sorted-header-color: $neutral-light-font !default;
$grid-headerconent-font-opacity: 1 !default;
$grid-header-border-color: $neutral-light !default;
...
$grid-filterbarcell-padding: 0 8px !default;
$grid-filterdiv-padding: 2px 0 !default;
...
$grid-toolbar-search-icon-min-width: 30px !default;
$grid-bigger-toolbar-search-icon-min-width: 38px !default;
$grid-toolbar-search-wrapper-padding-top: 4px !default;
$grid-toolbar-search-wrapper-padding-bottom: 4px !default;
$grid-toolbar-search-clear-icon-min-width: 30px !default;
...
$grid-filterbarcell-text-indent: 10px !default;
$grid-sortdiv-margin: -21px -2px 0 0 !default;
$grid-sortdiv-right-align-margin: -21px 10px 0 0 !default;
$grid-sortnumer-line-height: 15px !default;
$grid-bigger-sortnumer-line-height: $grid-sortnumer-line-height !default;
$grid-sortnumber-border-radius: 55% !default;
$grid-rowcell-broder-width: 1px 0 0 !default;
$grid-rowcell-line-height: 21px !default;
$group-row-bg-color: $neutral-white !default;
$grid-first-last-rowcell-padding: 10px !default;
$grid-content-padding: 7px !default;
$grid-content-right-padding: 8px !default;
$grid-header-wrap-sortfilter-div-margin: -17px 11px 0 0 !default;
$grid-rtl-textwrap-sorticon-margin: -17px 17px !default;
$grid-rtl-textwrap-sorticon-rightalign-margin: -17px 17px !default;
...
$grid-summary-template-row-bg-color: $neutral-lighter !default;
$grid-cell-border-color: $neutral-light !default;
$grid-drag-clone-border-color: $neutral-light !default;
$grid-drag-clone-opacity: 1 !default;
$grid-content-font-color: $neutral-light-font !default;
$grid-hover-content-font-color: $neutral-light-fontalt !default;
$grid-conent-font-opacity: 1 !default;
$grid-row-selection-bg-color: $neutral-quintenary !default;
$grid-row-selection-color: $neutral-light-fontalt !default;
$grid-hover-bg-color: $neutral-light !default;
$grid-cell-selection-bg-color: $neutral-quintenary !default;
$grid-cell-selection-color: $neutral-light-fontalt !default;
$group-droparea-bg-color: $neutral-lighter-alt !default;
$group-droparea-color: $neutral-light-font !default;
$grid-grouparea-font-size: 17px !default;
$group-header-border-radius: 0 !default;
$grid-drag-clone-color: $neutral-light-fontalt !default;
$grid-drag-clone-bg-color: $neutral-quintenary !default;
$grouped-droparea-bg-color: $neutral-lighter-alt !default;
$group-droparea-hover-bg-color: $neutral-lighter-alt !default;
$group-header-bg-color: $neutral-light !default;
$group-header-color: $neutral-light-font !default;
$grid-group-height: 59px !default;
$grid-grouparea-margin: 8px 0 0 8px !default;
$group-area-padding: 16px 0 8px !default;
$grid-group-broder-color: $neutral-light !default;
$grid-group-headercell-line-height: 22px !default;
...
$grid-headecell-height: 26px !default;
$grid-filterbarcell-text-input: 32px !default;
$grid-grouped-headercell-padding: 1px 8px !default;
$grid-rtl-grouped-headercell-padding: 1px 0 1px 8px !default;
$group-sorticon-margin-right: 8px !default;
$grid-header-icon-color: $neutral-light-font !default;
$grid-grouptext-margin-right: 8px !default;
$grouped-text-font-size: 14px !default;
$group-sorticon-font-size: 12px !default;
$group-header-hover-bg-color: $neutral-quintenary !default;
$grid-group-hover-broder-color: $neutral-quintenary !default;
$grid-grouptopleftcell-border-top: 1px solid !default;
$grid-group-caption-font-size: 15px !default;
$grid-group-caption-header-padding: .7em !default;
$group-caption-font-color: $neutral-light-fontalt !default;
$grid-group-captioncell-line-height: 20px !default;
$grid-group-down-arrow-icon-font-size: 12px !default;
$grid-group-down-arrow-icon-padding: 16px 8px 13px 9px !default;
$grid-group-right-arrow-icon-font-size: 12px !default;
$grid-group-right-arrow-icon-padding: 14px 9px 15px 9px !default;
$grid-ungroup-button-line-height: 25px !default;
$grid-ungroup-button-font-size: 11px !default;
$grid-textwrap-sorticon-rightalign-margin: -15px 0 !default;
$grid-textwrap-sorticon-margin: -15px -5px !default;
...
$grid-fltr-sortnumber-margin: 8px 5px 0 2px !default;
$grid-fltr-sortnumber-rightalign-margin: 8px 0 0 7px !default;
$grid-sortnumber-rightalign-margin: 7px 0 0 15px !default;
$grid-icon-default-color: $neutral-light-font !default;
$grid-columnchooser-footer-border-color: rgba($neutral-black, .12) !default;
$grid-columnchooser-footer-border-opacity: 1 !default;
$grid-columnchooser-search-border-fcolor: $theme-primary !default;
$grid-columnchooser-input-padding-top: 1px !default;
$grid-columnchooser-input-padding-bottom: 1px !default;
$grid-column-chooser-searchdiv: 1px !default;
$grid-column-chooser-search-icon-padding: 2px 2px !default;
$grid-column-chooser-cancel-icon-padding: 4px 2px !default;
$grid-columnchooser-toolbar-div-margin-top: -2px !default;
$grid-bigger-columnchooser-li-padding: 11px 0 !default;
$grid-fltr-rtl-sortnumber-margin: 7px 0 0 7px !default;
$grid-rtl-sortnumber-margin: $grid-fltr-rtl-sortnumber-margin !default;
$grid-rtl-bigger-sortnumber-margin: 6px 0 0 3px !default;
$grid-rtl-bigger-sortnumber-withfilter-margin: $grid-rtl-bigger-sortnumber-margin !default;
$grid-rtl-bigger-rightalign-sortnumber-margin: 6px .7em 0 12px !default;
$grid-fltr-rtl-sortnumber-rightalign-margin: 7px 0 0 7px !default;
$grid-rtl-sortnumber-rightalign-margin: 7px 0 0 10px !default;
$grid-rtl-headercell-border-width: 0 !default;
$grid-rtl-th-firstcell-border-left: 0 !default;
$grid-rtl-sortcelldiv-margin: -21px 0 0 -3px !default;
$grid-rtl-sortcelldiv-right-align-margin: -21px 0 0 -3px !default;
$grid-rtl-bigger-sortcelldiv-margin: -22px 0 0 13px !default;
$grid-rtl-bigger-sortcelldiv-right-align-margin: -22px 0 0 -4px !default;
$grid-rtl-group-text-margin-left: 0 !default;
$grid-rtl-group-text-margin-right: 8px !default;
$grid-rtl-group-sorticon-margin-right: 8px !default;
$grid-ungroup-rtl-padding-top: 0 !default;
$grid-bigger-ungroup-rtl-padding-top: $grid-ungroup-rtl-padding-top !default;
$grid-bigger-headercell-padding: round($grid-header-padding*1.25) !default;
$grid-bigger-headercell-bootom-padding: round($grid-header-bottom-padding*1.25) !default;
$grid-bigger-headercell-line-height: round($grid-headercell-line-height*1.25) !default;
$grid-bigger-rhandler-height: $grid-bigger-headercell-line-height !default;
$grid-bigger-header-first-last-cell-padding: round($grid-header-first-last-cell-padding*1.25) !default;
$grid-bigger-content-padding: round($grid-content-padding*1.25) !default;
$grid-bigger-content-right-padding: round($grid-content-right-padding*1.25) !default;
$grid-bigger-rowcell-line-height: round($grid-rowcell-line-height*1.25) !default;
$grid-bigger-rowcell-autofill-top-line-height: 24px !default;
$grid-bigger-rowcell-autofill-top-bottom-line-height: 22px !default;
$grid-rowcell-autofill-top-line-height: 24px !default;
$grid-rowcell-autofill-top-bottom-line-height: 22px !default;
$grid-bigger-first-last-rowcell-padding: round($grid-first-last-rowcell-padding*1.25) !default;
$grid-bigger-group-line-height: round($grid-group-height*1.25) !default;
$grid-bigger-filterbarcell-text-input: 40px !default;
$grid-bigger-group-headercell-height: round($grid-headecell-height*1.25) !default;
$grid-bigger-group-clone-broder-radius: round($grid-gd-clone-border-radius *1.25) !default;
$grid-bigger-grouptext-marign: round($grid-grouptext-margin-right *1.25) !default;
$grid-bigger-groupedcell-icons-marign-left: round($group-sorticon-margin-left *1.25) !default;
$grid-bigger-groupcaption-line-height: 27px !default;
$grid-bigger-grouped-headercell-border-radius: 0 !default;
$grid-bigger-group-headercell-margin: 9px 0 0 10px !default;
$grid-bigger-group-headercell-padding: 0 10px !default;
$grid-device-group-headercell-padding: 0 10px !default;
$grid-bigger-ungroup-button-font-size: 13px !default;
$grid-bigger-ungroupbutton-icons-font-size: 13px !default;
$grid-bigger-ungroupbutton-icon-margin-top: 1px !default;
$grid-device-ungroupbutton-icon-margin-top: 1px !default;
...
$grid-bigger-grightarrow-icon-font-size: 14px !default;
$grid-bigger-icons-font-size: 14px !default;
$grid-bigger-header-icons-font-size: 14px !default;
$grid-bigger-sortdiv-margin: -23px -4px !default;
$grid-bigger-sortdiv-rightalign-margin: -23px -4px !default;
$grid-bigger-headercell-font-size: 15px !default;
$grid-bigger-content-font-size: 14px !default;
$grid-bigger-font-size: 14px !default;
$grid-bigger-textwrap-srotnumber-margin: 3px 11px 0 2px !default;
$grid-bigger-textwrap-srotnumber-rightalign-margin: 3px 2px 0 10px !default;
$grid-bigger-textwrap-sorticon-rightalign-margin: -17px 0 !default;
$grid-bigger-textwrap-sorticon-margin: -17px 0 !default;
$grid-device-headercell-padding: 0 8px !default;
$grid-device-headercell-fistchild-padding: 0 8px 0 10px !default;
$grid-device-headercell-lastchild-padding: 0 10px 0 8px !default;
$grid-device-groupheadercell-span-line-height: 30px !default;
$grid-device-rowcell-padding: $grid-content-padding 8px !default;
$grid-device-rowcell-firstchild-padding: $grid-content-padding 8px $grid-content-padding 10px !default;
$grid-device-rowcell-lastchild-padding: $grid-content-padding 10px $grid-content-padding 8px !default;
$grid-device-filterbarcell-padding: 3px 8px 2px 8px !default;
$grid-device-filterbarcell-firstchild-padding: 3px 8px 2px 10px !default;
$grid-device-filterbarcell-lastchild-padding: 3px 10px 2px 8px !default;
$grid-edit-cell-padding: 0 !default;
$grid-edit-input-padding-top: 0 !default;
$grid-edit-input-padding-bottom: 0 !default;
...
$grid-resize-helper-color: $neutral-primary !default;
$grid-columnchooser-toolbartxt-padding: 0 !default;
$grid-bigger-columnchooser-toolbartxt-padding: 0 !default;
$grid-column-chooser-searchdiv-left: 6px !default;
$grid-columnchooser-li-padding: 7px 0 6px !default;
$grid-columnchooser-content-padding: 25px 25px 0 12px !default;
$grid-columnchooser-toolbar-button-padding: 0 20px !default;
$grid-cc-checkbox-padding-left: 13px !default;
$grid-bigger-columnchooser-content-padding: 25px 25px 5px 12px !default;
...
$grid-cell-focus-shadow: 0 0 0 1px $neutral-secondary inset !default;
$grid-cell-focus-border-color: $neutral-secondary !default;
$grid-headercelldiv-fltricon-margin: 0 20px 0 -6px !default;
$grid-headercelldiv-rightalign-fltricon-margin: 0 20px 0 10px !default;
$grid-rtl-headercelldiv-rightalign-fltricon-margin: 0 !default;
$grid-rtl-headercelldiv-fltricon-margin: 0 !default;
$grid-rtl-fltrdiv-padding: 7px !default;
$grid-fltrdiv-margin: -24px -7px !default;
$grid-rtl-fltrdiv-margin: -27px 0 -24px -5px !default;
$grid-rtl-bigger-fltrdiv-margin: -27px 0 -26px -5px !default;
$grid-filtered-color: $theme-primary !default;
$grid-autofill-color: $theme-primary !default;
$grid-e-firstrow-dragborder-bcolor: $theme-primary !default;
$grid-filtermenu-icon: 'e21c' !default;
$grid-bigger-fltrdiv-margin: -26px -7px !default;
$grid-checkbox-padding-topbottom: 7px !default;
$grid-checkbox-content-padding-left: 18px !default;
$grid-rtl-checkbox-content-padding-left: 25px !default;
$grid-checkbox-wrapper-height: 20px !default;
$grid-checkbox-wrapper-line-height: 21px !default;
$grid-checkbox-wrapper-top: 0 !default;
$grid-bigger-checkbox-padding-topbottom: 12px !default;
$grid-bigger-checkbox-content-padding-left: 19.25px !default;
$grid-rtl-bigger-checkbox-content-padding-left: 31.25px !default;
$grid-sortdiv-filtericon-rightalign-margin: -20px 0 0 8px !default;
$grid-sortnumber-filtericon-rightalign-margin: 8px 25px 0 5px !default;
$grid-sortdiv-filtericon-margin: -20px 20px 0 0 !default;
$grid-rtl-sortdiv-filtericon-rightalign-margin: -22px 0 0 14px !default;
$grid-rtl-sortdiv-filtericon-margin: -22px 0 0 14px !default;
$grid-bigger-fltricon-sortdiv-rightalign-margin: -23px 11px 0 15px !default;
$grid-bigger-fltricon-sortdiv-margin: -23px 20px 0 0 !default;
$grid-column-menu-sub-menu-box-shadow: 0 0 10px 0 rgba($shadow, .2) !default;
$grid-bigger-checkbox-filter-min-height: 370px !default;
$grid-checkbox-filter-min-height: 348px !default;
$grid-column-menu-margin: -25px -24px !default;
$grid-column-menu-padding: 6px !default;
$grid-textwrap-column-menu-margin: -20px -24px -24px -24px !default;
$grid-bigger-column-menu-margin: -24.5px -24px !default;
$grid-bigger-device-column-menu-margin: -26px -20px !default;
$grid-column-menu-top-touch: 35px !default;
$grid-column-menu-bottom-touch: 37px !default;
$grid-column-menu-right-touch: 23px !default;
$grid-rtl-bigger-fltricon-sortdiv-margin: -22px 0 0 12px !default;
$grid-rtl-bigger-fltricon-sortdiv-rightalign-margin: -22px 0 0 12px !default;
...
$grid-dragborder-box-shadow: 0 2px 0 0 $theme-primary !default;
$grid-dragborder-cell-dashed: 1px dashed $theme-primary !default;
...
$grid-dragcell-border-color: $neutral-light !default;
$grid-drap-drop-icon-color: $neutral-light-font !default;
$grid-clone-dropitemscount-bg-color: $theme-primary !default;
$grid-clone-dropitemscount-color: $content-font-color !default;
$grid-clone-row-border-color: $neutral-light !default;
$grid-dropitemscount-color: $neutral-primary !default;
$grid-clone-prop-box-shadow: 0 3px 8px rgba($shadow, .26) !default;
$grid-drag-icon-opacity: $grid-conent-font-opacity !default;
$grid-clone-dropitemscount-border: $neutral-light !default;
$grid-clone-dragdrop-bg-color: $neutral-light !default;
...
$grid-bigger-fltr-sortnumber-rightalign-margin: $grid-sortnumber-rightalign-margin !default;
...
$grid-rtl-column-menu-margin: -25px -18px -18px 1px !default;
$grid-rtl-textwrap-column-menu-margin: -21px -13px -23px -3px !default;
$grid-filter-checkbox-width: 0 !default;
$grid-filter-checkbox-white-space: nowrap !default;

// group animator
$grid-group-animator-bigger-cell-margin: 20px 0 20px 0 !default;
...
$grid-animator-first-group: 16px 0 16px 16px !default;
$grid-animator-rtl-first-group: 16px 16px 16px 0 !default;
$grid-animator-margin-top-rtl: 22px !default;
$grid-filterbar-dropdown: 28px !default;

$grid-responsive-close-icon-margin: 8px !default;
...
$grid-responsive-search-icon-right: 6px !default;
$grid-responsive-search-padding-right: 0 !default;
$grid-responsive-search-padding-left: 16px !default;
$grid-responsive-header-background: $neutral-white !default;
...
$grid-responsive-res-apply-btn-font-size: 19px !default;
$grid-responsive-res-apply-btn-margin-top: -4px !default;
$grid-responsive-sort-clear-btn-font-size: 19px !default;
$grid-responsive-sort-clear-margin-top: -3px !default;
$grid-responsive-icon-filter-clear: 18px !default;
$grid-responsive-icon-filter-clear-bottom: 6px !default;
$grid-responsive-btn-icon-font-size: 17px !default;
$grid-responsive-back-btn-bottom: 9px !default;
$grid-responsive-header-padding-top: 8px !default;
$grid-responsive-search-place-holder-margin-top: 1px !default;
$grid-responsive-search-width: 32px !default;
$grid-responsive-search-left-padding: 0 !default;
$grid-responsive-filter-clear-margin: 0 !default;
$grid-responsive-toolbar-filter-font-size: 18px !default;
$grid-responsive-tbar-btn-bgr-padding: 0 !default;
$grid-responsive-btn-top: 2px !default;
$grid-responsive-apply-btn-top: 3px !default;
...
$grid-rtl-sort-num-left-align-margin: 6px -10px 0 0 !default;
...
$grid-bigger-sort-margin: -21px 3px !default;
$grid-bigger-sort-right-margin: 6px 2px 0 0 !default;
$grid-skin: 'fabric' !default;
...
$grid-adaptive-sort-clear-button-padding: 3px !default;
$grid-cc-margin-top: 3px !default;
$grid-bigger-rtl-cm-margin: $grid-rtl-column-menu-margin !default;
$grid-bigger-device-rtl-cm-margin: $grid-rtl-column-menu-margin !default;
...
$grid-bigger-headercell-autofit-padding: 0 10px 0 !default;
...
$grid-toolbar-placeholder-text-color: $neutral-tertiary-alt !default;
$grid-toolbar-searchbar-text-opacity: 1 !default;
$grid-dropitems-count-margin-left: -8px !default;
$grid-checkmark-color: $theme-dark-font !default;
...
@include export-module('grid-theme') {
  ...
  #{&}.e-grid {
    ...
    .e-gridcontent tr.e-row:first-child .e-rowcell.e-dragborder.e-leftfreeze,
    ...
    & .e-gridheader thead tr th.e-firstrowdragborder.e-leftfreeze,
    ...
    .e-gridcontent tr.e-row:first-child .e-rowcell.e-dragborder.e-rightfreeze,
    .e-gridcontent .e-rowcell.e-dragborder.e-rightfreeze,
    .e-gridcontent .e-groupcaption.e-dragborder.e-rightfreeze,
    .e-gridcontent .e-summarycell.e-dragborder.e-rightfreeze,
    .e-gridcontent .e-rowdragdrop.e-dragborder.e-rightfreeze,
    & .e-gridheader thead tr th.e-firstrowdragborder.e-rightfreeze,
    &.e-rtl .e-gridcontent tr.e-row:first-child .e-rowcell.e-dragborder.e-rightfreeze,
    &.e-rtl .e-gridcontent .e-rowcell.e-dragborder.e-rightfreeze,
    &.e-rtl .e-gridcontent .e-rowdragdrop.e-dragborder.e-rightfreeze {
      z-index: 6;
    }

    .e-gridcontent tr.e-row:first-child .e-rowcell.e-dragborder.e-fixedfreeze,
    .e-gridcontent .e-rowcell.e-dragborder.e-fixedfreeze,
    .e-gridcontent .e-groupcaption.e-dragborder.e-fixedfreeze,
    .e-gridcontent .e-summarycell.e-dragborder.e-fixedfreeze,
    .e-gridcontent .e-rowdragdrop.e-dragborder.e-fixedfreeze,
    & .e-gridheader thead tr th.e-firstrowdragborder.e-fixedfreeze,
    &.e-rtl .e-gridcontent tr.e-row:first-child .e-rowcell.e-dragborder.e-fixedfreeze,
    &.e-rtl .e-gridcontent .e-rowcell.e-dragborder.e-fixedfreeze,
    &.e-rtl .e-gridcontent .e-rowdragdrop.e-dragborder.e-fixedfreeze {
      z-index: 6;
    }
    ...
    .e-fixedfreeze:not(.e-summarycell, .e-selectionbackground, .e-updatedtd, .e-columnselection, .e-groupcaption, .e-cellselectionbackground, .e-active) {
      @if $grid-skin == 'material' $grid-skin == 'highcontrast' {
        background-color: $grid-rows-bg-color;
      }
      @else {
        background-color: $grid-content-bg-color;
    ...
    .e-gridcontent .e-groupcaptionrow .e-leftfreeze.e-groupcaption,
    .e-gridcontent .e-groupcaptionrow .e-leftfreeze.e-recordplusexpand,
    .e-gridcontent .e-groupcaptionrow .e-leftfreeze.e-recordpluscollapse,
    .e-gridcontent .e-groupcaptionrow .e-leftfreeze.ee-indentcell {
      @if $grid-skin == 'material3' {
        background: $group-row-bg-color;
      }
      @else {
    ...
    &.e-gridhover .e-row tr:not(.e-disable-gridhover):not(.e-editedrow):not(.e-detailrow):hover .e-rowcell.e-leftfreeze,
    &.e-gridhover .e-row tr:not(.e-disable-gridhover):not(.e-editedrow):not(.e-detailrow):hover .e-rowcell.e-rightfreeze,
    &.e-gridhover .e-row tr:not(.e-disable-gridhover):not(.e-editedrow):not(.e-detailrow):hover .e-rowcell.e-unfreeze,
    &.e-gridhover .e-row tr:not(.e-disable-gridhover):not(.e-editedrow):not(.e-detailrow):hover .e-rowcell.e-fixedfreeze,
    &.e-gridhover .e-row:not(.e-disable-gridhover):not(.e-editedrow):not(.e-detailrow):hover .e-rowcell.e-leftfreeze,
    &.e-gridhover .e-row:not(.e-disable-gridhover):not(.e-editedrow):not(.e-detailrow):hover .e-rowcell.e-rightfreeze,
    &.e-gridhover .e-row:not(.e-disable-gridhover):not(.e-editedrow):not(.e-detailrow):hover .e-rowcell.e-unfreeze,
    &.e-gridhover .e-row:not(.e-disable-gridhover):not(.e-editedrow):not(.e-detailrow):hover .e-rowcell.e-fixedfreeze,
    &.e-gridhover .e-row:not(.e-disable-gridhover):not(.e-detailrow):hover .e-detailrowcollapse.e-leftfreeze,
    &.e-gridhover .e-row:not(.e-disable-gridhover):not(.e-detailrow):hover .e-detailrowcollapse.e-rightfreeze,
    &.e-gridhover .e-row:not(.e-disable-gridhover):not(.e-detailrow):hover .e-detailrowcollapse.e-unfreeze,
    &.e-gridhover .e-row:not(.e-disable-gridhover):not(.e-detailrow):hover .e-detailrowcollapse.e-fixedfreeze,
    &.e-gridhover .e-row:not(.e-disable-gridhover):not(.e-detailrow):hover .e-rowdragdrop.e-leftfreeze,
    &.e-gridhover .e-row:not(.e-disable-gridhover):not(.e-detailrow):hover .e-rowdragdrop.e-rightfreeze,
    &.e-gridhover .e-row:not(.e-disable-gridhover):not(.e-detailrow):hover .e-rowdragdrop.e-unfreeze,
    &.e-gridhover .e-row:not(.e-disable-gridhover):not(.e-detailrow):hover .e-rowdragdrop.e-fixedfreeze,
    &.e-rtl .e-gridhover .e-row:not(.e-disable-gridhover):not(.e-detailrow):hover .e-rowdragdrop.e-leftfreeze,
    &.e-rtl .e-gridhover .e-row:not(.e-disable-gridhover):not(.e-detailrow):hover .e-rowdragdrop.e-rightfreeze,
    &.e-rtl .e-gridhover .e-row:not(.e-disable-gridhover):not(.e-detailrow):hover .e-rowdragdrop.e-unfreeze,
    ...
    &.e-resize-lines .e-headercell.e-stackedheadercell:not(.e-freezerightborder, .e-freezeleftborder) {
...
.e-grid-toolbarmenu {
  .e-responsivetoolbar-menu .e-menu-icon.e-print::before  {
    content: '\e7df';
  }
  .e-responsivetoolbar-menu .e-menu-icon.e-pdfexport::before  {
    content: '\e240';
  }
  .e-responsivetoolbar-menu .e-menu-icon.e-excelexport::before  {
    content: '\e242';
  }
  .e-responsivetoolbar-menu .e-menu-icon.e-csvexport::before  {
    content: '\e241';
  }
}
