...
$grid-xlfl-dlg-padding-bottom: 1px !default;
...
$grid-bigger-xlfl-dlg-padding-bottom: 1px !default;
...
$grid-bigger-xlfl-radio-margin-left: 0 !default;
$grid-bigger-xlfl-dropdown-padding-right: 10px !default;
$grid-bigger-xlfl-radiodiv-width: 145px !default;
...
$grid-excel-filter-bottom-padding: 24px !default;
