...
$grid-exlfltr-ctxtmnu-max-height: 227px !default;
...
$grid-xlfl-fieldset-font-size: $font-icon-13 !default;
$grid-xlfl-dlgfields-font-size: $font-icon-15 !default;
...
@include export-module('excel-filter-bds-icons') {
