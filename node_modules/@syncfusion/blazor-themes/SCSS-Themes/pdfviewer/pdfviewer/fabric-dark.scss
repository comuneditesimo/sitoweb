...
@import '../../navigations/accordion/fabric-dark.scss';
...
@import '../../notifications/badge/fabric-dark.scss';
...
@import '../../splitbuttons/drop-down-button/fabric-dark.scss';
@import '../../splitbuttons/split-button/fabric-dark.scss';
@import '../../inputs/numerictextbox/fabric-dark.scss';
@import '../../popups/tooltip/fabric-dark.scss';
@import '../../inputs/slider/fabric-dark.scss';
@import '../../inputs/color-picker/fabric-dark.scss';
@import '../../dropdowns/combo-box/fabric-dark.scss';
@import '../../navigations/context-menu/fabric-dark.scss';
@import '../../buttons/radio-button/fabric-dark.scss';
@import '../../buttons/switch/fabric-dark.scss';
@import '../../lists/list-view/fabric-dark.scss';
@import '../../lists/sortable/fabric-dark.scss';
@import '../../inputs/maskedtextbox/fabric-dark.scss';
@import '../../inputs/textbox/fabric-dark.scss';
@import '../../inputs/uploader/fabric-dark.scss';
...
@import '../../navigations/tab/fabric-dark.scss';
@import '../../navigations/treeview/fabric-dark.scss';
@import '../../navigations/sidebar/fabric-dark.scss';
@import '../../navigations/menu/fabric-dark.scss';
@import '../../dropdowns/drop-down-tree/fabric-dark.scss';
@import '../../dropdowns/multi-select/fabric-dark.scss';
@import '../../dropdowns/list-box/fabric-dark.scss';
@import '../../dropdowns/mention/fabric-dark.scss';
@import '../../splitbuttons/button-group/fabric-dark.scss';
@import '../../splitbuttons/progress-button/fabric-dark.scss';
@import '../../notifications/toast/fabric-dark.scss';
@import '../../navigations/appbar/fabric-dark.scss';
@import '../../notifications/message/fabric-dark.scss';
@import '../../notifications/skeleton/fabric-dark.scss';
/*! PdfViewer's fabric theme override definitions and variables */
$pv-background: $neutral-white !default;
$pv-control-border-color: $neutral-tertiary-alt !default;
$pv-viewer-border-width: 0 !default;
...
$pv-viewer-container-height: calc(100% - 50px) !default;
...
$pv-icon-color: $neutral-light-font !default;
$pv-icon-disable-color: $neutral-black !default;
...
$pv-toolbar-border-width: 1px !default;
$pv-toolbar-border-radius: 0 !default;
$pv-current-page-height: 30px !default;
$pv-current-page-width: 35px !default;
$pv-zoom-dropdown-height: 50px !default;
$pv-zoom-dropdown-width: 81px !default;
...
$pv-corrupted-pop-header-font-size: 21px !default;
$pv-corrupted-pop-header-letter-spacing: -.21px !default;
$pv-corrupted-pop-header-text-align: left !default;
$pv-corrupted-pop-content-font-size: 14px !default;
$pv-corrupted-pop-header-color: $base-font !default;
$pv-corrupted-pop-content-letter-spacing: 0 !default;
$pv-corrupted-pop-content-line-height: 24px !default;
$pv-corrupted-pop-content-margin-left: 0 !default;
$pv-toolbar-separator-margin-left: 5.5px !default;
$pv-toolbar-separator-margin-right: 5.5px !default;
$pv-toolbar-separator-border-right-width: 1px !default;
$pv-toolbar-separator-height: 24px !default;
$pv-toolbar-popup-icon-padding: 0 10px;
$pv-toolbar-popup-icon-padding-rtl: $pv-toolbar-popup-icon-padding;
$pv-toolbar-items-margin-left: 1.5px !default;
$pv-toolbar-items-margin-right: 1.5px !default;
$pv-toolbar-items-padding-top: 0 !default;
$pv-toolbar-items-padding-bottom: 0 !default;
$pv-toolbar-items-first-child-margin-left: 4px !default;
$pv-toolbar-items-last-child-margin-right: 4px !default;
$pv-toolbar-btn-height: 50px !default;
$pv-toolbar-btn-width: 36px !default;
...
$pv-toolbar-download-icon-width: 12px !default;
...
$pv-toolbar-open-btn-padding: 4px 0 4px 1px !default;
$pv-toolbar-zoom-drop-margin: 0 2.5px !default;
$pv-toolbar-zoom-drop-padding: 0 !default;
$pv-toolbar-total-page-div-padding-left: 0 !default;
$pv-toolbar-total-page-padding-bottom: 2px !default;
$pv-toolbar-total-page-div-margin-left: 1.5px !default;
$pv-toolbar-total-page-div-margin-right: 5.5px !default;
$pv-toolbar-total-page-font-color: $neutral-light-font !default;
$pv-toolbar-current-page-box-margin-top: 0 !default;
$pv-toolbar-zoom-drop-down-margin-top: -1px !default;
$pv-toolbar-zoom-drop-down-padding: 0 0 0 3px !default;
$pv-toolbar-zoom-drop-down-border: 0 !default;
$pv-toolbar-zoom-drop-down-border-focus: 1px solid $theme-primary !default;
$pv-toolbar-zoom-drop-down-border-radius: 0 !default;
...
$pv-zoom-drop-down-margin-top: 3px !default;
...
$pv-zoom-drop-down-active-color: rgba($theme-primary, .87) !default;
$pv-current-page-border: 1px solid $neutral-tertiary-alt !default;
$pv-current-page-border-radius: 0 !default;
$pv-current-page-padding-left: 0 !default;
$pv-current-page-padding-right-rtl: 12px !default;
$pv-current-page-padding-bottom: 5px !default;
...
$pv-corrupted-pop-content-padding-top: 0 !default;
$pv-password-pop-content-padding-top: 1px !default;
$pv-zoom-drop-down-popup-height: 300px !default;
$pv-zoom-drop-down-popup-width: 110px !default;
$pv-zoom-drop-down-transform: rotate(0deg) !default;
$pv-corrupted-dialog-width: 346px !default;
$pv-corrupted-dialog-height: 175px !default;
$pv-corrupted-dialog-header-border-bottom: 0 !default;
$pv-corrupted-dialog-footer-border-top: 0 !default;
$pv-password-dialog-width: 425px !default;
$pv-password-dialog-height: 216px !default;
$pv-password-dialog-header-border-bottom: 0 !default;
$pv-password-dialog-footer-border-top: 0 !default;
$pv-dialog-pop-close-icon-padding-top: 2px !default;
$pv-corrupted-dialog-pop-content-padding-top: 1px !default;
$pv-corrupted-dialog-pop-content-padding-bottom: 0 !default;
$pv-password-dialog-pop-content-padding-bottom: 0 !default;
$pv-toolbar-total-page-number-color: $neutral-light-font !default;
$pv-toolbar-total-page-number-font-size: 14px !default;
$pv-corrupted-notification-background-image: none !default;
$pv-corrupted-notification-background-repeat: no-repeat !default;
$pv-corrupted-notification-background-size: auto !default;
$pv-corrupted-notification-height: auto !default;
$pv-corrupted-notification-background-position: right !default;
$pv-toolbar-open-icon-font-size: $pv-icon-font-size !default;
$pv-thumbnail-icon-disable-color: rgba($neutral-black, .2) !default;
$pv-thumbnail-icon-selection-color: $theme-primary !default;
...
$pv-sidebar-container-background: $neutral-lighter !default;
$pv-sidebar-container-border-top:  1px solid $neutral-tertiary-alt !default;
...
$pv-sidebar-content-container-left: 47px !default;
$pv-sidebar-content-container-display: none !default;
$pv-sidebar-content-container-height: calc(100% - 51px) !default;
$pv-sidebar-content-container-width: 202px !default;
$pv-sidebar-content-container-float: left !default;
$pv-sidebar-content-container-border-top:  1px solid $neutral-tertiary-alt !default;
...
$pv-sidebar-title-container-height: 50px !default;
$pv-sidebar-title-container-top: 0 !default;
$pv-sidebar-title-container-background: $neutral-lighter !default;
$pv-sidebar-title-container-z-index: 102 !default;
$pv-sidebar-title-margin: 0 !default;
$pv-sidebar-title-top: 15px !default;
...
$pv-sidebar-content-scrollbar-track-background: $neutral-tertiary-alt !default;
$pv-sidebar-content-scrollbar-track-border: 1px solid $neutral-tertiary-alt !default;
$pv-sidebar-content-scrollbar-thumb-border-radius: 100px !default;
$pv-sidebar-content-scrollbar-thumb-background: #c1c1c1 !default;
...
$pv-thumbnail-view-button-width: 32px !default;
$pv-thumbnail-view-button-height: 32px !default;
$pv-thumbnail-view-button-margin: 8px !default;
$pv-thumbnail-view-button-background: transparent !default;
$pv-thumbnail-view-button-selection-background: $neutral-lighter-alt !default;
$pv-thumbnail-view-button-selection-line-height: 1.1em !default;
...
$pv-bookmark-button-width: 34px !default;
$pv-bookmark-button-height: 34px !default;
...
$pv-title-close-height: 32px !default;
$pv-title-close-left: 170px !default;
$pv-title-close-right: 21px !default;
$pv-title-close-top: 11px !default;
$pv-title-close-padding: 0 18px 3px 0 !default;
...
$pv-sidebar-toolbar-splitter-background: $neutral-quintenary !default;
$pv-sidebar-toolbar-splitter-height: calc(100% - 51px) !default;
...
$pv-sidebar-content-splitter-background: $neutral-tertiary-alt !default;
$pv-sidebar-content-splitter-z-index: 104 !default;
$pv-sidebar-content-splitter-top: 47px !default;
...
$pv-thumbnail-selection-ring-padding: 6px !default;
$pv-thumbnail-selection-ring-box-shadow: 0 0 4px 0 rgba($shadow, .25) !default;
$pv-thumbnail-image-width: 86px !default;
...
$pv-thumbnail-hover-padding: 5px !default;
$pv-thumbnail-hover-cursor: pointer !default;
$pv-thumbnail-hover-border: 1px solid $neutral-quintenary !default;
$pv-thumbnail-hover-box-shadow: 0 0 3px 0 rgba($shadow, .25) !default;
...
$pv-thumbnail-focus-padding: 4px !default;
$pv-thumbnail-focus-border: 2px solid $neutral-quintenary !default;
$pv-organize-page-select-border: 6px solid $theme-primary !default;
$pv-thumbnail-focus-box-shadow: 0 0 4px 0 rgba($shadow, .25) !default;
$pv-thumbnail-selection-border-radius: 2px !default;
$pv-thumbnail-selection-cursor: pointer !default;
$pv-thumbnail-selection-border: 6px solid $theme-primary !default;
$pv-thumbnail-selection-padding: 0 !default;
$pv-thumbnail-selection-box-shadow: 0 0 4px 0 rgba($shadow, .25) !default;
...
$pv-item-selection-color: $theme-tertiary !default;
$pv-item-selection-background-color: $neutral-lighter-alt !default;
$pv-item-selection-border-radius: 0 !default;
$pv-item-selection-border: 0 !default;
...
$pv-search-box-height: 114px !default;
$pv-search-box-width: 355px !default;
$pv-search-box-background-color: $neutral-lighter !default;
$pv-search-box-border: 0 solid $neutral-quintenaryalt !default;
$pv-search-box-border-radius: 0 !default;
$pv-search-box-box-shadow: 0 3px 8px 0 rgba(0, 0, 0, .26) !default;
$pv-search-box-padding: 24px 22.5px 26.5px 24px !default;
$pv-search-input-height: 30px !default;
$pv-search-input-width: 242px !default;
$pv-match-case-margin-top: 17.5px !default;
$pv-search-btn-height: 24px !default;
$pv-search-btn-width: 24px !default;
$pv-search-btn-margin-top: -6px;
$pv-search-prev-margin-left: 10.5px !default;
$pv-search-next-margin-left: 8px !default;
$pv-notification-popup-height: 210px !default;
$pv-notification-popup-width: $pv-corrupted-dialog-width !default;
$pv-notification-popup-height-large-content: 230px;
$pv-notification-popup-width-large-content: 368px;
$pv-notification-content-font-size: 14px !default;
$pv-zoom-dropdown-input-focus-color: inherit !default;
$pv-text-selection-bg-color: #247796 !default;
...
$pv-toolbar-btn-padding: 0 !default;
$pv-toolbar-btn-line-height: 25px !default;
$pv-toolbaritem-btn-line-height: 26px !default;
$pv-toolbaritem-btn-min-height: 26px !default;
$pv-toolbar-btn-margin: 0 !default;
$pv-mobile-page-box-padding-top: 0 !default;
$pv-zoom-dropdown-width-mobile: 91px !default;
$pv-mobile-page-box-padding-left-focus: 0 !default;
$pv-password-dialog-height-mobile: 245px !default;
$pv-notification-dialog-height-mobile: 224px !default;
$pv-notification-dialog-height-large-mobile: 243px !default;
$pv-corrupted-dialog-height-mobile: 216px !default;
$pv-dialog-pop-close-icon-padding-top-mobile: $pv-dialog-pop-close-icon-padding-top !default;
$pv-sidebar-resizer-border: 1px solid $neutral-tertiary-alt !default;
$pv-sidebar-resizer-border-width: 0 1px 0 0 !default;
$pv-sidebar-resizer-color: $neutral-light-font !default;
$pv-input-active-background: $theme-primary !default;
$pv-input-active-color: $theme-primary-font !default;
$pv-input-hover-background: $neutral-white !default;
$pv-input-hover-color: $neutral-light-fontalt !default;
...
$pv-bookmark-container-background-color: $grey-dark-font !default;
$pv-nav-toolbar-text-color: $base-font !default;
$pv-toolbar-btn-width-mobile: 50px !default;
$pv-toolbar-btn-height-mobile: 50px !default;
$pv-bookmark-container-border: 1px solid $neutral-tertiary-alt !default;
$pv-bookmark-list-border-bottom: 1px solid $neutral-tertiary-alt !default;
$pv-annotation-opacity-popup-background-color: #282727 !default;
$pv-annotation-opacity-popup-color: #dadada !default;
$pv-annotation-opacity-popup-padding: 16px !default;
$pv-annotation-opacity-popup-min-height: 48px !default;
$pv-annotation-opacity-popup-box-shadow: 0 3px 8px 0 rgba(0, 0, 0, .26) !default;
$pv-annotation-opacity-slider-width: 172px !default;
$pv-annotation-opacity-slider-width-rtl: 115px !default;
...
$pv-annotation-drop-down-height: 50px !default;
$pv-annotation-drop-down-width: 56px !default;
$pv-annotation-opacity-icon-padding-top: 1px !default;
$pv-annotation-dropdown-background-color: $neutral-lighter !default;
$pv-annotation-dropdown-border-color: transparent !default;
$pv-annotation-dropdown-background-color-hover: $neutral-light !default;
$pv-annotation-dropdown-border-color-hover: $neutral-light !default;
$pv-annotation-dropdown-background-color-active: $neutral-quintenary !default;
$pv-annotation-dropdown-border-color-active: $neutral-quintenary !default;
$pv-annotation-drop-down-btn-line-height: 18px !default;
$pv-annotation-drop-down-btn-padding: 17px 8px !default;
...
$pv-comment-font-color: rgba(218, 218, 218, .9) !default;
$pv-comment-text-color:  rgba(218, 218, 218, .6) !default;
$pv-comment-color: #38a9ff !default;
$pv-comment-panel-bg: #333232 !default;
$pv-comment-panel-bottom-color: #6f6c6c !default;
...
$pv-properties-padding: 2px 20px !default;
$pv-properties-drop-down-margin-left: 80px !default;
$pv-properties-line-style-padding: 8px !default;
$pv-status-icon-color: #fff !default;
$pv-save-button-bg-color: #414040 !default;
$pv-save-button-color: rgba(218, 218, 218, .6) !default;
...
$pv-comment-text-cursor-color: #38a9ff !default;
$pv-comment-panel-border-color: #6f6c6c !default;
$pv-drop-down-toolbar-box-shadow: none !default;
$pv-line-stroke-color-margin-left: 154px !default;
$pv-line-leader-length-margin-left: 21px !default;
$pv-annot-toolbar-dropdown-btn-height: 32px !default;
$pv-annot-toolbar-dropdown-btn-line-height: 32px !default;
$pv-annot-toolbar-dropdown-btn-width: 71px !default;
$pv-annot-toolbar-dropdown-btn-padding-top: 2px !default;
$pv-annot-toolbar-dropdown-btn-padding-top: 2px !default;
$pv-properties-win-max-width: 436px !default;
$pv-properties-win-max-width-big: 448px !default;
$pv-properties-container-margin-bottom: 16px !default;
$pv-properties-container-height: 52px !default;
$pv-scale-ratio-win-max-width: 436px !default;
$pv-scale-ratio-win-max-width-big: 464px !default;
$pv-prop-line-styles-color: #000 !default;
$pv-prop-line-styles-hover-bg: $neutral-lighter !default;
$pv-prop-color-picker-height: 32px !default;
$pv-prop-color-picker-line-height: 16px !default;
$pv-scale-ratio-win-drop-down-padding: 2px 20px !default;
$pv-scale-ratio-win-drop-down-caret-margin-left: 91px !default;
$pv-scale-ratio-win-drop-down-caret-margin-top: 10px !default;
...
$pv-annotation-dd-background-color-active: $neutral-quintenaryalt !default;
$pv-prop-line-styles-margin-top: 2.5px !default;
$pv-more-option-button-padding: 5px 7px 1px 1px !default;
$pv-comment-title-padding-top: 5px !default;
$pv-stamp-icon-padding: 0 !default;
...
$pv-form-field-li-background-color: #6f6c6c !default;
...
$pv-form-field-property-header-color: #dadada !default;
...
$pv-form-field-property-font-style-color: #414040 !default;
$pv-prop-win-margin-left: 24px !default;
$pv-font-size-field-width: 99px !default;
$pv-formfield-maxlength-width: 80px !default;
$pv-formfield-maxlength-arrow-width: 20px !default;
$pv-formfield-designer-dialog-height: 544px !default;
$pv-properties-header-spliter-border-bottom-color: $base-font !default;
...
$pv-formfield-maxlength-group-padding-left: 85px !default;
...
$pv-signature-dialog-height: 580px !default;
$pv-signature-dialog-blazor-height: 580px !default;
$pv-blazor-scale-ratio-dialog-max-width: 514px !default;
$pv-handwritten-sign-width: 697px !default;
$pv-handwritten-sign-height: 360px !default;
$pv-canvas-sign-width: 698px !default;
$pv-canvas-sign-width-blazor: 698px !default;
$pv-font-div-padding: 8px !default;
$pv-font-div-padding-blazor: 8px !default;
...
$pv-organize-anchor-node-border-width: 6px !default;
$pv-organize-anchor-node-border: $pv-organize-anchor-node-border-width solid $neutral-tertiary-alt !default;
$pv-organize-image-border: 1px solid $neutral-tertiary-alt !default;
