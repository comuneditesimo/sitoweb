@use 'sass:math';
@import '../../base/material-dark.scss';
@import '../../navigations/accordion/material-dark.scss';
@import '../../dropdowns/drop-down-list/material-dark.scss';
@import '../../inputs/input/material-dark.scss';
@import '../../popups/popup/material-dark.scss';
@import '../../popups/spinner/material-dark.scss';
@import '../../dropdowns/drop-down-base/material-dark.scss';
@import '../../dropdowns/auto-complete/material-dark.scss';
@import '../../notifications/badge/material-dark.scss';
...
@import '../../splitbuttons/drop-down-button/material-dark.scss';
@import '../../splitbuttons/split-button/material-dark.scss';
@import '../../inputs/numerictextbox/material-dark.scss';
@import '../../popups/tooltip/material-dark.scss';
@import '../../inputs/slider/material-dark.scss';
@import '../../inputs/color-picker/material-dark.scss';
@import '../../dropdowns/combo-box/material-dark.scss';
@import '../../navigations/context-menu/material-dark.scss';
@import '../../buttons/radio-button/material-dark.scss';
@import '../../buttons/switch/material-dark.scss';
@import '../../lists/list-view/material-dark.scss';
@import '../../lists/sortable/material-dark.scss';
@import '../../inputs/maskedtextbox/material-dark.scss';
@import '../../inputs/textbox/material-dark.scss';
@import '../../inputs/uploader/material-dark.scss';
@import '../../popups/dialog/material-dark.scss';
@import '../../navigations/h-scroll/material-dark.scss';
@import '../../navigations/v-scroll/material-dark.scss';
@import '../../navigations/toolbar/material-dark.scss';
@import '../../navigations/tab/material-dark.scss';
@import '../../navigations/treeview/material-dark.scss';
@import '../../navigations/sidebar/material-dark.scss';
@import '../../navigations/menu/material-dark.scss';
@import '../../dropdowns/drop-down-tree/material-dark.scss';
@import '../../dropdowns/multi-select/material-dark.scss';
@import '../../dropdowns/list-box/material-dark.scss';
@import '../../dropdowns/mention/material-dark.scss';
@import '../../splitbuttons/button-group/material-dark.scss';
@import '../../splitbuttons/progress-button/material-dark.scss';
@import '../../notifications/toast/material-dark.scss';
@import '../../navigations/appbar/material-dark.scss';
@import '../../notifications/message/material-dark.scss';
@import '../../notifications/skeleton/material-dark.scss';
/*! PdfViewer's default definitions and variables */
$pv-background: $grey-dark !default;
$pv-control-border-color: $grey-700 !default;
...
$pv-viewer-container-height: calc(100% - 56px) !default;
...
$pv-page-div-box-shadow: 0 2px 4px 0 rgba($grey-dark-font, .21) !default;
...
$pv-toolbar-total-page-div-padding-left: .5px !default;
$pv-toolbar-total-page-padding-bottom: 6.5px !default;
$pv-toolbar-total-page-div-margin-left: .5px !default;
$pv-toolbar-total-page-div-margin-right: 9.5px !default;
$pv-toolbar-total-page-font-color: $grey-dark-font !default;
$pv-toolbar-current-page-box-margin-top: 3px !default;
$pv-toolbar-zoom-drop-down-margin-top: 3px !default;
...
$pv-toolbar-zoom-drop-down-background-color: $grey-700 !default;
$pv-material-line-background: none !default;
$pv-text-align: center !default;
$pv-zoom-drop-down-popup-text-align: left !default;
$pv-zoom-drop-down-padding-top: 7px !default;
$pv-zoom-drop-down-padding-bottom: 5px !default;
$pv-zoom-drop-down-padding-left: 14px !default;
...
$pv-zoom-drop-down-margin-top: 7.5px !default;
$pv-zoom-drop-down-margin-bottom: 4.5px !default;
$pv-zoom-drop-down-margin-left: 0 !default;
$pv-zoom-drop-down-padding-right: 15px !default;
$pv-zoom-drop-down-active-color: $accent !default;
$pv-current-page-border: 1px solid rgba($grey-dark-font, .42) !default;
...
$pv-current-page-height: 18px !default;
$pv-current-page-padding-bottom: 8px !default;
...
$pv-password-dialog-height: 198px !default;
...
$pv-toolbar-total-page-number-color: rgba($grey-dark-font, .87) !default;
...
$pv-thumbnail-icon-selection-color: rgba($accent, .6) !default;
...
$pv-sidebar-container-background: $grey-900 !default;
$pv-sidebar-container-border-top: 1px solid $grey-700 !default;
...
$pv-sidebar-content-container-height: calc(100% - 56px) !default;
$pv-sidebar-content-container-width: 202px !default;
$pv-sidebar-content-container-float: left !default;
$pv-sidebar-content-container-border-top: 1px solid $grey-700 !default;
...
$pv-sidebar-title-container-background: $grey-900 !default;
...
$pv-sidebar-content-scrollbar-track-box-shadow: inset 0 0 0 rgba($grey-dark-font, .3) !default;
$pv-sidebar-content-scrollbar-track-background: $grey-700 !default;
$pv-sidebar-content-scrollbar-track-border: 1px solid $grey-700 !default;
$pv-sidebar-content-scrollbar-thumb-border-radius: 100px !default;
$pv-sidebar-content-scrollbar-thumb-background: $grey-500 !default;
$pv-sidebar-content-scrollbar-thumb-box-shadow: inset 0 0 0 rgba($grey-dark-font, .5) !default;
...
$pv-thumbnail-view-button-selection-background: transparent !default;
...
$pv-title-close-top: 8px !default;
$pv-title-close-padding: 0 10px 2px 0 !default;
...
$pv-sidebar-toolbar-splitter-background: $grey-700 !default;
$pv-sidebar-toolbar-splitter-height: calc(100% - 56px) !default;
...
$pv-sidebar-content-splitter-background: $grey-700 !default;
...
$pv-thumbnail-hover-border: 3px solid $grey-600 !default;
...
$pv-thumbnail-focus-border: 6px solid rgba($grey-dark-font, .3) !default;
$pv-organize-page-select-border: 6px solid rgba($accent, .7) !default;
...
$pv-thumbnail-selection-border: 6px solid rgba($accent, .7) !default;
...
$pv-item-selection-color: rgba($accent, .7) !default;
$pv-item-selection-background-color: $grey-900 !default;
...
$pv-search-box-background-color: $grey-900 !default;
$pv-search-box-border: 0 solid $grey-700 !default;
$pv-search-box-border-radius: 2px !default;
...
$pv-search-input-width: 244px !default;
...
$pv-notification-popup-height: 175px !default;
$pv-notification-popup-width: $pv-corrupted-dialog-width !default;
$pv-notification-popup-height-large-content: 190px;
...
$pv-sidebar-resizer-border-width: 0 !default;
$pv-sidebar-resizer-border: 1px solid $grey-700 !default;
...
$pv-input-active-color: rgba($base-font, .54) !default;
$pv-input-hover-background: transparent !default;
$pv-input-hover-color: rgba($base-font, .54) !default;
...
$pv-bookmark-container-background-color: $grey-dark !default;
$pv-nav-toolbar-text-color: $primary-font !default;
$pv-toolbar-btn-width-mobile: 36px !default;
$pv-toolbar-btn-height-mobile: 36px !default;
$pv-bookmark-container-border: 1px solid $grey-700 !default;
$pv-bookmark-list-border-bottom: 1px solid $grey-700 !default;
$pv-annotation-opacity-popup-background-color: #424242 !default;
...
$pv-annotation-dropdown-background-color: $grey-900 !default;
$pv-annotation-dropdown-border-color: transparent !default;
$pv-annotation-dropdown-background-color-hover: rgba(255, 255, 255, .1) !default;
$pv-annotation-dropdown-border-color-hover: transparent !default;
$pv-annotation-dropdown-background-color-active: $grey-700 !default;
$pv-annotation-dropdown-border-color-active: transparent !default;
$pv-annotation-drop-down-btn-line-height: 1.143em !default;
$pv-annotation-drop-down-btn-padding: 6px 7px 4px !default;
...
$pv-comment-color: rgba(255, 128, 171, .9) !default;
$pv-comment-panel-bg: #212121 !default;
$pv-comment-panel-bottom-color: rgba(255, 128, 171, .6) !default;
...
$pv-properties-padding: 8px !default;
$pv-properties-drop-down-margin-left: 95px !default;
$pv-properties-line-style-padding: 8px !default;
$pv-status-icon-color: #fff !default;
$pv-save-button-bg-color: rgba(255, 255, 255, .2) !default;
...
$pv-comment-text-cursor-color: rgba(255, 128, 171, 1) !default;
$pv-comment-panel-border-color: #616161 !default;
...
$pv-properties-win-max-width: 422px !default;
...
$pv-prop-line-styles-hover-bg: $grey-300 !default;
...
$pv-scale-ratio-win-drop-down-caret-margin-left: 96px !default;
...
$pv-annotation-dd-background-color-active: $grey-300 !default;
...
$pv-form-field-property-header-letter-spacing: -.198px !default;
...
$pv-form-field-property-header-color: $primary-font !default;
...
$pv-form-field-property-general-header-letter-spacing: -.1287px !default;
...
$pv-formfield-maxlength-width: 76px !default;
$pv-formfield-maxlength-arrow-width: 18px !default;
$pv-formfield-designer-dialog-height: 505px !default;
$pv-properties-header-spliter-border-bottom-color: #e0e0e0 !default;
...
$pv-properties-header-spliter-margin-bottom: 0 !default;
$pv-formfield-maxlength-group-padding-left: 100px !default;
$pv-formfield-properties-icon-height: 44px !default;
$pv-formfield-properties-icon-padding: 5px !default;
$pv-formfield-properties-icon-align-padding: 10px 8px !default;
$pv-form-field-property-font-style-width: 46px !default;
$pv-signature-delete-icon-margin-top: 10px !default;
$pv-signature-dialog-height: 540px !default;
$pv-signature-dialog-blazor-height: 540px !default;
$pv-blazor-scale-ratio-dialog-max-width: 423px !default;
$pv-handwritten-sign-width: 713px !default;
...
$pv-organize-anchor-node-border: $pv-organize-anchor-node-border-width solid $grey-700 !default;
$pv-organize-image-border: 1px solid $grey-700 !default;
