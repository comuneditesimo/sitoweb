...
@import '../../navigations/accordion/fluent-dark.scss';
...
@import '../../notifications/badge/fluent-dark.scss';
...
@import '../../splitbuttons/drop-down-button/fluent-dark.scss';
@import '../../splitbuttons/split-button/fluent-dark.scss';
@import '../../inputs/numerictextbox/fluent-dark.scss';
@import '../../popups/tooltip/fluent-dark.scss';
@import '../../inputs/slider/fluent-dark.scss';
@import '../../inputs/color-picker/fluent-dark.scss';
@import '../../dropdowns/combo-box/fluent-dark.scss';
@import '../../navigations/context-menu/fluent-dark.scss';
@import '../../buttons/radio-button/fluent-dark.scss';
@import '../../buttons/switch/fluent-dark.scss';
@import '../../lists/list-view/fluent-dark.scss';
@import '../../lists/sortable/fluent-dark.scss';
@import '../../inputs/maskedtextbox/fluent-dark.scss';
@import '../../inputs/textbox/fluent-dark.scss';
@import '../../inputs/uploader/fluent-dark.scss';
...
@import '../../navigations/tab/fluent-dark.scss';
@import '../../navigations/treeview/fluent-dark.scss';
@import '../../navigations/sidebar/fluent-dark.scss';
@import '../../navigations/menu/fluent-dark.scss';
@import '../../dropdowns/drop-down-tree/fluent-dark.scss';
@import '../../dropdowns/multi-select/fluent-dark.scss';
@import '../../dropdowns/list-box/fluent-dark.scss';
@import '../../dropdowns/mention/fluent-dark.scss';
@import '../../splitbuttons/button-group/fluent-dark.scss';
@import '../../splitbuttons/progress-button/fluent-dark.scss';
@import '../../notifications/toast/fluent-dark.scss';
@import '../../navigations/appbar/fluent-dark.scss';
@import '../../notifications/message/fluent-dark.scss';
@import '../../notifications/skeleton/fluent-dark.scss';
/*! PdfViewer's default definitions and variables */
$pv-background: $content-bg-color-alt4 !default;
$pv-control-border-color: $content-bg-color-alt4 !default;
...
$pv-icon-font-size: 14px !default;
...
$pv-toolbar-border-width: 1px 1px 1px 1px !default;
$pv-toolbar-border-radius: 0 !default;
$pv-current-page-height: 32px !default;
$pv-current-page-width: 50px !default;
...
$pv-toolbar-open-icon-height: 12.44px !default;
$pv-toolbar-open-icon-line-height: 12.44px !default;
...
$pv-toolbar-total-page-padding-bottom: 0 !default;
$pv-toolbar-total-page-div-margin-left: 4px !default;
...
$pv-current-page-border: 1px solid $border !default;
...
$pv-current-page-padding-bottom: 1px !default;
...
$pv-password-dialog-height: 240px !default;
...
$pv-sidebar-container-border-top:  1px solid $primary !default;
...
$pv-sidebar-content-container-left: 38px !default;
...
$pv-sidebar-content-container-border-top:  1px solid $border-light !default;
$pv-sidebar-title-container-width: 202px !default;
$pv-sidebar-title-container-position: $pv-page-div-position !default;
$pv-sidebar-title-container-height: 38px !default;
$pv-sidebar-title-container-top: 0 !default;
$pv-sidebar-title-container-border-width: 0 1px 0 0 !default;
...
$pv-sidebar-toolbar-width: 40px !default;
$pv-sidebar-toolbar-width-big: 46px !default;
...
$pv-sidebar-toolbar-border:  1px solid $border-light !default;
$pv-sidebar-toolbar-border-width:  1px 1px 1px 1px !default;
...
$pv-sidebar-content-scrollbar-track-box-shadow: inset 0 0 0 $border-light !default;
$pv-sidebar-content-scrollbar-track-background: $content-bg-color-alt1 !default;
$pv-sidebar-content-scrollbar-track-border: 1px solid $border-light !default;
$pv-sidebar-content-scrollbar-thumb-border-radius: 100px !default;
$pv-sidebar-content-scrollbar-thumb-background: $border !default;
$pv-sidebar-content-scrollbar-thumb-box-shadow: inset 0 0 0 $border-light !default;
...
$pv-thumbnail-view-button-margin: 12px 2px !default;
...
$pv-bookmark-button-margin: 15px 2px !default;
...
$pv-title-close-padding: 8px !default;
...
$pv-thumbnail-selection-ring-border: 1px solid $border-light;
...
$pv-bookmark-view-icon-collapsible-padding: 4px !default;
$pv-bookmark-view-icon-collapsible-height: 20px !default;
$pv-bookmark-view-icon-collapsible-width: 20px !default;
...
$pv-search-box-height: 90px !default;
$pv-search-box-width: 338px !default;
$pv-search-box-background-color: $content-bg-color-alt1 !default;
$pv-search-box-border: 1px solid $border-light !default;
$pv-search-box-border-radius: 2px !default;
$pv-search-box-box-shadow: 0 3px 8px 0 $border-light !default;
$pv-search-box-padding: 12px !default;
$pv-search-input-height: 32px !default;
$pv-search-input-height-big: 42px !default;
...
$pv-search-btn-height-big: 30px !default;
$pv-search-btn-width-big: 30px !default;
...
$pv-notification-popup-height-large-content: 278px;
...
$pv-toolbaritem-btn-line-height: 22px !default;
$pv-toolbaritem-btn-min-height: 22px !default;
...
$pv-input-hover-color: $icon-color-hover !default;
...
$pv-bookmark-container-background-color: $primary !default;
...
$pv-annotation-opacity-popup-box-shadow: none !default;
...
$pv-annotation-drop-down-caret-font-size: 16px !default;
...
$pv-annotation-dropdown-background-color-hover: $content-bg-color-alt3 !default;
$pv-annotation-dropdown-border-color-hover: $content-bg-color-alt3 !default;
$pv-annotation-dropdown-background-color-active: $content-bg-color-alt3 !default;
$pv-annotation-dropdown-border-color-active: $content-bg-color-alt3 !default;
$pv-annotation-drop-down-btn-line-height: 30px !default;
$pv-annotation-drop-down-btn-padding: 0 8px !default;
...
$pv-comment-text-color: $primary !default;
$pv-comment-color: $content-text-color !default;
$pv-comment-panel-bg: $content-bg-color-alt1 !default;
$pv-comment-tile-text-color: $content-text-color !default;
$pv-comment-tile-font-weight: 600 !default;
...
$pv-properties-drop-down-margin-left: 83px !default;
$pv-properties-line-style-padding: 11px 4px !default;
...
$pv-line-stroke-color-margin-left: 131px !default;
$pv-line-leader-length-margin-left: 20px !default;
$pv-annot-toolbar-dropdown-btn-height: 32px !default;
$pv-annot-toolbar-dropdown-btn-line-height: 30px !default;
$pv-annot-toolbar-dropdown-btn-width: auto !default;
$pv-annot-toolbar-dropdown-btn-padding-top: 1px !default;
$pv-properties-win-max-width: 412px !default;
$pv-properties-form-field-win-max-width: 456px !default;
$pv-properties-win-max-width-big: 577px !default;
$pv-properties-container-margin-bottom: 24px !default;
$pv-properties-container-height: 58px !default;
$pv-scale-ratio-win-max-width: 472px !default;
$pv-scale-ratio-win-max-width-big: 580px !default;
...
$pv-scale-ratio-win-drop-down-padding: 4px 8px 4px !default;
$pv-scale-ratio-win-drop-down-caret-margin-left: 96px !default;
$pv-scale-ratio-win-drop-down-caret-margin-top: 0 !default;
$pv-scale-ratio-input-container-height: 32px !default;
$pv-scale-ratio-input-container-margin-bottom: 16px !default;
$pv-scale-ratio-width: 200px !default;
$pv-scale-ratio-container-max-width: 200px !default;
$pv-properties-window-container-max-width: 170px !default;
$pv-properties-window-container-width: 170px !default;
$pv-annotation-dd-background-color-active: $secondary-bg-color-pressed !default;
$pv-prop-line-styles-margin-top: 2.5px !default;
$pv-more-option-button-padding: 4px 7px 4px 7px !default;
...
$pv-form-field-property-header-font-size: 16px !default;
...
$pv-form-field-property-general-header-font-size: 14px !default;
$pv-form-field-property-general-header-line-height: 22px !default;
...
$pv-formfield-maxlength-width: 62px !default;
$pv-formfield-maxlength-arrow-width: 18px !default;
$pv-formfield-designer-dialog-height: 555px !default;
...
$pv-formfield-maxlength-group-padding-left: 30px !default;
$pv-formfield-properties-icon-height: auto !default;
...
$pv-signature-dialog-height: 591px !default;
$pv-signature-dialog-blazor-height: 535px !default;
$pv-blazor-scale-ratio-dialog-max-width: 508px !default;
$pv-handwritten-sign-width: 712px !default;
$pv-handwritten-sign-height: 366px !default;
$pv-canvas-sign-width: 702px !default;
$pv-canvas-sign-width-blazor: 702px !default;
...
$pv-show-designer-name-color: $black !default;
...
$pv-comment-text-cursor-color: $black !default;
...
$pv-organize-image-border: 1px solid $border-light !default;
