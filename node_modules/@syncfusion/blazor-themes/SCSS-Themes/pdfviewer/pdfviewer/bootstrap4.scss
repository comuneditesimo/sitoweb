@use 'sass:math';
@import '../../base/bootstrap4.scss';
@import '../../navigations/accordion/bootstrap4.scss';
@import '../../dropdowns/drop-down-list/bootstrap4.scss';
@import '../../inputs/input/bootstrap4.scss';
@import '../../popups/popup/bootstrap4.scss';
@import '../../popups/spinner/bootstrap4.scss';
@import '../../dropdowns/drop-down-base/bootstrap4.scss';
@import '../../dropdowns/auto-complete/bootstrap4.scss';
@import '../../notifications/badge/bootstrap4.scss';
...
@import '../../splitbuttons/drop-down-button/bootstrap4.scss';
@import '../../splitbuttons/split-button/bootstrap4.scss';
@import '../../inputs/numerictextbox/bootstrap4.scss';
@import '../../popups/tooltip/bootstrap4.scss';
@import '../../inputs/slider/bootstrap4.scss';
@import '../../inputs/color-picker/bootstrap4.scss';
@import '../../dropdowns/combo-box/bootstrap4.scss';
@import '../../navigations/context-menu/bootstrap4.scss';
@import '../../buttons/radio-button/bootstrap4.scss';
@import '../../buttons/switch/bootstrap4.scss';
@import '../../lists/list-view/bootstrap4.scss';
@import '../../lists/sortable/bootstrap4.scss';
@import '../../inputs/maskedtextbox/bootstrap4.scss';
@import '../../inputs/textbox/bootstrap4.scss';
@import '../../inputs/uploader/bootstrap4.scss';
@import '../../popups/dialog/bootstrap4.scss';
@import '../../navigations/h-scroll/bootstrap4.scss';
@import '../../navigations/v-scroll/bootstrap4.scss';
@import '../../navigations/toolbar/bootstrap4.scss';
@import '../../navigations/tab/bootstrap4.scss';
@import '../../navigations/treeview/bootstrap4.scss';
@import '../../navigations/sidebar/bootstrap4.scss';
@import '../../navigations/menu/bootstrap4.scss';
@import '../../dropdowns/drop-down-tree/bootstrap4.scss';
@import '../../dropdowns/multi-select/bootstrap4.scss';
@import '../../dropdowns/list-box/bootstrap4.scss';
@import '../../dropdowns/mention/bootstrap4.scss';
@import '../../splitbuttons/button-group/bootstrap4.scss';
@import '../../splitbuttons/progress-button/bootstrap4.scss';
@import '../../notifications/toast/bootstrap4.scss';
@import '../../navigations/appbar/bootstrap4.scss';
@import '../../notifications/message/bootstrap4.scss';
@import '../../notifications/skeleton/bootstrap4.scss';
/*! PdfViewer's default definitions and variables */
$pv-background: $gray-200 !default;
$pv-control-border-color: $gray-300 !default;
$pv-viewer-border-width: 1px 1px 1px 0 !default;
...
$pv-viewer-container-height: calc(100% - 40px) !default;
...
$pv-icon-color: $gray-700 !default;
$pv-icon-color-hover: $white !default;
$pv-icon-disable-color: $pv-icon-color !default;
$pv-icon-font-size: 16px !default;
$pv-icon-margin: 9px 7.5px !default;
...
$pv-toolbar-border-radius: 4px 4px 0 0 !default;
$pv-current-page-height: 30px !default;
$pv-current-page-width: 48px !default;
$pv-zoom-dropdown-height: 32px !default;
$pv-zoom-dropdown-width: 91px !default;
$pv-password-input-margin-top: 14px !default;
$pv-password-error-color: $error-font-color !default;
$pv-corrupted-pop-header-opacity: .87 !default;
$pv-corrupted-pop-header-font-size: 18px !default;
$pv-corrupted-pop-header-letter-spacing: -.18px !default;
$pv-corrupted-pop-header-text-align: left !default;
$pv-corrupted-pop-content-font-size: 14px !default;
$pv-corrupted-pop-header-color: $gray-900 !default;
$pv-corrupted-pop-content-letter-spacing: 0 !default;
$pv-corrupted-pop-content-line-height: 24px !default;
$pv-corrupted-pop-content-margin-left: 50px !default;
$pv-toolbar-separator-margin-left: 6px !default;
$pv-toolbar-separator-margin-right: 6px !default;
$pv-toolbar-separator-border-right-width: 1px !default;
$pv-toolbar-separator-height: 27px !default;
$pv-toolbar-popup-icon-padding: 0 12px 0 15px;
$pv-toolbar-popup-icon-padding-rtl: $pv-toolbar-popup-icon-padding;
$pv-toolbar-items-margin-left: 0 !default;
$pv-toolbar-items-margin-right: 0 !default;
$pv-toolbar-items-padding-top: 3px !default;
$pv-toolbar-items-padding-bottom: 4px !default;
$pv-toolbar-items-padding-top-big: 8px !default;
$pv-toolbar-items-padding-bottom-big: 8px !default;
$pv-toolbar-items-first-child-margin-left: 4px !default;
$pv-toolbar-items-last-child-margin-right: 4px !default;
$pv-toolbar-btn-height: 32px !default;
$pv-toolbar-btn-width: 32px !default;
$pv-toolbar-btn-height-big: 38px !default;
$pv-toolbar-btn-width-big: 38px !default;
$pv-toolbar-open-icon-width: 18px !default;
$pv-toolbar-open-icon-height: 16px !default;
$pv-toolbar-open-icon-line-height: 16px !default;
...
$pv-toolbar-first-page-icon-line-height: 16px !default;
$pv-toolbar-previous-page-icon-line-height: 16px !default;
$pv-toolbar-next-page-icon-line-height: 16px !default;
$pv-toolbar-last-page-icon-line-height: 16px !default;
$pv-toolbar-zoom-out-icon-size: 18px !default;
$pv-toolbar-zoom-out-icon-line-height: 18px !default;
$pv-toolbar-zoom-drop-margin: 0 4px !default;
$pv-toolbar-zoom-drop-padding: 6px 0 7px 0 !default;
$pv-toolbar-total-page-div-padding-left: 0 !default;
$pv-toolbar-total-page-padding-bottom: 6.5px !default;
$pv-toolbar-total-page-div-margin-left: 0 !default;
$pv-toolbar-total-page-div-margin-right: 7.5px !default;
$pv-toolbar-total-page-font-color: #000 !default;
$pv-toolbar-current-page-box-margin-top: 0 !default;
$pv-toolbar-zoom-drop-down-margin-top: 0 !default;
$pv-toolbar-zoom-drop-down-padding: 0 0 0 3px !default;
$pv-toolbar-zoom-drop-down-border: 1px solid $gray-100 !default;
$pv-toolbar-zoom-drop-down-border-focus: 1px solid $gray-100 !default;
$pv-toolbar-zoom-drop-down-border-radius: 2px !default;
$pv-toolbar-zoom-drop-down-background-color: transparent !default;
$pv-text-align: center !default;
$pv-zoom-drop-down-popup-text-align: left !default;
$pv-zoom-drop-down-padding-top: 0 !default;
$pv-zoom-drop-down-padding-bottom: 0 !default;
$pv-zoom-drop-down-padding-left: 0 !default;
$pv-zoom-drop-down-padding-left-rtl: 0 !default;
$pv-zoom-drop-down-padding-right-rtl: 12px !default;
$pv-zoom-drop-down-input-height: inherit !default;
$pv-zoom-drop-down-input-margin-top: -1px !default;
$pv-zoom-drop-down-margin-top: -.2px !default;
...
$pv-current-page-height: 32px !default;
$pv-current-page-padding-bottom: 3px !default;
$pv-dialog-pop-header-font-weight: normal !default;
$pv-password-pop-content-font-size: 14px !default;
$pv-password-pop-content-letter-spacing: -.16px !default;
$pv-corrupted-pop-content-padding-top: 4px !default;
$pv-password-pop-content-padding-top: 6px !default;
$pv-zoom-drop-down-popup-height: 236px !default;
$pv-zoom-drop-down-popup-width: 122px !default;
$pv-zoom-drop-down-transform: rotate(0deg) !default;
$pv-corrupted-dialog-width: 380px !default;
$pv-corrupted-dialog-height: 165px !default;
$pv-corrupted-dialog-header-border-bottom: 1px solid $gray-200 !default;
$pv-corrupted-dialog-footer-border-top: 1px solid $gray-200 !default;
$pv-password-dialog-width: 441px !default;
$pv-password-dialog-height: 202px !default;
$pv-password-dialog-header-border-bottom: 1px solid $gray-200 !default;
$pv-password-dialog-footer-border-top: 1px solid $gray-200 !default;
$pv-dialog-pop-close-icon-padding-top: 10px !default;
$pv-corrupted-dialog-pop-content-padding-top: 5px !default;
$pv-corrupted-dialog-pop-content-padding-bottom: 0 !default;
$pv-password-dialog-pop-content-padding-bottom: 0 !default;
$pv-toolbar-total-page-number-color: $gray-900 !default;
...
$pv-corrupted-notification-background-size: 38px 33px !default;
$pv-corrupted-notification-height: 33px !default;
$pv-corrupted-notification-background-position: right !default;
$pv-toolbar-open-icon-font-size: 18px !default;
$pv-thumbnail-icon-disable-color: rgba($gray-700, .4) !default;
$pv-thumbnail-icon-selection-color: $white !default;
$pv-sidebar-container-position: $pv-page-div-position !default;
$pv-sidebar-container-top: $pv-toolbar-height !default;
$pv-sidebar-container-bottom: 0 !default;
$pv-sidebar-container-width: 250px !default;
$pv-sidebar-container-z-index: 100 !default;
$pv-sidebar-container-background: $gray-100 !default;
$pv-sidebar-container-border-top:  1px solid $gray-100 !default;
...
$pv-sidebar-content-container-left: 41px !default;
$pv-sidebar-content-container-left-big: 57px !default;
$pv-sidebar-content-container-display: none !default;
$pv-sidebar-content-container-height: calc(100% - 41px) !default;
$pv-sidebar-content-container-width: 210px !default;
$pv-sidebar-content-container-float: left !default;
$pv-sidebar-content-container-border-top:  1px solid $gray-300 !default;
$pv-sidebar-title-container-border-width: 0 0 0 0 !default;
...
$pv-sidebar-title-container-height-big: 46px !default;
$pv-sidebar-title-container-top: 0 !default;
$pv-sidebar-title-container-background: $gray-100 !default;
$pv-sidebar-title-container-z-index: 102 !default;
$pv-sidebar-title-margin: 0 !default;
$pv-sidebar-title-top: 12px !default;
$pv-sidebar-title-top-big: 14px !default;
...
$pv-sidebar-title-height: 16px !default;
$pv-sidebar-title-font-size: 14px !default;
$pv-sidebar-title-color: $gray-900 !default;
$pv-sidebar-title-text-align: left !default;
$pv-sidebar-toolbar-z-index: 100 !default;
$pv-sidebar-toolbar-width: 47px !default;
$pv-sidebar-toolbar-width-big: 56px !default;
$pv-sidebar-toolbar-height: calc(100% - 41px) !default;
$pv-sidebar-toolbar-bottom: 0 !default;
$pv-sidebar-toolbar-background: $gray-100 !default;
$pv-sidebar-toolbar-position: $pv-page-div-position !default;
$pv-sidebar-toolbar-border:  1px solid $gray-300 !default;
$pv-sidebar-toolbar-border-width:  1px 0 1px 1px !default;
$pv-sidebar-content-top: 42px !default;
$pv-sidebar-content-top-big: 48px !default;
...
$pv-sidebar-content-background: $gray-100 !default;
$pv-sidebar-content-overflow-x: hidden !default;
$pv-sidebar-content-z-index: 103 !default;
$pv-sidebar-resizer-width: 8px !default;
$pv-sidebar-resizer-background: darken($gray-100, 2%) !default;
$pv-sidebar-resizer-height: calc(100%) !default;
...
$pv-sidebar-resizer-border-color: $gray-400;
$pv-sidebar-content-scrollbar-width: 16px !default;
$pv-sidebar-content-scrollbar-track-box-shadow: inset 0 0 0 rgba(0, 0, 0, .3) !default;
$pv-sidebar-content-scrollbar-track-background: $gray-100 !default;
$pv-sidebar-content-scrollbar-track-border: 1px solid $gray-300 !default;
$pv-sidebar-content-scrollbar-thumb-border-radius: 100px !default;
$pv-sidebar-content-scrollbar-thumb-background: $gray-500 !default;
$pv-sidebar-content-scrollbar-thumb-box-shadow: inset 0 0 0 rgba(0, 0, 0, .5) !default;
$pv-sidebar-content-scrollbar-thumb-border: 4px solid transparent !default;
$pv-sidebar-content-scrollbar-thumb-background-clip: content-box !default;
$pv-thumbnail-view-button-width: $pv-toolbar-btn-width !default;
$pv-thumbnail-view-button-height: $pv-toolbar-btn-height !default;
$pv-thumbnail-view-button-width-big: $pv-toolbar-btn-width-big !default;
$pv-thumbnail-view-button-height-big: $pv-toolbar-btn-height-big !default;
$pv-thumbnail-view-button-margin: 8px 4px 4px 3px !default;
$pv-thumbnail-view-button-margin-big: 8px 8px 4px 8px !default;
$pv-thumbnail-view-button-background: transparent !default;
$pv-thumbnail-view-button-selection-background: #545b62 !default;
$pv-thumbnail-view-button-selection-line-height: 1em !default;
$pv-thumbnail-button-selection-line-height: 1 !default;
...
$pv-thumbnail-view-button-selection-padding-big: 9px !default;
$pv-thumbnail-border-radius: 4px !default;
$pv-thumbnail-outline: none !default;
$pv-bookmark-button-width: $pv-toolbar-btn-width !default;
$pv-bookmark-button-height: $pv-toolbar-btn-height !default;
$pv-bookmark-button-width-big: $pv-toolbar-btn-width-big !default;
$pv-bookmark-button-height-big: $pv-toolbar-btn-height-big !default;
$pv-bookmark-button-margin: 4px 4px 4px 3px !default;
$pv-bookmark-button-margin-big: 4px 8px 8px !default;
...
$pv-title-close-height: 38px !default;
$pv-title-close-left: 170px !default;
$pv-title-close-right: 21px !default;
$pv-title-close-top: 1px !default;
$pv-title-close-top-big: 5px !default;
$pv-title-close-padding: 0 7px 1px 0 !default;
...
$pv-sidebar-toolbar-splitter-left-big: 56px !default;
$pv-sidebar-toolbar-splitter-background: $gray-400 !default;
$pv-sidebar-toolbar-splitter-height: calc(100% - 41px) !default;
...
$pv-sidebar-content-splitter-background: $gray-300 !default;
$pv-sidebar-content-splitter-z-index: 104 !default;
$pv-sidebar-content-splitter-top: 41px !default;
$pv-sidebar-content-splitter-top-big: 47px !default;
...
$pv-thumbnail-selection-ring-border-radius: 2px !default;
$pv-thumbnail-selection-ring-padding: 3px !default;
$pv-thumbnail-selection-ring-box-shadow: 0 0 3px 0 rgba($gray-300, 1) !default;
$pv-thumbnail-image-width: 94px !default;
$pv-thumbnail-image-height: 126px !default;
$pv-thumbnail-image-background-color: #fff !default;
$pv-thumbnail-image-background-clip: content-box !default;
$pv-thumbnail-hover-border-radius: 2px !default;
$pv-thumbnail-hover-padding: 2px !default;
$pv-thumbnail-hover-cursor: pointer !default;
$pv-thumbnail-hover-border: 1px solid $gray-500 !default;
$pv-thumbnail-hover-box-shadow: 0 0 4px 0 rgba($gray-500, 1) !default;
$pv-thumbnail-focus-border-radius: 2px !default;
$pv-organize-page-select-border-radius: 2px !default;
$pv-thumbnail-focus-cursor: pointer !default;
$pv-thumbnail-focus-padding: 2px !default;
$pv-thumbnail-focus-border: 2px solid $primary !default;
$pv-organize-page-select-border: 2px solid $primary !default;
$pv-thumbnail-focus-box-shadow: 0 0 4px 0 rgba($gray-100, .25) !default;
$pv-thumbnail-selection-border-radius: 2px !default;
$pv-thumbnail-selection-cursor: pointer !default;
$pv-thumbnail-selection-border: 2px solid $primary !default;
$pv-thumbnail-selection-padding: 1px !default;
$pv-thumbnail-selection-box-shadow: 0 0 4px 0 rgba($gray-100, .25) !default;
...
$pv-bookmark-view-padding-top: 15px !default;
$pv-bookmark-view-overflow: auto !default;
$pv-bookmark-icon-float: left !default;
$pv-bookmark-icon-font-size: 14px !default;
$pv-bookmark-icon-padding-right: 18px !default;
$pv-bookmark-icon-padding-left: 6px !default;
$pv-bookmark-title-padding-left: 40px !default;
$pv-bookmark-expandable-icon-margin-top: 3px !default;
$pv-bookmark-icon-font: grey-light-font 54% !default;
$pv-sidebar-bookmark-title-font-size: 14px !default;
$pv-sidebar-bookmark-title-font-family: Roboto-Regular !default;
$pv-sidebar-bookmark-title-color: rgba(0, 0, 0, .87) !default;
$pv-sidebar-bookmark-title-font: grey-light-font 87% !default;
$-treeview-overflow: unset !default;
$-treeview-fullrow-height: 34px !default;
...
$pv-bookmark-view-icon-collapsible-padding: 7px !default;
$pv-bookmark-view-icon-collapsible-height: 13px !default;
$pv-bookmark-view-icon-collapsible-width: 13px !default;
$pv-item-selection-color: $white !default;
$pv-item-selection-background-color: #545b62 !default;
$pv-item-selection-border-radius: 4px !default;
$pv-item-selection-border: 1px solid $gray-100 !default;
...
$pv-print-popup-container-background-color: #000 !default;
$pv-print-popup-container-opacity: .3 !default;
$pv-search-box-height: 92px !default;
$pv-search-box-width: 394px !default;
$pv-search-box-height-big: 106px !default;
$pv-search-box-width-big: 410px !default;
$pv-search-box-top-big: 52px !default;
$pv-search-box-background-color: $gray-100 !default;
$pv-search-box-border: 1px solid $gray-300 !default;
$pv-search-box-border-radius: 4px !default;
$pv-search-box-box-shadow: 0 0 10px 0 rgba(0, 0, 0, 0) !default;
$pv-search-box-padding: 14px !default;
$pv-search-box-padding-big: 16px !default;
$pv-search-input-height: 31px !default;
$pv-search-input-height-big: 39px !default;
$pv-search-input-width: 282px !default;
$pv-match-case-margin-top: 14px !default;
$pv-match-case-margin-top-big: 16px !default;
$pv-search-btn-height: 32px !default;
$pv-search-btn-width: 32px !default;
$pv-search-btn-height-big: 38px !default;
$pv-search-btn-width-big: 38px !default;
$pv-search-btn-margin-top: 0;
$pv-search-prev-margin-left: 9px !default;
$pv-search-next-margin-left: 8px !default;
$pv-notification-popup-height: 185px !default;
$pv-notification-popup-width: $pv-corrupted-dialog-width !default;
$pv-notification-popup-height-large-content: 205px;
$pv-notification-popup-width-large-content: 384px;
$pv-notification-content-font-size: 14px !default;
$pv-zoom-dropdown-input-focus-color: inherit !default;
$pv-text-selection-bg-color: $primary !default;
$pv-text-selection-opacity: .4 !default;
$pv-selection-touch-element-background-color: #3088ed !default;
$pv-selection-touch-element-border-color: #3088ed !default;
$pv-sidebar-toolbar-border-top:  1px solid #e0e0e0 !default;
$pv-material-line-background: none !default;
$pv-toolbar-btn-padding: 1px 2.5px !default;
$pv-toolbar-btn-line-height: 27px !default;
$pv-toolbaritem-btn-line-height: 26px !default;
$pv-toolbaritem-btn-min-height: 26px !default;
$pv-toolbar-btn-margin: 0 !default;
$pv-mobile-page-box-padding-top: 3px !default;
$pv-zoom-dropdown-width-mobile: 105px !default;
$pv-mobile-page-box-padding-left-focus: 1.5px !default;
$pv-password-dialog-height-mobile: 225px !default;
$pv-notification-dialog-height-mobile: 217px !default;
$pv-notification-dialog-height-large-mobile: 235px !default;
$pv-corrupted-dialog-height-mobile: 185px !default;
$pv-dialog-pop-close-icon-padding-top-mobile: 0 !default;
$pv-sidebar-resizer-border: 0 !default;
$pv-sidebar-resizer-border-width: $pv-sidebar-resizer-border !default;
$pv-sidebar-resizer-color: inherit !default;
$pv-input-active-background: $gray-100 !default;
$pv-input-active-color: $gray-700 !default;
$pv-input-hover-background: $gray-100 !default;
$pv-input-hover-color: $gray-900 !default;
...
$pv-corrupted-pop-content-margin-right: 53px !default;
$pv-corrupted-pop-header-rtl-text-align: right !default;
$pv-bookmark-container-background-color: $gray-100 !default;
$pv-nav-toolbar-text-color: $gray-100 !default;
$pv-toolbar-btn-width-mobile: 38px !default;
$pv-toolbar-btn-height-mobile: 38px !default;
$pv-bookmark-container-border: 1px solid $gray-100 !default;
$pv-bookmark-list-border-bottom: 1px solid $gray-100 !default;
$pv-annotation-opacity-popup-background-color: #fff !default;
$pv-annotation-opacity-popup-color: #212529 !default;
$pv-annotation-opacity-popup-padding: 23px !default;
$pv-annotation-opacity-popup-min-height: 58px !default;
$pv-annotation-opacity-popup-box-shadow: 0 6px 12px 0 rgba(0, 0, 0, .26) !default;
$pv-annotation-opacity-slider-width: 174px !default;
$pv-annotation-opacity-slider-width-rtl: 130px !default;
$pv-annotation-opacity-slider-margin-left: 9px !default;
$pv-annotation-opacity-slider-margin-right: 9px !default;
...
$pv-annotation-drop-down-width: 54px !default;
$pv-annotation-opacity-icon-padding-top: 1px !default;
$pv-annotation-dropdown-background-color: $gray-100 !default;
$pv-annotation-dropdown-border-color: transparent !default;
$pv-annotation-dropdown-background-color-hover: #545b62 !default;
$pv-annotation-dropdown-border-color-hover: #545b62 !default;
$pv-annotation-dropdown-background-color-active: #545b62 !default;
$pv-annotation-dropdown-border-color-active: #545b62 !default;
$pv-annotation-drop-down-btn-line-height: 16px !default;
$pv-annotation-drop-down-btn-padding: 7px 8px !default;
$pv-annotation-icon-padding: 1px 8px 3px !default;
$pv-annotation-note-border-bottom-color: #000 !default;
$pv-annotation-note-popup-bg-color: #fff !default;
$pv-toolbar-items-last-child-margin-right-big: 4px !default;
$pv-toolbar-items-first-child-margin-left-big: 4px !default;
$pv-toolbar-items-padding-left-big: 4px !default;
$pv-toolbar-items-padding-right-big: 4px !default;
$pv-icon-font-size-big: 18px !default;
$pv-treeview-item-hover-bg-color: $gray-200 !default;
$pv-label-font-size-big: 16px !default;
$pv-thumbnail-view-button-margin-selection: 8px 4px 4px 3px !default;
$pv-bookmark-button-margin-selection: 4px 4px 4px 3px !default;
$pv-print-overlay-bg-color: rgba($pv-print-popup-container-background-color, $pv-print-popup-container-opacity) !default;
$pv-comment-font-color: rgba(33, 37, 41, .9) !default;
$pv-comment-text-color: rgba(33, 37, 41, .6) !default;
$pv-comment-color: rgba(33, 37, 41, .9) !default;
$pv-comment-panel-bg: #f8f9fa !default;
$pv-comment-panel-bottom-color: #f8f9fa !default;
...
$pv-properties-padding: 0 12px !default;
$pv-properties-drop-down-margin-left: 143px !default;
$pv-properties-line-style-padding: 8px !default;
$pv-status-icon-color: #fff !default;
$pv-save-button-bg-color: rgba(0, 0, 0, .12) !default;
$pv-save-button-color: rgba(33, 37, 41, .6) !default;
$pv-status-icon-padding: 2px 1px 1px 3.5px !default;
...
$pv-comment-text-cursor-color: #007bff !default;
$pv-comment-panel-border-color: #dee2e6 !default;
$pv-drop-down-toolbar-box-shadow: none !default;
$pv-line-stroke-color-margin-left: 150px !default;
$pv-line-leader-length-margin-left: 15px !default;
$pv-annot-toolbar-dropdown-btn-height: 36px !default;
$pv-annot-toolbar-dropdown-btn-line-height: 36px !default;
$pv-annot-toolbar-dropdown-btn-width: 69px !default;
$pv-annot-toolbar-dropdown-btn-padding-top: 2px !default;
$pv-properties-win-max-width: 417px !default;
$pv-properties-win-max-width-big: 425px !default;
$pv-properties-container-margin-bottom: 16px !default;
$pv-properties-container-height: 52px !default;
$pv-scale-ratio-win-max-width: 420px !default;
$pv-scale-ratio-win-max-width-big: 435px !default;
$pv-scale-ratio-input-container-height: 24px !default;
$pv-scale-ratio-input-container-margin-bottom: 24px !default;
$pv-scale-ratio-width: 180px !default;
$pv-scale-ratio-container-max-width: 180px !default;
$pv-properties-window-container-max-width: $pv-scale-ratio-container-max-width !default;
$pv-properties-window-container-width: $pv-scale-ratio-container-max-width !default;
$pv-prop-line-styles-color: #000 !default;
$pv-prop-line-styles-hover-bg: #f2f4f6 !default;
$pv-prop-color-picker-height: 36px !default;
$pv-prop-color-picker-line-height: 16px !default;
$pv-prop-win-drop-down-bg: $gray-100 !default;
$pv-prop-win-drop-down-color: $gray-600 !default;
$pv-prop-win-drop-down-bg-hover: #5a6268 !default;
$pv-prop-win-drop-down-color-hover: #fff !default;
$pv-scale-ratio-win-drop-down-padding: 4px 8px !default;
$pv-scale-ratio-win-drop-down-caret-margin-left: 98px !default;
$pv-scale-ratio-win-drop-down-caret-margin-top: 7px !default;
$pv-annotation-dd-background-color-active: $white !default;
$pv-prop-line-styles-margin-top: 2.5px !default;
$pv-more-option-button-padding: 8px 7px 1px 1px !default;
$pv-comment-title-padding-top: 7px !default;
$pv-signature-footer-color: #bdbdbd !default;
$pv-signature-border-color: 1px dotted #bdbdbd !default;
$pv-signature-color: #e3165b !default;
$pv-zoom-drop-down-bgcolor: #6c757d !default;
$pv-form-checkbox-border-color: #303030 !default;
$pv-form-field-size: 0 !default;
$pv-properties-form-field-win-max-width: 477px !default;
$pv-form-field-radiobutton-border: 5px solid #fff !default;
$pv-form-field-radiobutton-box-shadow: 0 0 0 1px #303030 !default;
$pv-form-field-li-background-color: #d3d3d3 !default;
$pv-form-field-font-style-icon-color: #e2e2e2 !default;
$pv-form-field-font-style-icon-color-active: #b8b8b8 !default;
$pv-form-field-checkbox-container: 1px solid #303030 !default;
$pv-form-field-checkbox-checked: solid #303030 !default;
...
$pv-form-field-property-header-line-height: 23px !default;
$pv-form-field-property-header-opacity: .87 !default;
$pv-form-field-property-header-margin-top: 5px !default;
$pv-form-field-property-header-width: 80% !default;
$pv-form-field-property-header-color: #000 !default;
$pv-form-field-property-general-header-font-size: 13px !default;
$pv-form-field-property-general-header-line-height: 15px !default;
$pv-form-field-property-label-color: #757575 !default;
$pv-form-field-property-font-style-color: #eee !default;
$pv-prop-win-margin-left: 24px !default;
$pv-font-size-field-width: 99px !default;
$pv-formfield-maxlength-width: 77px !default;
$pv-formfield-maxlength-arrow-width: 18px !default;
$pv-formfield-designer-dialog-height: 544px !default;
$pv-properties-header-spliter-border-bottom-color: $gray-100 !default;
$pv-properties-header-spliter-border-bottom-style: solid !default;
$pv-properties-header-spliter-border-bottom-width: 0 !default;
$pv-properties-header-spliter-left: 0 !default;
$pv-properties-header-spliter-padding-top: 35px !default;
$pv-properties-header-spliter-position: absolute !default;
$pv-properties-header-spliter-width: 0 !default;
$pv-properties-header-spliter-margin-bottom: 10px !default;
$pv-formfield-maxlength-group-padding-left: 105px !default;
$pv-formfield-properties-icon-height: 44px !default;
$pv-formfield-properties-icon-padding: 5px !default;
$pv-formfield-properties-icon-align-padding: 8px 8px !default;
$pv-form-field-property-font-style-width: 46px !default;
$pv-signature-delete-icon-margin-top: 14px !default;
$pv-signature-dialog-height: 535px !default;
$pv-signature-dialog-blazor-height: 540px !default;
$pv-blazor-scale-ratio-dialog-max-width: 488px !default;
$pv-handwritten-sign-width: 718px !default;
$pv-handwritten-sign-height: 350px !default;
$pv-canvas-sign-width: 718px !default;
$pv-canvas-sign-width-blazor: 718px !default;
$pv-font-div-padding: 15px !default;
$pv-font-div-padding-blazor: 15px !default;
$pv-signature-appearance-checkbox: 1px !default;
$pv-show-designer-name-color: #000 !default;
...
$pv-organize-anchor-node-border-width: 2px !default;
$pv-organize-anchor-node-border: $pv-organize-anchor-node-border-width solid $gray-300 !default;
$pv-organize-image-border: 1px solid $gray-300 !default;
