...
@import '../../filemanager/file-manager/highcontrast.scss';
...
$rte-list-btn-line-height: 36px !default;
$rte-big-list-btn-line-height: 46px !default;
...
$rte-dropdown-btn-color-content-height: 36px !default;
$rte-big-dropdown-btn-color-content-height: 45px !default;
...
$rte-formatlists-dropdown-line-height: 30px;
...
$rte-expand-tbar-hover-bg: $hover-bg !default;
...
@include export-module('richtexteditor-highcontrast-icons') {
