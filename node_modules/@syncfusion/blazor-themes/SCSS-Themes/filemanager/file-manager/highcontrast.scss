...
@import '../../layouts/splitter/highcontrast.scss';
...
$fm-skin-name: 'highcontrast' !default;
...
$fe-border-color: $border-default !default;
$fe-background: $bg-base-0;
$fe-icon-color: $content-font !default;
$fe-label-color: $content-font !default;
$fe-text-color: $content-font !default;
$fe-active-border-color: $selection-bg !default;
$fe-active-bg-color: $selection-bg !default;
$fe-active-font-color: $selection-font !default;
$fe-hover-border-color: $hover-bg !default;
$fe-hover-bg-color: $hover-bg !default;
$fe-ah-border-color: $selection-bg !default;
$fe-ah-bg-color: $selection-bg !default;
$fe-focus-border-color: $hover-bg !default;
$fe-bc-color: $fe-text-color !default;
$fe-bc-link-color: $selection-bg !default;
$fe-bc-hover-bg-color: $hover-bg !default;
$fe-bc-hover-font-color: $content-font !default;
$fe-grid-header-bg-color: $bg-base-0 !default;
$fe-grid-type-color: $content-font !default;
$fe-grid-text-color: $content-font !default;
$fe-ddl-icon-color: $fe-text-color !default;
$fe-error-color: $error-alt !default;
$fe-img-border-color: rgba($border-fg, 1) !default;
$fe-search-bg-color: $bg-base-0 !default;
$fe-tb-hover-border-color: $hover-bg !default;
$fe-tb-focus-border-color: $selection-bg !default;
$fe-tb-focus-bg: $hover-bg !default;
$fe-checkbox-color: $selection-bg !default;
$fe-checkbox-bg-color: $bg-base-0 !default;
$fe-drop-border-color: $selection-bg !default;
$fe-up-list-border-color: $border-default !default;
$fe-clone-bg-color: $selection-bg !default;
$fe-clone-border-color: none !default;
$fe-clone-count-border-color: $content-font !default;
$fe-clone-count-font-color: $content-font !default;
$fe-clone-count-bg-color: $bg-base-0 !default;
$fe-drop-folder-bg-color: $selection-bg !default;

$fe-clone-box-shadow: 0 0 10px 0 rgba($bg-base-0, .2) !default;
$fe-clone-border: none !default;
$fe-img-box-shadow: 0 1px 3px 1px rgba(0, 0, 0, .05) !default;
$fe-tb-ddb-icon-padding: 0 !default;
$fe-tb-ddb-height: inherit !default;
...
$fe-search-padding: 1.5px 8px 0 8px !default;
...
$fe-grid-header-cb-padding-left: 10px !default;
$fe-grid-content-font-size: 12px !default;
$fe-grid-content-name-font-size: 13px !default;
$fe-grid-icon-sort-margin: 0 !default;
$fe-grid-row-ie-box-shadow: inset 0 1px 0 0 $border-default, inset 0 -1px 0 0 $border-default !default;
$fe-grid-row-fc-ie-box-shadow: inset 1px 1px 0 0 $border-default, inset 1px -1px 0 0 $border-default !default;
$fe-grid-row-lc-ie-box-shadow: inset -1px 1px 0 0 $border-default, inset -1px -1px 0 0 $border-default !default;
...
$fe-dd-popup-blank-icon-padding-left: 34px !default;
...
$fe-big-cb-line-height: 16px !default;
...
@include export-module('FileManager-highcontrast-icons') {
