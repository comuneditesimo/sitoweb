...
$fe-bc-li-item-height: 22px !default;
...
$fe-tb-ddb-height: calc(100% - 18px) !default;
...
$fe-bc-padding: 9px 8px 9px 8px !default;
$fe-rtl-bc-padding: 8px 18px 8px 12px !default;
$fe-bc-text-padding: 0 !default;
$fe-bc-text-size: 22px !default;
$fe-bc-icon-margin: 16px 14px !default;
...
$fe-lg-icon-margin: 18px 25px 8px !default;
...
$fe-big-search-height: 30px !default;
...
$fe-grid-empty-content-padding: 8px 0 8px 0 !default;
...
$fe-lg-icon-empty-content-padding: 8px 0 8px 0 !default;
...
$fe-bc-color: $content-text-color-alt1 !default;
...
@include export-module('FileManager-fluent-icons') {
