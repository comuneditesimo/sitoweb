...
@import '../../layouts/splitter/fabric-dark.scss';
...
$fm-skin-name: 'fabric-dark' !default;
$fe-bc-font-size: 16px !default;
...
$fe-big-bc-font-size: 18px !default;
...
$fe-border-color: $neutral-light !default;
$fe-background: $neutral-white !default;
$fe-icon-color: $neutral-secondary !default;
$fe-label-color: $neutral-light-font !default;
$fe-text-color: $neutral-secondary !default;
$fe-active-border-color: $neutral-quintenary !default;
$fe-active-bg-color: $neutral-quintenary !default;
$fe-focus-border-color:  $neutral-light !default;
$fe-active-font-color: $neutral-light-fontalt !default;
$fe-hover-border-color: $neutral-light !default;
$fe-hover-bg-color: $neutral-light !default;
$fe-ah-border-color: $neutral-light !default;
$fe-ah-bg-color: $neutral-quintenary !default;
$fe-bc-color: $neutral-secondary !default;
$fe-bc-link-color: $theme-tertiary !default;
$fe-bc-hover-bg-color: $neutral-lighter !default;
$fe-bc-hover-font-color: $theme-light !default;
$fe-grid-header-bg-color: $neutral-white !default;
$fe-ddl-icon-color: $theme-tertiary !default;
$fe-error-color: $error-font !default;
$fe-img-border-color: $neutral-tertiary !default;
$fe-search-bg-color:  $neutral-white !default;
$fe-tb-hover-border-color: $neutral-light !default;
$fe-tb-focus-border-color: $neutral-quintenary !default;
$fe-tb-focus-bg: $neutral-quintenary !default;
$fe-checkbox-color: $theme-primary-font !default;
$fe-checkbox-bg-color: $theme-primary !default;
$fe-drop-border-color: $grey-dark-font !default;
$fe-up-list-border-color: $neutral-light !default;
$fe-clone-bg-color: $neutral-quintenary !default;
$fe-clone-border-color: $neutral-light !default;
$fe-clone-count-border-color: $theme-primary !default;
$fe-clone-count-font-color: $theme-dark-font !default;
$fe-clone-count-bg-color: $theme-primary !default;
$fe-drop-folder-bg-color: $theme-primary !default;
...
$fe-tb-ddb-caret-size: 10px !default;
...
$fe-grid-row-ie-box-shadow: inset 0 1px 0 0 $neutral-secondary, inset 0 -1px 0 0 $neutral-secondary !default;
$fe-grid-row-fc-ie-box-shadow: inset 1px 1px 0 0 $neutral-secondary, inset 1px -1px 0 0 $neutral-secondary !default;
$fe-grid-row-lc-ie-box-shadow: inset -1px 1px 0 0 $neutral-secondary, inset -1px -1px 0 0 $neutral-secondary !default;
...
$fe-big-search-padding: 1.5px 4.5px 1px 8px !default;
...
$fe-big-bc-li-item-height: 32px !default;
$fe-big-bc-submenu-height: 30px !default;
...
$fe-mobile-newfolder-padding-top: 3px !default;
$fe-mobile-upload-padding-left: 5px !default;
...
@include export-module('FileManager-fabric-dark-icons') {
