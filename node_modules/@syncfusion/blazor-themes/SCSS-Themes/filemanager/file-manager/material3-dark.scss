...
@import '../../layouts/splitter/material3-dark.scss';
...
//layout variables
$fm-skin-name: 'Material3' !default;
$fe-bc-font-size: $text-sm !default;
$fe-bc-icon-font-size: 14px !default;
...
$fe-search-padding: 2px 16px 2px 0 !default;
$fe-search-height: 32px !default;
$fe-search-icon-margin: 0 !default;
$fe-search-icon-font-size : 20px !default;
$fe-search-clear-icon-padding: 0 !default;
$fe-search-input-margin: 0 0 0 42px !default;
...
$fe-lg-icon-width: 32px !default;
$fe-lg-icon-margin: 26px 32px 12px 32px !default;
$fe-lg-img-height: 62px !default;
$fe-lg-img-margin: 6px !default;
$fe-lg-text-padding: 0 0 16px !default;
$fe-lg-text-line-height: 18px !default;
...
$fe-big-lg-item-margin: 20px 8px !default;
$fe-big-lg-item-inner-height: 120px !default;
$fe-big-lg-item-inner-width: 120px !default;
$fe-big-lg-icon-height: 36px !default;
...
$fe-mobile-tb-icon-padding: 8px !default;
$fe-mobile-tb-icon-font-size: 24px !default;
...
$fe-big-lg-icon-empty-content-font-size: 22px !default;
...
$fe-big-grid-empty-content-font-size: 22px !default;
...
$fe-grid-empty-content-font-size: $text-base !default;
$fe-grid-empty-content-margin: 0 auto !default;
$fe-grid-empty-content-padding: 18px 0 8px 0 !default;
...
$fe-grid-empty-inner-content-color: rgba($content-text-color-alt1) !default;
...
$fe-lg-icon-empty-content-font-size: $text-base !default;
$fe-lg-icon-empty-content-margin: 0 auto !default;
$fe-lg-icon-empty-content-padding: 18px 0 8px 0 !default;
...
$fe-icon-color: rgba($icon-color) !default;
$fe-label-color: rgba($content-text-color) !default;
$fe-text-color: rgba($content-text-color) !default;
$fe-active-border-color: rgba($content-bg-color-selected) !default;
$fe-tb-active-color: rgba($secondary-text-color) !default;
$fe-active-bg-color: rgba($content-bg-color-selected) !default;
$fe-active-font-color: rgba($secondary-text-color) !default;
$fe-hover-border-color: $content-bg-color-hover !default;
$fe-hover-bg-color: $content-bg-color-hover !default;
$fe-ah-border-color: rgba($content-bg-color-selected) !default;
$fe-ah-bg-color: rgba($content-bg-color-selected) !default;
$fe-focus-border-color: rgba($border-light) !default;
$fe-bc-color: rgba($content-text-color-alt1) !default;
$fe-bc-link-color: rgba($content-text-color-alt1) !default;
$fe-bc-hover-bg-color: $content-bg-color-alt2 !default;
$fe-bc-hover-font-color: rgba($content-text-color) !default;
$fe-grid-header-bg-color: $content-bg-color-alt1 !default;
$fe-ddl-icon-color: rgba($icon-color) !default;
$fe-error-color: rgba($danger) !default;
$fe-img-border-color: rgba($border-light) !default;
$fe-search-bg-color: $content-bg-color-alt1 !default;
...
$fe-checkbox-color: rgba($primary-text-color) !default;
$fe-checkbox-bg-color: rgba($primary) !default;
$fe-drop-border-color: rgba($primary) !default;
$fe-up-list-border-color: rgba($border-light) !default;
$fe-clone-bg-color: $content-bg-color-alt3 !default;
$fe-clone-border-color: none !default;
$fe-clone-count-border-color: rgba($primary-text-color) !default;
$fe-clone-count-font-color: rgba($primary-text-color) !default;
$fe-clone-count-bg-color: rgba($primary) !default;
$fe-drop-folder-bg-color: rgba($primary) !default;
...
@include export-module('FileManager-material3-icons') {
