...
@import '../../layouts/splitter/bootstrap.scss';
...
$fm-skin-name: 'bootstrap' !default;
...
$fe-icon-color: $grey !default;
$fe-label-color: $grey-light !default;
$fe-text-color: $grey-light-font !default;
$fe-active-border-color: $brand-primary !default;
$fe-active-bg-color: $brand-primary !default;
$fe-active-font-color: $brand-primary-font !default;
$fe-hover-border-color: $grey-f5 !default;
$fe-hover-bg-color: $grey-f5 !default;
$fe-ah-border-color: $brand-primary !default;
$fe-ah-bg-color: $brand-primary !default;
$fe-focus-border-color: $grey-f5 !default;
$fe-bc-color: $grey-light-font !default;
$fe-bc-link-color: $brand-primary !default;
$fe-bc-hover-font-color: $brand-primary !default;
$fe-bc-hover-bg-color: $grey-f5 !default;
$fe-grid-header-bg-color: $grey-white !default;
$fe-grid-type-color: $grey-light !default;
$fe-grid-text-color: $grey-light-font !default;
$fe-ddl-icon-color: $brand-primary !default;
$fe-error-color: $brand-danger-dark !default;
$fe-img-border-color: $grey-white !default;
$fe-search-bg-color: $grey-white !default;
$fe-tb-hover-border-color: $grey-ad !default;
$fe-tb-focus-border-color: $grey-8c !default;
$fe-tb-focus-bg: $grey-e6 !default;
$fe-checkbox-color: $grey !default;
$fe-checkbox-bg-color: $grey-white !default;
$fe-drop-border-color: $brand-primary !default;
$fe-up-list-border-color: $grey-dd !default;
$fe-clone-bg-color: $grey-white !default;
$fe-clone-border-color: none !default;
$fe-clone-count-border-color: $brand-primary !default;
...
$fe-clone-box-shadow: 0 6px 12px rgba($grey-base, .175) !default;
...
$fe-tb-ddb-border: 1px solid !default;
...
$fe-grid-row-ie-box-shadow: inset 0 1px 0 0 $input-border-focus, inset 0 -1px 0 0 $input-border-focus !default;
$fe-grid-row-fc-ie-box-shadow: inset 1px 1px 0 0 $input-border-focus, inset 1px -1px 0 0 $input-border-focus !default;
$fe-grid-row-lc-ie-box-shadow: inset -1px 1px 0 0 $input-border-focus, inset -1px -1px 0 0 $input-border-focus !default;
...
@include export-module('FileManager-bootstrap-icons') {
